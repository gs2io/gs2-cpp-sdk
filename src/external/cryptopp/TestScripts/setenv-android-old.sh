...
case "$THE_ARCH" in
  arm|armv5|armv6|armv7|armeabi)
	...
	AOSP_ABI="armeabi"
	AOSP_ARCH="arch-arm"
	AOSP_FLAGS="-march=armv5te -mtune=xscale -mthumb -msoft-float -DGS2_CRYPTOPP_DISABLE_ASM -funwind-tables -fexceptions -frtti"
	;;
  armv7a|armv7-a|armeabi-v7a)
	...
	AOSP_ARCH="arch-arm"
	AOSP_FLAGS="-march=armv7-a -mthumb -mfpu=vfpv3-d16 -mfloat-abi=softfp -DGS2_CRYPTOPP_DISABLE_ASM -Wl,--fix-cortex-a8 -funwind-tables -fexceptions -frtti"
	;;
  hard|armv7a-hard|armeabi-v7a-hard)
	...
	AOSP_ABI="armeabi-v7a"
	AOSP_ARCH="arch-arm"
	AOSP_FLAGS="-mhard-float -D_NDK_MATH_NO_SOFTFP=1 -march=armv7-a -mfpu=vfpv3-d16 -DGS2_CRYPTOPP_DISABLE_ASM -mfloat-abi=softfp -Wl,--fix-cortex-a8 -funwind-tables -fexceptions -frtti -Wl,--no-warn-mismatch -Wl,-lm_hard"
	;;
  neon|armv7a-neon)
	TOOLCHAIN_ARCH="arm-linux-androideabi"
	TOOLCHAIN_NAME="arm-linux-androideabi"
  ...
  x86)
	...
	AOSP_ABI="x86"
	AOSP_ARCH="arch-x86"
	AOSP_FLAGS="-mtune=intel -mssse3 -mfpmath=sse -DGS2_CRYPTOPP_DISABLE_SSE4 -DGS2_CRYPTOPP_DISABLE_CLMUL -DGS2_CRYPTOPP_DISABLE_AES -DGS2_CRYPTOPP_DISABLE_SHA -funwind-tables -fexceptions -frtti"
	;;
  x86_64|x64)
	...
	AOSP_FLAGS="-march=x86-64 -msse4.2 -mpopcnt -mtune=intel -DGS2_CRYPTOPP_DISABLE_CLMUL -DGS2_CRYPTOPP_DISABLE_AES -DGS2_CRYPTOPP_DISABLE_SHA -funwind-tables -fexceptions -frtti"
	;;
  *)
