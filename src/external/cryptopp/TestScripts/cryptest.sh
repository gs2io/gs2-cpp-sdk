...
# Avoid GS2_CRYPTOPP_DATA_DIR in this shell (it is tested below)
unset GS2_CRYPTOPP_DATA_DIR
...
if [[ (-z "$HAVE_CXX17") ]]; then
	HAVE_CXX17=0
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=c++17 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_CXX17=1
	fi
fi
...
if [[ (-z "$HAVE_GNU17") ]]; then
	HAVE_GNU17=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=gnu++17 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_GNU17=1
	fi
fi
...
if [[ (-z "$HAVE_CXX20") ]]; then
	HAVE_CXX20=0
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=c++20 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_CXX20=1
	fi
fi
...
if [[ (-z "$HAVE_GNU20") ]]; then
	HAVE_GNU20=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=gnu++20 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_GNU20=1
	fi
fi
...
if [[ (-z "$HAVE_CXX14") ]]; then
	HAVE_CXX14=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=c++14 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_CXX14=1
	fi
fi
...
if [[ (-z "$HAVE_GNU14") ]]; then
	HAVE_GNU14=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=gnu++14 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_GNU14=1
	fi
fi
...
if [[ (-z "$HAVE_CXX11") ]]; then
	HAVE_CXX11=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=c++11 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_CXX11=1
	fi
fi
...
if [[ (-z "$HAVE_GNU11") ]]; then
	HAVE_GNU11=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=gnu++11 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_GNU11=1
	fi
fi
...
if [[ (-z "$HAVE_CXX03") ]]; then
	HAVE_CXX03=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=c++03 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_CXX03=1
	fi
fi
...
if [[ (-z "$HAVE_GNU03") ]]; then
	HAVE_GNU03=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -std=gnu++03 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		HAVE_GNU03=1
	fi
fi
...
OPT_O0=
rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -O0 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
if [[ ("$?" -eq "0") ]]; then
	OPT_O0=-O0
else
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -xO0 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		OPT_O0=-xO0
	fi
fi
...
OPT_O1=
rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -O1 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
if [[ ("$?" -eq "0") ]]; then
	HAVE_O1=1
	OPT_O1=-O1
else
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -xO1 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_O1=1
		OPT_O1=-xO1
	fi
...
OPT_O2=
rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -O2 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
if [[ ("$?" -eq "0") ]]; then
	HAVE_O2=1
	OPT_O2=-O2
else
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -xO2 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_O2=1
		OPT_O2=-xO2
	fi
...
OPT_O3=
rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -O3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
if [[ ("$?" -eq "0") ]]; then
	HAVE_O3=1
	OPT_O3=-O3
else
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -xO3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_O3=1
		OPT_O3=-xO3
	fi
...
if [[ ( (-z "$HAVE_O5") && ("$CLANG_COMPILER" -eq "0") ) ]]; then
	...
	OPT_O5=
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -O5 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_O5=1
		OPT_O5=-O5
	else
		rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -xO5 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ ("$?" -eq "0") ]]; then
			HAVE_O5=1
			OPT_O5=-xO5
		fi
...
if [[ (-z "$HAVE_OS") ]]; then
	...
	OPT_OS=
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -Os adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_OS=1
		OPT_OS=-Os
	fi
...
if [[ (-z "$HAVE_OFAST") ]]; then
	...
	OPT_OFAST=
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -Ofast adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_OFAST=1
		OPT_OFAST=-Ofast
	fi
...
OPT_G2=
rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -g2 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
if [[ ("$?" -eq "0") ]]; then
	OPT_G2=-g2
else
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -g adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		OPT_G2=-g
	fi
fi
...
OPT_G3=
rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -g3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
if [[ ("$?" -eq "0") ]]; then
	OPT_G3=-g3
else
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
...
if [[ (-z "$HAVE_PIC") ]]; then
	HAVE_PIC=0
	PIC_PROBLEMS=$("$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fPIC adhoc.cpp -o "$TMPDIR/adhoc.exe" 2>&1 | "$GREP" -i -c -E  '(warning|error)')
...
if [[ (-z "$HAVE_UBSAN") ]]; then
	HAVE_UBSAN=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fsanitize=undefined adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
...
if [[ (-z "$HAVE_ASAN") ]]; then
	HAVE_ASAN=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fsanitize=address adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		"$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ ("$?" -eq "0") ]]; then
			HAVE_ASAN=1
...
if [[ (-z "$HAVE_BSAN") ]]; then
	HAVE_BSAN=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fsanitize=bounds-strict adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		"$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ ("$?" -eq "0") ]]; then
			HAVE_BSAN=1
...
if [[ (-z "$HAVE_CET") ]]; then
	HAVE_CET=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fcf-protection=full -mcet adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		"$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ ("$?" -eq "0") ]]; then
			HAVE_CET=1
...
if [[ (-z "$HAVE_REPTOLINE") ]]; then
	HAVE_REPTOLINE=0
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -mfunction-return=thunk -mindirect-branch=thunk adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		"$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ ("$?" -eq "0") ]]; then
			HAVE_REPTOLINE=1
...
if [[ (-z "$HAVE_OMP") ]]; then
	...
	if [[ "$GCC_COMPILER" -ne "0" ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fopenmp -O3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			HAVE_OMP=1
			OMP_FLAGS=(-fopenmp -O3)
		fi
	elif [[ "$INTEL_COMPILER" -ne "0" ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -openmp -O3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			HAVE_OMP=1
			OMP_FLAGS=(-openmp -O3)
		fi
	elif [[ "$CLANG_COMPILER" -ne "0" ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fopenmp=libomp -O3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			HAVE_OMP=1
			OMP_FLAGS=(-fopenmp=libomp -O3)
		fi
	elif [[ "$SUN_COMPILER" -ne "0" ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -xopenmp=parallel -xO3 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			HAVE_OMP=1
...
if [[ (-z "$HAVE_INTEL_MULTIARCH") ]]; then
	...
	if [[ ("$IS_DARWIN" -ne "0") && ("$IS_X86" -ne "0" || "$IS_X64" -ne "0") ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -arch i386 -arch x86_64 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
...
if [[ (-z "$HAVE_PPC_MULTIARCH") ]]; then
	...
	if [[ ("$IS_DARWIN" -ne "0") && ("$IS_PPC32" -ne "0" || "$IS_PPC64" -ne "0") ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -arch ppc -arch ppc64 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
...
if [[ (-z "$HAVE_X32") ]]; then
	HAVE_X32=0
	if [[ "$IS_X32" -ne "0" ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -mx32 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			HAVE_X32=1
		fi
	fi
...
if [[ (-z "$HAVE_NATIVE_ARCH") ]]; then
	HAVE_NATIVE_ARCH=0
	rm -f "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -march=native adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ ("$?" -eq "0") ]]; then
		HAVE_NATIVE_ARCH=1
	fi
fi
...
if [[ (-z "$HAVE_LDGOLD") ]]; then
	...
	if [[ (! -z "$LD_GOLD") && (! -z "$ELF_FILE") ]]; then
		...
		if [[ ("$LD_GOLD" -ne "0") ]]; then
			"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -fuse-ld=gold adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
			if [[ "$?" -eq "0" ]]; then
				HAVE_LDGOLD=1
			fi
		fi
...
if [[ ("$HAVE_DISASS" -ne "0" && ("$IS_X86" -ne "0" || "$IS_X64" -ne "0")) ]]; then
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -msse4.2 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		X86_CRC32=1
	fi
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -maes adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		X86_AESNI=1
	fi
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -mpclmul adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		X86_PCLMUL=1
	fi
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -mrdrnd adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		X86_RDRAND=1
	fi
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -mrdseed adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		X86_RDSEED=1
	fi
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -msha adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		X86_SHA=1
	fi
...
if [[ ("$HAVE_DISASS" -ne "0" && ("$IS_ARM32" -ne "0" || "$IS_ARM64" -ne "0")) ]]; then
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -march=armv8-a+crc adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		ARM_CRC32=1
	fi
	...
	"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -march=armv8-a+crypto adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
		ARM_PMULL=1
	fi
...
if [[ ("$HAVE_DISASS" -ne "0" && ("$IS_PPC32" -ne "0" || "$IS_PPC64" -ne "0")) ]]; then
	...
	if [[ ("$PPC_AES" -eq "0") ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -mcpu=power8 adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			PPC_AES=1
	...
	if [[ ("$PPC_AES" -eq "0") ]]; then
		"$CXX" -DGS2_CRYPTOPP_ADHOC_MAIN -qarch=pwr8 -qaltivec adhoc.cpp -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
			PPC_AES=1
...
if [[ ("$IS_DEBIAN" -ne "0" || "$IS_UBUNTU" -ne "0") ]]; then
	...
	"-fstack-protector-strong" "-Wformat -Werror=format-security" "-DGS2_CRYPTOPP_INIT_PRIORITY=250"
	"-DGS2_CRYPTOPP_NO_UNALIGNED_DATA_ACCESS" "-DNDEBUG" "-fPIC" "-DPIC")
...
if [[ ( ("$IS_X86" -ne "0" || "$IS_X32" -ne "0" || "$IS_X64" -ne "0") && "$HAVE_NATIVE_ARCH" -ne "0") ]]; then
	...
	if [[ "$IS_X86" -ne "0" ]]; then
		...
		# The makefile may add -DGS2_CRYPTOPP_DISABLE_XXX, so we can't add -march=native
...
if true; then
	...
	CXXFLAGS="$DEBUG_CXXFLAGS -DGS2_CRYPTOPP_DISABLE_ASM"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -DGS2_CRYPTOPP_DISABLE_ASM"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if true; then
	...
	CXXFLAGS="$DEBUG_CXXFLAGS -DGS2_CRYPTOPP_NO_CPU_FEATURE_PROBES=1"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -DGS2_CRYPTOPP_NO_CPU_FEATURE_PROBES=1"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
############################################
# Debug build, GS2_CRYPTOPP_NO_CXX11
if [[ "$HAVE_CXX11" -ne "0" ]] || [[ "$HAVE_GNU11" -ne "0" ]]; then
	...
	echo
	echo "************************************" | tee -a "$TEST_RESULTS"
	echo "Testing: Debug, GS2_CRYPTOPP_NO_CXX11" | tee -a "$TEST_RESULTS"
	echo

	TEST_LIST+=("Debug, GS2_CRYPTOPP_NO_CXX11")

	"$MAKE" clean > /dev/null 2>&1
	rm -f adhoc.cpp > /dev/null 2>&1

	CXXFLAGS="$DEBUG_CXXFLAGS -DGS2_CRYPTOPP_CRYPTOPP_NO_CXX11=1"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
	...
	echo
	echo "************************************" | tee -a "$TEST_RESULTS"
	echo "Testing: Release, GS2_CRYPTOPP_NO_CXX11" | tee -a "$TEST_RESULTS"
	echo

	TEST_LIST+=("Release, GS2_CRYPTOPP_NO_CXX11")

	"$MAKE" clean > /dev/null 2>&1
	rm -f adhoc.cpp > /dev/null 2>&1

	CXXFLAGS="$RELEASE_CXXFLAGS -DGS2_CRYPTOPP_CRYPTOPP_NO_CXX11=1"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if true; then
	...
	CXXFLAGS="$DEBUG_CXXFLAGS -DGS2_CRYPTOPP_INIT_PRIORITY=0 $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -DGS2_CRYPTOPP_INIT_PRIORITY=0 $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static dynamic cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if [[ "$IS_DARWIN" -ne "0" && "$HAVE_INTEL_MULTIARCH" -ne "0" && "$HAVE_CXX03" -ne "0" ]]; then
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -arch i386 -arch x86_64 -std=c++03 -DGS2_CRYPTOPP_DISABLE_ASM $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if [[ "$IS_DARWIN" -ne "0" && "$HAVE_INTEL_MULTIARCH" -ne "0" && "$HAVE_CXX11" -ne "0" ]]; then
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -arch i386 -arch x86_64 -std=c++11 -DGS2_CRYPTOPP_DISABLE_ASM $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if [[ "$IS_DARWIN" -ne "0" && "$HAVE_INTEL_MULTIARCH" -ne "0" && "$HAVE_CXX14" -ne "0" ]]; then
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -arch i386 -arch x86_64 -std=c++14 -DGS2_CRYPTOPP_DISABLE_ASM $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if [[ "$IS_DARWIN" -ne "0" && "$HAVE_INTEL_MULTIARCH" -ne "0" && "$HAVE_CXX17" -ne "0" ]]; then
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -arch i386 -arch x86_64 -std=c++17 -DGS2_CRYPTOPP_DISABLE_ASM $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if [[ ("$IS_DARWIN" -ne "0" && "$HAVE_PPC_MULTIARCH" -ne "0") ]]; then
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -arch ppc -arch ppc64 -DGS2_CRYPTOPP_DISABLE_ASM $USER_CXXFLAGS"
	CXX="$CXX" CXXFLAGS="$CXXFLAGS" "$MAKE" "${MAKEARGS[@]}" static cryptest.exe 2>&1 | tee -a "$TEST_RESULTS"
...
if [[ ("$CLANG_COMPILER" -eq "0") ]]; then
	...
	"$CLANG_CXX" -x c++ -DGS2_CRYPTOPP_ADHOC_MAIN adhoc.cpp.proto -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
...
if [[ ("$GCC_COMPILER" -eq "0") ]]; then
	...
	"$GCC_CXX" -x c++ -DGS2_CRYPTOPP_ADHOC_MAIN adhoc.cpp.proto -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
...
if [[ ("$INTEL_COMPILER" -eq "0") ]]; then
	...
	"$INTEL_CXX" -x c++ -DGS2_CRYPTOPP_ADHOC_MAIN adhoc.cpp.proto -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
	if [[ "$?" -eq "0" ]]; then
...
if [[ ("$IS_DARWIN" -ne "0" && "$MACPORTS_COMPILER" -eq "0") ]]; then
	...
	if [[ (! -z "$MACPORTS_CXX") ]]; then
		"$MACPORTS_CXX" -x c++ -std=c++11 -DGS2_CRYPTOPP_ADHOC_MAIN adhoc.cpp.proto -o "$TMPDIR/adhoc.exe" > /dev/null 2>&1
		if [[ "$?" -eq "0" ]]; then
...
############################################
# Test an install with GS2_CRYPTOPP_DATA_DIR
if [[ ("$IS_CYGWIN" -eq "0") && ("$IS_MINGW" -eq "0") ]]; then
	...
	CXXFLAGS="$RELEASE_CXXFLAGS -DGS2_CRYPTOPP_DATA_DIR='\"$INSTALL_DIR/share/cryptopp/\"' $USER_CXXFLAGS"
...
############################################
# Test a remove with GS2_CRYPTOPP_DATA_DIR
if [[ ("$IS_CYGWIN" -eq "0" && "$IS_MINGW" -eq "0") ]]; then
...
ECOUNT=$("$GREP" -E '(Error|ERROR|error|FAILED|Illegal|Conditional|gs2::detail::CryptoPP::Exception)' $TEST_RESULTS | "$GREP" -v -E '( 0 errors|suppressed errors|error detector|format-security)' | wc -l | "$AWK" '{print $1}')
if (( "$ECOUNT" == "0" )); then
	echo "No failures detected" | tee -a "$TEST_RESULTS"
else
	echo "$ECOUNT errors detected. See $TEST_RESULTS for details" | tee -a "$TEST_RESULTS"
	if (( "$ECOUNT" < 16 )); then
		"$GREP" -n -E '(Error|ERROR|error|FAILED|Illegal|Conditional|gs2::detail::CryptoPP::Exception)' "$TEST_RESULTS" | "$GREP" -v -E '( 0 errors|suppressed errors|error detector|Assertion|format-security)'
	fi
fi
