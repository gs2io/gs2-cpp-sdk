...
#ifndef GS2_CRYPTOPP_SEAL_H
#define GS2_CRYPTOPP_SEAL_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == LITTLE_ENDIAN_ORDER ? "SEAL-3.0-LE" : "SEAL-3.0-BE";}
};
...
/// \since Crypto++ 2.2
template <class B = BigEndian>
class GS2_CRYPTOPP_NO_VTABLE SEAL_Policy : public AdditiveCipherConcretePolicy<word32, 256>, public SEAL_Info<B>
{
protected:
