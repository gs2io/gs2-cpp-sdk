...
#ifndef GS2_CRYPTOPP_RANDPOOL_H
#define GS2_CRYPTOPP_RANDPOOL_H
...
/// \sa OldRandomPool
/// \since Crypto++ 4.0 (PGP 2.6.x style), Crypto++ 5.5 (AES-256 based)
class GS2_CRYPTOPP_DLL RandomPool : public RandomNumberGenerator, public NotCopyable
{
public:
...
///   GS2_CRYPTOPP_MAINTAIN_BACKWARDS_COMPATIBILITY. OldRandomPool also provides the modern
...
class GS2_CRYPTOPP_DLL OldRandomPool : public RandomNumberGenerator
{
public:
