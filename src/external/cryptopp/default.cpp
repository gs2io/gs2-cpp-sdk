...
{
	GS2_CRYPTOPP_COMPILE_ASSERT((int)SALTLENGTH <= DIGESTSIZE);
	GS2_CRYPTOPP_COMPILE_ASSERT((int)BLOCKSIZE <= (int)DIGESTSIZE);
}
...
{
	GS2_CRYPTOPP_COMPILE_ASSERT((int)SALTLENGTH <= (int)DIGESTSIZE);
	GS2_CRYPTOPP_COMPILE_ASSERT((int)BLOCKSIZE <= (int)DIGESTSIZE);
}
...
{
	GS2_CRYPTOPP_UNUSED(inString); GS2_CRYPTOPP_UNUSED(length);
	m_filter->MessageEnd();
}
