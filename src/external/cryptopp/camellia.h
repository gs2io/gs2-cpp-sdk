...
#ifndef GS2_CRYPTOPP_CAMELLIA_H
#define GS2_CRYPTOPP_CAMELLIA_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Camellia";}
};
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Camellia_Info>
	{
	public:
	...
	protected:
		GS2_CRYPTOPP_ALIGN_DATA(4) static const byte s1[256];
