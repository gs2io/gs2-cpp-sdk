...
#ifndef GS2_CRYPTOPP_PSSR_H
#define GS2_CRYPTOPP_PSSR_H
...
/// \since Crypto++ 2.1
class GS2_CRYPTOPP_DLL PSSR_MEM_Base : public PK_RecoverableSignatureMessageEncodingMethod
{
public:
...
public:
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string(ALLOW_RECOVERY ? "PSSR-" : "PSS-") + MGF::StaticAlgorithmName();}
};
