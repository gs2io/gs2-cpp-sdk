...
#ifndef GS2_CRYPTOPP_SERPENT_H
#define GS2_CRYPTOPP_SERPENT_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Serpent";}
};
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Serpent_Info>
	{
	public:
