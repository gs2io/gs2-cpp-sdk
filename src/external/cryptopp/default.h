...
#ifndef GS2_CRYPTOPP_DEFAULT_H
#define GS2_CRYPTOPP_DEFAULT_H
...
{
	GS2_CRYPTOPP_CONSTANT(BLOCKSIZE  = BlockSize)
	GS2_CRYPTOPP_CONSTANT(KEYLENGTH  = KeyLength)
	GS2_CRYPTOPP_CONSTANT(SALTLENGTH = SaltSize)
	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE = DigestSize)
	GS2_CRYPTOPP_CONSTANT(ITERATIONS = Iterations)
};
...
{
public:
	GS2_CRYPTOPP_CONSTANT(BLOCKSIZE  = Info::BLOCKSIZE)
	GS2_CRYPTOPP_CONSTANT(KEYLENGTH  = Info::KEYLENGTH)
	GS2_CRYPTOPP_CONSTANT(SALTLENGTH = Info::SALTLENGTH)
	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE = Info::DIGESTSIZE)
	GS2_CRYPTOPP_CONSTANT(ITERATIONS = Info::ITERATIONS)
...
protected:
	void FirstPut(const byte *inString) {GS2_CRYPTOPP_UNUSED(inString);}
	void LastPut(const byte *inString, size_t length);
