...
#ifndef GS2_CRYPTOPP_FIPS140_H
#define GS2_CRYPTOPP_FIPS140_H
...
///   when GS2_CRYPTOPP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined.
class GS2_CRYPTOPP_DLL SelfTestFailure : public Exception
{
public:
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API FIPS_140_2_ComplianceEnabled();
...
///   when GS2_CRYPTOPP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined.
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API DoPowerUpSelfTest(const char *moduleFilename, const byte *expectedModuleMac);
...
/// \details The self tests for an algorithm are performed by the Algortihm class
///   when GS2_CRYPTOPP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined.
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API DoDllPowerUpSelfTest();
...
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API SimulatePowerUpSelfTestFailure();

/// \brief Provides the current power-up self test status
/// \returns the current power-up self test status
GS2_CRYPTOPP_DLL PowerUpSelfTestStatus GS2_CRYPTOPP_API GetPowerUpSelfTestStatus();

#ifndef GS2_CRYPTOPP_DOXYGEN_PROCESSING
typedef PowerUpSelfTestStatus (GS2_CRYPTOPP_API * PGetPowerUpSelfTestStatus)();
#endif

/// \brief Class object that calculates the MAC on the module
/// \returns the MAC for the module
GS2_CRYPTOPP_DLL MessageAuthenticationCode * GS2_CRYPTOPP_API NewIntegrityCheckingMAC();
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IntegrityCheckModule(const char *moduleFilename, const byte *expectedModuleMac, SecByteBlock *pActualMac = NULLPTR, unsigned long *pMacFileLocation = NULLPTR);
...
/// \details After the DLL is built but before it is MAC'd, the string GS2_CRYPTOPP_DUMMY_DLL_MAC
...
#define GS2_CRYPTOPP_DUMMY_DLL_MAC "MAC_51f34b8db820ae8"
