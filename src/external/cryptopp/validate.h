...
#ifndef GS2_CRYPTOPP_VALIDATE_H
#define GS2_CRYPTOPP_VALIDATE_H
...
// If GS2_CRYPTOPP_DEBUG or GS2_CRYPTOPP_COVERAGE is in effect, then perform additional tests
#if (defined(GS2_CRYPTOPP_DEBUG) || defined(GS2_CRYPTOPP_COVERAGE) || defined(GS2_CRYPTOPP_VALGRIND)) && !defined(GS2_CRYPTOPP_IMPORTS)
# define GS2_CRYPTOPP_EXTENDED_VALIDATION 1
#endif
...
gs2::detail::CryptoPP::RandomNumberGenerator & GlobalRNG();

bool RunTestDataFile(const char *filename, const gs2::detail::CryptoPP::NameValuePairs &overrideParameters=gs2::detail::CryptoPP::g_nullNameValuePairs, bool thorough=true);
