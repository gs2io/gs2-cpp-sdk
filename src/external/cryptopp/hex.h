...
#ifndef GS2_CRYPTOPP_HEX_H
#define GS2_CRYPTOPP_HEX_H
...
class GS2_CRYPTOPP_DLL HexEncoder : public SimpleProxyFilter
{
public:
...
class GS2_CRYPTOPP_DLL HexDecoder : public BaseN_Decoder
{
public:
...
private:
	static const int * GS2_CRYPTOPP_API GetDefaultDecodingLookupArray();
};
