...
#ifndef GS2_CRYPTOPP_SM4_H
#define GS2_CRYPTOPP_SM4_H
...
/// \since Crypto++ 6.0
class GS2_CRYPTOPP_NO_VTABLE SM4 : public SM4_Info, public BlockCipherDocumentation
{
public:
    /// \brief SM4 block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<SM4_Info>
    {
    protected:
