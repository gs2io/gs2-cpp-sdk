#ifndef GS2_CRYPTOPP_SOCKETFT_H
#define GS2_CRYPTOPP_SOCKETFT_H
...
public:
	...
	~SocketsInitializer() {try {Socket::ShutdownSockets();} catch (const Exception&) {GS2_CRYPTOPP_ASSERT(0);}}
};
