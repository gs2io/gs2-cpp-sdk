...
{
	GS2_CRYPTOPP_UNUSED(xorBlock);
	GS2_CRYPTOPP_ASSERT(IsAlignedOn(inBlock,GetAlignmentOf<word32>()));
	GS2_CRYPTOPP_ASSERT(IsAlignedOn(outBlock,GetAlignmentOf<word32>()));
