...
{
#if defined(GS2_CRYPTOPP_X86_ASM_AVAILABLE)
	if (!HasPadlockRNG())
...
#if defined(GS2_CRYPTOPP_X86_ASM_AVAILABLE) && defined(__GNUC__)
	while (size)
	{
...
#elif defined(GS2_CRYPTOPP_X86_ASM_AVAILABLE) && defined(_MSC_VER) && defined(_M_IX86)
	while (size)
	{
...
#endif  // GS2_CRYPTOPP_X86_ASM_AVAILABLE
}
