...
#ifndef GS2_CRYPTOPP_OSRNG_H
#define GS2_CRYPTOPP_OSRNG_H
...
class GS2_CRYPTOPP_DLL OS_RNG_Err : public Exception
{
public:
...
class GS2_CRYPTOPP_DLL MicrosoftCryptoProvider
{
public:
...
class GS2_CRYPTOPP_DLL NonblockingRng : public RandomNumberGenerator
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "NonblockingRng"; }
...
#if defined(BLOCKING_RNG_AVAILABLE) || defined(GS2_CRYPTOPP_DOXYGEN_PROCESSING)
...
class GS2_CRYPTOPP_DLL BlockingRng : public RandomNumberGenerator
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "BlockingRng"; }
...
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API OS_GenerateRandomBlock(bool blocking, byte *output, size_t size);
...
class GS2_CRYPTOPP_DLL AutoSeededRandomPool : public RandomPool
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "AutoSeededRandomPool"; }
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AutoSeededX917RNG<AES>;
...
///   If GS2_CRYPTOPP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined, then DefaultAutoSeededRNG is
