...
#ifndef GS2_CRYPTOPP_PANAMA_H
#define GS2_CRYPTOPP_PANAMA_H
...
# define GS2_CRYPTOPP_DISABLE_PANAMA_ASM
#endif
...
template <class B>
class GS2_CRYPTOPP_NO_VTABLE Panama
{
public:
	void Reset();
...
protected:
	...
	GS2_CRYPTOPP_CONSTANT(STAGES = 32)
...
{
public:
	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE = 32)
	PanamaHash() {Panama<B>::Reset();}
	unsigned int DigestSize() const {return DIGESTSIZE;}
	void TruncatedFinal(byte *hash, size_t size);
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == BIG_ENDIAN_ORDER ? "Panama-BE" : "Panama-LE";}
