...
#ifndef GS2_CRYPTOPP_WAIT_H
#define GS2_CRYPTOPP_WAIT_H
...
#if defined(GS2_CRYPTOPP_WIN32_AVAILABLE)
...
#define GS2_CRYPTOPP_TRACER_CONSTRUCTOR(DERIVED) \
	public: DERIVED(unsigned int level = 0) : Tracer(level) {}

#define GS2_CRYPTOPP_BEGIN_TRACER_CLASS_1(DERIVED, BASE1) \
	class DERIVED : virtual public BASE1, public NotCopyable { GS2_CRYPTOPP_TRACER_CONSTRUCTOR(DERIVED)

#define GS2_CRYPTOPP_BEGIN_TRACER_CLASS_2(DERIVED, BASE1, BASE2) \
	class DERIVED : virtual public BASE1, virtual public BASE2, public NotCopyable { GS2_CRYPTOPP_TRACER_CONSTRUCTOR(DERIVED)

#define GS2_CRYPTOPP_END_TRACER_CLASS };
...
#define GS2_CRYPTOPP_BEGIN_TRACER_EVENTS(UNIQUENR)	enum { EVENTBASE = UNIQUENR,
#define GS2_CRYPTOPP_TRACER_EVENT(EVENTNAME)				EventNr_##EVENTNAME,
#define GS2_CRYPTOPP_END_TRACER_EVENTS				};
...
#define GS2_CRYPTOPP_TRACER_EVENT_METHODS(EVENTNAME, LOGLEVEL) \
...
GS2_CRYPTOPP_BEGIN_TRACER_CLASS_1(WaitObjectsTracer, Tracer)
	GS2_CRYPTOPP_BEGIN_TRACER_EVENTS(0x48752841)
		GS2_CRYPTOPP_TRACER_EVENT(NoWaitLoop)
	GS2_CRYPTOPP_END_TRACER_EVENTS
	GS2_CRYPTOPP_TRACER_EVENT_METHODS(NoWaitLoop, 1)
GS2_CRYPTOPP_END_TRACER_CLASS
