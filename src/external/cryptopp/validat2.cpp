...
bool ValidateRSA()
{
...

	{
		...
		FileSource keys(GS2_CRYPTOPP_DATA_DIR "TestData/rsa512a.dat", true, new HexDecoder);
		Weak::RSASSA_PKCS1v15_MD2_Signer rsaPriv(keys);
		Weak::RSASSA_PKCS1v15_MD2_Verifier rsaPub(rsaPriv);

		size_t signatureLength = rsaPriv.SignMessage(GlobalRNG(), (byte *)plain, strlen(plain), out);
		GS2_CRYPTOPP_ASSERT(signatureLength <= sizeof(out));
	...
	/////
	{
		...
		FileSource keys(GS2_CRYPTOPP_DATA_DIR "TestData/rsa2048a.dat", true, new HexDecoder);
	...
	/////
	{
		FileSource keys(GS2_CRYPTOPP_DATA_DIR "TestData/rsa1024.dat", true, new HexDecoder);
	...
	}
	{
		...
		FileSource privFile(GS2_CRYPTOPP_DATA_DIR "TestData/rsa400pv.dat", true, new HexDecoder);
		FileSource pubFile(GS2_CRYPTOPP_DATA_DIR "TestData/rsa400pb.dat", true, new HexDecoder);
...
bool ValidateDH()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/dh1024.dat", true, new HexDecoder());
	DH dh(f);
...
bool ValidateMQV()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/mqv1024.dat", true, new HexDecoder());
	MQV mqv(f);
...
bool ValidateHMQV()
{
	...
	FileSource f256(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv256.dat", true, new HexDecoder());
	FileSource f384(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv384.dat", true, new HexDecoder());
	FileSource f512(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv512.dat", true, new HexDecoder());
...
bool ValidateFHMQV()
{
	...
	FileSource f256(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv256.dat", true, new HexDecoder());
	FileSource f384(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv384.dat", true, new HexDecoder());
	FileSource f512(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv512.dat", true, new HexDecoder());
...
bool ValidateLUC_DH()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/lucd512.dat", true, new HexDecoder());
	LUC_DH dh(f);
	return SimpleKeyAgreementValidate(dh);
}
...
bool ValidateXTR_DH()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/xtrdh171.dat", true, new HexDecoder());
	XTR_DH dh(f);
	return SimpleKeyAgreementValidate(dh);
}
...
bool ValidateElGamal()
{
	...
	bool pass = true;
	{
		FileSource fc(GS2_CRYPTOPP_DATA_DIR "TestData/elgc1024.dat", true, new HexDecoder);
...
bool ValidateDLIES()
{
	...
	bool pass = true;
	{
		FileSource fc(GS2_CRYPTOPP_DATA_DIR "TestData/dlie1024.dat", true, new HexDecoder);
...
bool ValidateNR()
{
	...
	bool pass = true;
	{
		FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/nr2048.dat", true, new HexDecoder);
...
bool ValidateDSA(bool thorough)
{
	...
	bool pass = true;
	FileSource fs1(GS2_CRYPTOPP_DATA_DIR "TestData/dsa1024.dat", true, new HexDecoder());
	DSA::Signer priv(fs1);
	DSA::Verifier pub(priv);
	FileSource fs2(GS2_CRYPTOPP_DATA_DIR "TestData/dsa1024b.dat", true, new HexDecoder());
	DSA::Verifier pub1(fs2);
	GS2_CRYPTOPP_ASSERT(pub.GetKey() == pub1.GetKey());
	pass = SignatureValidate(priv, pub, thorough) && pass;
	pass = RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/dsa.txt", g_nullNameValuePairs, thorough) && pass;
...
bool ValidateLUC()
{
	...
	{
		FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/luc1024.dat", true, new HexDecoder);
...
bool ValidateLUC_DL()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/lucs512.dat", true, new HexDecoder);
	...
	FileSource fc(GS2_CRYPTOPP_DATA_DIR "TestData/lucc512.dat", true, new HexDecoder);
...
bool ValidateRabin()
{
	...
	{
		FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/rabi1024.dat", true, new HexDecoder);
...
bool ValidateRW()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/rw1024.dat", true, new HexDecoder);
...
bool ValidateBlumGoldwasser()
{
	...
	FileSource f(GS2_CRYPTOPP_DATA_DIR "TestData/blum512.dat", true, new HexDecoder);
...
bool ValidateECDSA()
{
	...
	GS2_CRYPTOPP_ASSERT(result); GS2_CRYPTOPP_UNUSED(result);
...
bool ValidateESIGN()
{
	...
	FileSource keys(GS2_CRYPTOPP_DATA_DIR "TestData/esig1536.dat", true, new HexDecoder);
