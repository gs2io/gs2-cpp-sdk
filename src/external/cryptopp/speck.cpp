...
using gs2::detail::CryptoPP::rotlConstant;
using gs2::detail::CryptoPP::rotrConstant;
...
{
    GS2_CRYPTOPP_ASSERT(keyLength == 12 || keyLength == 16);
...
{
    GS2_CRYPTOPP_ASSERT(keyLength == 16 || keyLength == 24 || keyLength == 32);
    GS2_CRYPTOPP_UNUSED(params);
...
#if defined(GS2_CRYPTOPP_SPECK64_ADVANCED_PROCESS_BLOCKS)
...
#endif  // GS2_CRYPTOPP_SPECK64_ADVANCED_PROCESS_BLOCKS

#if defined(GS2_CRYPTOPP_SPECK128_ADVANCED_PROCESS_BLOCKS)
...
#endif  // GS2_CRYPTOPP_SPECK128_ADVANCED_PROCESS_BLOCKS
