...
#ifndef GS2_CRYPTOPP_POLYNOMI_H
#define GS2_CRYPTOPP_POLYNOMI_H
...
inline bool operator==(const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &a, const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &b)
...
///
template <class T, int instance>
inline gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> operator+(const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &a, const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance>(a.Plus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> operator-(const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &a, const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance>(a.Minus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> operator*(const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &a, const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance>(a.Times(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> operator/(const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &a, const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance>(a.DividedBy(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> operator%(const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &a, const gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return gs2::detail::CryptoPP::PolynomialOverFixedRing<T, instance>(a.Modulo(b, a.ms_fixedRing));}
...
NAMESPACE_BEGIN(std)
template<class T> inline void swap(gs2::detail::CryptoPP::PolynomialOver<T> &a, gs2::detail::CryptoPP::PolynomialOver<T> &b)
{
	a.swap(b);
}
template<class T, int i> inline void swap(gs2::detail::CryptoPP::PolynomialOverFixedRing<T,i> &a, gs2::detail::CryptoPP::PolynomialOverFixedRing<T,i> &b)
{
	a.swap(b);
}
NAMESPACE_END
