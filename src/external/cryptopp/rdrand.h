...
#ifndef GS2_CRYPTOPP_RDRAND_H
#define GS2_CRYPTOPP_RDRAND_H
...
{
public:
    GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RDRAND"; }
...
{
public:
    GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RDSEED"; }
