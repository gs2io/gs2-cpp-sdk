...
using gs2::detail::CryptoPP::GetWord;
using gs2::detail::CryptoPP::PutWord;
using gs2::detail::CryptoPP::Salsa20_Core;
using gs2::detail::CryptoPP::rotlConstant;
using gs2::detail::CryptoPP::LITTLE_ENDIAN_ORDER;
using gs2::detail::CryptoPP::AlignedSecByteBlock;
...
{
    using gs2::detail::CryptoPP::SHA256;
    using gs2::detail::CryptoPP::PKCS5_PBKDF2_HMAC;
...
void Scrypt::ValidateParameters(size_t derivedLen, word64 cost, word64 blockSize, word64 parallelization) const
{
    ...
    GS2_CRYPTOPP_ASSERT(IsPowerOf2(cost));
    ...
    GS2_CRYPTOPP_ASSERT(prod < (1U << 30));
    ...
    GS2_CRYPTOPP_ASSERT(bLimit); GS2_CRYPTOPP_ASSERT(xyLimit); GS2_CRYPTOPP_ASSERT(vLimit);
...
{
    GS2_CRYPTOPP_ASSERT(secret /*&& secretLen*/);
    GS2_CRYPTOPP_ASSERT(derived && derivedLen);
    GS2_CRYPTOPP_ASSERT(derivedLen <= MaxDerivedLength());
