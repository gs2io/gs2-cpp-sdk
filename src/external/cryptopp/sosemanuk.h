...
#ifndef GS2_CRYPTOPP_SOSEMANUK_H
#define GS2_CRYPTOPP_SOSEMANUK_H
...
# define GS2_CRYPTOPP_DISABLE_SOSEMANUK_ASM
#endif
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Sosemanuk";}
};
