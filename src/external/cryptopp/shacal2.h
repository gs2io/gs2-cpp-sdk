...
#ifndef GS2_CRYPTOPP_SHACAL2_H
#define GS2_CRYPTOPP_SHACAL2_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SHACAL-2";}
};
...
class SHACAL2 : public SHACAL2_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<SHACAL2_Info>
	{
	public:
