...
#ifndef GS2_CRYPTOPP_WAKE_H
#define GS2_CRYPTOPP_WAKE_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == LITTLE_ENDIAN_ORDER ? "WAKE-OFB-LE" : "WAKE-OFB-BE";}
};

class GS2_CRYPTOPP_NO_VTABLE WAKE_Base
{
protected:
...
/// \since Crypto++ 1.0
template <class B = BigEndian>
class GS2_CRYPTOPP_NO_VTABLE WAKE_Policy : public AdditiveCipherConcretePolicy<word32, 1, 64>, protected WAKE_Base
{
protected:
