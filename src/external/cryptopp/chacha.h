...
#ifndef GS2_CRYPTOPP_CHACHA_H
#define GS2_CRYPTOPP_CHACHA_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {
...
/// \since Crypto++ 5.6.4
template <unsigned int R>
class GS2_CRYPTOPP_NO_VTABLE ChaCha_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
protected:
	GS2_CRYPTOPP_CONSTANT(ROUNDS=FixedRounds<R>::ROUNDS)
