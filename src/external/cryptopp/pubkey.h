...
#ifndef GS2_CRYPTOPP_PUBKEY_H
#define GS2_CRYPTOPP_PUBKEY_H
...
#else
# define MAYBE_RETURN(x) GS2_CRYPTOPP_UNUSED(x)
#endif
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TrapdoorFunctionBounds
{
public:
...
/// \sa TrapdoorFunctionBounds(), RandomizedTrapdoorFunction(), TrapdoorFunction(),
///   RandomizedTrapdoorFunctionInverse() and TrapdoorFunctionInverse()
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE RandomizedTrapdoorFunction : public TrapdoorFunctionBounds
{
public:
...
/// \sa TrapdoorFunctionBounds(), RandomizedTrapdoorFunction(), TrapdoorFunction(),
///   RandomizedTrapdoorFunctionInverse() and TrapdoorFunctionInverse()
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TrapdoorFunction : public RandomizedTrapdoorFunction
{
public:
	...
	Integer ApplyRandomizedFunction(RandomNumberGenerator &rng, const Integer &x) const
		{GS2_CRYPTOPP_UNUSED(rng); return ApplyFunction(x);}
...
/// \sa TrapdoorFunctionBounds(), RandomizedTrapdoorFunction(), TrapdoorFunction(),
///   RandomizedTrapdoorFunctionInverse() and TrapdoorFunctionInverse()
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE RandomizedTrapdoorFunctionInverse
{
public:
...
/// \sa TrapdoorFunctionBounds(), RandomizedTrapdoorFunction(), TrapdoorFunction(),
///   RandomizedTrapdoorFunctionInverse() and TrapdoorFunctionInverse()
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TrapdoorFunctionInverse : public RandomizedTrapdoorFunctionInverse
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE PK_EncryptionMessageEncodingMethod
{
public:
	virtual ~PK_EncryptionMessageEncodingMethod() {}

	virtual bool ParameterSupported(const char *name) const
		{GS2_CRYPTOPP_UNUSED(name); return false;}
...
class GS2_CRYPTOPP_NO_VTABLE TF_Base
{
protected:
	virtual ~TF_Base() {}
...
template <class BASE>
class GS2_CRYPTOPP_NO_VTABLE PK_FixedLengthCryptoSystemImpl : public BASE
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE TF_CryptoSystemBase : public PK_FixedLengthCryptoSystemImpl<INTFACE>, protected BASE
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TF_DecryptorBase : public TF_CryptoSystemBase<PK_Decryptor, TF_Base<TrapdoorFunctionInverse, PK_EncryptionMessageEncodingMethod> >
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TF_EncryptorBase : public TF_CryptoSystemBase<PK_Encryptor, TF_Base<RandomizedTrapdoorFunction, PK_EncryptionMessageEncodingMethod> >
{
public:
...
///   based schemes.
class GS2_CRYPTOPP_NO_VTABLE PK_SignatureMessageEncodingMethod
{
public:
	virtual ~PK_SignatureMessageEncodingMethod() {}

	virtual size_t MinRepresentativeBitLength(size_t hashIdentifierLength, size_t digestLength) const
		{GS2_CRYPTOPP_UNUSED(hashIdentifierLength); GS2_CRYPTOPP_UNUSED(digestLength); return 0;}
	virtual size_t MaxRecoverableLength(size_t representativeBitLength, size_t hashIdentifierLength, size_t digestLength) const
		{GS2_CRYPTOPP_UNUSED(representativeBitLength); GS2_CRYPTOPP_UNUSED(representativeBitLength); GS2_CRYPTOPP_UNUSED(hashIdentifierLength); GS2_CRYPTOPP_UNUSED(digestLength); return 0;}
	...
	virtual void ProcessSemisignature(HashTransformation &hash, const byte *semisignature, size_t semisignatureLength) const
		{GS2_CRYPTOPP_UNUSED(hash); GS2_CRYPTOPP_UNUSED(semisignature); GS2_CRYPTOPP_UNUSED(semisignatureLength);}
	...
	{
		GS2_CRYPTOPP_UNUSED(hash);GS2_CRYPTOPP_UNUSED(recoverableMessage); GS2_CRYPTOPP_UNUSED(recoverableMessageLength);
		GS2_CRYPTOPP_UNUSED(presignature); GS2_CRYPTOPP_UNUSED(presignatureLength); GS2_CRYPTOPP_UNUSED(semisignature);
		if (RecoverablePartFirst())
			GS2_CRYPTOPP_ASSERT(!"ProcessRecoverableMessage() not implemented");
	}
	...
	virtual DecodingResult RecoverMessageFromRepresentative(	// for TF
		...
		{GS2_CRYPTOPP_UNUSED(hash);GS2_CRYPTOPP_UNUSED(hashIdentifier); GS2_CRYPTOPP_UNUSED(messageEmpty);
		GS2_CRYPTOPP_UNUSED(representative); GS2_CRYPTOPP_UNUSED(representativeBitLength); GS2_CRYPTOPP_UNUSED(recoveredMessage);
		throw NotImplemented("PK_MessageEncodingMethod: this signature scheme does not support message recovery");}
	...
	virtual DecodingResult RecoverMessageFromSemisignature(		// for DL
		...
		byte *recoveredMessage) const
		{GS2_CRYPTOPP_UNUSED(hash);GS2_CRYPTOPP_UNUSED(hashIdentifier); GS2_CRYPTOPP_UNUSED(presignature); GS2_CRYPTOPP_UNUSED(presignatureLength);
		GS2_CRYPTOPP_UNUSED(semisignature); GS2_CRYPTOPP_UNUSED(semisignatureLength); GS2_CRYPTOPP_UNUSED(recoveredMessage);
		throw NotImplemented("PK_MessageEncodingMethod: this signature scheme does not support message recovery");}
	...
	struct HashIdentifierLookup
	{
		...
		{
			static HashIdentifier GS2_CRYPTOPP_API Lookup()
			{
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_DeterministicSignatureMessageEncodingMethod : public PK_SignatureMessageEncodingMethod
{
public:
...
///   for message encoding method for public key signature schemes.
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_RecoverableSignatureMessageEncodingMethod : public PK_SignatureMessageEncodingMethod
{
public:
	bool VerifyMessageRepresentative(
		HashTransformation &hash, HashIdentifier hashIdentifier, bool messageEmpty,
...
class GS2_CRYPTOPP_DLL DL_SignatureMessageEncodingMethod_DSA : public PK_DeterministicSignatureMessageEncodingMethod
{
public:
...
class GS2_CRYPTOPP_DLL DL_SignatureMessageEncodingMethod_NR : public PK_DeterministicSignatureMessageEncodingMethod
{
public:
	void ComputeMessageRepresentative(RandomNumberGenerator &rng,
		const byte *recoverableMessage, size_t recoverableMessageLength,
...
class GS2_CRYPTOPP_DLL DL_SignatureMessageEncodingMethod_SM2 : public PK_DeterministicSignatureMessageEncodingMethod
{
public:
	void ComputeMessageRepresentative(RandomNumberGenerator &rng,
		const byte *recoverableMessage, size_t recoverableMessageLength,
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_MessageAccumulatorBase : public PK_MessageAccumulator
{
public:
...
template <class INTFACE, class BASE>
class GS2_CRYPTOPP_NO_VTABLE TF_SignatureSchemeBase : public INTFACE, protected BASE
{
public:
	...
	size_t MaxRecoverableLengthFromSignatureLength(size_t signatureLength) const
		{GS2_CRYPTOPP_UNUSED(signatureLength); return this->MaxRecoverableLength();}
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TF_SignerBase : public TF_SignatureSchemeBase<PK_Signer, TF_Base<RandomizedTrapdoorFunctionInverse, PK_SignatureMessageEncodingMethod> >
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE TF_VerifierBase : public TF_SignatureSchemeBase<PK_Verifier, TF_Base<TrapdoorFunction, PK_SignatureMessageEncodingMethod> >
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE TF_ObjectImplBase : public AlgorithmImpl<BASE, typename SCHEME_OPTIONS::AlgorithmInfo>
{
public:
...
template <class BASE, class SCHEME_OPTIONS, class KEY_CLASS>
class GS2_CRYPTOPP_NO_VTABLE TF_ObjectImpl : public TF_ObjectImplBase<BASE, SCHEME_OPTIONS, KEY_CLASS>
{
public:
	typedef KEY_CLASS KeyClass;
...
class GS2_CRYPTOPP_NO_VTABLE MaskGeneratingFunction
{
public:
...
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API P1363_MGF1KDF2_Common(HashTransformation &hash, byte *output, size_t outputLength, const byte *input, size_t inputLength, const byte *derivationParams, size_t derivationParamsLength, bool mask, unsigned int counterStart);

/// \brief P1363 mask generation function
class P1363_MGF1 : public MaskGeneratingFunction
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "MGF1";}
...
{
public:
	static void GS2_CRYPTOPP_API DeriveKey(byte *output, size_t outputLength, const byte *input, size_t inputLength, const byte *derivationParams, size_t derivationParamsLength)
	{
		H h;
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_GroupParameters : public CryptoParameters
{
...
public:
	...
	bool GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const
	{
		return GetValueHelper(this, name, valueType, pValue)
			GS2_CRYPTOPP_GET_FUNCTION_ENTRY(SubgroupOrder)
			GS2_CRYPTOPP_GET_FUNCTION_ENTRY(SubgroupGenerator)
			;
	}
...
/// \details The element is usually an Integer, \ref ECP "ECP::Point" or \ref EC2N "EC2N::Point"
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_Key
{
public:
	virtual ~DL_Key() {}
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_PublicKey : public DL_Key<T>
{
...
public:
	...
	bool GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const
	{
		return GetValueHelper(this, name, valueType, pValue, &this->GetAbstractGroupParameters())
				GS2_CRYPTOPP_GET_FUNCTION_ENTRY(PublicElement);
	}
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_PrivateKey : public DL_Key<T>
{
...
public:
	...
	{
		return GetValueHelper(this, name, valueType, pValue, &this->GetAbstractGroupParameters())
				GS2_CRYPTOPP_GET_FUNCTION_ENTRY(PrivateExponent);
	}
	...
	void AssignFrom(const NameValuePairs &source)
	{
		...
		AssignFromHelper(this, source)
			GS2_CRYPTOPP_SET_FUNCTION_ENTRY(PrivateExponent);
	}
...
void DL_PublicKey<T>::AssignFrom(const NameValuePairs &source)
{
	...
	else
	{
		this->AccessAbstractGroupParameters().AssignFrom(source);
		AssignFromHelper(this, source)
			GS2_CRYPTOPP_SET_FUNCTION_ENTRY(PublicElement);
	}
}
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_ElgamalLikeSignatureAlgorithm
{
public:
	...
	{
		GS2_CRYPTOPP_UNUSED(params); GS2_CRYPTOPP_UNUSED(publicKey); GS2_CRYPTOPP_UNUSED(r); GS2_CRYPTOPP_UNUSED(s);
...
class GS2_CRYPTOPP_NO_VTABLE DeterministicSignatureAlgorithm
{
public:
...
/// \tparam T Field element
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_KeyAgreementAlgorithm
{
public:
	typedef T Element;
...
/// \tparam T Field element
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_KeyDerivationAlgorithm
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE DL_SymmetricEncryptionAlgorithm
{
public:
...
template <class KI>
class GS2_CRYPTOPP_NO_VTABLE DL_Base
{
protected:
...
class GS2_CRYPTOPP_NO_VTABLE DL_SignatureSchemeBase : public INTFACE, public DL_Base<KEY_INTFACE>
{
public:
	...
	size_t MaxRecoverableLengthFromSignatureLength(size_t signatureLength) const
		{GS2_CRYPTOPP_UNUSED(signatureLength); GS2_CRYPTOPP_ASSERT(false); return 0;}	// TODO
...
/// \tparam T Field element
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_SignerBase : public DL_SignatureSchemeBase<PK_Signer, DL_PrivateKey<T> >
{
public:
...
protected:
	void RestartMessageAccumulator(RandomNumberGenerator &rng, PK_MessageAccumulatorBase &ma) const
	{
		...
		*/
		GS2_CRYPTOPP_UNUSED(rng); GS2_CRYPTOPP_UNUSED(ma);
	}
};
...
/// \tparam T Field element
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_VerifierBase : public DL_SignatureSchemeBase<PK_Verifier, DL_PublicKey<T> >
{
public:
	...
	void InputSignature(PK_MessageAccumulator &messageAccumulator, const byte *signature, size_t signatureLength) const
	{
		GS2_CRYPTOPP_UNUSED(signature); GS2_CRYPTOPP_UNUSED(signatureLength);
		PK_MessageAccumulatorBase &ma = static_cast<PK_MessageAccumulatorBase &>(messageAccumulator);
		const DL_ElgamalLikeSignatureAlgorithm<T> &alg = this->GetSignatureAlgorithm();
		const DL_GroupParameters<T> &params = this->GetAbstractGroupParameters();
...
class GS2_CRYPTOPP_NO_VTABLE DL_CryptoSystemBase : public PK, public DL_Base<KI>
{
public:
...
/// \tparam T Field element
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_DecryptorBase : public DL_CryptoSystemBase<PK_Decryptor, DL_PrivateKey<T> >
{
public:
	typedef T Element;
...
/// \tparam T Field element
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_EncryptorBase : public DL_CryptoSystemBase<PK_Encryptor, DL_PublicKey<T> >
{
public:
	typedef T Element;
...
template <class BASE, class SCHEME_OPTIONS, class KEY>
class GS2_CRYPTOPP_NO_VTABLE DL_ObjectImplBase : public AlgorithmImpl<BASE, typename SCHEME_OPTIONS::AlgorithmInfo>
{
public:
	typedef SCHEME_OPTIONS SchemeOptions;
...
/// \tparam KEY key used in the scheme
template <class BASE, class SCHEME_OPTIONS, class KEY>
class GS2_CRYPTOPP_NO_VTABLE DL_ObjectImpl : public DL_ObjectImplBase<BASE, SCHEME_OPTIONS, KEY>
{
public:
	typedef typename KEY::Element Element;
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE DL_SimpleKeyAgreementDomainBase : public SimpleKeyAgreementDomain
{
public:
	typedef T Element;
...
public:
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName()
	...
	Element AgreeWithStaticPrivateKey(const DL_GroupParameters<Element> &params, const Element &publicElement, bool validateOtherPublicKey, const Integer &privateExponent) const
	{
		...
		{
			GS2_CRYPTOPP_ASSERT(COFACTOR_OPTION::ToEnum() == NO_COFACTOR_MULTIPLICTION);
...
template <class BASE>
class GS2_CRYPTOPP_NO_VTABLE PK_FinalTemplate : public BASE
{
public:
	PK_FinalTemplate() {}
...
public:
	...
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string(KEYS::StaticAlgorithmName()) + "/" + MessageEncodingMethod::StaticAlgorithmName();}
...
public:
	...
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string(KEYS::StaticAlgorithmName()) + "/" + MessageEncodingMethod::StaticAlgorithmName() + "(" + H::StaticAlgorithmName() + ")";}
