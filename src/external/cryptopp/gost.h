...
#ifndef GS2_CRYPTOPP_GOST_H
#define GS2_CRYPTOPP_GOST_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "GOST";}
};
...
class GOST : public GOST_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<GOST_Info>
	{
	public:
