...
#ifndef GS2_CRYPTOPP_CHANNELS_H
#define GS2_CRYPTOPP_CHANNELS_H
...
class GS2_CRYPTOPP_DLL ChannelSwitch : public Multichannel<Sink>, public ChannelSwitchTypedefs
{
public:
