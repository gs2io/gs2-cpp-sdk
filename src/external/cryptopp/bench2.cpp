...
void Benchmark3(double t, double hertz)
{
	...
	{
		BenchMarkCrypto<RSAES<OAEP<SHA1> > >(GS2_CRYPTOPP_DATA_DIR "TestData/rsa1024.dat", "RSA 1024", t);
		BenchMarkCrypto<LUCES<OAEP<SHA1> > >(GS2_CRYPTOPP_DATA_DIR "TestData/luc1024.dat", "LUC 1024", t);
		BenchMarkCrypto<DLIES<> >(GS2_CRYPTOPP_DATA_DIR "TestData/dlie1024.dat", "DLIES 1024", t);
		BenchMarkCrypto<LUC_IES<> >(GS2_CRYPTOPP_DATA_DIR "TestData/lucc512.dat", "LUCELG 512", t);
	}

	std::cout << "\n<TBODY style=\"background: yellow;\">";
	{
		BenchMarkCrypto<RSAES<OAEP<SHA1> > >(GS2_CRYPTOPP_DATA_DIR "TestData/rsa2048.dat", "RSA 2048", t);
		BenchMarkCrypto<LUCES<OAEP<SHA1> > >(GS2_CRYPTOPP_DATA_DIR "TestData/luc2048.dat", "LUC 2048", t);
		BenchMarkCrypto<DLIES<> >(GS2_CRYPTOPP_DATA_DIR "TestData/dlie2048.dat", "DLIES 2048", t);
		BenchMarkCrypto<LUC_IES<> >(GS2_CRYPTOPP_DATA_DIR "TestData/lucc1024.dat", "LUCELG 1024", t);
	}

	std::cout << "\n<TBODY style=\"background: white;\">";
	{
		BenchMarkSignature<RSASS<PSSR, SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/rsa1024.dat", "RSA 1024", t);
		BenchMarkSignature<RWSS<PSSR, SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/rw1024.dat", "RW 1024", t);
		BenchMarkSignature<LUCSS<PSSR, SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/luc1024.dat", "LUC 1024", t);
		BenchMarkSignature<NR<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/nr1024.dat", "NR 1024", t);
		BenchMarkSignature<DSA>(GS2_CRYPTOPP_DATA_DIR "TestData/dsa1024.dat", "DSA 1024", t);
		BenchMarkSignature<LUC_HMP<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/lucs512.dat", "LUC-HMP 512", t);
		BenchMarkSignature<ESIGN<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/esig1023.dat", "ESIGN 1023", t);
		BenchMarkSignature<ESIGN<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/esig1536.dat", "ESIGN 1536", t);
	}

	std::cout << "\n<TBODY style=\"background: yellow;\">";
	{
		BenchMarkSignature<RSASS<PSSR, SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/rsa2048.dat", "RSA 2048", t);
		BenchMarkSignature<RWSS<PSSR, SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/rw2048.dat", "RW 2048", t);
		BenchMarkSignature<LUCSS<PSSR, SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/luc2048.dat", "LUC 2048", t);
		BenchMarkSignature<NR<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/nr2048.dat", "NR 2048", t);
		BenchMarkSignature<LUC_HMP<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/lucs1024.dat", "LUC-HMP 1024", t);
		BenchMarkSignature<ESIGN<SHA1> >(GS2_CRYPTOPP_DATA_DIR "TestData/esig2046.dat", "ESIGN 2046", t);
	}

	std::cout << "\n<TBODY style=\"background: white;\">";
	{
		BenchMarkKeyAgreement<XTR_DH>(GS2_CRYPTOPP_DATA_DIR "TestData/xtrdh171.dat", "XTR-DH 171", t);
		BenchMarkKeyAgreement<XTR_DH>(GS2_CRYPTOPP_DATA_DIR "TestData/xtrdh342.dat", "XTR-DH 342", t);
		BenchMarkKeyAgreement<DH>(GS2_CRYPTOPP_DATA_DIR "TestData/dh1024.dat", "DH 1024", t);
		BenchMarkKeyAgreement<DH>(GS2_CRYPTOPP_DATA_DIR "TestData/dh2048.dat", "DH 2048", t);
		BenchMarkKeyAgreement<LUC_DH>(GS2_CRYPTOPP_DATA_DIR "TestData/lucd512.dat", "LUCDIF 512", t);
		BenchMarkKeyAgreement<LUC_DH>(GS2_CRYPTOPP_DATA_DIR "TestData/lucd1024.dat", "LUCDIF 1024", t);
		BenchMarkKeyAgreement<MQV>(GS2_CRYPTOPP_DATA_DIR "TestData/mqv1024.dat", "MQV 1024", t);
		BenchMarkKeyAgreement<MQV>(GS2_CRYPTOPP_DATA_DIR "TestData/mqv2048.dat", "MQV 2048", t);

#if 0
		BenchMarkKeyAgreement<ECHMQV160>(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv160.dat", "HMQV P-160", t);
		BenchMarkKeyAgreement<ECHMQV256>(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv256.dat", "HMQV P-256", t);
		BenchMarkKeyAgreement<ECHMQV384>(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv384.dat", "HMQV P-384", t);
		BenchMarkKeyAgreement<ECHMQV512>(GS2_CRYPTOPP_DATA_DIR "TestData/hmqv512.dat", "HMQV P-512", t);

		BenchMarkKeyAgreement<ECFHMQV160>(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv160.dat", "FHMQV P-160", t);
		BenchMarkKeyAgreement<ECFHMQV256>(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv256.dat", "FHMQV P-256", t);
		BenchMarkKeyAgreement<ECFHMQV384>(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv384.dat", "FHMQV P-384", t);
		BenchMarkKeyAgreement<ECFHMQV512>(GS2_CRYPTOPP_DATA_DIR "TestData/fhmqv512.dat", "FHMQV P-512", t);
#endif
	}
