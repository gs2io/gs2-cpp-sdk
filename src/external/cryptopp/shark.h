...
#ifndef GS2_CRYPTOPP_SHARK_H
#define GS2_CRYPTOPP_SHARK_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SHARK-E";}
};
...
class SHARK : public SHARK_Info, public BlockCipherDocumentation
{
	...
	/// \since Crypto++ 2.1
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<SHARK_Info>
	{
	public:
