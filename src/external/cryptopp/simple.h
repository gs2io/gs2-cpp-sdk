...
#ifndef GS2_CRYPTOPP_SIMPLE_H
#define GS2_CRYPTOPP_SIMPLE_H
...
class GS2_CRYPTOPP_NO_VTABLE ClonableImpl : public BASE
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE AlgorithmImpl : public BASE
{
public:
	...
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return ALGORITHM_INFO::StaticAlgorithmName();}
	/// \brief The algorithm name
	/// \returns the algorithm name
...
class GS2_CRYPTOPP_DLL InvalidKeyLength : public InvalidArgument
{
public:
...
class GS2_CRYPTOPP_DLL InvalidRounds : public InvalidArgument
{
public:
...
class GS2_CRYPTOPP_DLL InvalidBlockSize : public InvalidArgument
{
public:
...
class GS2_CRYPTOPP_DLL InvalidDerivedLength : public InvalidArgument
{
public:
...
class GS2_CRYPTOPP_DLL InvalidPersonalizationLength : public InvalidArgument
{
public:
...
class GS2_CRYPTOPP_DLL InvalidSaltLength : public InvalidArgument
{
public:
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE Bufferless : public T
{
public:
	bool IsolatedFlush(bool hardFlush, bool blocking)
		{GS2_CRYPTOPP_UNUSED(hardFlush); GS2_CRYPTOPP_UNUSED(blocking); return false;}
};

/// \brief Base class for unflushable filters
/// \tparam T the class or type
template <class T>
class GS2_CRYPTOPP_NO_VTABLE Unflushable : public T
{
public:
	bool Flush(bool completeFlush, int propagation=-1, bool blocking=true)
		{return ChannelFlush(DEFAULT_CHANNEL, completeFlush, propagation, blocking);}
	bool IsolatedFlush(bool hardFlush, bool blocking)
		{GS2_CRYPTOPP_UNUSED(hardFlush); GS2_CRYPTOPP_UNUSED(blocking); GS2_CRYPTOPP_ASSERT(false); return false;}
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE InputRejecting : public T
{
public:
	...
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
		{GS2_CRYPTOPP_UNUSED(inString); GS2_CRYPTOPP_UNUSED(length); GS2_CRYPTOPP_UNUSED(messageEnd); GS2_CRYPTOPP_UNUSED(blocking); throw InputRejected();}
	//@}
	...
	bool IsolatedMessageSeriesEnd(bool blocking)
		{GS2_CRYPTOPP_UNUSED(blocking); throw InputRejected();}
	size_t ChannelPut2(const std::string &channel, const byte *inString, size_t length, int messageEnd, bool blocking)
		{GS2_CRYPTOPP_UNUSED(channel); GS2_CRYPTOPP_UNUSED(inString); GS2_CRYPTOPP_UNUSED(length); GS2_CRYPTOPP_UNUSED(messageEnd); GS2_CRYPTOPP_UNUSED(blocking); throw InputRejected();}
	bool ChannelMessageSeriesEnd(const std::string& channel, int messageEnd, bool blocking)
		{GS2_CRYPTOPP_UNUSED(channel); GS2_CRYPTOPP_UNUSED(messageEnd); GS2_CRYPTOPP_UNUSED(blocking); throw InputRejected();}
	//@}
};
...
template <class T>
class GS2_CRYPTOPP_NO_VTABLE CustomFlushPropagation : public T
{
public:
	///	\name SIGNALS
	//@{
...
/// \tparam T BufferedTransformation derived class
template <class T>
class GS2_CRYPTOPP_NO_VTABLE CustomSignalPropagation : public CustomFlushPropagation<T>
{
public:
...
/// \details T should be a BufferedTransformation derived class
template <class T>
class GS2_CRYPTOPP_NO_VTABLE Multichannel : public CustomFlushPropagation<T>
{
public:
...
//		{PropagateMessageSeriesEnd(propagation, channel);}
	byte * ChannelCreatePutSpace(const std::string &channel, size_t &size)
		{GS2_CRYPTOPP_UNUSED(channel); size = 0; return NULLPTR;}
...
/// \tparam T BufferedTransformation derived class
template <class T>
class GS2_CRYPTOPP_NO_VTABLE AutoSignaling : public T
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Store : public AutoSignaling<InputRejecting<BufferedTransformation> >
{
public:
...
///   more details.
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Sink : public BufferedTransformation
{
public:
	size_t TransferTo2(BufferedTransformation &target, lword &transferBytes, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true)
		{GS2_CRYPTOPP_UNUSED(target); GS2_CRYPTOPP_UNUSED(transferBytes); GS2_CRYPTOPP_UNUSED(channel); GS2_CRYPTOPP_UNUSED(blocking); transferBytes = 0; return 0;}
	size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const
		{GS2_CRYPTOPP_UNUSED(target); GS2_CRYPTOPP_UNUSED(begin); GS2_CRYPTOPP_UNUSED(end); GS2_CRYPTOPP_UNUSED(channel); GS2_CRYPTOPP_UNUSED(blocking); return 0;}
};
...
class GS2_CRYPTOPP_DLL BitBucket : public Bufferless<Sink>
{
public:
	std::string AlgorithmName() const {return "BitBucket";}
	void IsolatedInitialize(const NameValuePairs &params)
		{GS2_CRYPTOPP_UNUSED(params);}
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
		{GS2_CRYPTOPP_UNUSED(inString); GS2_CRYPTOPP_UNUSED(length); GS2_CRYPTOPP_UNUSED(messageEnd); GS2_CRYPTOPP_UNUSED(blocking); return 0;}
};
