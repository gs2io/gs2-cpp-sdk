...
#ifndef GS2_CRYPTOPP_SIMON_H
#define GS2_CRYPTOPP_SIMON_H
...
# define GS2_CRYPTOPP_SIMON64_ADVANCED_PROCESS_BLOCKS 1
#endif

#if GS2_CRYPTOPP_BOOL_X64 || GS2_CRYPTOPP_BOOL_X32 || GS2_CRYPTOPP_BOOL_X86 || GS2_CRYPTOPP_BOOL_ARM32 || GS2_CRYPTOPP_BOOL_ARM64
# define GS2_CRYPTOPP_SIMON128_ADVANCED_PROCESS_BLOCKS 1
#endif
...
///   Crypto++ wiki
/// \since Crypto++ 6.0
class GS2_CRYPTOPP_NO_VTABLE SIMON64 : public SIMON_Info<8, 12, 12, 16>, public BlockCipherDocumentation
{
public:
    /// \brief SIMON block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class GS2_CRYPTOPP_NO_VTABLE Base : protected SIMON_Base<word32>, public BlockCipherImpl<SIMON_Info<8, 12, 12, 16> >
    {
    public:
...
#if GS2_CRYPTOPP_SIMON64_ADVANCED_PROCESS_BLOCKS
...
///   Crypto++ wiki
/// \since Crypto++ 6.0
class GS2_CRYPTOPP_NO_VTABLE SIMON128 : public SIMON_Info<16, 16, 16, 32>, public BlockCipherDocumentation
{
public:
    /// \brief SIMON block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class GS2_CRYPTOPP_NO_VTABLE Base : protected SIMON_Base<word64>, public BlockCipherImpl<SIMON_Info<16, 16, 16, 32> >
    {
    public:
        std::string AlgorithmName() const {
            return StaticAlgorithmName() + (m_kwords == 0 ? "" :
    ...
    protected:
        void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
#if GS2_CRYPTOPP_SIMON128_ADVANCED_PROCESS_BLOCKS
        size_t AdvancedProcessBlocks(const byte *inBlocks, const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags) const;
#endif
    };
