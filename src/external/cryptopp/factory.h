...
#ifndef GS2_CRYPTOPP_OBJFACT_H
#define GS2_CRYPTOPP_OBJFACT_H
...
public:
	...
	GS2_CRYPTOPP_NOINLINE static ObjectFactoryRegistry<AbstractClass, instance> & Registry(GS2_CRYPTOPP_NOINLINE_DOTDOTDOT);
...
ObjectFactoryRegistry<AbstractClass, instance> & ObjectFactoryRegistry<AbstractClass, instance>::Registry(GS2_CRYPTOPP_NOINLINE_DOTDOTDOT)
{
