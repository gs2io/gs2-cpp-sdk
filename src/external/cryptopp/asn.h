...
#ifndef GS2_CRYPTOPP_ASN_H
#define GS2_CRYPTOPP_ASN_H
...
class GS2_CRYPTOPP_DLL UnknownOID : public BERDecodeErr
{
public:
...
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API DERLengthEncode(BufferedTransformation &bt, lword length);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API BERLengthDecode(BufferedTransformation &bt, size_t &length);

/// \brief DER encode NULL
/// \param bt BufferedTransformation object for writing
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API DEREncodeNull(BufferedTransformation &bt);

/// \brief BER decode NULL
/// \param bt BufferedTransformation object for reading
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API BERDecodeNull(BufferedTransformation &bt);
...
/// \returns the number of octets used for the encoding
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API DEREncodeOctetString(BufferedTransformation &bt, const byte *str, size_t strLen);

/// \brief DER encode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the string to encode
/// \returns the number of octets used for the encoding
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API DEREncodeOctetString(BufferedTransformation &bt, const SecByteBlock &str);

/// \brief BER decode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \returns the number of octets used for the encoding
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API BERDecodeOctetString(BufferedTransformation &bt, SecByteBlock &str);

/// \brief BER decode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \returns the number of octets used for the encoding
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API BERDecodeOctetString(BufferedTransformation &bt, BufferedTransformation &str);
...
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API DEREncodeTextString(BufferedTransformation &bt, const std::string &str, byte asnTag);
...
/// \param asnTag the ASN.1 type
/// \details DEREncodeTextString() can be used for UTF8_STRING, PRINTABLE_STRING, and IA5_STRING
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API BERDecodeTextString(BufferedTransformation &bt, std::string &str, byte asnTag);
...
/// \returns the number of octets used for the encoding
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API DEREncodeBitString(BufferedTransformation &bt, const byte *str, size_t strLen, unsigned int unusedBits=0);

/// \brief DER decode bit string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \param unusedBits the number of unused bits
GS2_CRYPTOPP_DLL size_t GS2_CRYPTOPP_API BERDecodeBitString(BufferedTransformation &bt, SecByteBlock &str, unsigned int &unusedBits);

/// \brief BER decode and DER re-encode
/// \param bt BufferedTransformation object for writing
/// \param dest BufferedTransformation object
GS2_CRYPTOPP_DLL void GS2_CRYPTOPP_API DERReencode(BufferedTransformation &bt, BufferedTransformation &dest);

/// \brief Object Identifier
class GS2_CRYPTOPP_DLL OID
{
public:
	virtual ~OID() {}
...
class GS2_CRYPTOPP_DLL BERGeneralDecoder : public Store
{
public:
	...
	lword RemainingLength() const {GS2_CRYPTOPP_ASSERT(m_definiteLength); return m_length;}
...
private:
	...
	void StoreInitialize(const NameValuePairs &parameters)
		{GS2_CRYPTOPP_UNUSED(parameters); GS2_CRYPTOPP_ASSERT(false);}
	lword ReduceLength(lword delta);
};

/// \brief DER General Encoder
class GS2_CRYPTOPP_DLL DERGeneralEncoder : public ByteQueue
{
public:
...
class GS2_CRYPTOPP_DLL BERSequenceDecoder : public BERGeneralDecoder
{
public:
...
class GS2_CRYPTOPP_DLL DERSequenceEncoder : public DERGeneralEncoder
{
public:
...
class GS2_CRYPTOPP_DLL BERSetDecoder : public BERGeneralDecoder
{
public:
...
class GS2_CRYPTOPP_DLL DERSetEncoder : public DERGeneralEncoder
{
public:
...
template <class BASE>
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE ASN1CryptoMaterial : public ASN1Object, public BASE
{
public:
...
class GS2_CRYPTOPP_DLL X509PublicKey : public ASN1CryptoMaterial<PublicKey>
{
public:
...
class GS2_CRYPTOPP_DLL PKCS8PrivateKey : public ASN1CryptoMaterial<PrivateKey>
{
public:
...
#else
inline bool operator==(const ::gs2::detail::CryptoPP::OID &lhs, const ::gs2::detail::CryptoPP::OID &rhs)
	{return lhs.m_values == rhs.m_values;}
inline bool operator!=(const ::gs2::detail::CryptoPP::OID &lhs, const ::gs2::detail::CryptoPP::OID &rhs)
	{return lhs.m_values != rhs.m_values;}
inline bool operator<(const ::gs2::detail::CryptoPP::OID &lhs, const ::gs2::detail::CryptoPP::OID &rhs)
	{return std::lexicographical_compare(lhs.m_values.begin(), lhs.m_values.end(), rhs.m_values.begin(), rhs.m_values.end());}
inline ::gs2::detail::CryptoPP::OID operator+(const ::gs2::detail::CryptoPP::OID &lhs, unsigned long rhs)
	{return ::gs2::detail::CryptoPP::OID(lhs)+=rhs;}
#endif
