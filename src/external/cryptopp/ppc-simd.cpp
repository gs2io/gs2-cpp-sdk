...
//    we should be able to use GS2_CRYPTOPP_POWER8_AES_AVAILABLE and
//    GS2_CRYPTOPP_POWER8_SHA_AVAILABLE instead of the broader
//    GS2_CRYPTOPP_POWER8_AVAILABLE. The change will need to be coordinated
//    with the defines in config.h.

// TODO: Bob Wilkinson reported we are misdetecting GS2_CRYPTOPP_POWER8_AVAILABLE.
...
//    being GS2_CRYPTOPP_DISABLE_POWER8 will have to be applied manually. Another
...
bool CPU_ProbeAltivec()
{
    ...
    return false;
#elif (GS2_CRYPTOPP_ALTIVEC_AVAILABLE)
...
#if defined(GS2_CRYPTOPP_NO_CPU_FEATURE_PROBES)
    return false;
#elif (GS2_CRYPTOPP_POWER7_AVAILABLE)
# if defined(GS2_CRYPTOPP_GNU_STYLE_INLINE_ASSEMBLY)
...
#if defined(GS2_CRYPTOPP_NO_CPU_FEATURE_PROBES)
    return false;
#elif (GS2_CRYPTOPP_POWER8_AVAILABLE)
# if defined(GS2_CRYPTOPP_GNU_STYLE_INLINE_ASSEMBLY)
