...
#ifndef GS2_CRYPTOPP_ECPOINT_H
#define GS2_CRYPTOPP_ECPOINT_H
...
/// \since Crypto++ 2.0
struct GS2_CRYPTOPP_DLL ECPPoint
{
	virtual ~ECPPoint() {}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractGroup<ECPPoint>;

/// \brief Elliptical Curve Point over GF(2^n)
/// \since Crypto++ 2.0
struct GS2_CRYPTOPP_DLL EC2NPoint
{
	virtual ~EC2NPoint() {}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractGroup<EC2NPoint>;
