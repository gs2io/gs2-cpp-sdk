...
#ifndef GS2_CRYPTOPP_RC2_H
#define GS2_CRYPTOPP_RC2_H
...
{
	GS2_CRYPTOPP_CONSTANT(DEFAULT_EFFECTIVE_KEYLENGTH = 1024)
	GS2_CRYPTOPP_CONSTANT(MAX_EFFECTIVE_KEYLENGTH = 1024)
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RC2";}
};
...
class RC2 : public RC2_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<RC2_Info>
	{
	public:
