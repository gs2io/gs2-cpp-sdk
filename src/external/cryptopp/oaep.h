...
#ifndef GS2_CRYPTOPP_OAEP_H
#define GS2_CRYPTOPP_OAEP_H
...
/// \since Crypto++ 2.1
class GS2_CRYPTOPP_DLL OAEP_Base : public PK_EncryptionMessageEncodingMethod
{
public:
...
{
public:
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string("OAEP-") + MGF::StaticAlgorithmName() + "(" + H::StaticAlgorithmName() + ")";}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS OAEP<SHA1>;
