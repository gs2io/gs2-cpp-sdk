...
#ifndef GS2_CRYPTOPP_RW_H
#define GS2_CRYPTOPP_RW_H
...
class GS2_CRYPTOPP_DLL RWFunction : public TrapdoorFunction, public PublicKey
{
...
/// \since Crypto++ 3.0, Tweaked roots using <em>e</em> and <em>f</em> since Crypto++ 5.6.4
class GS2_CRYPTOPP_DLL InvertibleRWFunction : public RWFunction, public TrapdoorFunctionInverse, public PrivateKey
{
...
public:
	...
	virtual void Precompute(unsigned int unused = 0) {GS2_CRYPTOPP_UNUSED(unused); PrecomputeTweakedRoots();}
	virtual void Precompute(unsigned int unused = 0) const {GS2_CRYPTOPP_UNUSED(unused); PrecomputeTweakedRoots();}
...
struct RW
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RW";}
