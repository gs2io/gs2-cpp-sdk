...
#ifndef GS2_CRYPTOPP_OS_SIGNAL_H
#define GS2_CRYPTOPP_OS_SIGNAL_H
...
#if defined(UNIX_SIGNALS_AVAILABLE) || defined(GS2_CRYPTOPP_DOXYGEN_PROCESSING)
...
extern "C" {
    inline void NullSignalHandler(int unused) {GS2_CRYPTOPP_UNUSED(unused);}
}
...
/// \since Crypto++ 5.6.5
/// \sa NullSignalHandler, SignalHandlerFn, \ref GS2_CRYPTOPP_ASSERT "GS2_CRYPTOPP_ASSERT", DebugTrapHandler
...
#endif // GS2_CRYPTOPP_OS_SIGNAL_H
