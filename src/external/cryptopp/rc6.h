...
#ifndef GS2_CRYPTOPP_RC6_H
#define GS2_CRYPTOPP_RC6_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RC6";}
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<RC6_Info>
	{
	public:
