...
using gs2::detail::CryptoPP::KalynaTab::T;
using gs2::detail::CryptoPP::KalynaTab::S;
using gs2::detail::CryptoPP::KalynaTab::IT;
using gs2::detail::CryptoPP::KalynaTab::IS;
