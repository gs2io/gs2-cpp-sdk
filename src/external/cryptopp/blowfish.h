...
#ifndef GS2_CRYPTOPP_BLOWFISH_H
#define GS2_CRYPTOPP_BLOWFISH_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Blowfish";}
};
...
class Blowfish : public Blowfish_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Blowfish_Info>
	{
	public:
