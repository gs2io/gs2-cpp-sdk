...
bool ValidateSHA()
{
	...
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/sha.txt");
}
...
bool ValidatePanama()
{
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/panama.txt");
}

bool ValidateWhirlpool()
{
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/whrlpool.txt");
}
...
bool ValidateHMAC()
{
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/hmac.txt");
}
...
bool ValidateSM3()
{
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/sm3.txt");
}
