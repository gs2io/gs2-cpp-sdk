...
#ifndef GS2_CRYPTOPP_ELGAMAL_H
#define GS2_CRYPTOPP_ELGAMAL_H
...
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_NO_VTABLE ElGamalBase : public DL_KeyAgreementAlgorithm_DH<Integer, NoCofactorMultiplication>,
...
public:
	...
	{
		GS2_CRYPTOPP_UNUSED(groupParams), GS2_CRYPTOPP_UNUSED(ephemeralPublicKey), GS2_CRYPTOPP_UNUSED(derivationParams);
		agreedElement.Encode(derivedKey, derivedLength);
	}

	size_t GetSymmetricKeyLength(size_t plainTextLength) const
	{
		GS2_CRYPTOPP_UNUSED(plainTextLength);
...
struct ElGamal
{
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ElgamalEnc/Crypto++Padding";}
