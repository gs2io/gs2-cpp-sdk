...
//                gs2::detail::CryptoPP::Test namespace added by JW in February 2017
...
bool ValidateAll(bool thorough)
{
...
#if defined(GS2_CRYPTOPP_EXTENDED_VALIDATION)
	...
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/keccak.txt") && pass;
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/sha3.txt") && pass;
	...
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/seed.txt") && pass;
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/threefish.txt") && pass;
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/kalyna.txt") && pass;
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/sm4.txt") && pass;
	pass=ValidateVMAC() && pass;
	pass=ValidateCCM() && pass;
	pass=ValidateGCM() && pass;
	pass=ValidateCMAC() && pass;
	pass=RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/eax.txt") && pass;
...
bool TestSettings()
{
	...
	{
#ifndef GS2_CRYPTOPP_LITTLE_ENDIAN
		std::cout << "passed:  ";
#else
		std::cout << "FAILED:  ";
		pass = false;
	...
	if (*(word32 *)(void *)(testvals+3) == 0x03030303 && *(word64 *)(void *)(testvals+1) == W64LIT(0x0202030303030202))
		std::cout << "passed:  Unaligned data access (GS2_CRYPTOPP_ALLOW_UNALIGNED_DATA_ACCESS).\n";
	else
	{
...
#else
	std::cout << "passed:  Aligned data access (no GS2_CRYPTOPP_ALLOW_UNALIGNED_DATA_ACCESS).\n";
#endif
...
#ifdef GS2_CRYPTOPP_WORD128_AVAILABLE
...
#ifdef GS2_CRYPTOPP_CPUID_AVAILABLE
...
#elif (GS2_CRYPTOPP_BOOL_ARM32 || GS2_CRYPTOPP_BOOL_ARM64)
...
#elif (GS2_CRYPTOPP_BOOL_PPC32 || GS2_CRYPTOPP_BOOL_PPC64)
	...
	bool TestPadlockRNG()
{
	...
	if (rng.get())
	{
		...
		GS2_CRYPTOPP_ASSERT(0 == maurer.BytesNeeded());
...
public:
	...
	void PutByte(byte inByte)
	{
		if (counter >= outputLen || validOutput[counter] != inByte)
		{
			...
			fail = true;
			GS2_CRYPTOPP_ASSERT(false);
		}
		counter++;
	}
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
	{
		GS2_CRYPTOPP_UNUSED(messageEnd), GS2_CRYPTOPP_UNUSED(blocking);
...
bool ValidateDES()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/descert.dat", true, new HexDecoder);
	bool pass = BlockTransformationTest(FixedRoundsCipherFactory<DESEncryption, DESDecryption>(), valdata);

	std::cout << "\nTesting EDE2, EDE3, and XEX3 variants...\n\n";

	FileSource valdata1(GS2_CRYPTOPP_DATA_DIR "TestData/3desval.dat", true, new HexDecoder);
...
bool ValidateIDEA()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/ideaval.dat", true, new HexDecoder);
...
bool ValidateSAFER()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/saferval.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateRC2()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/rc2val.dat", true, new HexDecoder);
	HexEncoder output(new FileSink(std::cout));
...
bool ValidateRC5()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/rc5val.dat", true, new HexDecoder);
...
bool ValidateRC6()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/rc6val.dat", true, new HexDecoder);
...
bool ValidateMARS()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/marsval.dat", true, new HexDecoder);
...
bool ValidateRijndael()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/rijndael.dat", true, new HexDecoder);
	...
	pass3 = RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/aes.txt") && pass3;
	return pass1 && pass2 && pass3;
}
...
bool ValidateTwofish()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/twofishv.dat", true, new HexDecoder);
...
bool ValidateSerpent()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/serpentv.dat", true, new HexDecoder);
...
bool ValidateThreeWay()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/3wayval.dat", true, new HexDecoder);
...
bool ValidateGOST()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/gostval.dat", true, new HexDecoder);
...
bool ValidateSHARK()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/sharkval.dat", true, new HexDecoder);
...
bool ValidateCAST()
{
	...
	FileSource val128(GS2_CRYPTOPP_DATA_DIR "TestData/cast128v.dat", true, new HexDecoder);
	...
	FileSource val256(GS2_CRYPTOPP_DATA_DIR "TestData/cast256v.dat", true, new HexDecoder);
...
bool ValidateSquare()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/squareva.dat", true, new HexDecoder);
...
bool ValidateSKIPJACK()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/skipjack.dat", true, new HexDecoder);
...
public:
	...
	void IsolatedInitialize(const NameValuePairs &params);
	static const int * GS2_CRYPTOPP_API GetDecodingLookupArray();
};
...
bool ValidateSHACAL2()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/shacal2v.dat", true, new HexDecoder);
...
bool ValidateARIA()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/aria.dat", true, new HexDecoder);
...
bool ValidateCamellia()
{
	...
	FileSource valdata(GS2_CRYPTOPP_DATA_DIR "TestData/camellia.dat", true, new HexDecoder);
...
bool ValidateSalsa()
{
	...
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/salsa.txt");
}

bool ValidateSosemanuk()
{
	std::cout << "\nSosemanuk validation suite running...\n";
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/sosemanuk.txt");
}

bool ValidateVMAC()
{
	std::cout << "\nVMAC validation suite running...\n";
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/vmac.txt");
}

bool ValidateCCM()
{
	std::cout << "\nAES/CCM validation suite running...\n";
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/ccm.txt");
}
...
bool ValidateGCM()
{
	...
	std::cout << "\n2K tables:";
	bool pass = RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/gcm.txt", MakeParameters(Name::TableSize(), (int)2048));
	std::cout << "\n64K tables:";
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/gcm.txt", MakeParameters(Name::TableSize(), (int)64*1024)) && pass;
}

bool ValidateCMAC()
{
	std::cout << "\nCMAC validation suite running...\n";
	return RunTestDataFile(GS2_CRYPTOPP_DATA_DIR "TestVectors/cmac.txt");
}
