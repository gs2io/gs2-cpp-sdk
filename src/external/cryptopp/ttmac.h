...
#ifndef GS2_CRYPTOPP_TTMAC_H
#define GS2_CRYPTOPP_TTMAC_H
...
class GS2_CRYPTOPP_NO_VTABLE TTMAC_Base : public FixedKeyLength<20>, public IteratedHash<word32, LittleEndian, 64, MessageAuthenticationCode>
{
public:
	static std::string StaticAlgorithmName() {return std::string("Two-Track-MAC");}
	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE=20)
