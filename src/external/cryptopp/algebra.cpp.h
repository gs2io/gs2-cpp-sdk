...
#ifndef GS2_CRYPTOPP_ALGEBRA_CPP	// SunCC workaround: compiler could cause this file to be included twice
#define GS2_CRYPTOPP_ALGEBRA_CPP
...
void AbstractGroup<T>::SimultaneousMultiply(T *results, const T &base, const Integer *expBegin, unsigned int expCount) const
{
	...
	{
		GS2_CRYPTOPP_ASSERT(expBegin->NotNegative());
