...
#ifndef GS2_CRYPTOPP_ESIGN_H
#define GS2_CRYPTOPP_ESIGN_H
...
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "EMSA5";}
...
struct ESIGN_Keys
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ESIGN";}
