...
#ifndef GS2_CRYPTOPP_SALSA_H
#define GS2_CRYPTOPP_SALSA_H
...
# define GS2_CRYPTOPP_DISABLE_SALSA_ASM
#endif
...
class GS2_CRYPTOPP_NO_VTABLE Salsa20_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
protected:
...
class GS2_CRYPTOPP_NO_VTABLE XSalsa20_Policy : public Salsa20_Policy
{
public:
	void CipherSetKey(const NameValuePairs &params, const byte *key, size_t length);
	void CipherResynchronize(byte *keystreamBuffer, const byte *IV, size_t length);
