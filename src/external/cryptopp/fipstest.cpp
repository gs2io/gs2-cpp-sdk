...
// Simply disable GS2_CRYPTOPP_WIN32_AVAILABLE for Windows Phone and Windows Store apps
#ifdef GS2_CRYPTOPP_WIN32_AVAILABLE
# if defined(WINAPI_FAMILY)
#   if !(WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP))
#	  undef GS2_CRYPTOPP_WIN32_AVAILABLE
#   endif
# endif
#endif
...
static const byte s_moduleMac[gs2::detail::CryptoPP::HMAC<gs2::detail::CryptoPP::SHA1>::DIGESTSIZE] = GS2_CRYPTOPP_DUMMY_DLL_MAC;
GS2_CRYPTOPP_COMPILE_ASSERT(sizeof(s_moduleMac) == gs2::detail::CryptoPP::SHA1::DIGESTSIZE);

#ifdef GS2_CRYPTOPP_WIN32_AVAILABLE
static HMODULE s_hModule = NULLPTR;
#endif

const byte * GS2_CRYPTOPP_API GetActualMacAndLocation(unsigned int &macSize, unsigned int &fileLocation)
{
...
{
	gs2::detail::CryptoPP::DoPowerUpSelfTest(NULLPTR, s_moduleMac);
}
...
#endif	// #ifdef GS2_CRYPTOPP_WIN32_AVAILABLE
                      ...
                      LPVOID /*lpReserved*/)
{
	...
	{
		gs2::detail::CryptoPP::s_hModule = (HMODULE)hModule;
		gs2::detail::CryptoPP::DoDllPowerUpSelfTest();
	}
    return TRUE;
}
...
#endif	// #ifndef GS2_CRYPTOPP_IMPORTS
