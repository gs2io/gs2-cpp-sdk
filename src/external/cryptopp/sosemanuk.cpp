...
// use "cl /EP /P /DGS2_CRYPTOPP_GENERATE_X64_MASM sosemanuk.cpp" to generate MASM code
...
#if (GS2_CRYPTOPP_BOOL_X86 || GS2_CRYPTOPP_BOOL_X32 || GS2_CRYPTOPP_BOOL_X64) && !defined(GS2_CRYPTOPP_DISABLE_SOSEMANUK_ASM)
...
#if GS2_CRYPTOPP_SSE2_ASM_AVAILABLE && !defined(GS2_CRYPTOPP_DISABLE_SOSEMANUK_ASM)
...
#if defined(__GNUC__) && GS2_CRYPTOPP_BOOL_X64
...
#if (GS2_CRYPTOPP_BOOL_X86) && !defined(GS2_CRYPTOPP_DISABLE_SOSEMANUK_ASM)
		AS_PUSH_IF86(	bp)
...
#define SOSEMANUK_OUTPUT(x)	\
	GS2_CRYPTOPP_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 0, u2 ^ v0);\
	GS2_CRYPTOPP_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 1, u3 ^ v1);\
	GS2_CRYPTOPP_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 2, u1 ^ v2);\
	GS2_CRYPTOPP_KEYSTREAM_OUTPUT_WORD(x, LITTLE_ENDIAN_ORDER, 3, u4 ^ v3);

#define OUTPUT4	\
	S2(0, u0, u1, u2, u3, u4);\
	GS2_CRYPTOPP_KEYSTREAM_OUTPUT_SWITCH(SOSEMANUK_OUTPUT, 4*4);
