...
#ifndef GS2_CRYPTOPP_ALGPARAM_H
#define GS2_CRYPTOPP_ALGPARAM_H
...
public:
	...
	template <class T> ConstByteArrayParameter(const T &string, bool deepCopy = false)
		: m_deepCopy(false), m_data(NULLPTR), m_size(0)
	{
		GS2_CRYPTOPP_COMPILE_ASSERT(sizeof(typename T::value_type) == 1);
	...
	void Assign(const byte *data, size_t size, bool deepCopy)
	{
		...
		// GS2_CRYPTOPP_ASSERT((data && size) || !(data || size));
		if (deepCopy)
...
class GS2_CRYPTOPP_DLL CombinedNameValuePairs : public NameValuePairs
{
public:
...
GS2_CRYPTOPP_DLL bool AssignIntToInteger(const std::type_info &valueType, void *pInteger, const void *pInt);
#endif

GS2_CRYPTOPP_DLL const std::type_info & GS2_CRYPTOPP_API IntegerTypeId();

/// \brief Base class for AlgorithmParameters
class GS2_CRYPTOPP_DLL AlgorithmParametersBase
{
public:
	...
	virtual ~AlgorithmParametersBase() GS2_CRYPTOPP_THROW
	{

#if defined(GS2_CRYPTOPP_CXX17_EXCEPTIONS)
		if (std::uncaught_exceptions() == 0)
#elif defined(GS2_CRYPTOPP_UNCAUGHT_EXCEPTION_AVAILABLE)
...
#if !defined(GS2_CRYPTOPP_CXX17_EXCEPTIONS) && !defined(GS2_CRYPTOPP_UNCAUGHT_EXCEPTION_AVAILABLE)
...
# undef new
	...
	void MoveInto(void *buffer) const
	{
		...
		GS2_CRYPTOPP_UNUSED(p);	// silence warning
	}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AlgorithmParametersTemplate<bool>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AlgorithmParametersTemplate<int>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AlgorithmParametersTemplate<ConstByteArrayParameter>;
...
///   </pre>
class GS2_CRYPTOPP_DLL AlgorithmParameters : public NameValuePairs
{
public:
...
#define GS2_CRYPTOPP_GET_FUNCTION_ENTRY(name)		(Name::name(), &ThisClass::Get##name)
#define GS2_CRYPTOPP_SET_FUNCTION_ENTRY(name)		(Name::name(), &ThisClass::Set##name)
#define GS2_CRYPTOPP_SET_FUNCTION_ENTRY2(name1, name2)	(Name::name1(), Name::name2(), &ThisClass::Set##name1##And##name2)
