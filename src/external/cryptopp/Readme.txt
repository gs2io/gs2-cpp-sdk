...
define GS2_CRYPTOPP_INIT_PRIORITY to control object initialization order. Set it to a
value like 250. User programs can use GS2_CRYPTOPP_USER_PRIORITY to avoid conflicts with
