...
void WAKE_Base::GenKey(word32 k0, word32 k1, word32 k2, word32 k3)
{
	...
	GS2_CRYPTOPP_COMPILE_ASSERT(sizeof(x) == 4);
...
{
	GS2_CRYPTOPP_UNUSED(params); GS2_CRYPTOPP_UNUSED(key); GS2_CRYPTOPP_UNUSED(length);
	word32 k0, k1, k2, k3;
...
#define WAKE_OUTPUT(x)\
	...
	{\
		GS2_CRYPTOPP_KEYSTREAM_OUTPUT_WORD(x, B::ToEnum(), 0, r6);\
		r3 = M(r3, r6);\
		r4 = M(r4, r3);\
		r5 = M(r5, r4);\
		r6 = M(r6, r5);\
	...
	GS2_CRYPTOPP_KEYSTREAM_OUTPUT_SWITCH(WAKE_OUTPUT, 0);
}
/*
template <class B>
