#ifndef GS2_CRYPTOPP_NETWORK_H
#define GS2_CRYPTOPP_NETWORK_H
...
class GS2_CRYPTOPP_NO_VTABLE NonblockingSource : public AutoSignaling<Source>, public LimitedBandwidth
{
public:
...
/// Network Receiver
class GS2_CRYPTOPP_NO_VTABLE NetworkReceiver : public Waitable
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE NonblockingSinkInfo
{
public:
...
class GS2_CRYPTOPP_NO_VTABLE NonblockingSink : public Sink, public NonblockingSinkInfo, public LimitedBandwidth
{
public:
...
/// Network Sender
class GS2_CRYPTOPP_NO_VTABLE NetworkSender : public Waitable
{
public:
...
/// Network Source
class GS2_CRYPTOPP_NO_VTABLE NetworkSource : public NonblockingSource
{
public:
...
/// Network Sink
class GS2_CRYPTOPP_NO_VTABLE NetworkSink : public NonblockingSink
{
public:
