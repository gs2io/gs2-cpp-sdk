...
#ifndef GS2_CRYPTOPP_MD2_H
#define GS2_CRYPTOPP_MD2_H
...
public:
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "MD2";}

	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE = 16)
	GS2_CRYPTOPP_CONSTANT(BLOCKSIZE = 16)
