...
#ifndef GS2_CRYPTOPP_INTEGER_H
#define GS2_CRYPTOPP_INTEGER_H
...
/// \since Crypto++ 1.0
/// \nosubgrouping
class GS2_CRYPTOPP_DLL Integer : private InitializeInteger, public ASN1Object
{
public:
	...
	//@{
		...
		static const Integer & GS2_CRYPTOPP_API Zero();
		...
		static const Integer & GS2_CRYPTOPP_API One();
		...
		static const Integer & GS2_CRYPTOPP_API Two();
		...
		static Integer GS2_CRYPTOPP_API Power2(size_t e);
	//@}
	...
	//@{
		...
		static void GS2_CRYPTOPP_API Divide(Integer &r, Integer &q, const Integer &a, const Integer &d);
		...
		static void GS2_CRYPTOPP_API Divide(word &r, Integer &q, const Integer &a, word d);
		...
		static void GS2_CRYPTOPP_API DivideByPowerOf2(Integer &r, Integer &q, const Integer &a, unsigned int n);
		...
		static Integer GS2_CRYPTOPP_API Gcd(const Integer &a, const Integer &n);
	...
	//@{
		...
		friend GS2_CRYPTOPP_DLL std::istream& GS2_CRYPTOPP_API operator>>(std::istream& in, Integer &a);
		...
		friend GS2_CRYPTOPP_DLL std::ostream& GS2_CRYPTOPP_API operator<<(std::ostream& out, const Integer &a);
	//@}
	...
	GS2_CRYPTOPP_DLL friend Integer GS2_CRYPTOPP_API a_times_b_mod_c(const Integer &x, const Integer& y, const Integer& m);
	/// \brief Modular exponentiation
	/// \param x a reference to the base
	/// \param e a reference to the exponent
	/// \param m a reference to the modulus
	/// \returns an Integer <tt>(a ^ b) % m</tt>.
	GS2_CRYPTOPP_DLL friend Integer GS2_CRYPTOPP_API a_exp_b_mod_c(const Integer &x, const Integer& e, const Integer& m);
...
/// \brief Comparison
inline bool operator==(const gs2::detail::CryptoPP::Integer& a, const gs2::detail::CryptoPP::Integer& b) {return a.Compare(b)==0;}
/// \brief Comparison
inline bool operator!=(const gs2::detail::CryptoPP::Integer& a, const gs2::detail::CryptoPP::Integer& b) {return a.Compare(b)!=0;}
/// \brief Comparison
inline bool operator> (const gs2::detail::CryptoPP::Integer& a, const gs2::detail::CryptoPP::Integer& b) {return a.Compare(b)> 0;}
...
inline bool operator<=(const gs2::detail::CryptoPP::Integer& a, const gs2::detail::CryptoPP::Integer& b) {return a.Compare(b)<=0;}
/// \brief Addition
inline gs2::detail::CryptoPP::Integer operator+(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.Plus(b);}
/// \brief Subtraction
inline gs2::detail::CryptoPP::Integer operator-(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.Minus(b);}
/// \brief Multiplication
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline gs2::detail::CryptoPP::Integer operator*(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.Times(b);}
/// \brief Division
inline gs2::detail::CryptoPP::Integer operator/(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline gs2::detail::CryptoPP::Integer operator%(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.Modulo(b);}
/// \brief Division
inline gs2::detail::CryptoPP::Integer operator/(const gs2::detail::CryptoPP::Integer &a, gs2::detail::CryptoPP::word b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline gs2::detail::CryptoPP::word    operator%(const gs2::detail::CryptoPP::Integer &a, gs2::detail::CryptoPP::word b) {return a.Modulo(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline gs2::detail::CryptoPP::Integer operator&(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.And(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline gs2::detail::CryptoPP::Integer operator|(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.Or(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline gs2::detail::CryptoPP::Integer operator^(const gs2::detail::CryptoPP::Integer &a, const gs2::detail::CryptoPP::Integer &b) {return a.Xor(b);}
...
#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
inline void swap(gs2::detail::CryptoPP::Integer &a, gs2::detail::CryptoPP::Integer &b)
{
	a.swap(b);
}
NAMESPACE_END
