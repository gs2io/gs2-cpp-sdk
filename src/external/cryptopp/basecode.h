...
#ifndef GS2_CRYPTOPP_BASECODE_H
#define GS2_CRYPTOPP_BASECODE_H
...
class GS2_CRYPTOPP_DLL BaseN_Encoder : public Unflushable<Filter>
{
public:
...
class GS2_CRYPTOPP_DLL BaseN_Decoder : public Unflushable<Filter>
{
public:
	...
	static void GS2_CRYPTOPP_API InitializeDecodingLookupArray(int *lookup, const byte *alphabet, unsigned int base, bool caseInsensitive);
...
class GS2_CRYPTOPP_DLL Grouper : public Bufferless<Filter>
{
public:
