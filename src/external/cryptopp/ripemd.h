...
#ifndef GS2_CRYPTOPP_RIPEMD_H
#define GS2_CRYPTOPP_RIPEMD_H
...
public:
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-160";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-320";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-128";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-256";}
};
