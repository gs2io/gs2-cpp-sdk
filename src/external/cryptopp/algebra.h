...
#ifndef GS2_CRYPTOPP_ALGEBRA_H
#define GS2_CRYPTOPP_ALGEBRA_H
...
template <class T> class GS2_CRYPTOPP_NO_VTABLE AbstractGroup
{
public:
	typedef T Element;
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T> class GS2_CRYPTOPP_NO_VTABLE AbstractRing : public AbstractGroup<T>
{
public:
	typedef T Element;
	...
	AbstractRing(const AbstractRing &source)
		{GS2_CRYPTOPP_UNUSED(source); m_mg.m_pRing = this;}

	/// \brief Assign an AbstractRing
	/// \param source other AbstractRing
	AbstractRing& operator=(const AbstractRing &source)
		{GS2_CRYPTOPP_UNUSED(source); return *this;}
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
template <class T> class GS2_CRYPTOPP_NO_VTABLE AbstractEuclideanDomain : public AbstractRing<T>
{
public:
	typedef T Element;
...
public:
	...
	bool operator==(const EuclideanDomainOf<T> &rhs) const
		{GS2_CRYPTOPP_UNUSED(rhs); return true;}
