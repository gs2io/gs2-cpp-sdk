...
#ifndef GS2_CRYPTOPP_DES_H
#define GS2_CRYPTOPP_DES_H
...
struct DES_Info : public FixedBlockSize<8>, public FixedKeyLength<8>
{
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "DES";}
};
...
class DES : public DES_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<DES_Info>, public RawDES
	{
	public:
...
{
	GS2_CRYPTOPP_DLL static const char * GS2_CRYPTOPP_API StaticAlgorithmName() {return "DES-EDE2";}
};
...
class DES_EDE2 : public DES_EDE2_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<DES_EDE2_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
...
{
	GS2_CRYPTOPP_DLL static const char * GS2_CRYPTOPP_API StaticAlgorithmName() {return "DES-EDE3";}
};
...
class DES_EDE3 : public DES_EDE3_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<DES_EDE3_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "DES-XEX3";}
};
...
class DES_XEX3 : public DES_XEX3_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<DES_XEX3_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
