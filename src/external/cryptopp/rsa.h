...
#ifndef GS2_CRYPTOPP_RSA_H
#define GS2_CRYPTOPP_RSA_H
...
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_DLL RSAFunction : public TrapdoorFunction, public X509PublicKey
{
...
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_DLL InvertibleRSAFunction : public RSAFunction, public TrapdoorFunctionInverse, public PKCS8PrivateKey
{
...
/// \brief RSA trapdoor function using the public key
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_DLL RSAFunction_ISO : public RSAFunction
{
public:
	Integer ApplyFunction(const Integer &x) const;
...
/// \brief RSA trapdoor function using the private key
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_DLL InvertibleRSAFunction_ISO : public InvertibleRSAFunction
{
public:
	Integer CalculateInverse(RandomNumberGenerator &rng, const Integer &x) const;
	Integer PreimageBound() const {return ++(m_n>>1);}
...
/// \brief RSA algorithm
/// \since Crypto++ 1.0
struct GS2_CRYPTOPP_DLL RSA
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "RSA";}
...
/// \brief RSA algorithm
/// \since Crypto++ 1.0
struct GS2_CRYPTOPP_DLL RSA_ISO
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "RSA-ISO";}
