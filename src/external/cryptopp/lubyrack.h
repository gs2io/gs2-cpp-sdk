...
#ifndef GS2_CRYPTOPP_LUBYRACK_H
#define GS2_CRYPTOPP_LUBYRACK_H
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<LR_Info<T> >
	{
	public:
	...
	protected:
		GS2_CRYPTOPP_CONSTANT(S=T::DIGESTSIZE)
