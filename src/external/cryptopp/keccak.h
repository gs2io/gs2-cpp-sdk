...
#ifndef GS2_CRYPTOPP_KECCAK_H
#define GS2_CRYPTOPP_KECCAK_H
...
///   {
///     public:
///       GS2_CRYPTOPP_CONSTANT(DIGESTSIZE = 24)
...
public:
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "Keccak"; }
...
{
public:
	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE = T_DigestSize)
	GS2_CRYPTOPP_CONSTANT(BLOCKSIZE = 200 - 2 * DIGESTSIZE)
...
private:
	GS2_CRYPTOPP_COMPILE_ASSERT(BLOCKSIZE < 200); // ensure there was no underflow in the math
	GS2_CRYPTOPP_COMPILE_ASSERT(BLOCKSIZE > (int)T_DigestSize); // this is a general expectation by HMAC
};
