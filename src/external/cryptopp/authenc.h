...
#ifndef GS2_CRYPTOPP_AUTHENC_H
#define GS2_CRYPTOPP_AUTHENC_H
...
///   Encryption</A> on the Crypto++ wiki.
/// \since Crypto++ 5.6.0
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE AuthenticatedSymmetricCipherBase : public AuthenticatedSymmetricCipher
{
public:
...
protected:
	void UncheckedSetKey(const byte * key, unsigned int length,const gs2::detail::CryptoPP::NameValuePairs &params)
		{GS2_CRYPTOPP_UNUSED(key), GS2_CRYPTOPP_UNUSED(length), GS2_CRYPTOPP_UNUSED(params); GS2_CRYPTOPP_ASSERT(false);}
