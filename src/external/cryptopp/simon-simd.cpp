...
// #undef GS2_CRYPTOPP_SSSE3_AVAILABLE
...
# define GS2_CRYPTOPP_AVX512_ROTATE 1
# include <immintrin.h>
#endif
...
using gs2::detail::CryptoPP::byte;
using gs2::detail::CryptoPP::word32;
using gs2::detail::CryptoPP::word64;
using gs2::detail::CryptoPP::rotlFixed;
using gs2::detail::CryptoPP::rotrFixed;
using gs2::detail::CryptoPP::vec_swap;  // SunCC
...
{
#if defined(GS2_CRYPTOPP_BIG_ENDIAN)
...
#if defined(GS2_CRYPTOPP_AVX512_ROTATE)
template <unsigned int R>
...
#endif  // GS2_CRYPTOPP_AVX512_ROTATE
...
#if defined(GS2_CRYPTOPP_SSE41_AVAILABLE)
