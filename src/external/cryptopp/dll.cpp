...
#define GS2_CRYPTOPP_MANUALLY_INSTANTIATE_TEMPLATES
...
#if defined(GS2_CRYPTOPP_EXPORTS) && defined(GS2_CRYPTOPP_WIN32_AVAILABLE)
# include <windows.h>
#endif
