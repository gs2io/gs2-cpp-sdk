...
#ifndef GS2_CRYPTOPP_CAST_H
#define GS2_CRYPTOPP_CAST_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "CAST-128";}
};
...
class CAST128 : public CAST128_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public CAST, public BlockCipherImpl<CAST128_Info>
	{
	public:
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "CAST-256";}
};
...
class CAST256 : public CAST256_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public CAST, public BlockCipherImpl<CAST256_Info>
	{
	public:
		void UncheckedSetKey(const byte *userKey, unsigned int length, const NameValuePairs &params);
		void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
