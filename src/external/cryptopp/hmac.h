...
#ifndef GS2_CRYPTOPP_HMAC_H
#define GS2_CRYPTOPP_HMAC_H
...
/// \since Crypto++ 2.1
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE HMAC_Base : public VariableKeyLength<16, 0, INT_MAX>, public MessageAuthenticationCode
{
public:
...
{
public:
	GS2_CRYPTOPP_CONSTANT(DIGESTSIZE=T::DIGESTSIZE)
