...
#ifndef GS2_CRYPTOPP_GFPCRYPT_H
#define GS2_CRYPTOPP_GFPCRYPT_H
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_GroupParameters<Integer>;

/// \brief Integer-based GroupParameters specialization
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE DL_GroupParameters_IntegerBased : public ASN1CryptoMaterial<DL_GroupParameters<Integer> >
{
...
public:
    ...
    static std::string GS2_CRYPTOPP_API StaticAlgorithmNamePrefix() {return "";}
...
class GS2_CRYPTOPP_NO_VTABLE DL_GroupParameters_IntegerBasedImpl : public DL_GroupParametersImpl<GROUP_PRECOMP, BASE_PRECOMP, DL_GroupParameters_IntegerBased>
{
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_GroupParameters_IntegerBasedImpl<ModExpPrecomputation>;

/// \brief GF(p) group parameters
class GS2_CRYPTOPP_DLL DL_GroupParameters_GFP : public DL_GroupParameters_IntegerBasedImpl<ModExpPrecomputation>
{
public:
...
class GS2_CRYPTOPP_DLL DL_GroupParameters_GFP_DefaultSafePrime : public DL_GroupParameters_GFP
{
public:
...
{
public:
    GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "DSA-1363";}
...
{
public:
    GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "DSA-RFC6979";}
...
{
public:
    GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "GDSA-ISO15946";}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<Integer>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA1>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA224>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA256>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA384>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA512>;
...
{
public:
    GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "NR";}
...
/// \sa DL_Keys_DSA
class GS2_CRYPTOPP_DLL DL_GroupParameters_DSA : public DL_GroupParameters_GFP
{
public:
    ...
    static bool GS2_CRYPTOPP_API IsValidPrimeLength(unsigned int pbits)
...
{
public:
    static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return "DSA/" + (std::string)H::StaticAlgorithmName();}
};
...
struct DSA_RFC6979 : public DL_SS<
    ...
    DSA_RFC6979<H> >
{
    static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string("DSA-RFC6979/") + H::StaticAlgorithmName();}
};

/// DSA with SHA-1, typedef'd for backwards compatibility
typedef DSA2<SHA1> DSA;

GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKey_GFP<DL_GroupParameters_DSA>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_GFP<DL_GroupParameters_DSA>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_GFP<DL_GroupParameters_DSA>, DSA2<SHA1> >;
...
struct DLIES
    : public DL_ES<
        ...
        DLIES<> >
{
    static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return "DLIES";}    // TODO: fix this after name is standardized
};
