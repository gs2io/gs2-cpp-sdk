...
#ifndef GS2_CRYPTOPP_SQUARE_H
#define GS2_CRYPTOPP_SQUARE_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Square";}
};
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Square_Info>
	{
	public:
