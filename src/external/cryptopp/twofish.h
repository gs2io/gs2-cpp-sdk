...
#ifndef GS2_CRYPTOPP_TWOFISH_H
#define GS2_CRYPTOPP_TWOFISH_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Twofish";}
};
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Twofish_Info>
	{
	public:
