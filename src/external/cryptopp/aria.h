...
#ifndef GS2_CRYPTOPP_ARIA_H
#define GS2_CRYPTOPP_ARIA_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ARIA";}
};
...
{
public:
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<ARIA_Info>
	{
	public:
		Base() : m_rounds(0) {}
