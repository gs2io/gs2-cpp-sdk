...
//   Crypto++ 5.6.3. At compile time, it uses GS2_CRYPTOPP_BOOL_{X86|X32|X64}
...
#if defined(GS2_CRYPTOPP_CPUID_AVAILABLE)
# if defined(GS2_CRYPTOPP_MSC_VERSION)
#  if (GS2_CRYPTOPP_MSC_VERSION >= 1700)
#    define ALL_RDRAND_INTRIN_AVAILABLE 1
#  else
#    define MASM_RDRAND_ASM_AVAILABLE 1
#  endif
#  if (GS2_CRYPTOPP_MSC_VERSION >= 1800)
#    define ALL_RDSEED_INTRIN_AVAILABLE 1
#  else
#    define MASM_RDSEED_ASM_AVAILABLE 1
#  endif
# elif defined(GS2_CRYPTOPP_LLVM_CLANG_VERSION) || defined(GS2_CRYPTOPP_APPLE_CLANG_VERSION)
...
#    define GCC_RDSEED_ASM_AVAILABLE 1
#  endif
# elif defined(GS2_CRYPTOPP_GCC_VERSION)
#  if defined(__RDRND__) && (GS2_CRYPTOPP_GCC_VERSION >= 40700) && !defined(__OPTIMIZE__)
#    define ALL_RDRAND_INTRIN_AVAILABLE 1
#  else
#    define GCC_RDRAND_ASM_AVAILABLE 1
#  endif
#  if defined(__RDSEED__) && (GS2_CRYPTOPP_GCC_VERSION >= 40800) && !defined(__OPTIMIZE__)
#    define ALL_RDSEED_INTRIN_AVAILABLE 1
#  else
#    define GCC_RDSEED_ASM_AVAILABLE 1
#  endif
...
# if defined(__GNUC__) && (GS2_CRYPTOPP_GCC_VERSION >= 40700)
...
extern "C" void GS2_CRYPTOPP_FASTCALL MASM_RDRAND_GenerateBlock(byte*, size_t);
#endif

#if MASM_RDSEED_ASM_AVAILABLE
extern "C" void GS2_CRYPTOPP_FASTCALL MASM_RDSEED_GenerateBlock(byte*, size_t);
#endif
...
inline void RDRAND32(void* output)
{
...
#elif defined(GCC_RDRAND_ASM_AVAILABLE) && (GS2_CRYPTOPP_GCC_VERSION >= 40700)
    __asm__ __volatile__
    (
        INTEL_NOPREFIX
        ASL(1)
...
#elif defined(GCC_RDRAND_ASM_AVAILABLE) && (GS2_CRYPTOPP_GCC_VERSION >= 30200)
    __asm__ __volatile__
    (
        "1:\n"
        ".byte 0x0f, 0xc7, 0xf0;\n"
    ...
    GS2_CRYPTOPP_UNUSED(output);
    throw NotImplemented("RDRAND: failed to find an implementation");
#endif
}

#if GS2_CRYPTOPP_BOOL_X64 || GS2_CRYPTOPP_BOOL_X32
// Fills 8 bytes
...
#endif  // GS2_CRYPTOPP_BOOL_X64, GS2_CRYPTOPP_BOOL_X32 and RDRAND64
...
{
    GS2_CRYPTOPP_ASSERT((output && size) || !(output || size));
    if (size == 0) return;
...
#elif GS2_CRYPTOPP_BOOL_X64 || GS2_CRYPTOPP_BOOL_X32
    size_t i = 0;
    for (i = 0; i < size/8; i++)
...
#elif defined(GCC_RDSEED_ASM_AVAILABLE) && (GS2_CRYPTOPP_GCC_VERSION >= 40800)
    __asm__ __volatile__
    (
        INTEL_NOPREFIX
        ASL(1)
...
#elif defined(GCC_RDSEED_ASM_AVAILABLE) && (GS2_CRYPTOPP_GCC_VERSION >= 30200)
    __asm__ __volatile__
    (
        "1:\n"
        ".byte 0x0f, 0xc7, 0xf8;\n"
...
#endif  // GS2_CRYPTOPP_BOOL_X64 and RDSEED64
...
#endif  // GS2_CRYPTOPP_BOOL_X64, GS2_CRYPTOPP_BOOL_X32 and RDSEED64
}
...
#else  // GS2_CRYPTOPP_CPUID_AVAILABLE
...
void RDRAND::GenerateBlock(byte *output, size_t size)
{
    GS2_CRYPTOPP_UNUSED(output); GS2_CRYPTOPP_UNUSED(size);
}

void RDRAND::DiscardBytes(size_t n)
{
    GS2_CRYPTOPP_UNUSED(n);
}
