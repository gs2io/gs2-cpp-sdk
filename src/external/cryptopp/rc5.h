...
#ifndef GS2_CRYPTOPP_RC5_H
#define GS2_CRYPTOPP_RC5_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RC5";}
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<RC5_Info>
	{
	public:
