...
#ifndef GS2_CRYPTOPP_IDEA_H
#define GS2_CRYPTOPP_IDEA_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "IDEA";}
};
...
private:
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<IDEA_Info>
	{
	public:
