...
#ifndef GS2_CRYPTOPP_STDCPP_H
#define GS2_CRYPTOPP_STDCPP_H
...
#if defined(GS2_CRYPTOPP_CXX11_SYNCHRONIZATION)
#include <mutex>
#endif

#if defined(GS2_CRYPTOPP_CXX11_RVALUES)
# include <utility>
#endif
...
#ifdef GS2_CRYPTOPP_INCLUDE_VECTOR_CC
# include <vector.cc>
#endif
