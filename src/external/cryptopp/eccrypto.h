...
#ifndef GS2_CRYPTOPP_ECCRYPTO_H
#define GS2_CRYPTOPP_ECCRYPTO_H
...
public:
	...
	static std::string GS2_CRYPTOPP_API StaticAlgorithmNamePrefix() {return "EC";}
	...
	static OID GS2_CRYPTOPP_API GetNextRecommendedParametersOID(const OID &oid);
...
{
public:
  GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "ECDSA";}
};
...
{
public:
  GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "ECDSA-RFC6979";}
};
...
{
public:
  GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "ECNR";}
};
...
struct ECDSA_RFC6979 : public DL_SS<
	...
	ECDSA_RFC6979<EC,H> >
{
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string("ECDSA-RFC6979/") + H::StaticAlgorithmName();}
};
...
public:
	...
	void Initialize(const DL_GroupParameters_EC<EC> &params, const Integer &x)
	{
		...
		GS2_CRYPTOPP_ASSERT(x>=1 && x<=params.GetSubgroupOrder()-1);
	}
	...
	void Initialize(const EC &ec, const Element &G, const Integer &n, const Integer &x)
	{
		...
		this->SetPrivateExponent(x);
		GS2_CRYPTOPP_ASSERT(x>=1 && x<=this->AccessGroupParameters().GetSubgroupOrder()-1);
	}
	...
	virtual void MakePublicKey(DL_PublicKey_ECGDSA<EC> &pub) const
	{
		...
		GS2_CRYPTOPP_ASSERT(xInv.NotZero());
	}
...
{
public:
  GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "ECGDSA";}
};
...
struct ECGDSA : public DL_SS<
	...
	H>
{
	static std::string GS2_CRYPTOPP_API StaticAlgorithmName() {return std::string("ECGDSA-ISO15946/") + H::StaticAlgorithmName();}
};
		...
		ECIES<EC> >
{
	...
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* GS2_CRYPTOPP_API StaticAlgorithmName() {return "ECIES";}
};
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_GroupParameters_EC<ECP>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_GroupParameters_EC<EC2N>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKeyImpl<DL_GroupParameters_EC<ECP> >;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKeyImpl<DL_GroupParameters_EC<EC2N> >;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKey_EC<ECP>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKey_EC<EC2N>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKey_ECGDSA<ECP>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PublicKey_ECGDSA<EC2N>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKeyImpl<DL_GroupParameters_EC<ECP> >;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKeyImpl<DL_GroupParameters_EC<EC2N> >;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_EC<ECP>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_EC<EC2N>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_ECGDSA<ECP>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_ECGDSA<EC2N>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<ECP::Point>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<EC2N::Point>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_EC<ECP>, ECDSA<ECP, SHA256> >;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_EC<EC2N>, ECDSA<EC2N, SHA256> >;
