...
#define GS2_CRYPTOPP_TRACE_NETWORK 0
...
size_t NetworkSink::Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
{
...

	{
		if (m_skipBytes)
		{
			GS2_CRYPTOPP_ASSERT(length >= m_skipBytes);
