...
#ifndef GS2_CRYPTOPP_SAFER_H
#define GS2_CRYPTOPP_SAFER_H
...
public:
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipher
	{
	public:
...
class GS2_CRYPTOPP_NO_VTABLE SAFER_Impl : public BlockCipherImpl<INFO, BASE>
{
protected:
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SAFER-K";}
};
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SAFER-SK";}
};
