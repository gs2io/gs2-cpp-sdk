...
/// \since Crypto++ 5.6.3
#ifndef GS2_CRYPTOPP_MERSENNE_TWISTER_H
#define GS2_CRYPTOPP_MERSENNE_TWISTER_H
...
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return (S==5489 ? "MT19937ar" : (S==4537 ? "MT19937" : "MT19937x")); }
	...
	void GenerateBlock(byte *output, size_t size)
	{
		...
		switch (size%4)
		{
			case 3: output[2] = GS2_CRYPTOPP_GET_BYTE_AS_BYTE(temp, 1); /* fall through */
			case 2: output[1] = GS2_CRYPTOPP_GET_BYTE_AS_BYTE(temp, 2); /* fall through */
			case 1: output[0] = GS2_CRYPTOPP_GET_BYTE_AS_BYTE(temp, 3); break;

			default: GS2_CRYPTOPP_ASSERT(0); ;;
		}
...
#endif // GS2_CRYPTOPP_MERSENNE_TWISTER_H
