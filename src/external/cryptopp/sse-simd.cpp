...
#if GS2_CRYPTOPP_BOOL_X64 || defined(__APPLE__)
    return true;
#elif defined(GS2_CRYPTOPP_NO_CPU_FEATURE_PROBES)
    return false;
#elif defined(GS2_CRYPTOPP_MS_STYLE_INLINE_ASSEMBLY)
    __try
    {
# if GS2_CRYPTOPP_SSE2_ASM_AVAILABLE
        AS2(por xmm0, xmm0)        // executing SSE2 instruction
# elif GS2_CRYPTOPP_SSE2_INTRIN_AVAILABLE
