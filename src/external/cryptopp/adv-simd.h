...
#ifndef GS2_CRYPTOPP_ADVANCED_SIMD_TEMPLATES
#define GS2_CRYPTOPP_ADVANCED_SIMD_TEMPLATES
...
#if (GS2_CRYPTOPP_SSSE3_AVAILABLE)
# include <emmintrin.h>
# include <pmmintrin.h>
# include <tmmintrin.h>
#endif

#if defined(GS2_CRYPTOPP_ALTIVEC_AVAILABLE)
# include "ppc-simd.h"
#endif

// https://www.spinics.net/lists/gcchelp/msg47735.html and
// https://www.spinics.net/lists/gcchelp/msg47749.html
#if (GS2_CRYPTOPP_GCC_VERSION >= 40900)
...
using gs2::detail::CryptoPP::BlockTransformation;

GS2_CRYPTOPP_CONSTANT(BT_XorInput = BlockTransformation::BT_XorInput)
GS2_CRYPTOPP_CONSTANT(BT_AllowParallel = BlockTransformation::BT_AllowParallel)
GS2_CRYPTOPP_CONSTANT(BT_InBlockIsCounter = BlockTransformation::BT_InBlockIsCounter)
GS2_CRYPTOPP_CONSTANT(BT_ReverseDirection = BlockTransformation::BT_ReverseDirection)
GS2_CRYPTOPP_CONSTANT(BT_DontIncrementInOutPointers = BlockTransformation::BT_DontIncrementInOutPointers)
...
{
    GS2_CRYPTOPP_ASSERT(subKeys);
    GS2_CRYPTOPP_ASSERT(inBlocks);
    GS2_CRYPTOPP_ASSERT(outBlocks);
...
#endif  // GS2_CRYPTOPP_ARM_NEON_AVAILABLE

// *************************** Intel SSE ************************** //

#if defined(GS2_CRYPTOPP_SSSE3_AVAILABLE)
...
#endif  // GS2_CRYPTOPP_SSSE3_AVAILABLE
...
#endif  // GS2_CRYPTOPP_ALTIVEC_AVAILABLE

#endif  // GS2_CRYPTOPP_ADVANCED_SIMD_TEMPLATES
