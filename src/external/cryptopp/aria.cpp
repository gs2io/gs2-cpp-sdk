...
# define GS2_CRYPTOPP_ENABLE_ARIA_SSE2_INTRINSICS 1
#endif

#if GS2_CRYPTOPP_SSSE3_AVAILABLE
# define GS2_CRYPTOPP_ENABLE_ARIA_SSSE3_INTRINSICS 1
#endif
...
using gs2::detail::CryptoPP::ARIATab::S1;
using gs2::detail::CryptoPP::ARIATab::S2;
using gs2::detail::CryptoPP::ARIATab::X1;
using gs2::detail::CryptoPP::ARIATab::X2;
using gs2::detail::CryptoPP::ARIATab::KRK;
...
void ARIA::Base::UncheckedSetKey(const byte *key, unsigned int keylen, const NameValuePairs &params)
{
	...
	// Silence warnings
	GS2_CRYPTOPP_UNUSED(Q); GS2_CRYPTOPP_UNUSED(R);
	GS2_CRYPTOPP_UNUSED(q); GS2_CRYPTOPP_UNUSED(r);
}
...
#if GS2_CRYPTOPP_ENABLE_ARIA_SSSE3_INTRINSICS
	if (HasSSSE3())
	{
...
#endif  // GS2_CRYPTOPP_ENABLE_ARIA_SSSE3_INTRINSICS
...
#endif  // GS2_CRYPTOPP_LITTLE_ENDIAN
