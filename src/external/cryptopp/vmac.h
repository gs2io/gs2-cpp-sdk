...
#ifndef GS2_CRYPTOPP_VMAC_H
#define GS2_CRYPTOPP_VMAC_H
...
#if (defined(GS2_CRYPTOPP_LLVM_CLANG_VERSION) && (GS2_CRYPTOPP_LLVM_CLANG_VERSION < 30400)) || GS2_CRYPTOPP_BOOL_X32
# define GS2_CRYPTOPP_DISABLE_VMAC_ASM
#endif
...
protected:
	...
	GS2_CRYPTOPP_BLOCK_1(polyState, word64, 4*(m_is128+1))
	GS2_CRYPTOPP_BLOCK_2(nhKey, word64, m_L1KeyLength/sizeof(word64) + 2*m_is128)
	GS2_CRYPTOPP_BLOCK_3(data, byte, m_L1KeyLength)
	GS2_CRYPTOPP_BLOCK_4(l3Key, word64, 2*(m_is128+1))
	GS2_CRYPTOPP_BLOCK_5(nonce, byte, IVSize())
	GS2_CRYPTOPP_BLOCK_6(pad, byte, IVSize())
	GS2_CRYPTOPP_BLOCKS_END(6)
