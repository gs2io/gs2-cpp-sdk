#ifndef GS2_CRYPTOPP_MQUEUE_H
#define GS2_CRYPTOPP_MQUEUE_H
...
/// Message Queue
class GS2_CRYPTOPP_DLL MessageQueue : public AutoSignaling<BufferedTransformation>
{
public:
	...
	bool IsolatedMessageSeriesEnd(bool blocking)
		{GS2_CRYPTOPP_UNUSED(blocking); m_messageCounts.push_back(0); return false;}
...
class GS2_CRYPTOPP_DLL EqualityComparisonFilter : public Unflushable<Multichannel<Filter> >
{
public:
...
#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
template<> inline void swap(gs2::detail::CryptoPP::MessageQueue &a, gs2::detail::CryptoPP::MessageQueue &b)
{
	a.swap(b);
}
NAMESPACE_END
