...
#ifndef GS2_CRYPTOPP_GF2N_H
#define GS2_CRYPTOPP_GF2N_H
...
/*!	\nosubgrouping */
class GS2_CRYPTOPP_DLL PolynomialMod2
{
public:
	...
	//@{
		...
		/// \brief Provides x^i
		/// \returns x^i
		static PolynomialMod2 GS2_CRYPTOPP_API Monomial(size_t i);
		/// \brief Provides x^t0 + x^t1 + x^t2
		/// \returns x^t0 + x^t1 + x^t2
		static PolynomialMod2 GS2_CRYPTOPP_API Trinomial(size_t t0, size_t t1, size_t t2);
		/// \brief Provides x^t0 + x^t1 + x^t2 + x^t3 + x^t4
		/// \returns x^t0 + x^t1 + x^t2 + x^t3 + x^t4
		static PolynomialMod2 GS2_CRYPTOPP_API Pentanomial(size_t t0, size_t t1, size_t t2, size_t t3, size_t t4);
		/// \brief Provides x^(n-1) + ... + x + 1
		/// \returns x^(n-1) + ... + x + 1
		static PolynomialMod2 GS2_CRYPTOPP_API AllOnes(size_t n);

		/// \brief The Zero polinomial
		/// \returns the zero polynomial
		static const PolynomialMod2 & GS2_CRYPTOPP_API Zero();
		/// \brief The One polinomial
		/// \returns the one polynomial
		static const PolynomialMod2 & GS2_CRYPTOPP_API One();
	//@}
	...
	//@{
		...
		static PolynomialMod2 GS2_CRYPTOPP_API Gcd(const PolynomialMod2 &a, const PolynomialMod2 &n);
		/// calculate multiplicative inverse of *this mod n
		PolynomialMod2 InverseMod(const PolynomialMod2 &) const;

		/// calculate r and q such that (a == d*q + r) && (deg(r) < deg(d))
		static void GS2_CRYPTOPP_API Divide(PolynomialMod2 &r, PolynomialMod2 &q, const PolynomialMod2 &a, const PolynomialMod2 &d);
	//@}
...
///
inline bool operator==(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b)
{return a.Equals(b);}
///
inline bool operator!=(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b)
{return !(a==b);}
...
{return a.Degree() <= b.Degree();}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator&(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.And(b);}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator^(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.Xor(b);}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator+(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.Plus(b);}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator-(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.Minus(b);}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator*(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.Times(b);}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator/(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.DividedBy(b);}
///
inline gs2::detail::CryptoPP::PolynomialMod2 operator%(const gs2::detail::CryptoPP::PolynomialMod2 &a, const gs2::detail::CryptoPP::PolynomialMod2 &b) {return a.Modulo(b);}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractGroup<PolynomialMod2>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractRing<PolynomialMod2>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractEuclideanDomain<PolynomialMod2>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS EuclideanDomainOf<PolynomialMod2>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS QuotientRing<EuclideanDomainOf<PolynomialMod2> >;

/// \brief GF(2^n) with Polynomial Basis
class GS2_CRYPTOPP_DLL GF2NP : public QuotientRing<EuclideanDomainOf<PolynomialMod2> >
{
public:
	...
	virtual void DEREncode(BufferedTransformation &bt) const
		{GS2_CRYPTOPP_UNUSED(bt); GS2_CRYPTOPP_ASSERT(false);}	// no ASN.1 syntax yet for general polynomial basis

	void DEREncodeElement(BufferedTransformation &out, const Element &a) const;
	void BERDecodeElement(BufferedTransformation &in, Element &a) const;

	bool Equal(const Element &a, const Element &b) const
		{GS2_CRYPTOPP_ASSERT(a.Degree() < m_modulus.Degree() && b.Degree() < m_modulus.Degree()); return a.Equals(b);}

	bool IsUnit(const Element &a) const
		{GS2_CRYPTOPP_ASSERT(a.Degree() < m_modulus.Degree()); return !!a;}
...
class GS2_CRYPTOPP_DLL GF2NT : public GF2NP
{
public:
...
class GS2_CRYPTOPP_DLL GF2NPP : public GF2NP
{
public:
...
GS2_CRYPTOPP_DLL GF2NP * GS2_CRYPTOPP_API BERDecodeGF2NP(BufferedTransformation &bt);
...
#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
template<> inline void swap(gs2::detail::CryptoPP::PolynomialMod2 &a, gs2::detail::CryptoPP::PolynomialMod2 &b)
{
	a.swap(b);
}
NAMESPACE_END
