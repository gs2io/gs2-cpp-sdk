...
#ifndef GS2_CRYPTOPP_PADLOCK_RNG_H
#define GS2_CRYPTOPP_PADLOCK_RNG_H
...
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "PadlockRNG"; }
...
#endif  // GS2_CRYPTOPP_PADLOCK_RNG_H
