...
#ifndef GS2_CRYPTOPP_FILTERS_H
#define GS2_CRYPTOPP_FILTERS_H
...
///   more details.
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Filter : public BufferedTransformation, public NotCopyable
{
public:
	virtual ~Filter() {}
...
struct GS2_CRYPTOPP_DLL FilterPutSpaceHelper
{
	...
	{
		GS2_CRYPTOPP_ASSERT(desiredSize >= minSize && bufferSize >= minSize);
...
class GS2_CRYPTOPP_DLL MeterFilter : public Bufferless<Filter>
{
public:
	virtual ~MeterFilter() {}
	...
	void IsolatedInitialize(const NameValuePairs &parameters)
		{GS2_CRYPTOPP_UNUSED(parameters); ResetMeter();}
...
class GS2_CRYPTOPP_DLL TransparentFilter : public MeterFilter
{
public:
...
class GS2_CRYPTOPP_DLL OpaqueFilter : public MeterFilter
{
public:
...
class GS2_CRYPTOPP_DLL FilterWithBufferedInput : public Filter
{
public:
...
protected:
	...
	virtual void InitializeDerivedAndReturnNewSizes(const NameValuePairs &parameters, size_t &firstSize, size_t &blockSize, size_t &lastSize)
		{GS2_CRYPTOPP_UNUSED(parameters); GS2_CRYPTOPP_UNUSED(firstSize); GS2_CRYPTOPP_UNUSED(blockSize); GS2_CRYPTOPP_UNUSED(lastSize); InitializeDerived(parameters);}
	...
	virtual void NextPutSingle(const byte *inString)
		{GS2_CRYPTOPP_UNUSED(inString); GS2_CRYPTOPP_ASSERT(false);}
...
protected:
	...
	virtual int NextPut(const byte *inString, size_t length)
		{GS2_CRYPTOPP_UNUSED(inString); GS2_CRYPTOPP_UNUSED(length); GS2_CRYPTOPP_ASSERT(false); return 0;}
...
class GS2_CRYPTOPP_DLL FilterWithInputQueue : public Filter
{
public:
...
protected:
	...
	void IsolatedInitialize(const NameValuePairs &parameters)
		{GS2_CRYPTOPP_UNUSED(parameters); m_inQueue.Clear();}
...
/// \since Crypto++ 5.0
class GS2_CRYPTOPP_DLL StreamTransformationFilter : public FilterWithBufferedInput, public BlockPaddingSchemeDef, private FilterPutSpaceHelper
{
public:
...
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_DLL HashFilter : public Bufferless<Filter>, private FilterPutSpaceHelper
{
public:
	virtual ~HashFilter() {}
...
/// \brief Filter wrapper for HashTransformation
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL HashVerificationFilter : public FilterWithBufferedInput
{
public:
...
/// \since Crypto++ 5.6.0
class GS2_CRYPTOPP_DLL AuthenticatedEncryptionFilter : public StreamTransformationFilter
{
public:
...
/// \since Crypto++ 5.6.0
class GS2_CRYPTOPP_DLL AuthenticatedDecryptionFilter : public FilterWithBufferedInput, public BlockPaddingSchemeDef
{
public:
	/// \enum Flags
	/// \brief Flags controlling filter behavior.
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL SignerFilter : public Unflushable<Filter>
{
public:
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL SignatureVerificationFilter : public FilterWithBufferedInput
{
public:
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL Redirector : public CustomSignalPropagation<Sink>
{
public:
	/// \enum Behavior
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL OutputProxy : public CustomSignalPropagation<Sink>
{
public:
	virtual ~OutputProxy() {}
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL ProxyFilter : public FilterWithBufferedInput
{
public:
	virtual ~ProxyFilter() {}
...
/// \since Crypto++ 5.0
class GS2_CRYPTOPP_DLL SimpleProxyFilter : public ProxyFilter
{
public:
	...
	/// </pre>
	void LastPut(const byte *inString, size_t length)
		{GS2_CRYPTOPP_UNUSED(inString), GS2_CRYPTOPP_UNUSED(length); m_filter->MessageEnd();}
};
...
/// \since Crypto++ 5.0
class GS2_CRYPTOPP_DLL PK_EncryptorFilter : public SimpleProxyFilter
{
public:
...
/// \since Crypto++ 5.0
class GS2_CRYPTOPP_DLL PK_DecryptorFilter : public SimpleProxyFilter
{
public:
...
public:
	...
	StringSinkTemplate(T &output)
		: m_output(&output) {GS2_CRYPTOPP_ASSERT(sizeof(output[0])==1);}
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS StringSinkTemplate<std::string>;
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL ArraySink : public Bufferless<Sink>
{
public:
	virtual ~ArraySink() {}
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL ArrayXorSink : public ArraySink
{
public:
...
public:
	...
	GS2_CRYPTOPP_DLL size_t TransferTo2(BufferedTransformation &target, lword &transferBytes, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true);
	GS2_CRYPTOPP_DLL size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const;

private:
	GS2_CRYPTOPP_DLL void StoreInitialize(const NameValuePairs &parameters);
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL RandomNumberStore : public Store
{
public:
	...
	size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const
	{
		GS2_CRYPTOPP_UNUSED(target); GS2_CRYPTOPP_UNUSED(begin); GS2_CRYPTOPP_UNUSED(end); GS2_CRYPTOPP_UNUSED(channel); GS2_CRYPTOPP_UNUSED(blocking);
...
/// \brief Empty store
/// \since Crypto++ 5.0
class GS2_CRYPTOPP_DLL NullStore : public Store
{
public:
...
/// \since Crypto++ 1.0
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Source : public InputRejecting<Filter>
{
public:
	virtual ~Source() {}
...
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL StringSource : public SourceTemplate<StringStore>
{
public:
...
/// \brief RNG-based implementation of Source interface
/// \since Crypto++ 4.0
class GS2_CRYPTOPP_DLL RandomNumberSource : public SourceTemplate<RandomNumberStore>
{
public:
