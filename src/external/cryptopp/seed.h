...
#ifndef GS2_CRYPTOPP_SEED_H
#define GS2_CRYPTOPP_SEED_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SEED";}
};
...
{
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<SEED_Info>
	{
	public:
