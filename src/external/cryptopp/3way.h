...
#ifndef GS2_CRYPTOPP_THREEWAY_H
#define GS2_CRYPTOPP_THREEWAY_H
...
{
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "3-Way";}
};
...
class ThreeWay : public ThreeWay_Info, public BlockCipherDocumentation
{
	...
	class GS2_CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<ThreeWay_Info>
	{
	public:
