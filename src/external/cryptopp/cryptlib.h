...
#ifndef GS2_CRYPTOPP_CRYPTLIB_H
#define GS2_CRYPTOPP_CRYPTLIB_H
...
class GS2_CRYPTOPP_DLL Exception : public std::exception
{
public:
	/// \enum ErrorType
...
/// \brief An invalid argument was detected
class GS2_CRYPTOPP_DLL InvalidArgument : public Exception
{
public:
...
/// \brief Input data was received that did not conform to expected format
class GS2_CRYPTOPP_DLL InvalidDataFormat : public Exception
{
public:
...
class GS2_CRYPTOPP_DLL InvalidCiphertext : public InvalidDataFormat
{
public:
...
/// \brief A method was called which was not implemented
class GS2_CRYPTOPP_DLL NotImplemented : public Exception
{
public:
...
class GS2_CRYPTOPP_DLL CannotFlush : public Exception
{
public:
...
class GS2_CRYPTOPP_DLL OS_Error : public Exception
{
public:
...
struct GS2_CRYPTOPP_DLL DecodingResult
{
...
public:
	...
	class GS2_CRYPTOPP_DLL ValueTypeMismatch : public InvalidArgument
	{
	public:
	...
	GS2_CRYPTOPP_DLL std::string GetValueNames() const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	GS2_CRYPTOPP_DLL bool GetIntValue(const char *name, int &value) const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	GS2_CRYPTOPP_DLL int GetIntValueWithDefault(const char *name, int defaultValue) const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	GS2_CRYPTOPP_DLL static void GS2_CRYPTOPP_API ThrowIfTypeMismatch(const char *name, const std::type_info &stored, const std::type_info &retrieving)
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	GS2_CRYPTOPP_DLL void GetRequiredIntParameter(const char *className, const char *name, int &value) const
	{
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	GS2_CRYPTOPP_DLL virtual bool GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const =0;
};
...
public:
	...
	bool GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const
		{GS2_CRYPTOPP_UNUSED(name); GS2_CRYPTOPP_UNUSED(valueType); GS2_CRYPTOPP_UNUSED(pValue); return false;}
};
...
///   GS2_CRYPTOPP_ENABLE_NAMESPACE_WEAK 1</tt> before including a header for a weak or wounded
///   algorithm. For example:
///   <pre>
///     \c \#define GS2_CRYPTOPP_ENABLE_NAMESPACE_WEAK 1
///     \c \#include <md5.h>
///     ...
///     gs2::detail::CryptoPP::Weak::MD5 md5;
///   </pre>
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Clonable
{
public:
	virtual ~Clonable() {}
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE Algorithm : public Clonable
{
public:
	virtual ~Algorithm() {}
	...
	///    GS2_CRYPTOPP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 in config.h.
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE SimpleKeyingInterface
{
public:
	...
	virtual void Resynchronize(const byte *iv, int ivLength=-1) {
		GS2_CRYPTOPP_UNUSED(iv); GS2_CRYPTOPP_UNUSED(ivLength);
		throw NotImplemented(GetAlgorithm().AlgorithmName() + ": this object doesn't support resynchronization");
	}
...
protected:
	...
	inline void AssertValidKeyLength(size_t length) const
		{GS2_CRYPTOPP_UNUSED(length); GS2_CRYPTOPP_ASSERT(IsValidKeyLength(length));}
};
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE BlockTransformation : public Algorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE StreamTransformation : public Algorithm
{
public:
	...
	///   \ref GS2_CRYPTOPP_ASSERT "asserts" IsRandomAccess() in debug builds.
	virtual void Seek(lword pos)
	{
		GS2_CRYPTOPP_UNUSED(pos);
		GS2_CRYPTOPP_ASSERT(!IsRandomAccess());
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE HashTransformation : public Algorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE BlockCipher : public SimpleKeyingInterface, public BlockTransformation
{
protected:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE SymmetricCipher : public SimpleKeyingInterface, public StreamTransformation
{
protected:
	const Algorithm & GetAlgorithm() const {return *this;}
};
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE MessageAuthenticationCode : public SimpleKeyingInterface, public HashTransformation
{
protected:
	const Algorithm & GetAlgorithm() const {return *this;}
};
...
/// \since Crypto++ 5.6.0
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE AuthenticatedSymmetricCipher : public MessageAuthenticationCode, public StreamTransformation
{
public:
...
protected:
	...
	virtual void UncheckedSpecifyDataLengths(lword headerLength, lword messageLength, lword footerLength)
		{GS2_CRYPTOPP_UNUSED(headerLength); GS2_CRYPTOPP_UNUSED(messageLength); GS2_CRYPTOPP_UNUSED(footerLength);}
};
...
/// \since Crypto++ 3.1
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE RandomNumberGenerator : public Algorithm
{
public:
...
/// \since Crypto++ 6.2
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE KeyDerivationFunction : public Algorithm
{
public:
...
GS2_CRYPTOPP_DLL RandomNumberGenerator & GS2_CRYPTOPP_API NullRNG();

class WaitObjectContainer;
class CallStack;

/// \brief Interface for objects that can be waited on.
class GS2_CRYPTOPP_NO_VTABLE Waitable
{
public:
	virtual ~Waitable() {}
...
/// \nosubgrouping
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE BufferedTransformation : public Algorithm, public Waitable
{
public:
	...
	//@{
		...
		virtual void IsolatedInitialize(const NameValuePairs &parameters) {
			GS2_CRYPTOPP_UNUSED(parameters);
		...
		virtual bool IsolatedMessageSeriesEnd(bool blocking)
			{GS2_CRYPTOPP_UNUSED(blocking); return false;}
		...
		virtual void SetAutoSignalPropagation(int propagation)
			{GS2_CRYPTOPP_UNUSED(propagation);}
...
public:
	...
	//@{
		...
		virtual BufferedTransformation *AttachedTransformation() {GS2_CRYPTOPP_ASSERT(!Attachable()); return NULLPTR;}
		...
		virtual void Detach(BufferedTransformation *newAttachment = NULLPTR) {
			GS2_CRYPTOPP_UNUSED(newAttachment); GS2_CRYPTOPP_ASSERT(!Attachable());
...
GS2_CRYPTOPP_DLL BufferedTransformation & TheBitBucket();

/// \brief Interface for crypto material, such as public and private keys, and crypto parameters
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE CryptoMaterial : public NameValuePairs
{
public:
	/// Exception thrown when invalid crypto material is detected
	class GS2_CRYPTOPP_DLL InvalidMaterial : public InvalidDataFormat
	{
	public:
	...
	virtual void Save(BufferedTransformation &bt) const
		{GS2_CRYPTOPP_UNUSED(bt); throw NotImplemented("CryptoMaterial: this object does not support saving");}
	...
	virtual void Load(BufferedTransformation &bt)
		{GS2_CRYPTOPP_UNUSED(bt); throw NotImplemented("CryptoMaterial: this object does not support loading");}
	...
	virtual void Precompute(unsigned int precomputationStorage) {
		GS2_CRYPTOPP_UNUSED(precomputationStorage); GS2_CRYPTOPP_ASSERT(!SupportsPrecomputation());
	...
	virtual void LoadPrecomputation(BufferedTransformation &storedPrecomputation)
		{GS2_CRYPTOPP_UNUSED(storedPrecomputation); GS2_CRYPTOPP_ASSERT(!SupportsPrecomputation()); throw NotImplemented("CryptoMaterial: this object does not support precomputation");}
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE GeneratableCryptoMaterial : virtual public CryptoMaterial
{
public:
	...
	virtual void GenerateRandom(RandomNumberGenerator &rng, const NameValuePairs &params = g_nullNameValuePairs) {
		GS2_CRYPTOPP_UNUSED(rng); GS2_CRYPTOPP_UNUSED(params);
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PublicKey : virtual public CryptoMaterial
{
};

/// \brief Interface for private keys
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PrivateKey : public GeneratableCryptoMaterial
{
};

/// \brief Interface for crypto prameters
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE CryptoParameters : public GeneratableCryptoMaterial
{
};
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE AsymmetricAlgorithm : public Algorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PublicKeyAlgorithm : public AsymmetricAlgorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PrivateKeyAlgorithm : public AsymmetricAlgorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE KeyAgreementAlgorithm : public AsymmetricAlgorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_CryptoSystem
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_Encryptor : public PK_CryptoSystem, public PublicKeyAlgorithm
{
public:
	/// \brief Exception thrown when trying to encrypt plaintext of invalid length
	class GS2_CRYPTOPP_DLL InvalidPlaintextLength : public Exception
	{
	public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_Decryptor : public PK_CryptoSystem, public PrivateKeyAlgorithm
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_SignatureScheme
{
public:
	...
	class GS2_CRYPTOPP_DLL InvalidKeyLength : public Exception
	{
	public:
	...
	class GS2_CRYPTOPP_DLL KeyTooShort : public InvalidKeyLength
	{
	public:
	...
	{GS2_CRYPTOPP_UNUSED(recoverablePartLength); return SignatureLength();}
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_MessageAccumulator : public HashTransformation
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_Signer : public PK_SignatureScheme, public PrivateKeyAlgorithm
{
public:
	virtual ~PK_Signer() {}
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE PK_Verifier : public PK_SignatureScheme, public PublicKeyAlgorithm
{
public:
	virtual ~PK_Verifier() {}
...
/// \since Crypto++ 3.0
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE SimpleKeyAgreementDomain : public KeyAgreementAlgorithm
{
public:
...
/// \since Crypto++ 3.0
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE AuthenticatedKeyAgreementDomain : public KeyAgreementAlgorithm
{
public:
...
class GS2_CRYPTOPP_DLL BERDecodeErr : public InvalidArgument
{
public:
...
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE ASN1Object
{
public:
	virtual ~ASN1Object() {}
...
/// \since Crypto++ 6.0
extern "C" {
	int LibraryVersion(GS2_CRYPTOPP_NOINLINE_DOTDOTDOT);
} // C linkage
