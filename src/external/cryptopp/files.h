...
#ifndef GS2_CRYPTOPP_FILES_H
#define GS2_CRYPTOPP_FILES_H
...
class GS2_CRYPTOPP_DLL FileStore : public Store, private FilterPutSpaceHelper, public NotCopyable
{
public:
...
#if defined(GS2_CRYPTOPP_UNIX_AVAILABLE) || defined(GS2_CRYPTOPP_DOXYGEN_PROCESSING) || _MSC_VER >= 1400
	/// \brief Construct a FileStore
...
/// \brief Implementation of Store interface
/// \details file-based implementation of Store interface
class GS2_CRYPTOPP_DLL FileSource : public SourceTemplate<FileStore>
{
public:
...
class GS2_CRYPTOPP_DLL FileSink : public Sink, public NotCopyable
{
public:
	/// \brief Exception thrown when file-based error is encountered
	class Err : public Exception
...
#if defined(GS2_CRYPTOPP_UNIX_AVAILABLE) || _MSC_VER >= 1400
	/// \brief Construct a FileSink
	/// \param filename the Unicode name of the file to open
	/// \details On non-Windows OS, this function assumes that setlocale() has been called.
