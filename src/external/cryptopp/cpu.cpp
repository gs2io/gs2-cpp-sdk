...
// GS2_CRYPTOPP_GLIBC_VERSION not used because config.h is missing <feature.h>
#if (((__GLIBC__ * 100) + __GLIBC_MINOR__) >= 216)
# define GS2_CRYPTOPP_GETAUXV_AVAILABLE 1
#endif

#if GS2_CRYPTOPP_GETAUXV_AVAILABLE
# include <sys/auxv.h>
#else
#ifndef AT_HWCAP
# define AT_HWCAP 16
...
#ifdef GS2_CRYPTOPP_GNU_STYLE_INLINE_ASSEMBLY
# include <signal.h>
# include <setjmp.h>
#endif
...
#ifndef GS2_CRYPTOPP_MS_STYLE_INLINE_ASSEMBLY
extern "C" {
...
extern "C"
{
	...
	{
		GS2_CRYPTOPP_UNUSED(unused);
		longjmp(s_jmpNoCPUID, 1);
	}
}
#endif  // Not GS2_CRYPTOPP_MS_STYLE_INLINE_ASSEMBLY
...
#elif _MSC_VER >= 1400 && GS2_CRYPTOPP_BOOL_X64
...
{
#if defined(GS2_CRYPTOPP_MS_STYLE_INLINE_ASSEMBLY) || defined(__BORLANDC__)
    __try
	{
...
# if GS2_CRYPTOPP_BOOL_X32 || GS2_CRYPTOPP_BOOL_X64
...
bool GS2_CRYPTOPP_SECTION_INIT g_x86DetectionDone = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSSE2 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSSSE3 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSSE41 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSSE42 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasAESNI = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasCLMUL = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasADX = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSHA = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasRDRAND = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasRDSEED = false;
bool GS2_CRYPTOPP_SECTION_INIT g_isP4 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPadlockRNG = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPadlockACE = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPadlockACE2 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPadlockPHE = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPadlockPMM = false;
word32 GS2_CRYPTOPP_SECTION_INIT g_cacheLineSize = GS2_CRYPTOPP_L1_CACHE_LINE_SIZE;
...
void DetectX86Features()
{
	...
	if (IsIntel(cpuid0))
	{
		GS2_CRYPTOPP_CONSTANT(RDRAND_FLAG = (1 << 30))
		GS2_CRYPTOPP_CONSTANT(RDSEED_FLAG = (1 << 18))
		GS2_CRYPTOPP_CONSTANT(   ADX_FLAG = (1 << 19))
		GS2_CRYPTOPP_CONSTANT(   SHA_FLAG = (1 << 29))
	...
	{
		GS2_CRYPTOPP_CONSTANT( RNG_FLAGS = (0x3 << 2))
		GS2_CRYPTOPP_CONSTANT( ACE_FLAGS = (0x3 << 6))
		GS2_CRYPTOPP_CONSTANT(ACE2_FLAGS = (0x3 << 8))
		GS2_CRYPTOPP_CONSTANT( PHE_FLAGS = (0x3 << 10))
		GS2_CRYPTOPP_CONSTANT( PMM_FLAGS = (0x3 << 12))
	...
	if (g_cacheLineSize == 0)
		g_cacheLineSize = GS2_CRYPTOPP_L1_CACHE_LINE_SIZE;
...
bool GS2_CRYPTOPP_SECTION_INIT g_ArmDetectionDone = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasNEON = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPMULL = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasCRC32 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasAES = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSHA1 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSHA2 = false;
word32 GS2_CRYPTOPP_SECTION_INIT g_cacheLineSize = GS2_CRYPTOPP_L1_CACHE_LINE_SIZE;
...
bool GS2_CRYPTOPP_SECTION_INIT g_PowerpcDetectionDone = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasAltivec = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPower7 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasPower8 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasAES = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSHA256 = false;
bool GS2_CRYPTOPP_SECTION_INIT g_hasSHA512 = false;
word32 GS2_CRYPTOPP_SECTION_INIT g_cacheLineSize = GS2_CRYPTOPP_L1_CACHE_LINE_SIZE;
...
public:
	...
	{
#if GS2_CRYPTOPP_BOOL_X86 || GS2_CRYPTOPP_BOOL_X32 || GS2_CRYPTOPP_BOOL_X64
		gs2::detail::CryptoPP::DetectX86Features();
#elif GS2_CRYPTOPP_BOOL_ARM32 || GS2_CRYPTOPP_BOOL_ARM64
		gs2::detail::CryptoPP::DetectArmFeatures();
#elif GS2_CRYPTOPP_BOOL_PPC32 || GS2_CRYPTOPP_BOOL_PPC64
		gs2::detail::CryptoPP::DetectPowerpcFeatures();
#endif
	}
};
...
// Dynamic initialization will be used if init priorities are not available.
	...
	const InitCpu s_init __attribute__ ((init_priority (GS2_CRYPTOPP_INIT_PRIORITY + 10))) = InitCpu();
