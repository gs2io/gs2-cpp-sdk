...
// use "cl /EP /P /DGS2_CRYPTOPP_GENERATE_X64_MASM sha.cpp" to generate MASM code
...
#if defined(GS2_CRYPTOPP_LLVM_CLANG_VERSION) && (GS2_CRYPTOPP_LLVM_CLANG_VERSION < 30500)
# define GS2_CRYPTOPP_DISABLE_SHA_ASM
#endif

#if defined(GS2_CRYPTOPP_DISABLE_SHA_ASM)
...
#if GS2_CRYPTOPP_SHANI_AVAILABLE
...
#if GS2_CRYPTOPP_ARM_SHA_AVAILABLE
...
#if GS2_CRYPTOPP_POWER8_SHA_AVAILABLE
...
{
    GS2_CRYPTOPP_ASSERT(state);
    GS2_CRYPTOPP_ASSERT(data);
...
{
    GS2_CRYPTOPP_ASSERT(input);
    GS2_CRYPTOPP_ASSERT(length >= SHA1::BLOCKSIZE);
...
#endif // Not GS2_CRYPTOPP_GENERATE_X64_MASM

#if (defined(GS2_CRYPTOPP_X86_ASM_AVAILABLE) || defined(GS2_CRYPTOPP_X32_ASM_AVAILABLE) || defined(GS2_CRYPTOPP_GENERATE_X64_MASM))

ANONYMOUS_NAMESPACE_BEGIN

void GS2_CRYPTOPP_FASTCALL SHA256_HashMultipleBlocks_SSE2(word32 *state, const word32 *data, size_t len)
{
...
// Unroll the use of GS2_CRYPTOPP_BOOL_X64 in assembler math. The GAS assembler on X32 (version 2.25)
...
#endif    // GS2_CRYPTOPP_X86_ASM_AVAILABLE or GS2_CRYPTOPP_GENERATE_X64_MASM
...
{
    GS2_CRYPTOPP_ASSERT(input);
    GS2_CRYPTOPP_ASSERT(length >= SHA256::BLOCKSIZE);
...
#if GS2_CRYPTOPP_SSE2_ASM_AVAILABLE && (GS2_CRYPTOPP_BOOL_X86 || GS2_CRYPTOPP_BOOL_X32)

ANONYMOUS_NAMESPACE_BEGIN

GS2_CRYPTOPP_NAKED void GS2_CRYPTOPP_FASTCALL SHA512_HashBlock_SSE2(word64 *state, const word64 *data)
{
#ifdef __GNUC__
    __asm__ __volatile__
    (
...
#endif    // GS2_CRYPTOPP_SSE2_ASM_AVAILABLE
...
#endif    // Not GS2_CRYPTOPP_GENERATE_X64_MASM
#endif    // Not GS2_CRYPTOPP_IMPORTS
