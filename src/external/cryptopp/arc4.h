...
#ifndef GS2_CRYPTOPP_ARC4_H
#define GS2_CRYPTOPP_ARC4_H
...
/// \since Crypto++ 3.1
class GS2_CRYPTOPP_NO_VTABLE ARC4_Base : public VariableKeyLength<16, 1, 256>, public RandomNumberGenerator, public SymmetricCipher, public SymmetricCipherDocumentation
{
public:
	~ARC4_Base();

	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ARC4";}
...
/// \since Crypto++ 3.1
class GS2_CRYPTOPP_NO_VTABLE MARC4_Base : public ARC4_Base
{
public:
	GS2_CRYPTOPP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "MARC4";}
