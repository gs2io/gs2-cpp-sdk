...
#ifndef GS2_CRYPTOPP_NBTHEORY_H
#define GS2_CRYPTOPP_NBTHEORY_H
...
GS2_CRYPTOPP_DLL const word16 * GS2_CRYPTOPP_API GetPrimeTable(unsigned int &size);
...
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API MaurerProvablePrime(RandomNumberGenerator &rng, unsigned int bits);
...
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API MihailescuProvablePrime(RandomNumberGenerator &rng, unsigned int bits);
...
///   in the table.
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IsSmallPrime(const Integer &p);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API TrialDivision(const Integer &p, unsigned bound);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API SmallDivisorsTest(const Integer &p);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IsFermatProbablePrime(const Integer &n, const Integer &b);
...
///   IsStrongLucasProbablePrime instead.
/// \sa IsStrongProbablePrime, IsStrongLucasProbablePrime
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IsLucasProbablePrime(const Integer &n);

/// \brief Determine if a number is probably prime
/// \param n the number to test
/// \param b the base to exponentiate
/// \returns true if the number n is probably prime, false otherwise.
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IsStrongProbablePrime(const Integer &n, const Integer &b);

/// \brief Determine if a number is probably prime
/// \param n the number to test
/// \returns true if the number n is probably prime, false otherwise.
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IsStrongLucasProbablePrime(const Integer &n);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API RabinMillerTest(RandomNumberGenerator &rng, const Integer &n, unsigned int rounds);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API IsPrime(const Integer &p);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API VerifyPrime(RandomNumberGenerator &rng, const Integer &p, unsigned int level = 1);

/// \brief Application callback to signal suitability of a cabdidate prime
class GS2_CRYPTOPP_DLL PrimeSelector
{
public:
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API FirstPrime(Integer &p, const Integer &max, const Integer &equiv, const Integer &mod, const PrimeSelector *pSelector);

GS2_CRYPTOPP_DLL unsigned int GS2_CRYPTOPP_API PrimeSearchInterval(const Integer &max);

GS2_CRYPTOPP_DLL AlgorithmParameters GS2_CRYPTOPP_API MakeParametersForTwoPrimesOfEqualSize(unsigned int productBitLength);
...
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API CRT(const Integer &xp, const Integer &p, const Integer &xq, const Integer &q, const Integer &u);
...
GS2_CRYPTOPP_DLL int GS2_CRYPTOPP_API Jacobi(const Integer &a, const Integer &b);

/// \brief Calculate the Lucas value
/// \returns the Lucas value
/// \details Lucas() calculates the Lucas function <tt>V_e(p, 1) mod n</tt>.
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API Lucas(const Integer &e, const Integer &p, const Integer &n);
...
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API InverseLucas(const Integer &e, const Integer &m, const Integer &p, const Integer &q, const Integer &u);
...
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API ModularSquareRoot(const Integer &a, const Integer &p);
...
GS2_CRYPTOPP_DLL Integer GS2_CRYPTOPP_API ModularRoot(const Integer &a, const Integer &dp, const Integer &dq, const Integer &p, const Integer &q, const Integer &u);
...
GS2_CRYPTOPP_DLL bool GS2_CRYPTOPP_API SolveModularQuadraticEquation(Integer &r1, Integer &r2, const Integer &a, const Integer &b, const Integer &c, const Integer &p);
...
GS2_CRYPTOPP_DLL unsigned int GS2_CRYPTOPP_API DiscreteLogWorkFactor(unsigned int bitlength);
...
///   calculate discrete log or factor a number.
GS2_CRYPTOPP_DLL unsigned int GS2_CRYPTOPP_API FactoringWorkFactor(unsigned int bitlength);

// ********************************************************

/// \brief Generator of prime numbers of special forms
class GS2_CRYPTOPP_DLL PrimeAndGenerator
{
public:
