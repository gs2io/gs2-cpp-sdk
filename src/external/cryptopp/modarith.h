...
#ifndef GS2_CRYPTOPP_MODARITH_H
#define GS2_CRYPTOPP_MODARITH_H
...
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractGroup<Integer>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractRing<Integer>;
GS2_CRYPTOPP_DLL_TEMPLATE_CLASS AbstractEuclideanDomain<Integer>;
...
class GS2_CRYPTOPP_DLL ModularArithmetic : public AbstractRing<Integer>
{
public:
	...
	{
		GS2_CRYPTOPP_UNUSED(ignore_for_now);
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
class GS2_CRYPTOPP_DLL MontgomeryRepresentation : public ModularArithmetic
{
public:
