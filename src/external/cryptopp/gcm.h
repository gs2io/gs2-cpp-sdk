...
#ifndef GS2_CRYPTOPP_GCM_H
#define GS2_CRYPTOPP_GCM_H
...
/// \since Crypto++ 5.6.0
class GS2_CRYPTOPP_DLL GS2_CRYPTOPP_NO_VTABLE GCM_Base : public AuthenticatedSymmetricCipherBase
{
public:
...
protected:
	...
	class GS2_CRYPTOPP_DLL GCTR : public CTR_Mode_ExternalCipher::Encryption
	{
	protected:
