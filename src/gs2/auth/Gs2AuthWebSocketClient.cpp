...
void write(detail::json::JsonWriter& jsonWriter, const AccessToken& obj);
 ...
 */
void Gs2AuthWebSocketClient::login(LoginRequest request, std::function<void(AsyncLoginResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2AuthWebSocketClient::loginBySignature(LoginBySignatureRequest request, std::function<void(AsyncLoginBySignatureResult)> callback)
{
