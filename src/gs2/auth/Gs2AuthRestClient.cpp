 ...
 */
void Gs2AuthRestClient::login(LoginRequest request, std::function<void(AsyncLoginResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2AuthRestClient::loginBySignature(LoginBySignatureRequest request, std::function<void(AsyncLoginBySignatureResult)> callback)
{
