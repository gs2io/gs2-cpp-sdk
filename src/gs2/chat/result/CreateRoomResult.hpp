...
public:
    ...
    CreateRoomResult(const CreateRoomResult& createRoomResult) = default;
    CreateRoomResult(CreateRoomResult&& createRoomResult) = default;
    ~CreateRoomResult() = default;

    CreateRoomResult& operator=(const CreateRoomResult& createRoomResult) = default;
    CreateRoomResult& operator=(CreateRoomResult&& createRoomResult) = default;

    CreateRoomResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateRoomResult);
    }
