...
#ifndef GS2_CHAT_CONTROL_CREATENAMESPACEREQUEST_HPP_
#define GS2_CHAT_CONTROL_CREATENAMESPACEREQUEST_HPP_
 ...
 */
class CreateNamespaceRequest : public Gs2BasicRequest, public Gs2Chat
{
public:
...
public:
     ...
     * @param allowCreateRoom ゲームプレイヤーによるルームの作成を許可するか
     */
    CreateNamespaceRequest& withAllowCreateRoom(Bool allowCreateRoom)
    {
        ensureData().allowCreateRoom.emplace(allowCreateRoom);
        return *this;
    }
...
#endif //GS2_CHAT_CONTROL_CREATENAMESPACEREQUEST_HPP_