...
#ifndef GS2_CHAT_CONTROL_UNSUBSCRIBEREQUEST_HPP_
#define GS2_CHAT_CONTROL_UNSUBSCRIBEREQUEST_HPP_
 ...
 */
class UnsubscribeRequest : public Gs2BasicRequest, public Gs2Chat
{
public:
...
public:
     ...
     * @param roomName ルーム名
     */
    UnsubscribeRequest& withRoomName(StringHolder roomName)
    {
        ensureData().roomName.emplace(std::move(roomName));
        return *this;
    }
...
#endif //GS2_CHAT_CONTROL_UNSUBSCRIBEREQUEST_HPP_