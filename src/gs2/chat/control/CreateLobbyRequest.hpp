...
#ifndef GS2_CHAT_CONTROL_CREATELOBBYREQUEST_HPP_
#define GS2_CHAT_CONTROL_CREATELOBBYREQUEST_HPP_
 ...
 */
class CreateLobbyRequest : public Gs2BasicRequest, public Gs2Chat
{
public:
    constexpr static const Char* const FUNCTION = "CreateLobby";
...
public:
    ...
    CreateLobbyRequest(const CreateLobbyRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Chat(obj),
    ...
    CreateLobbyRequest& operator=(const CreateLobbyRequest& createLobbyRequest)
    {
        Gs2BasicRequest::operator=(createLobbyRequest);
        Gs2Chat::operator=(createLobbyRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*createLobbyRequest.m_pData);

        return *this;
    }

    CreateLobbyRequest& operator=(CreateLobbyRequest&& createLobbyRequest)
    {
        Gs2BasicRequest::operator=(std::move(createLobbyRequest));
        Gs2Chat::operator=(std::move(createLobbyRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = createLobbyRequest.m_pData;
        createLobbyRequest.m_pData = nullptr;

        return *this;
    }

    const CreateLobbyRequest* operator->() const
    {
        return this;
    }

    CreateLobbyRequest* operator->()
    {
        return this;
    }
     ...
     * @param name ロビー名
     */
    CreateLobbyRequest& withName(const Char* name)
    {
        ensureData().name.emplace(name);
        return *this;
    }
     ...
     * @param description 説明文
     */
    CreateLobbyRequest& withDescription(const Char* description)
    {
        ensureData().description.emplace(description);
        return *this;
    }
     ...
     * @param serviceClass サービスクラス
     */
    CreateLobbyRequest& withServiceClass(const Char* serviceClass)
    {
        ensureData().serviceClass.emplace(serviceClass);
        return *this;
    }
     ...
     * @param notificationType 通知方式
     */
    CreateLobbyRequest& withNotificationType(const Char* notificationType)
    {
        ensureData().notificationType.emplace(notificationType);
        return *this;
    }
     ...
     * @param notificationUrl http/https を選択した際の通知先URL
     */
    CreateLobbyRequest& withNotificationUrl(const Char* notificationUrl)
    {
        ensureData().notificationUrl.emplace(notificationUrl);
        return *this;
    }
     ...
     * @param notificationGameName gs2-in-game-push-notification を選択した際の GS2-InGamePushNotification のゲーム名
     */
    CreateLobbyRequest& withNotificationGameName(const Char* notificationGameName)
    {
        ensureData().notificationGameName.emplace(notificationGameName);
        return *this;
    }
     ...
     * @param logging ログを記録するか
     */
    CreateLobbyRequest& withLogging(Bool logging)
    {
        ensureData().logging.emplace(logging);
        return *this;
    }
     ...
     * @param loggingDate ログを記録する日数
     */
    CreateLobbyRequest& withLoggingDate(Int32 loggingDate)
    {
        ensureData().loggingDate.emplace(loggingDate);
        return *this;
    }
     ...
     * @param createRoomTriggerScript ルーム作成時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withCreateRoomTriggerScript(const Char* createRoomTriggerScript)
    {
        ensureData().createRoomTriggerScript.emplace(createRoomTriggerScript);
        return *this;
    }
     ...
     * @param createRoomDoneTriggerScript ルーム作成完了時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withCreateRoomDoneTriggerScript(const Char* createRoomDoneTriggerScript)
    {
        ensureData().createRoomDoneTriggerScript.emplace(createRoomDoneTriggerScript);
        return *this;
    }
     ...
     * @param deleteRoomTriggerScript ルーム削除時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withDeleteRoomTriggerScript(const Char* deleteRoomTriggerScript)
    {
        ensureData().deleteRoomTriggerScript.emplace(deleteRoomTriggerScript);
        return *this;
    }
     ...
     * @param deleteRoomDoneTriggerScript ルーム削除完了時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withDeleteRoomDoneTriggerScript(const Char* deleteRoomDoneTriggerScript)
    {
        ensureData().deleteRoomDoneTriggerScript.emplace(deleteRoomDoneTriggerScript);
        return *this;
    }
     ...
     * @param createSubscribeTriggerScript ルーム購読時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withCreateSubscribeTriggerScript(const Char* createSubscribeTriggerScript)
    {
        ensureData().createSubscribeTriggerScript.emplace(createSubscribeTriggerScript);
        return *this;
    }
     ...
     * @param createSubscribeDoneTriggerScript ルーム購読完了時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withCreateSubscribeDoneTriggerScript(const Char* createSubscribeDoneTriggerScript)
    {
        ensureData().createSubscribeDoneTriggerScript.emplace(createSubscribeDoneTriggerScript);
        return *this;
    }
     ...
     * @param deleteSubscribeTriggerScript ルーム購読解除時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withDeleteSubscribeTriggerScript(const Char* deleteSubscribeTriggerScript)
    {
        ensureData().deleteSubscribeTriggerScript.emplace(deleteSubscribeTriggerScript);
        return *this;
    }
     ...
     * @param deleteSubscribeDoneTriggerScript ルーム購読解除完了時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withDeleteSubscribeDoneTriggerScript(const Char* deleteSubscribeDoneTriggerScript)
    {
        ensureData().deleteSubscribeDoneTriggerScript.emplace(deleteSubscribeDoneTriggerScript);
        return *this;
    }
     ...
     * @param sendMessageTriggerScript メッセージ送信時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withSendMessageTriggerScript(const Char* sendMessageTriggerScript)
    {
        ensureData().sendMessageTriggerScript.emplace(sendMessageTriggerScript);
        return *this;
    }
     ...
     * @param sendMessageDoneTriggerScript メッセージ送信完了時 に実行されるGS2-Script
     */
    CreateLobbyRequest& withSendMessageDoneTriggerScript(const Char* sendMessageDoneTriggerScript)
    {
        ensureData().sendMessageDoneTriggerScript.emplace(sendMessageDoneTriggerScript);
        return *this;
    }
     ...
     */
    CreateLobbyRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    CreateLobbyRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    CreateLobbyRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    CreateLobbyRequest& withRequestId(const Char* gs2RequestId)
    {
...
#endif //GS2_CHAT_CONTROL_CREATELOBBYREQUEST_HPP_