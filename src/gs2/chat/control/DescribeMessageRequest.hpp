...
#ifndef GS2_CHAT_CONTROL_DESCRIBEMESSAGEREQUEST_HPP_
#define GS2_CHAT_CONTROL_DESCRIBEMESSAGEREQUEST_HPP_
 ...
 */
class DescribeMessageRequest : public Gs2UserRequest, public Gs2Chat
{
public:
...
public:
    ...
    DescribeMessageRequest& operator=(const DescribeMessageRequest& describeMessageRequest)
    {
        ...
        Gs2Chat::operator=(describeMessageRequest);
    ...
    DescribeMessageRequest& operator=(DescribeMessageRequest&& describeMessageRequest)
    {
        ...
        Gs2Chat::operator=(std::move(describeMessageRequest));
     ...
     * @param lobbyName ロビーの名前
     */
    DescribeMessageRequest& withLobbyName(const Char* lobbyName)
    {
        ensureData().lobbyName.emplace(lobbyName);
        return *this;
    }
     ...
     * @param roomId ルームID
     */
    DescribeMessageRequest& withRoomId(const Char* roomId)
    {
        ensureData().roomId.emplace(roomId);
        return *this;
    }
     ...
     * @param password パスワード
     */
    DescribeMessageRequest& withPassword(const Char* password)
    {
        ensureData().password.emplace(password);
        return *this;
    }
     ...
     * @param startAt メッセージの取得を開始する日時(エポック秒)
     */
    DescribeMessageRequest& withStartAt(Int32 startAt)
    {
        ensureData().startAt.emplace(startAt);
        return *this;
    }
...
#endif //GS2_CHAT_CONTROL_DESCRIBEMESSAGEREQUEST_HPP_