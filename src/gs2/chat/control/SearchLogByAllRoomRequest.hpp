...
#ifndef GS2_CHAT_CONTROL_SEARCHLOGBYALLROOMREQUEST_HPP_
#define GS2_CHAT_CONTROL_SEARCHLOGBYALLROOMREQUEST_HPP_
 ...
 */
class SearchLogByAllRoomRequest : public Gs2BasicRequest, public Gs2Chat
{
public:
    constexpr static const Char* const FUNCTION = "SearchLogByAllRoom";
...
public:
    ...
    SearchLogByAllRoomRequest(const SearchLogByAllRoomRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Chat(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    SearchLogByAllRoomRequest(SearchLogByAllRoomRequest&& obj) :
    ...
    SearchLogByAllRoomRequest& operator=(const SearchLogByAllRoomRequest& searchLogByAllRoomRequest)
    {
        Gs2BasicRequest::operator=(searchLogByAllRoomRequest);
        Gs2Chat::operator=(searchLogByAllRoomRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*searchLogByAllRoomRequest.m_pData);

        return *this;
    }

    SearchLogByAllRoomRequest& operator=(SearchLogByAllRoomRequest&& searchLogByAllRoomRequest)
    {
        Gs2BasicRequest::operator=(std::move(searchLogByAllRoomRequest));
        Gs2Chat::operator=(std::move(searchLogByAllRoomRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = searchLogByAllRoomRequest.m_pData;
        searchLogByAllRoomRequest.m_pData = nullptr;

        return *this;
    }

    const SearchLogByAllRoomRequest* operator->() const
    {
        return this;
    }

    SearchLogByAllRoomRequest* operator->()
    {
        return this;
    }
     ...
     * @param lobbyName ロビーの名前
     */
    SearchLogByAllRoomRequest& withLobbyName(const Char* lobbyName)
    {
        ensureData().lobbyName.emplace(lobbyName);
        return *this;
    }
     ...
     * @param userId 検索するユーザID文字列(部分一致)
     */
    SearchLogByAllRoomRequest& withUserId(const Char* userId)
    {
        ensureData().userId.emplace(userId);
        return *this;
    }
     ...
     * @param message 検索するメッセージテキスト文字列(部分一致)
     */
    SearchLogByAllRoomRequest& withMessage(const Char* message)
    {
        ensureData().message.emplace(message);
        return *this;
    }
     ...
     * @param meta 検索するメッセージメタデータ文字列(部分一致)
     */
    SearchLogByAllRoomRequest& withMeta(const Char* meta)
    {
        ensureData().meta.emplace(meta);
        return *this;
    }
     ...
     * @param begin 検索期間 開始日時（エポック秒）
     */
    SearchLogByAllRoomRequest& withBegin(Int32 begin)
    {
        ensureData().begin.emplace(begin);
        return *this;
    }
     ...
     * @param end 検索期間 終了日時（エポック秒）
     */
    SearchLogByAllRoomRequest& withEnd(Int32 end)
    {
        ensureData().end.emplace(end);
        return *this;
    }
     ...
     * @param pageToken データの取得を開始する位置を指定するトークン
     */
    SearchLogByAllRoomRequest& withPageToken(const Char* pageToken)
    {
        ensureData().pageToken.emplace(pageToken);
        return *this;
    }
     ...
     * @param limit データの取得件数
     */
    SearchLogByAllRoomRequest& withLimit(Int32 limit)
    {
        ensureData().limit.emplace(limit);
        return *this;
    }
     ...
     * @param useCache クエリキャッシュを有効にするか
     */
    SearchLogByAllRoomRequest& withUseCache(Bool useCache)
    {
        ensureData().useCache.emplace(useCache);
        return *this;
    }
     ...
     */
    SearchLogByAllRoomRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    SearchLogByAllRoomRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    SearchLogByAllRoomRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    SearchLogByAllRoomRequest& withRequestId(const Char* gs2RequestId)
    {
...
#endif //GS2_CHAT_CONTROL_SEARCHLOGBYALLROOMREQUEST_HPP_