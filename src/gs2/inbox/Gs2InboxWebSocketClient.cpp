 ...
 */
void Gs2InboxWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::describeMessages(DescribeMessagesRequest request, std::function<void(AsyncDescribeMessagesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::describeMessagesByUserId(DescribeMessagesByUserIdRequest request, std::function<void(AsyncDescribeMessagesByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::sendMessageByUserId(SendMessageByUserIdRequest request, std::function<void(AsyncSendMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::getMessage(GetMessageRequest request, std::function<void(AsyncGetMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::getMessageByUserId(GetMessageByUserIdRequest request, std::function<void(AsyncGetMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::openMessage(OpenMessageRequest request, std::function<void(AsyncOpenMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::openMessageByUserId(OpenMessageByUserIdRequest request, std::function<void(AsyncOpenMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::readMessage(ReadMessageRequest request, std::function<void(AsyncReadMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::readMessageByUserId(ReadMessageByUserIdRequest request, std::function<void(AsyncReadMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::deleteMessage(DeleteMessageRequest request, std::function<void(AsyncDeleteMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::deleteMessageByUserId(DeleteMessageByUserIdRequest request, std::function<void(AsyncDeleteMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxWebSocketClient::openByStampTask(OpenByStampTaskRequest request, std::function<void(AsyncOpenByStampTaskResult)> callback)
{
