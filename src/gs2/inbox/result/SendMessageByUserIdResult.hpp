...
public:
    SendMessageByUserIdResult() = default;
    SendMessageByUserIdResult(const SendMessageByUserIdResult& sendMessageByUserIdResult) = default;
    SendMessageByUserIdResult(SendMessageByUserIdResult&& sendMessageByUserIdResult) = default;
    ~SendMessageByUserIdResult() = default;

    SendMessageByUserIdResult& operator=(const SendMessageByUserIdResult& sendMessageByUserIdResult) = default;
    SendMessageByUserIdResult& operator=(SendMessageByUserIdResult&& sendMessageByUserIdResult) = default;

    SendMessageByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SendMessageByUserIdResult);
    }
