 ...
 */
void Gs2InboxRestClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::describeMessages(DescribeMessagesRequest request, std::function<void(AsyncDescribeMessagesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::describeMessagesByUserId(DescribeMessagesByUserIdRequest request, std::function<void(AsyncDescribeMessagesByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::sendMessageByUserId(SendMessageByUserIdRequest request, std::function<void(AsyncSendMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::getMessage(GetMessageRequest request, std::function<void(AsyncGetMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::getMessageByUserId(GetMessageByUserIdRequest request, std::function<void(AsyncGetMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::openMessage(OpenMessageRequest request, std::function<void(AsyncOpenMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::openMessageByUserId(OpenMessageByUserIdRequest request, std::function<void(AsyncOpenMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::readMessage(ReadMessageRequest request, std::function<void(AsyncReadMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::readMessageByUserId(ReadMessageByUserIdRequest request, std::function<void(AsyncReadMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::deleteMessage(DeleteMessageRequest request, std::function<void(AsyncDeleteMessageResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::deleteMessageByUserId(DeleteMessageByUserIdRequest request, std::function<void(AsyncDeleteMessageByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2InboxRestClient::openByStampTask(OpenByStampTaskRequest request, std::function<void(AsyncOpenByStampTaskResult)> callback)
{
