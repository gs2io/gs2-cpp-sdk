...
#ifndef GS2_PROJECT_CONTROL_DESCRIBERECEIPTSREQUEST_HPP_
#define GS2_PROJECT_CONTROL_DESCRIBERECEIPTSREQUEST_HPP_
 ...
 */
class DescribeReceiptsRequest : public Gs2BasicRequest, public Gs2Project
{
public:
...
public:
     ...
     * @param accountToken GS2アカウントトークン
     */
    DescribeReceiptsRequest& withAccountToken(StringHolder accountToken)
    {
        ensureData().accountToken.emplace(std::move(accountToken));
        return *this;
    }
...
#endif //GS2_PROJECT_CONTROL_DESCRIBERECEIPTSREQUEST_HPP_