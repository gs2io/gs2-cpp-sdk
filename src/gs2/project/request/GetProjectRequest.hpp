...
public:
    ...
    GetProjectRequest(const GetProjectRequest& getProjectRequest) = default;
    GetProjectRequest(GetProjectRequest&& getProjectRequest) = default;
    ~GetProjectRequest() GS2_OVERRIDE = default;

    GetProjectRequest& operator=(const GetProjectRequest& getProjectRequest) = default;
    GetProjectRequest& operator=(GetProjectRequest&& getProjectRequest) = default;

    GetProjectRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetProjectRequest);
    }
     ...
     * @param accountToken GS2アカウントトークン
     */
    GetProjectRequest& withAccountToken(StringHolder accountToken)
    {
        ensureData().accountToken.emplace(std::move(accountToken));
        return *this;
    }
     ...
     * @param projectName プロジェクト名
     */
    GetProjectRequest& withProjectName(StringHolder projectName)
    {
        ensureData().projectName.emplace(std::move(projectName));
        return *this;
    }
     ...
     */
    GetProjectRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    GetProjectRequest& withRequestId(StringHolder gs2RequestId)
    {
