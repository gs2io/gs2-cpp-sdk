...
public:
    ...
    DeleteProjectResult(const DeleteProjectResult& deleteProjectResult) = default;
    DeleteProjectResult(DeleteProjectResult&& deleteProjectResult) = default;
    ~DeleteProjectResult() = default;

    DeleteProjectResult& operator=(const DeleteProjectResult& deleteProjectResult) = default;
    DeleteProjectResult& operator=(DeleteProjectResult&& deleteProjectResult) = default;

    DeleteProjectResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteProjectResult);
    }
