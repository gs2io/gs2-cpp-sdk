...
public:
    ...
    VerifyResult(const VerifyResult& verifyResult) = default;
    VerifyResult(VerifyResult&& verifyResult) = default;
    ~VerifyResult() = default;

    VerifyResult& operator=(const VerifyResult& verifyResult) = default;
    VerifyResult& operator=(VerifyResult&& verifyResult) = default;

    VerifyResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(VerifyResult);
    }
