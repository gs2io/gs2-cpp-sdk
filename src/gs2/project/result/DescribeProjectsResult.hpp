...
public:
    DescribeProjectsResult() = default;
    DescribeProjectsResult(const DescribeProjectsResult& describeProjectsResult) = default;
    DescribeProjectsResult(DescribeProjectsResult&& describeProjectsResult) = default;
    ~DescribeProjectsResult() = default;

    DescribeProjectsResult& operator=(const DescribeProjectsResult& describeProjectsResult) = default;
    DescribeProjectsResult& operator=(DescribeProjectsResult&& describeProjectsResult) = default;

    DescribeProjectsResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeProjectsResult);
    }
