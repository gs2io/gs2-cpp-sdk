...
#include "ForgetResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace project
{

ForgetResult::Data::Data(const Data& data) :
    detail::json::IModel(data),
    issuePasswordToken(data.issuePasswordToken)
{
}

void ForgetResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ForgetResult ForgetResult::deepCopy() const
{
