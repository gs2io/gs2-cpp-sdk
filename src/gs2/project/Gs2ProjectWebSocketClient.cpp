...
#include "Gs2ProjectWebSocketClient.hpp"
...
void write(detail::json::JsonWriter& jsonWriter, const Project& obj);
 ...
 */
void Gs2ProjectWebSocketClient::createAccount(CreateAccountRequest request, std::function<void(AsyncCreateAccountResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::verify_(VerifyRequest request, std::function<void(AsyncVerifyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::signIn(SignInRequest request, std::function<void(AsyncSignInResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::issueAccountToken(IssueAccountTokenRequest request, std::function<void(AsyncIssueAccountTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::forget(ForgetRequest request, std::function<void(AsyncForgetResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::issuePassword(IssuePasswordRequest request, std::function<void(AsyncIssuePasswordResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::updateAccount(UpdateAccountRequest request, std::function<void(AsyncUpdateAccountResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::deleteAccount(DeleteAccountRequest request, std::function<void(AsyncDeleteAccountResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::describeProjects(DescribeProjectsRequest request, std::function<void(AsyncDescribeProjectsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::createProject(CreateProjectRequest request, std::function<void(AsyncCreateProjectResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::getProject(GetProjectRequest request, std::function<void(AsyncGetProjectResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::getProjectToken(GetProjectTokenRequest request, std::function<void(AsyncGetProjectTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::updateProject(UpdateProjectRequest request, std::function<void(AsyncUpdateProjectResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectWebSocketClient::deleteProject(DeleteProjectRequest request, std::function<void(AsyncDeleteProjectResult)> callback)
{
