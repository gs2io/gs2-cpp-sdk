...
#include "Gs2ProjectRestClient.hpp"
 ...
 */
void Gs2ProjectRestClient::createAccount(CreateAccountRequest request, std::function<void(AsyncCreateAccountResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::verify_(VerifyRequest request, std::function<void(AsyncVerifyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::signIn(SignInRequest request, std::function<void(AsyncSignInResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::issueAccountToken(IssueAccountTokenRequest request, std::function<void(AsyncIssueAccountTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::forget(ForgetRequest request, std::function<void(AsyncForgetResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::issuePassword(IssuePasswordRequest request, std::function<void(AsyncIssuePasswordResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::updateAccount(UpdateAccountRequest request, std::function<void(AsyncUpdateAccountResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::deleteAccount(DeleteAccountRequest request, std::function<void(AsyncDeleteAccountResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::describeProjects(DescribeProjectsRequest request, std::function<void(AsyncDescribeProjectsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::createProject(CreateProjectRequest request, std::function<void(AsyncCreateProjectResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::getProject(GetProjectRequest request, std::function<void(AsyncGetProjectResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::getProjectToken(GetProjectTokenRequest request, std::function<void(AsyncGetProjectTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::updateProject(UpdateProjectRequest request, std::function<void(AsyncUpdateProjectResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ProjectRestClient::deleteProject(DeleteProjectRequest request, std::function<void(AsyncDeleteProjectResult)> callback)
{
