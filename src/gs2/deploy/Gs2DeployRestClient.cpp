...
#include "Gs2DeployRestClient.hpp"
 ...
 */
void Gs2DeployRestClient::describeStacks(DescribeStacksRequest request, std::function<void(AsyncDescribeStacksResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::createStack(CreateStackRequest request, std::function<void(AsyncCreateStackResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::createStackFromGitHub(CreateStackFromGitHubRequest request, std::function<void(AsyncCreateStackFromGitHubResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::getStackStatus(GetStackStatusRequest request, std::function<void(AsyncGetStackStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::getStack(GetStackRequest request, std::function<void(AsyncGetStackResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::updateStack(UpdateStackRequest request, std::function<void(AsyncUpdateStackResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::updateStackFromGitHub(UpdateStackFromGitHubRequest request, std::function<void(AsyncUpdateStackFromGitHubResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::deleteStack(DeleteStackRequest request, std::function<void(AsyncDeleteStackResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::forceDeleteStack(ForceDeleteStackRequest request, std::function<void(AsyncForceDeleteStackResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::describeResources(DescribeResourcesRequest request, std::function<void(AsyncDescribeResourcesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::getResource(GetResourceRequest request, std::function<void(AsyncGetResourceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::describeEvents(DescribeEventsRequest request, std::function<void(AsyncDescribeEventsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::getEvent(GetEventRequest request, std::function<void(AsyncGetEventResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::describeOutputs(DescribeOutputsRequest request, std::function<void(AsyncDescribeOutputsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2DeployRestClient::getOutput(GetOutputRequest request, std::function<void(AsyncGetOutputResult)> callback)
{
