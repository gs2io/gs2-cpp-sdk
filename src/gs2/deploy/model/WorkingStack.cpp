...
#include "WorkingStack.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace deploy {

WorkingStack::Data::Data(const Data& data) :
...
void WorkingStack::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
WorkingStack WorkingStack::deepCopy() const
{
