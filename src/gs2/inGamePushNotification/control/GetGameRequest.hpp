...
#ifndef GS2_INGAMEPUSHNOTIFICATION_CONTROL_GETGAMEREQUEST_HPP_
#define GS2_INGAMEPUSHNOTIFICATION_CONTROL_GETGAMEREQUEST_HPP_
 ...
 */
class GetGameRequest : public Gs2BasicRequest, public Gs2InGamePushNotification
{
public:
...
public:
    ...
    GetGameRequest& operator=(const GetGameRequest& getGameRequest)
    {
        ...
        Gs2InGamePushNotification::operator=(getGameRequest);
    ...
    GetGameRequest& operator=(GetGameRequest&& getGameRequest)
    {
        ...
        Gs2InGamePushNotification::operator=(std::move(getGameRequest));
...
#endif //GS2_INGAMEPUSHNOTIFICATION_CONTROL_GETGAMEREQUEST_HPP_