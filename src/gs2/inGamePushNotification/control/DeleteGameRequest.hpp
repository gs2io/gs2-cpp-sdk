...
#ifndef GS2_INGAMEPUSHNOTIFICATION_CONTROL_DELETEGAMEREQUEST_HPP_
#define GS2_INGAMEPUSHNOTIFICATION_CONTROL_DELETEGAMEREQUEST_HPP_
 ...
 */
class DeleteGameRequest : public Gs2BasicRequest, public Gs2InGamePushNotification
{
public:
...
public:
    ...
    DeleteGameRequest& operator=(const DeleteGameRequest& deleteGameRequest)
    {
        ...
        Gs2InGamePushNotification::operator=(deleteGameRequest);
    ...
    DeleteGameRequest& operator=(DeleteGameRequest&& deleteGameRequest)
    {
        ...
        Gs2InGamePushNotification::operator=(std::move(deleteGameRequest));
...
#endif //GS2_INGAMEPUSHNOTIFICATION_CONTROL_DELETEGAMEREQUEST_HPP_