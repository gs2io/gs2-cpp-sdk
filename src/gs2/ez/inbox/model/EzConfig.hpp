...
#ifndef GS2_EZ_INBOX_MODEL_EZCONFIG_HPP_
#define GS2_EZ_INBOX_MODEL_EZCONFIG_HPP_
...
private:
    ...
    public:
        ...
        Data(const gs2::inbox::Config& config);
        Data(const gs2::optional<gs2::inbox::Config>& config);
        ~Data() = default;
...
public:
    ...
    EzConfig(gs2::inbox::Config config);
    EzConfig(gs2::optional<gs2::inbox::Config> config);
    ...
    gs2::inbox::Config ToModel() const;
...
#endif //GS2_EZ_INBOX_EZCONFIG_HPP_