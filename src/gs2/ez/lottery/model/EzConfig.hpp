...
#ifndef GS2_EZ_LOTTERY_MODEL_EZCONFIG_HPP_
#define GS2_EZ_LOTTERY_MODEL_EZCONFIG_HPP_
...
private:
    ...
    public:
        ...
        Data(const gs2::lottery::Config& config);
        Data(const gs2::optional<gs2::lottery::Config>& config);
        ~Data() = default;
...
public:
    ...
    EzConfig(gs2::lottery::Config config);
    EzConfig(gs2::optional<gs2::lottery::Config> config);
    ...
    gs2::lottery::Config ToModel() const;
...
#endif //GS2_EZ_LOTTERY_EZCONFIG_HPP_