...
#ifndef GS2_EZ_CHAT_EZGETROOMRESULT_HPP_
#define GS2_EZ_CHAT_EZGETROOMRESULT_HPP_

#include "../model/model.hpp"
#include <gs2/core/AsyncResult.hpp>
#include <gs2/chat/result/GetRoomResult.hpp>
...
private:
    ...
    public:
        ...
        Data(const gs2::chat::GetRoomResult& getRoomResult) :
...
public:
    ...
    EzGetRoomResult(gs2::chat::GetRoomResult result) :
    ...
    static bool isConvertible(const gs2::chat::GetRoomResult& result)
    {
        return
...
#endif //GS2_EZ_CHAT_EZGETROOMRESULT_HPP_