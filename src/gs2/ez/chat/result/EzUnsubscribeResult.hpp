...
#ifndef GS2_EZ_CHAT_EZUNSUBSCRIBERESULT_HPP_
#define GS2_EZ_CHAT_EZUNSUBSCRIBERESULT_HPP_

#include "../model/model.hpp"
#include <gs2/core/AsyncResult.hpp>
#include <gs2/chat/result/UnsubscribeResult.hpp>
...
private:
    ...
    public:
        ...
        Data(const gs2::chat::UnsubscribeResult& unsubscribeResult) :
...
public:
    ...
    EzUnsubscribeResult(gs2::chat::UnsubscribeResult result) :
    ...
    static bool isConvertible(const gs2::chat::UnsubscribeResult& result)
    {
        return
...
#endif //GS2_EZ_CHAT_EZUNSUBSCRIBERESULT_HPP_