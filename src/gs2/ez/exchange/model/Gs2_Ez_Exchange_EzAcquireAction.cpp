...
EzAcquireAction::Data::Data(const gs2::optional<gs2::exchange::AcquireAction>& acquireAction) :
...
EzAcquireAction::EzAcquireAction(gs2::optional<gs2::exchange::AcquireAction> acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}
