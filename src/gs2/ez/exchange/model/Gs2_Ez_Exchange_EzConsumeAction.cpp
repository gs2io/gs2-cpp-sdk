...
#include <gs2/exchange/model/ConsumeAction.hpp>
...
EzConsumeAction::Data::Data(const gs2::exchange::ConsumeAction& consumeAction) :
...
EzConsumeAction::Data::Data(const gs2::optional<gs2::exchange::ConsumeAction>& consumeAction) :
...
EzConsumeAction::EzConsumeAction(gs2::exchange::ConsumeAction consumeAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(consumeAction)
{
}

EzConsumeAction::EzConsumeAction(gs2::optional<gs2::exchange::ConsumeAction> consumeAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(consumeAction)
{
}
...
gs2::exchange::ConsumeAction EzConsumeAction::ToModel() const
{
    gs2::exchange::ConsumeAction consumeAction;
