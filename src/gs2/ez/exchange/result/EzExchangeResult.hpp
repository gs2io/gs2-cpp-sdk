...
private:
    ...
    public:
        ...
        Data(const gs2::exchange::ExchangeResult& exchangeResult) :
            ...
            stampSheet(*exchangeResult.getStampSheet()),
            stampSheetEncryptionKeyId(*exchangeResult.getStampSheetEncryptionKeyId())
        {
        }
...
public:
    ...
    static bool isConvertible(const gs2::exchange::ExchangeResult& result)
    {
        return
