...
public:
    EzAddTakeOverSettingResult() = default;
    EzAddTakeOverSettingResult(const EzAddTakeOverSettingResult& result) = default;
    EzAddTakeOverSettingResult(EzAddTakeOverSettingResult&& result) = default;
    ~EzAddTakeOverSettingResult() = default;

    EzAddTakeOverSettingResult(gs2::account::CreateTakeOverResult result) :
        GS2_CORE_SHARED_DATA_INITIALIZATION(result)
    {}

    EzAddTakeOverSettingResult& operator=(const EzAddTakeOverSettingResult& result) = default;
    EzAddTakeOverSettingResult& operator=(EzAddTakeOverSettingResult&& result) = default;
