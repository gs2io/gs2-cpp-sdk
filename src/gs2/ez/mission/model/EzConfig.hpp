...
#ifndef GS2_EZ_MISSION_MODEL_EZCONFIG_HPP_
#define GS2_EZ_MISSION_MODEL_EZCONFIG_HPP_
...
private:
    ...
    public:
        ...
        Data(const gs2::mission::Config& config);
        Data(const gs2::optional<gs2::mission::Config>& config);
        ~Data() = default;
...
public:
    ...
    EzConfig(gs2::mission::Config config);
    EzConfig(gs2::optional<gs2::mission::Config> config);
    ...
    gs2::mission::Config ToModel() const;
...
#endif //GS2_EZ_MISSION_EZCONFIG_HPP_