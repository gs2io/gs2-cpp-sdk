...
#include <gs2/mission/model/AcquireAction.hpp>
...
EzAcquireAction::Data::Data(const gs2::mission::AcquireAction& acquireAction) :
...
EzAcquireAction::Data::Data(const gs2::optional<gs2::mission::AcquireAction>& acquireAction) :
...
EzAcquireAction::EzAcquireAction(gs2::mission::AcquireAction acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}

EzAcquireAction::EzAcquireAction(gs2::optional<gs2::mission::AcquireAction> acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}
...
gs2::mission::AcquireAction EzAcquireAction::ToModel() const
{
    gs2::mission::AcquireAction acquireAction;
