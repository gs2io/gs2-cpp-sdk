...
#ifndef GS2_EZ_ENHANCE_EZLISTRATEMODELSRESULT_HPP_
#define GS2_EZ_ENHANCE_EZLISTRATEMODELSRESULT_HPP_

#include "../model/model.hpp"
#include <gs2/core/AsyncResult.hpp>
#include <gs2/enhance/result/DescribeRateModelsResult.hpp>
...
private:
    ...
    public:
        ...
        Data(const gs2::enhance::DescribeRateModelsResult& describeRateModelsResult)
        {
            {
...
public:
    ...
    EzListRateModelsResult(gs2::enhance::DescribeRateModelsResult result) :
    ...
    static bool isConvertible(const gs2::enhance::DescribeRateModelsResult& result)
    {
        return
...
#endif //GS2_EZ_ENHANCE_EZLISTRATEMODELSRESULT_HPP_