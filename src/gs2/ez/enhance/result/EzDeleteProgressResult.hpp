...
#ifndef GS2_EZ_ENHANCE_EZDELETEPROGRESSRESULT_HPP_
#define GS2_EZ_ENHANCE_EZDELETEPROGRESSRESULT_HPP_

#include "../model/model.hpp"
#include <gs2/core/AsyncResult.hpp>
#include <gs2/enhance/result/DeleteProgressResult.hpp>
...
private:
    ...
    public:
        ...
        Data(const gs2::enhance::DeleteProgressResult& deleteProgressResult) :
...
public:
    ...
    EzDeleteProgressResult(gs2::enhance::DeleteProgressResult result) :
    ...
    static bool isConvertible(const gs2::enhance::DeleteProgressResult& result)
    {
        return
...
#endif //GS2_EZ_ENHANCE_EZDELETEPROGRESSRESULT_HPP_