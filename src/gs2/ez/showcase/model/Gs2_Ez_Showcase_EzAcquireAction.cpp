...
EzAcquireAction::Data::Data(const gs2::showcase::AcquireAction& acquireAction) :
...
EzAcquireAction::Data::Data(const gs2::optional<gs2::showcase::AcquireAction>& acquireAction) :
...
EzAcquireAction::EzAcquireAction(gs2::showcase::AcquireAction acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}

EzAcquireAction::EzAcquireAction(gs2::optional<gs2::showcase::AcquireAction> acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}
...
gs2::showcase::AcquireAction EzAcquireAction::ToModel() const
{
