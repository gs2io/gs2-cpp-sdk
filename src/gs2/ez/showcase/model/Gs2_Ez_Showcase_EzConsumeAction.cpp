...
EzConsumeAction::Data::Data(const gs2::showcase::ConsumeAction& consumeAction) :
...
EzConsumeAction::Data::Data(const gs2::optional<gs2::showcase::ConsumeAction>& consumeAction) :
...
EzConsumeAction::EzConsumeAction(gs2::showcase::ConsumeAction consumeAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(consumeAction)
{
}

EzConsumeAction::EzConsumeAction(gs2::optional<gs2::showcase::ConsumeAction> consumeAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(consumeAction)
{
}
...
gs2::showcase::ConsumeAction EzConsumeAction::ToModel() const
{
