...
private:
    ...
    public:
        ...
        Data(const gs2::optional<gs2::showcase::ConsumeAction>& consumeAction);
        ~Data() = default;
...
public:
    ...
    EzConsumeAction(gs2::optional<gs2::showcase::ConsumeAction> consumeAction);
...
#endif //GS2_EZ_SHOWCASE_EZCONSUMEACTION_HPP_