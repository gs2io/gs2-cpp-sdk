...
#ifndef GS2_EZ_FORMATION_MODEL_EZACQUIREACTION_HPP_
#define GS2_EZ_FORMATION_MODEL_EZACQUIREACTION_HPP_
...
private:
    ...
    public:
        ...
        Data(const gs2::formation::AcquireAction& acquireAction);
        Data(const gs2::optional<gs2::formation::AcquireAction>& acquireAction);
        ~Data() = default;
...
public:
    ...
    EzAcquireAction(gs2::formation::AcquireAction acquireAction);
    EzAcquireAction(gs2::optional<gs2::formation::AcquireAction> acquireAction);
    ...
    gs2::formation::AcquireAction ToModel() const;
...
#endif //GS2_EZ_FORMATION_EZACQUIREACTION_HPP_