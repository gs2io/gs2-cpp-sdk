...
#include <gs2/formation/model/AcquireAction.hpp>
...
EzAcquireAction::Data::Data(const gs2::formation::AcquireAction& acquireAction) :
...
EzAcquireAction::Data::Data(const gs2::optional<gs2::formation::AcquireAction>& acquireAction) :
...
EzAcquireAction::EzAcquireAction(gs2::formation::AcquireAction acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}

EzAcquireAction::EzAcquireAction(gs2::optional<gs2::formation::AcquireAction> acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}
...
gs2::formation::AcquireAction EzAcquireAction::ToModel() const
{
    gs2::formation::AcquireAction acquireAction;
