...
#ifndef GS2_EZ_RANKING_EZSUBSCRIBERESULT_HPP_
#define GS2_EZ_RANKING_EZSUBSCRIBERESULT_HPP_

#include "../model/model.hpp"
#include <gs2/core/AsyncResult.hpp>
#include <gs2/ranking/result/SubscribeResult.hpp>
...
private:
    ...
    public:
        ...
        Data(const gs2::ranking::SubscribeResult& subscribeResult) :
...
public:
    ...
    EzSubscribeResult(gs2::ranking::SubscribeResult result) :
    ...
    static bool isConvertible(const gs2::ranking::SubscribeResult& result)
    {
        return
...
#endif //GS2_EZ_RANKING_EZSUBSCRIBERESULT_HPP_