...
private:
    ...
    public:
        ...
        Data(const gs2::optional<gs2::stamina::RecoverValueTable>& recoverValueTable);
        ~Data() = default;
...
public:
    ...
    EzRecoverValueTable(gs2::optional<gs2::stamina::RecoverValueTable> recoverValueTable);
