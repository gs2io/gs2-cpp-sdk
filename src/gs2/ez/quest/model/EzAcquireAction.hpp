...
#ifndef GS2_EZ_QUEST_MODEL_EZACQUIREACTION_HPP_
#define GS2_EZ_QUEST_MODEL_EZACQUIREACTION_HPP_
...
private:
    ...
    public:
        ...
        Data(const gs2::quest::AcquireAction& acquireAction);
        Data(const gs2::optional<gs2::quest::AcquireAction>& acquireAction);
        ~Data() = default;
...
public:
    ...
    EzAcquireAction(gs2::quest::AcquireAction acquireAction);
    EzAcquireAction(gs2::optional<gs2::quest::AcquireAction> acquireAction);
    ...
    gs2::quest::AcquireAction ToModel() const;
...
#endif //GS2_EZ_QUEST_EZACQUIREACTION_HPP_