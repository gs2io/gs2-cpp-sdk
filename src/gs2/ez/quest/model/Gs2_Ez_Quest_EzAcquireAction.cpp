...
#include <gs2/quest/model/AcquireAction.hpp>
...
EzAcquireAction::Data::Data(const gs2::quest::AcquireAction& acquireAction) :
...
EzAcquireAction::Data::Data(const gs2::optional<gs2::quest::AcquireAction>& acquireAction) :
...
EzAcquireAction::EzAcquireAction(gs2::quest::AcquireAction acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}

EzAcquireAction::EzAcquireAction(gs2::optional<gs2::quest::AcquireAction> acquireAction) :
    GS2_CORE_SHARED_DATA_INITIALIZATION(acquireAction)
{
}
...
gs2::quest::AcquireAction EzAcquireAction::ToModel() const
{
    gs2::quest::AcquireAction acquireAction;
