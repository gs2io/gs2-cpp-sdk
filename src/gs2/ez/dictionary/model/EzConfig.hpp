...
#ifndef GS2_EZ_DICTIONARY_MODEL_EZCONFIG_HPP_
#define GS2_EZ_DICTIONARY_MODEL_EZCONFIG_HPP_
...
private:
    ...
    public:
        ...
        Data(const gs2::dictionary::Config& config);
        Data(const gs2::optional<gs2::dictionary::Config>& config);
        ~Data() = default;
...
public:
    ...
    EzConfig(gs2::dictionary::Config config);
    EzConfig(gs2::optional<gs2::dictionary::Config> config);
    ...
    gs2::dictionary::Config ToModel() const;
...
#endif //GS2_EZ_DICTIONARY_EZCONFIG_HPP_