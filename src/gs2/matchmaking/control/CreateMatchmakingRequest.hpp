...
#ifndef GS2_MATCHMAKING_CONTROL_CREATEMATCHMAKINGREQUEST_HPP_
#define GS2_MATCHMAKING_CONTROL_CREATEMATCHMAKINGREQUEST_HPP_
 ...
 */
class CreateMatchmakingRequest : public Gs2BasicRequest, public Gs2Matchmaking
{
public:
    constexpr static const Char* const FUNCTION = "CreateMatchmaking";
...
public:
    ...
    CreateMatchmakingRequest(const CreateMatchmakingRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Matchmaking(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    CreateMatchmakingRequest(CreateMatchmakingRequest&& obj) :
    ...
    CreateMatchmakingRequest& operator=(const CreateMatchmakingRequest& createMatchmakingRequest)
    {
        Gs2BasicRequest::operator=(createMatchmakingRequest);
        Gs2Matchmaking::operator=(createMatchmakingRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*createMatchmakingRequest.m_pData);

        return *this;
    }

    CreateMatchmakingRequest& operator=(CreateMatchmakingRequest&& createMatchmakingRequest)
    {
        Gs2BasicRequest::operator=(std::move(createMatchmakingRequest));
        Gs2Matchmaking::operator=(std::move(createMatchmakingRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = createMatchmakingRequest.m_pData;
        createMatchmakingRequest.m_pData = nullptr;

        return *this;
    }

    const CreateMatchmakingRequest* operator->() const
    {
        return this;
    }

    CreateMatchmakingRequest* operator->()
    {
        return this;
    }
     ...
     * @param name マッチメイキングの名前
     */
    CreateMatchmakingRequest& withName(const Char* name)
    {
        ensureData().name.emplace(name);
        return *this;
    }
     ...
     * @param description マッチメイキングの説明
     */
    CreateMatchmakingRequest& withDescription(const Char* description)
    {
        ensureData().description.emplace(description);
        return *this;
    }
     ...
     * @param serviceClass マッチメイキングのサービスクラス
     */
    CreateMatchmakingRequest& withServiceClass(const Char* serviceClass)
    {
        ensureData().serviceClass.emplace(serviceClass);
        return *this;
    }
     ...
     * @param type マッチメイキングの種類
     */
    CreateMatchmakingRequest& withType(const Char* type)
    {
        ensureData().type.emplace(type);
        return *this;
    }
     ...
     * @param maxPlayer 最大プレイヤー数
     */
    CreateMatchmakingRequest& withMaxPlayer(Int32 maxPlayer)
    {
        ensureData().maxPlayer.emplace(maxPlayer);
        return *this;
    }
     ...
     * @param gatheringPoolName GS2-Realtime のギャザリングプール名
     */
    CreateMatchmakingRequest& withGatheringPoolName(const Char* gatheringPoolName)
    {
        ensureData().gatheringPoolName.emplace(gatheringPoolName);
        return *this;
    }
     ...
     * @param callback マッチメイキング完了コールバックURL
     */
    CreateMatchmakingRequest& withCallback(const Char* callback)
    {
        ensureData().callback.emplace(callback);
        return *this;
    }
     ...
     * @param notificationGameName GS2-InGamePushNotification のゲーム名
     */
    CreateMatchmakingRequest& withNotificationGameName(const Char* notificationGameName)
    {
        ensureData().notificationGameName.emplace(notificationGameName);
        return *this;
    }
     ...
     * @param createGatheringTriggerScript ギャザリング作成時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withCreateGatheringTriggerScript(const Char* createGatheringTriggerScript)
    {
        ensureData().createGatheringTriggerScript.emplace(createGatheringTriggerScript);
        return *this;
    }
     ...
     * @param createGatheringDoneTriggerScript ギャザリング作成完了時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withCreateGatheringDoneTriggerScript(const Char* createGatheringDoneTriggerScript)
    {
        ensureData().createGatheringDoneTriggerScript.emplace(createGatheringDoneTriggerScript);
        return *this;
    }
     ...
     * @param joinGatheringTriggerScript ギャザリング参加時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withJoinGatheringTriggerScript(const Char* joinGatheringTriggerScript)
    {
        ensureData().joinGatheringTriggerScript.emplace(joinGatheringTriggerScript);
        return *this;
    }
     ...
     * @param joinGatheringDoneTriggerScript ギャザリング参加完了時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withJoinGatheringDoneTriggerScript(const Char* joinGatheringDoneTriggerScript)
    {
        ensureData().joinGatheringDoneTriggerScript.emplace(joinGatheringDoneTriggerScript);
        return *this;
    }
     ...
     * @param leaveGatheringTriggerScript ギャザリング離脱時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withLeaveGatheringTriggerScript(const Char* leaveGatheringTriggerScript)
    {
        ensureData().leaveGatheringTriggerScript.emplace(leaveGatheringTriggerScript);
        return *this;
    }
     ...
     * @param leaveGatheringDoneTriggerScript ギャザリング離脱完了時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withLeaveGatheringDoneTriggerScript(const Char* leaveGatheringDoneTriggerScript)
    {
        ensureData().leaveGatheringDoneTriggerScript.emplace(leaveGatheringDoneTriggerScript);
        return *this;
    }
     ...
     * @param breakupGatheringTriggerScript ギャザリング解散時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withBreakupGatheringTriggerScript(const Char* breakupGatheringTriggerScript)
    {
        ensureData().breakupGatheringTriggerScript.emplace(breakupGatheringTriggerScript);
        return *this;
    }
     ...
     * @param matchmakingCompleteTriggerScript マッチメイキング成立時 に実行されるGS2-Script
     */
    CreateMatchmakingRequest& withMatchmakingCompleteTriggerScript(const Char* matchmakingCompleteTriggerScript)
    {
        ensureData().matchmakingCompleteTriggerScript.emplace(matchmakingCompleteTriggerScript);
        return *this;
    }
     ...
     */
    CreateMatchmakingRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    CreateMatchmakingRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    CreateMatchmakingRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    CreateMatchmakingRequest& withRequestId(const Char* gs2RequestId)
    {
...
#endif //GS2_MATCHMAKING_CONTROL_CREATEMATCHMAKINGREQUEST_HPP_