...
#ifndef GS2_MATCHMAKING_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_MATCHMAKING_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Matchmaking
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Matchmaking::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Matchmaking::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_MATCHMAKING_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_