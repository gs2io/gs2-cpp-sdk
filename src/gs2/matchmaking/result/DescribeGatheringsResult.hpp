...
public:
    DescribeGatheringsResult() = default;
    DescribeGatheringsResult(const DescribeGatheringsResult& describeGatheringsResult) = default;
    DescribeGatheringsResult(DescribeGatheringsResult&& describeGatheringsResult) = default;
    ~DescribeGatheringsResult() = default;

    DescribeGatheringsResult& operator=(const DescribeGatheringsResult& describeGatheringsResult) = default;
    DescribeGatheringsResult& operator=(DescribeGatheringsResult&& describeGatheringsResult) = default;

    DescribeGatheringsResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeGatheringsResult);
    }
     ...
     */
    void setItems(List<Gathering> items)
    {
