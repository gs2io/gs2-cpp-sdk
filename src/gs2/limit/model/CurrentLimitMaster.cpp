...
CurrentLimitMaster::Data::Data(const Data& data) :
...
void CurrentLimitMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentLimitMaster CurrentLimitMaster::deepCopy() const
{
