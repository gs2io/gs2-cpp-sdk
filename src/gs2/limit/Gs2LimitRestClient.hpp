...
private:
    ...
    class CountUpTask : public detail::Gs2RestSessionTask<CountUpResult>
    {
    private:
    ...
    public:
        CountUpTask(
            ...
            Gs2RestSessionTask<CountUpResult>::CallbackType callback
        ) :
            Gs2RestSessionTask<CountUpResult>(callback),
            m_Request(std::move(request))
        {}
