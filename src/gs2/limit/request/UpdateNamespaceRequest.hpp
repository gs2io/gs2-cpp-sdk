...
#ifndef GS2_LIMIT_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_LIMIT_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Limit
{
public:
...
public:
    ...
    UpdateNamespaceRequest& operator=(const UpdateNamespaceRequest& updateNamespaceRequest)
    {
        ...
        Gs2Limit::operator=(updateNamespaceRequest);
    ...
    UpdateNamespaceRequest& operator=(UpdateNamespaceRequest&& updateNamespaceRequest)
    {
        ...
        Gs2Limit::operator=(std::move(updateNamespaceRequest));
...
#endif //GS2_LIMIT_CONTROL_UPDATENAMESPACEREQUEST_HPP_