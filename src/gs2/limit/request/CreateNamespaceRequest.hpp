...
#ifndef GS2_LIMIT_CONTROL_CREATENAMESPACEREQUEST_HPP_
#define GS2_LIMIT_CONTROL_CREATENAMESPACEREQUEST_HPP_
 ...
 */
class CreateNamespaceRequest : public Gs2BasicRequest, public Gs2Limit
{
public:
...
public:
    ...
    CreateNamespaceRequest& operator=(const CreateNamespaceRequest& createNamespaceRequest)
    {
        ...
        Gs2Limit::operator=(createNamespaceRequest);
    ...
    CreateNamespaceRequest& operator=(CreateNamespaceRequest&& createNamespaceRequest)
    {
        ...
        Gs2Limit::operator=(std::move(createNamespaceRequest));
...
#endif //GS2_LIMIT_CONTROL_CREATENAMESPACEREQUEST_HPP_