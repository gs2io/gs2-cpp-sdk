...
#ifndef GS2_LIMIT_CONTROL_DESCRIBELIMITMODELMASTERSREQUEST_HPP_
#define GS2_LIMIT_CONTROL_DESCRIBELIMITMODELMASTERSREQUEST_HPP_
 ...
 */
class DescribeLimitModelMastersRequest : public Gs2BasicRequest, public Gs2Limit
{
public:
...
public:
    ...
    DescribeLimitModelMastersRequest* operator->()
    {
        return this;
    }
     ...
     * @param limit データの取得件数
     */
    DescribeLimitModelMastersRequest& withLimit(Int64 limit)
    {
        ensureData().limit.emplace(limit);
        return *this;
    }
...
#endif //GS2_LIMIT_CONTROL_DESCRIBELIMITMODELMASTERSREQUEST_HPP_