...
public:
    CreateLimitModelMasterResult() = default;
    CreateLimitModelMasterResult(const CreateLimitModelMasterResult& createLimitModelMasterResult) = default;
    CreateLimitModelMasterResult(CreateLimitModelMasterResult&& createLimitModelMasterResult) = default;
    ~CreateLimitModelMasterResult() = default;

    CreateLimitModelMasterResult& operator=(const CreateLimitModelMasterResult& createLimitModelMasterResult) = default;
    CreateLimitModelMasterResult& operator=(CreateLimitModelMasterResult&& createLimitModelMasterResult) = default;

    CreateLimitModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateLimitModelMasterResult);
    }
