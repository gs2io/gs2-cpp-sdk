...
public:
    UpdateLimitModelMasterResult() = default;
    UpdateLimitModelMasterResult(const UpdateLimitModelMasterResult& updateLimitModelMasterResult) = default;
    UpdateLimitModelMasterResult(UpdateLimitModelMasterResult&& updateLimitModelMasterResult) = default;
    ~UpdateLimitModelMasterResult() = default;

    UpdateLimitModelMasterResult& operator=(const UpdateLimitModelMasterResult& updateLimitModelMasterResult) = default;
    UpdateLimitModelMasterResult& operator=(UpdateLimitModelMasterResult&& updateLimitModelMasterResult) = default;

    UpdateLimitModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateLimitModelMasterResult);
    }
