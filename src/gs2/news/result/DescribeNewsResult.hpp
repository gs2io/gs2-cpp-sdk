...
#ifndef GS2_NEWS_CONTROL_DESCRIBENEWSRESULT_HPP_
#define GS2_NEWS_CONTROL_DESCRIBENEWSRESULT_HPP_
 ...
 */
class DescribeNewsResult : public Gs2Object
{
private:
...
public:
    DescribeNewsResult() = default;
    DescribeNewsResult(const DescribeNewsResult& describeNewsResult) = default;
    DescribeNewsResult(DescribeNewsResult&& describeNewsResult) = default;
    ~DescribeNewsResult() = default;

    DescribeNewsResult& operator=(const DescribeNewsResult& describeNewsResult) = default;
    DescribeNewsResult& operator=(DescribeNewsResult&& describeNewsResult) = default;

    DescribeNewsResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeNewsResult);
    }

    const DescribeNewsResult* operator->() const
    {
        return this;
    }

    DescribeNewsResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<DescribeNewsResult> AsyncDescribeNewsResult;

} }

#endif //GS2_NEWS_CONTROL_DESCRIBENEWSRESULT_HPP_