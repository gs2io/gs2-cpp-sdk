...
#ifndef GS2_NEWS_CONTROL_WANTGRANTBYUSERIDRESULT_HPP_
#define GS2_NEWS_CONTROL_WANTGRANTBYUSERIDRESULT_HPP_
 ...
 */
class WantGrantByUserIdResult : public Gs2Object
{
private:
...
public:
    WantGrantByUserIdResult() = default;
    WantGrantByUserIdResult(const WantGrantByUserIdResult& wantGrantByUserIdResult) = default;
    WantGrantByUserIdResult(WantGrantByUserIdResult&& wantGrantByUserIdResult) = default;
    ~WantGrantByUserIdResult() = default;

    WantGrantByUserIdResult& operator=(const WantGrantByUserIdResult& wantGrantByUserIdResult) = default;
    WantGrantByUserIdResult& operator=(WantGrantByUserIdResult&& wantGrantByUserIdResult) = default;

    WantGrantByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(WantGrantByUserIdResult);
    }

    const WantGrantByUserIdResult* operator->() const
    {
        return this;
    }

    WantGrantByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<WantGrantByUserIdResult> AsyncWantGrantByUserIdResult;

} }

#endif //GS2_NEWS_CONTROL_WANTGRANTBYUSERIDRESULT_HPP_