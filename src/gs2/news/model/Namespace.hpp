...
#ifndef GS2_NEWS_MODEL_NAMESPACE_HPP_
#define GS2_NEWS_MODEL_NAMESPACE_HPP_
    ...
    public:
        ...
        virtual void set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
        {
            ...
            else if (std::strcmp(name_, "version") == 0)
            {
                if (jsonValue.IsString())
                {
                    this->version.emplace(jsonValue.GetString());
                }
            }
...
public:
     ...
     * @return バージョン
     */
    const optional<StringHolder>& getVersion() const
    {
     ...
     * @param version バージョン
     */
    void setVersion(StringHolder version)
    {
     ...
     * @param version バージョン
     */
    Namespace& withVersion(StringHolder version)
    {
...
#endif //GS2_NEWS_MODEL_NAMESPACE_HPP_