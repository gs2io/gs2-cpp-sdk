...
#ifndef GS2_ENHANCE_MODEL_NAMESPACE_HPP_
#define GS2_ENHANCE_MODEL_NAMESPACE_HPP_
...
private:
    ...
    public:
        ...
        optional<Bool> enableDirectEnhance;
        ...
        Data(const Data& data) :
            ...
            enableDirectEnhance(data.enableDirectEnhance),
        ...
        virtual void set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
        {
            ...
            else if (std::strcmp(name_, "enableDirectEnhance") == 0)
            {
                if (jsonValue.IsBool())
                {
                    this->enableDirectEnhance = jsonValue.GetBool();
                }
            }
...
public:
     ...
     */
    const optional<Bool>& getEnableDirectEnhance() const
    {
        return ensureData().enableDirectEnhance;
    }
     ...
     */
    void setEnableDirectEnhance(Bool enableDirectEnhance)
    {
        ensureData().enableDirectEnhance.emplace(enableDirectEnhance);
    }
     ...
     * @param enableDirectEnhance DirectEnhance を利用できるようにするか
     */
    Namespace& withEnableDirectEnhance(Bool enableDirectEnhance)
    {
...
inline bool operator!=(const Namespace& lhs, const Namespace& lhr)
{
    if (lhs.m_pData != lhr.m_pData)
    {
        ...
        if (lhs.m_pData->enableDirectEnhance != lhr.m_pData->enableDirectEnhance)
        {
            return true;
        }
...
#endif //GS2_ENHANCE_MODEL_NAMESPACE_HPP_