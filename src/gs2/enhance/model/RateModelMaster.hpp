...
public:
     ...
     * @param targetInventoryModelId 強化対象に使用できるインベントリモデル のGRN
     */
    RateModelMaster& withTargetInventoryModelId(StringHolder targetInventoryModelId)
    {
     ...
     * @param materialInventoryModelId 強化素材に使用できるインベントリモデル のGRN
     */
    RateModelMaster& withMaterialInventoryModelId(StringHolder materialInventoryModelId)
    {
