...
#ifndef GS2_ENHANCE_CONTROL_DIRECTENHANCEREQUEST_HPP_
#define GS2_ENHANCE_CONTROL_DIRECTENHANCEREQUEST_HPP_
 ...
 */
class DirectEnhanceRequest : public Gs2BasicRequest, public Gs2Enhance
{
public:
...
public:
    DirectEnhanceRequest() = default;
    DirectEnhanceRequest(const DirectEnhanceRequest& directEnhanceRequest) = default;
    DirectEnhanceRequest(DirectEnhanceRequest&& directEnhanceRequest) = default;
    ~DirectEnhanceRequest() GS2_OVERRIDE = default;

    DirectEnhanceRequest& operator=(const DirectEnhanceRequest& directEnhanceRequest) = default;
    DirectEnhanceRequest& operator=(DirectEnhanceRequest&& directEnhanceRequest) = default;

    DirectEnhanceRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DirectEnhanceRequest);
    }

    const DirectEnhanceRequest* operator->() const
    {
        return this;
    }

    DirectEnhanceRequest* operator->()
    {
        return this;
    }
     ...
     * @return this
     */
    DirectEnhanceRequest& withAccessToken(StringHolder accessToken)
    {
     ...
     * @param namespaceName ネームスペース名
     */
    DirectEnhanceRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param rateName 強化レート名
     */
    DirectEnhanceRequest& withRateName(StringHolder rateName)
    {
        ensureData().rateName.emplace(std::move(rateName));
        return *this;
    }
     ...
     * @param targetItemSetId 強化対象の GS2-Inventory アイテムセットGRN
     */
    DirectEnhanceRequest& withTargetItemSetId(StringHolder targetItemSetId)
    {
        ensureData().targetItemSetId.emplace(std::move(targetItemSetId));
        return *this;
    }
     ...
     * @param materials 強化素材リスト
     */
    DirectEnhanceRequest& withMaterials(List<Material> materials)
    {
        ensureData().materials.emplace(std::move(materials));
        return *this;
    }
     ...
     * @param config 設定値
     */
    DirectEnhanceRequest& withConfig(List<Config> config)
    {
        ensureData().config.emplace(std::move(config));
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    DirectEnhanceRequest& withDuplicationAvoider(StringHolder duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(std::move(duplicationAvoider));
        return *this;
    }
     ...
     */
    DirectEnhanceRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    DirectEnhanceRequest& withRequestId(StringHolder gs2RequestId)
    {
...
#endif //GS2_ENHANCE_CONTROL_DIRECTENHANCEREQUEST_HPP_