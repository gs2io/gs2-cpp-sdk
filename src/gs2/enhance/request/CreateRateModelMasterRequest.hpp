...
#ifndef GS2_ENHANCE_CONTROL_CREATERATEMODELMASTERREQUEST_HPP_
#define GS2_ENHANCE_CONTROL_CREATERATEMODELMASTERREQUEST_HPP_
 ...
 */
class CreateRateModelMasterRequest : public Gs2BasicRequest, public Gs2Enhance
{
public:
...
public:
     ...
     * @param acquireExperienceSuffix GS2-Experience で入手した経験値を格納する プロパティID に付与するサフィックス
     */
    CreateRateModelMasterRequest& withAcquireExperienceSuffix(StringHolder acquireExperienceSuffix)
    {
        ensureData().acquireExperienceSuffix.emplace(std::move(acquireExperienceSuffix));
        return *this;
    }
     ...
     * @param acquireExperienceHierarchy 入手経験値を格納しているメタデータのJSON階層
     */
    CreateRateModelMasterRequest& withAcquireExperienceHierarchy(List<StringHolder> acquireExperienceHierarchy)
    {
        ensureData().acquireExperienceHierarchy.emplace(std::move(acquireExperienceHierarchy));
        return *this;
    }
     ...
     * @param experienceModelId 獲得できる経験値の種類マスター のGRN
     */
    CreateRateModelMasterRequest& withExperienceModelId(StringHolder experienceModelId)
    {
        ensureData().experienceModelId.emplace(std::move(experienceModelId));
        return *this;
    }
     ...
     * @param bonusRates 経験値獲得量ボーナス
     */
    CreateRateModelMasterRequest& withBonusRates(List<BonusRate> bonusRates)
    {
        ensureData().bonusRates.emplace(std::move(bonusRates));
        return *this;
    }
...
#endif //GS2_ENHANCE_CONTROL_CREATERATEMODELMASTERREQUEST_HPP_