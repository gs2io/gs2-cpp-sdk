...
#ifndef GS2_ENHANCE_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_ENHANCE_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Enhance
{
public:
...
public:
     ...
     * @param enableDirectEnhance DirectEnhance を利用できるようにするか
     */
    UpdateNamespaceRequest& withEnableDirectEnhance(Bool enableDirectEnhance)
    {
        ensureData().enableDirectEnhance.emplace(enableDirectEnhance);
        return *this;
    }
...
#endif //GS2_ENHANCE_CONTROL_UPDATENAMESPACEREQUEST_HPP_