...
#ifndef GS2_ENHANCE_CONTROL_CREATENAMESPACEREQUEST_HPP_
#define GS2_ENHANCE_CONTROL_CREATENAMESPACEREQUEST_HPP_
 ...
 */
class CreateNamespaceRequest : public Gs2BasicRequest, public Gs2Enhance
{
public:
...
public:
     ...
     * @param enableDirectEnhance DirectEnhance を利用できるようにするか
     */
    CreateNamespaceRequest& withEnableDirectEnhance(Bool enableDirectEnhance)
    {
        ensureData().enableDirectEnhance.emplace(enableDirectEnhance);
        return *this;
    }
...
#endif //GS2_ENHANCE_CONTROL_CREATENAMESPACEREQUEST_HPP_