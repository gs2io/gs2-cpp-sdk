...
#ifndef GS2_ENHANCE_CONTROL_DIRECTENHANCEBYUSERIDRESULT_HPP_
#define GS2_ENHANCE_CONTROL_DIRECTENHANCEBYUSERIDRESULT_HPP_
 ...
 */
class DirectEnhanceByUserIdResult : public Gs2Object
{
private:
...
public:
    DirectEnhanceByUserIdResult() = default;
    DirectEnhanceByUserIdResult(const DirectEnhanceByUserIdResult& directEnhanceByUserIdResult) = default;
    DirectEnhanceByUserIdResult(DirectEnhanceByUserIdResult&& directEnhanceByUserIdResult) = default;
    ~DirectEnhanceByUserIdResult() = default;

    DirectEnhanceByUserIdResult& operator=(const DirectEnhanceByUserIdResult& directEnhanceByUserIdResult) = default;
    DirectEnhanceByUserIdResult& operator=(DirectEnhanceByUserIdResult&& directEnhanceByUserIdResult) = default;

    DirectEnhanceByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DirectEnhanceByUserIdResult);
    }

    const DirectEnhanceByUserIdResult* operator->() const
    {
        return this;
    }

    DirectEnhanceByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<DirectEnhanceByUserIdResult> AsyncDirectEnhanceByUserIdResult;

} }

#endif //GS2_ENHANCE_CONTROL_DIRECTENHANCEBYUSERIDRESULT_HPP_