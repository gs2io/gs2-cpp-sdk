...
#ifndef GS2_ENHANCE_CONTROL_DIRECTENHANCERESULT_HPP_
#define GS2_ENHANCE_CONTROL_DIRECTENHANCERESULT_HPP_
 ...
 */
class DirectEnhanceResult : public Gs2Object
{
private:
...
public:
    DirectEnhanceResult() = default;
    DirectEnhanceResult(const DirectEnhanceResult& directEnhanceResult) = default;
    DirectEnhanceResult(DirectEnhanceResult&& directEnhanceResult) = default;
    ~DirectEnhanceResult() = default;

    DirectEnhanceResult& operator=(const DirectEnhanceResult& directEnhanceResult) = default;
    DirectEnhanceResult& operator=(DirectEnhanceResult&& directEnhanceResult) = default;

    DirectEnhanceResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DirectEnhanceResult);
    }

    const DirectEnhanceResult* operator->() const
    {
        return this;
    }

    DirectEnhanceResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<DirectEnhanceResult> AsyncDirectEnhanceResult;

} }

#endif //GS2_ENHANCE_CONTROL_DIRECTENHANCERESULT_HPP_