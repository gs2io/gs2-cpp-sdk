...
public:
    DescribeSalesItemGroupMastersResult() = default;
    DescribeSalesItemGroupMastersResult(const DescribeSalesItemGroupMastersResult& describeSalesItemGroupMastersResult) = default;
    DescribeSalesItemGroupMastersResult(DescribeSalesItemGroupMastersResult&& describeSalesItemGroupMastersResult) = default;
    ~DescribeSalesItemGroupMastersResult() = default;

    DescribeSalesItemGroupMastersResult& operator=(const DescribeSalesItemGroupMastersResult& describeSalesItemGroupMastersResult) = default;
    DescribeSalesItemGroupMastersResult& operator=(DescribeSalesItemGroupMastersResult&& describeSalesItemGroupMastersResult) = default;

    DescribeSalesItemGroupMastersResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeSalesItemGroupMastersResult);
    }
     ...
     */
    void setItems(List<SalesItemGroupMaster> items)
    {
