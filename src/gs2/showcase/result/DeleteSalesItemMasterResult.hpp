...
public:
    DeleteSalesItemMasterResult() = default;
    DeleteSalesItemMasterResult(const DeleteSalesItemMasterResult& deleteSalesItemMasterResult) = default;
    DeleteSalesItemMasterResult(DeleteSalesItemMasterResult&& deleteSalesItemMasterResult) = default;
    ~DeleteSalesItemMasterResult() = default;

    DeleteSalesItemMasterResult& operator=(const DeleteSalesItemMasterResult& deleteSalesItemMasterResult) = default;
    DeleteSalesItemMasterResult& operator=(DeleteSalesItemMasterResult&& deleteSalesItemMasterResult) = default;

    DeleteSalesItemMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteSalesItemMasterResult);
    }
