...
#ifndef GS2_SHOWCASE_CONTROL_UPDATEITEMMASTERREQUEST_HPP_
#define GS2_SHOWCASE_CONTROL_UPDATEITEMMASTERREQUEST_HPP_
 ...
 */
class UpdateItemMasterRequest : public Gs2BasicRequest, public Gs2Showcase
{
public:
...
public:
    ...
    UpdateItemMasterRequest& operator=(const UpdateItemMasterRequest& updateItemMasterRequest)
    {
        ...
        Gs2Showcase::operator=(updateItemMasterRequest);
    ...
    UpdateItemMasterRequest& operator=(UpdateItemMasterRequest&& updateItemMasterRequest)
    {
        ...
        Gs2Showcase::operator=(std::move(updateItemMasterRequest));
     ...
     * @param showcaseName ショーケースの名前
     */
    UpdateItemMasterRequest& withShowcaseName(const Char* showcaseName)
    {
        ensureData().showcaseName.emplace(showcaseName);
        return *this;
    }
     ...
     * @param meta メタデータ
     */
    UpdateItemMasterRequest& withMeta(const Char* meta)
    {
        ensureData().meta.emplace(meta);
        return *this;
    }
     ...
     * @param currencyType 販売通貨
     */
    UpdateItemMasterRequest& withCurrencyType(const Char* currencyType)
    {
        ensureData().currencyType.emplace(currencyType);
        return *this;
    }
     ...
     * @param currencyMoneyName GS2-Money 課金通貨名
     */
    UpdateItemMasterRequest& withCurrencyMoneyName(const Char* currencyMoneyName)
    {
        ensureData().currencyMoneyName.emplace(currencyMoneyName);
        return *this;
    }
     ...
     * @param currencyGoldName GS2-Gold 通貨名
     */
    UpdateItemMasterRequest& withCurrencyGoldName(const Char* currencyGoldName)
    {
        ensureData().currencyGoldName.emplace(currencyGoldName);
        return *this;
    }
     ...
     * @param currencyGoldPoolName GS2-Gold 通貨プール名
     */
    UpdateItemMasterRequest& withCurrencyGoldPoolName(const Char* currencyGoldPoolName)
    {
        ensureData().currencyGoldPoolName.emplace(currencyGoldPoolName);
        return *this;
    }
     ...
     * @param currencyConsumableItemItemPoolName GS2-ConsumableItem アイテムプール名
     */
    UpdateItemMasterRequest& withCurrencyConsumableItemItemPoolName(const Char* currencyConsumableItemItemPoolName)
    {
        ensureData().currencyConsumableItemItemPoolName.emplace(currencyConsumableItemItemPoolName);
        return *this;
    }
     ...
     * @param currencyConsumableItemItemName GS2-ConsumableItem アイテム名
     */
    UpdateItemMasterRequest& withCurrencyConsumableItemItemName(const Char* currencyConsumableItemItemName)
    {
        ensureData().currencyConsumableItemItemName.emplace(currencyConsumableItemItemName);
        return *this;
    }
     ...
     * @param currencyOption 対価消費処理にまつわるオプション値
     */
    UpdateItemMasterRequest& withCurrencyOption(const Char* currencyOption)
    {
        ensureData().currencyOption.emplace(currencyOption);
        return *this;
    }
     ...
     * @param price 販売価格
     */
    UpdateItemMasterRequest& withPrice(Float price)
    {
        ensureData().price.emplace(price);
        return *this;
    }
     ...
     * @param itemType 入手アイテムの種類
     */
    UpdateItemMasterRequest& withItemType(const Char* itemType)
    {
        ensureData().itemType.emplace(itemType);
        return *this;
    }
     ...
     * @param itemMoneyName GS2-Money 課金通貨名
     */
    UpdateItemMasterRequest& withItemMoneyName(const Char* itemMoneyName)
    {
        ensureData().itemMoneyName.emplace(itemMoneyName);
        return *this;
    }
     ...
     * @param itemGoldPoolName GS2-Gold 通貨プール名
     */
    UpdateItemMasterRequest& withItemGoldPoolName(const Char* itemGoldPoolName)
    {
        ensureData().itemGoldPoolName.emplace(itemGoldPoolName);
        return *this;
    }
     ...
     * @param itemGoldName GS2-Gold 通貨名
     */
    UpdateItemMasterRequest& withItemGoldName(const Char* itemGoldName)
    {
        ensureData().itemGoldName.emplace(itemGoldName);
        return *this;
    }
     ...
     * @param itemStaminaStaminaPoolName GS2-Stamina スタミナプール名
     */
    UpdateItemMasterRequest& withItemStaminaStaminaPoolName(const Char* itemStaminaStaminaPoolName)
    {
        ensureData().itemStaminaStaminaPoolName.emplace(itemStaminaStaminaPoolName);
        return *this;
    }
     ...
     * @param itemConsumableItemItemPoolName GS2-ConsumableItem アイテムプール名
     */
    UpdateItemMasterRequest& withItemConsumableItemItemPoolName(const Char* itemConsumableItemItemPoolName)
    {
        ensureData().itemConsumableItemItemPoolName.emplace(itemConsumableItemItemPoolName);
        return *this;
    }
     ...
     * @param itemConsumableItemItemName GS2-ConsumableItem アイテム名
     */
    UpdateItemMasterRequest& withItemConsumableItemItemName(const Char* itemConsumableItemItemName)
    {
        ensureData().itemConsumableItemItemName.emplace(itemConsumableItemItemName);
        return *this;
    }
     ...
     * @param itemGachaGachaPoolName GS2-Gacha ガチャプール名
     */
    UpdateItemMasterRequest& withItemGachaGachaPoolName(const Char* itemGachaGachaPoolName)
    {
        ensureData().itemGachaGachaPoolName.emplace(itemGachaGachaPoolName);
        return *this;
    }
     ...
     * @param itemGachaGachaName GS2-Gacha ガチャ名
     */
    UpdateItemMasterRequest& withItemGachaGachaName(const Char* itemGachaGachaName)
    {
        ensureData().itemGachaGachaName.emplace(itemGachaGachaName);
        return *this;
    }
     ...
     * @param itemAmount 入手数量
     */
    UpdateItemMasterRequest& withItemAmount(Int32 itemAmount)
    {
        ensureData().itemAmount.emplace(itemAmount);
        return *this;
    }
     ...
     * @param itemOption アイテムの入手処理にまつわるオプション値
     */
    UpdateItemMasterRequest& withItemOption(const Char* itemOption)
    {
        ensureData().itemOption.emplace(itemOption);
        return *this;
    }
     ...
     * @param openConditionType 購入許可判定の種類
     */
    UpdateItemMasterRequest& withOpenConditionType(const Char* openConditionType)
    {
        ensureData().openConditionType.emplace(openConditionType);
        return *this;
    }
     ...
     * @param openConditionLimitName 購入許可判定 に実行されるGS2-Limit
     */
    UpdateItemMasterRequest& withOpenConditionLimitName(const Char* openConditionLimitName)
    {
        ensureData().openConditionLimitName.emplace(openConditionLimitName);
        return *this;
    }
     ...
     * @param openConditionLimitCounterName 購入許可判定 に実行されるGS2-Limit のカウンター
     */
    UpdateItemMasterRequest& withOpenConditionLimitCounterName(const Char* openConditionLimitCounterName)
    {
        ensureData().openConditionLimitCounterName.emplace(openConditionLimitCounterName);
        return *this;
    }
...
#endif //GS2_SHOWCASE_CONTROL_UPDATEITEMMASTERREQUEST_HPP_