 ...
 */
class BuyRequest : public Gs2UserRequest, public Gs2Showcase
{
public:
...
public:
    ...
    BuyRequest(const BuyRequest& obj) :
        Gs2UserRequest(obj),
        Gs2Showcase(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    BuyRequest(BuyRequest&& obj) :
    ...
    BuyRequest& operator=(const BuyRequest& buyRequest)
    {
        Gs2UserRequest::operator=(buyRequest);
        Gs2Showcase::operator=(buyRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*buyRequest.m_pData);

        return *this;
    }

    BuyRequest& operator=(BuyRequest&& buyRequest)
    {
        Gs2UserRequest::operator=(std::move(buyRequest));
        Gs2Showcase::operator=(std::move(buyRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = buyRequest.m_pData;
        buyRequest.m_pData = nullptr;
     ...
     * @param namespaceName ネームスペース名
     */
    BuyRequest& withNamespaceName(const Char* namespaceName)
    {
        ensureData().namespaceName.emplace(namespaceName);
        return *this;
    }
     ...
     * @param showcaseName 商品名
     */
    BuyRequest& withShowcaseName(const Char* showcaseName)
    {
        ensureData().showcaseName.emplace(showcaseName);
        return *this;
    }
     ...
     * @param displayItemId 陳列商品ID
     */
    BuyRequest& withDisplayItemId(const Char* displayItemId)
    {
        ensureData().displayItemId.emplace(displayItemId);
        return *this;
    }
     ...
     * @param config 設定値
     */
    BuyRequest& withConfig(const List<Config>& config)
    {
        ensureData().config.emplace(config);
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    BuyRequest& withDuplicationAvoider(const Char* duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(duplicationAvoider);
        return *this;
    }
     ...
     */
    BuyRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    BuyRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    BuyRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    BuyRequest& withRequestId(const Char* gs2RequestId)
    {
     ...
     * @return this
     */
    BuyRequest& withAccessToken(const Char* accessToken) {
