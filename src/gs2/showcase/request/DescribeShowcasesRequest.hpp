...
public:
    ...
    DescribeShowcasesRequest& operator=(const DescribeShowcasesRequest& describeShowcasesRequest)
    {
        ...
        m_pData = new Data(*describeShowcasesRequest.m_pData);
    ...
    DescribeShowcasesRequest& operator=(DescribeShowcasesRequest&& describeShowcasesRequest)
    {
        ...
        m_pData = describeShowcasesRequest.m_pData;
        describeShowcasesRequest.m_pData = nullptr;
     ...
     * @param namespaceName ネームスペース名
     */
    DescribeShowcasesRequest& withNamespaceName(const Char* namespaceName)
    {
        ensureData().namespaceName.emplace(namespaceName);
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    DescribeShowcasesRequest& withDuplicationAvoider(const Char* duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(duplicationAvoider);
        return *this;
    }
     ...
     */
    DescribeShowcasesRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    DescribeShowcasesRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    DescribeShowcasesRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    DescribeShowcasesRequest& withRequestId(const Char* gs2RequestId)
    {
