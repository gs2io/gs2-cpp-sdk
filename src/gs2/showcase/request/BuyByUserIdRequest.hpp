...
public:
    ...
    BuyByUserIdRequest(const BuyByUserIdRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Showcase(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    BuyByUserIdRequest(BuyByUserIdRequest&& obj) :
    ...
    BuyByUserIdRequest& operator=(const BuyByUserIdRequest& buyByUserIdRequest)
    {
        Gs2BasicRequest::operator=(buyByUserIdRequest);
        Gs2Showcase::operator=(buyByUserIdRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*buyByUserIdRequest.m_pData);

        return *this;
    }

    BuyByUserIdRequest& operator=(BuyByUserIdRequest&& buyByUserIdRequest)
    {
        Gs2BasicRequest::operator=(std::move(buyByUserIdRequest));
        Gs2Showcase::operator=(std::move(buyByUserIdRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = buyByUserIdRequest.m_pData;
        buyByUserIdRequest.m_pData = nullptr;
     ...
     * @param namespaceName ネームスペース名
     */
    BuyByUserIdRequest& withNamespaceName(const Char* namespaceName)
    {
        ensureData().namespaceName.emplace(namespaceName);
        return *this;
    }
     ...
     * @param showcaseName 商品名
     */
    BuyByUserIdRequest& withShowcaseName(const Char* showcaseName)
    {
        ensureData().showcaseName.emplace(showcaseName);
        return *this;
    }
     ...
     * @param displayItemId 陳列商品ID
     */
    BuyByUserIdRequest& withDisplayItemId(const Char* displayItemId)
    {
        ensureData().displayItemId.emplace(displayItemId);
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    BuyByUserIdRequest& withUserId(const Char* userId)
    {
        ensureData().userId.emplace(userId);
        return *this;
    }
     ...
     * @param config 設定値
     */
    BuyByUserIdRequest& withConfig(const List<Config>& config)
    {
        ensureData().config.emplace(config);
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    BuyByUserIdRequest& withDuplicationAvoider(const Char* duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(duplicationAvoider);
        return *this;
    }
     ...
     */
    BuyByUserIdRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    BuyByUserIdRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    BuyByUserIdRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    BuyByUserIdRequest& withRequestId(const Char* gs2RequestId)
    {
