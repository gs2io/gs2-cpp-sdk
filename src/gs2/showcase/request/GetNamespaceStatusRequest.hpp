...
#ifndef GS2_SHOWCASE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_SHOWCASE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Showcase
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Showcase::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Showcase::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_SHOWCASE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_