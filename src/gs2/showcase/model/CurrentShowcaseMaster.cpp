...
CurrentShowcaseMaster::Data::Data(const Data& data) :
...
void CurrentShowcaseMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentShowcaseMaster CurrentShowcaseMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentShowcaseMaster);
}
