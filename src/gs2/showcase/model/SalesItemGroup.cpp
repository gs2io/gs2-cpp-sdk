...
SalesItemGroup::Data::Data(const Data& data) :
...
void SalesItemGroup::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
    ...
    else if (std::strcmp(name_, "salesItems") == 0)
    {
        if (jsonValue.IsArray())
        {
            ...
            for (const detail::json::JsonConstValue* json = array.Begin(); json != array.End(); ++json) {
                ...
                *this->salesItems += std::move(item);
            }
        }
    }
}

SalesItemGroup SalesItemGroup::deepCopy() const
{
