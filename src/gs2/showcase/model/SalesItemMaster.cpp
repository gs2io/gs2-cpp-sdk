...
SalesItemMaster::Data::Data(const Data& data) :
...
void SalesItemMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
SalesItemMaster SalesItemMaster::deepCopy() const
{
