...
SalesItemGroupMaster::Data::Data(const Data& data) :
...
void SalesItemGroupMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
SalesItemGroupMaster SalesItemGroupMaster::deepCopy() const
{
