...
AcquireAction::Data::Data(const Data& data) :
...
void AcquireAction::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
AcquireAction AcquireAction::deepCopy() const
{
