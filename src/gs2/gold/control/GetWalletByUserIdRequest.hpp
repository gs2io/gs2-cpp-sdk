...
#ifndef GS2_GOLD_CONTROL_GETWALLETBYUSERIDREQUEST_HPP_
#define GS2_GOLD_CONTROL_GETWALLETBYUSERIDREQUEST_HPP_
 ...
 */
class GetWalletByUserIdRequest : public Gs2BasicRequest, public Gs2Gold
{
public:
...
public:
    ...
    GetWalletByUserIdRequest& operator=(const GetWalletByUserIdRequest& getWalletByUserIdRequest)
    {
        ...
        Gs2Gold::operator=(getWalletByUserIdRequest);
    ...
    GetWalletByUserIdRequest& operator=(GetWalletByUserIdRequest&& getWalletByUserIdRequest)
    {
        ...
        Gs2Gold::operator=(std::move(getWalletByUserIdRequest));
     ...
     * @param goldPoolName ゴールドプールの名前
     */
    GetWalletByUserIdRequest& withGoldPoolName(const Char* goldPoolName)
    {
        ensureData().goldPoolName.emplace(goldPoolName);
        return *this;
    }
     ...
     * @param goldName ゴールドの名前
     */
    GetWalletByUserIdRequest& withGoldName(const Char* goldName)
    {
        ensureData().goldName.emplace(goldName);
        return *this;
    }
...
#endif //GS2_GOLD_CONTROL_GETWALLETBYUSERIDREQUEST_HPP_