...
#ifndef GS2_GOLD_CONTROL_EXPORTMASTERREQUEST_HPP_
#define GS2_GOLD_CONTROL_EXPORTMASTERREQUEST_HPP_
 ...
 */
class ExportMasterRequest : public Gs2BasicRequest, public Gs2Gold
{
public:
...
public:
    ...
    ExportMasterRequest& operator=(const ExportMasterRequest& exportMasterRequest)
    {
        ...
        Gs2Gold::operator=(exportMasterRequest);
    ...
    ExportMasterRequest& operator=(ExportMasterRequest&& exportMasterRequest)
    {
        ...
        Gs2Gold::operator=(std::move(exportMasterRequest));
     ...
     * @param goldPoolName ゴールドプールの名前
     */
    ExportMasterRequest& withGoldPoolName(const Char* goldPoolName)
    {
        ensureData().goldPoolName.emplace(goldPoolName);
        return *this;
    }
...
#endif //GS2_GOLD_CONTROL_EXPORTMASTERREQUEST_HPP_