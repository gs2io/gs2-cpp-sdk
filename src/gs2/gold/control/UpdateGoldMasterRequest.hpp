...
#ifndef GS2_GOLD_CONTROL_UPDATEGOLDMASTERREQUEST_HPP_
#define GS2_GOLD_CONTROL_UPDATEGOLDMASTERREQUEST_HPP_
 ...
 */
class UpdateGoldMasterRequest : public Gs2BasicRequest, public Gs2Gold
{
public:
    constexpr static const Char* const FUNCTION = "UpdateGoldMaster";
...
public:
    ...
    UpdateGoldMasterRequest(const UpdateGoldMasterRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Gold(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    UpdateGoldMasterRequest(UpdateGoldMasterRequest&& obj) :
    ...
    UpdateGoldMasterRequest& operator=(const UpdateGoldMasterRequest& updateGoldMasterRequest)
    {
        Gs2BasicRequest::operator=(updateGoldMasterRequest);
        Gs2Gold::operator=(updateGoldMasterRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*updateGoldMasterRequest.m_pData);

        return *this;
    }

    UpdateGoldMasterRequest& operator=(UpdateGoldMasterRequest&& updateGoldMasterRequest)
    {
        Gs2BasicRequest::operator=(std::move(updateGoldMasterRequest));
        Gs2Gold::operator=(std::move(updateGoldMasterRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = updateGoldMasterRequest.m_pData;
        updateGoldMasterRequest.m_pData = nullptr;

        return *this;
    }

    const UpdateGoldMasterRequest* operator->() const
    {
        return this;
    }

    UpdateGoldMasterRequest* operator->()
    {
        return this;
    }
     ...
     * @param goldPoolName ゴールドプールの名前
     */
    UpdateGoldMasterRequest& withGoldPoolName(const Char* goldPoolName)
    {
        ensureData().goldPoolName.emplace(goldPoolName);
        return *this;
    }
     ...
     * @param goldName ゴールドの名前
     */
    UpdateGoldMasterRequest& withGoldName(const Char* goldName)
    {
        ensureData().goldName.emplace(goldName);
        return *this;
    }
     ...
     * @param meta メタデータ
     */
    UpdateGoldMasterRequest& withMeta(const Char* meta)
    {
        ensureData().meta.emplace(meta);
        return *this;
    }
     ...
     * @param balanceMax 各ウォレットの残高の最大値
     */
    UpdateGoldMasterRequest& withBalanceMax(Int64 balanceMax)
    {
        ensureData().balanceMax.emplace(balanceMax);
        return *this;
    }
     ...
     * @param resetType 取得量の期間制限のタイプ
     */
    UpdateGoldMasterRequest& withResetType(const Char* resetType)
    {
        ensureData().resetType.emplace(resetType);
        return *this;
    }
     ...
     * @param resetDayOfMonth 期間内の取得量をリセットする日にち
     */
    UpdateGoldMasterRequest& withResetDayOfMonth(Int32 resetDayOfMonth)
    {
        ensureData().resetDayOfMonth.emplace(resetDayOfMonth);
        return *this;
    }
     ...
     * @param resetDayOfWeek 期間内の取得量をリセットする曜日
     */
    UpdateGoldMasterRequest& withResetDayOfWeek(const Char* resetDayOfWeek)
    {
        ensureData().resetDayOfWeek.emplace(resetDayOfWeek);
        return *this;
    }
     ...
     * @param resetHour 期間内の取得量をリセットする時
     */
    UpdateGoldMasterRequest& withResetHour(Int32 resetHour)
    {
        ensureData().resetHour.emplace(resetHour);
        return *this;
    }
     ...
     * @param latestGainMax 期間内の最大取得量
     */
    UpdateGoldMasterRequest& withLatestGainMax(Int64 latestGainMax)
    {
        ensureData().latestGainMax.emplace(latestGainMax);
        return *this;
    }
     ...
     * @param createWalletTriggerScript ウォレットの生成時 に実行されるGS2-Script
     */
    UpdateGoldMasterRequest& withCreateWalletTriggerScript(const Char* createWalletTriggerScript)
    {
        ensureData().createWalletTriggerScript.emplace(createWalletTriggerScript);
        return *this;
    }
     ...
     * @param createWalletDoneTriggerScript ウォレットの生成完了時 に実行されるGS2-Script
     */
    UpdateGoldMasterRequest& withCreateWalletDoneTriggerScript(const Char* createWalletDoneTriggerScript)
    {
        ensureData().createWalletDoneTriggerScript.emplace(createWalletDoneTriggerScript);
        return *this;
    }
     ...
     * @param depositIntoWalletTriggerScript ウォレットへの加算時 に実行されるGS2-Script
     */
    UpdateGoldMasterRequest& withDepositIntoWalletTriggerScript(const Char* depositIntoWalletTriggerScript)
    {
        ensureData().depositIntoWalletTriggerScript.emplace(depositIntoWalletTriggerScript);
        return *this;
    }
     ...
     * @param depositIntoWalletDoneTriggerScript ウォレットへの加算完了時 に実行されるGS2-Script
     */
    UpdateGoldMasterRequest& withDepositIntoWalletDoneTriggerScript(const Char* depositIntoWalletDoneTriggerScript)
    {
        ensureData().depositIntoWalletDoneTriggerScript.emplace(depositIntoWalletDoneTriggerScript);
        return *this;
    }
     ...
     * @param withdrawFromWalletTriggerScript ウォレットからの減算時 に実行されるGS2-Script
     */
    UpdateGoldMasterRequest& withWithdrawFromWalletTriggerScript(const Char* withdrawFromWalletTriggerScript)
    {
        ensureData().withdrawFromWalletTriggerScript.emplace(withdrawFromWalletTriggerScript);
        return *this;
    }
     ...
     * @param withdrawFromWalletDoneTriggerScript ウォレットからの減算完了時 に実行されるGS2-Script
     */
    UpdateGoldMasterRequest& withWithdrawFromWalletDoneTriggerScript(const Char* withdrawFromWalletDoneTriggerScript)
    {
        ensureData().withdrawFromWalletDoneTriggerScript.emplace(withdrawFromWalletDoneTriggerScript);
        return *this;
    }
     ...
     */
    UpdateGoldMasterRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    UpdateGoldMasterRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    UpdateGoldMasterRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    UpdateGoldMasterRequest& withRequestId(const Char* gs2RequestId)
    {
...
#endif //GS2_GOLD_CONTROL_UPDATEGOLDMASTERREQUEST_HPP_