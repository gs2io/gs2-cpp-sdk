...
#ifndef GS2_FORMATION_CONTROL_GETFORMBYUSERIDRESULT_HPP_
#define GS2_FORMATION_CONTROL_GETFORMBYUSERIDRESULT_HPP_
 ...
 */
class GetFormByUserIdResult : public Gs2Object
{
private:
...
public:
    GetFormByUserIdResult() = default;
    GetFormByUserIdResult(const GetFormByUserIdResult& getFormByUserIdResult) = default;
    GetFormByUserIdResult(GetFormByUserIdResult&& getFormByUserIdResult) = default;
    ~GetFormByUserIdResult() = default;

    GetFormByUserIdResult& operator=(const GetFormByUserIdResult& getFormByUserIdResult) = default;
    GetFormByUserIdResult& operator=(GetFormByUserIdResult&& getFormByUserIdResult) = default;

    GetFormByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetFormByUserIdResult);
    }

    const GetFormByUserIdResult* operator->() const
    {
        return this;
    }

    GetFormByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<GetFormByUserIdResult> AsyncGetFormByUserIdResult;

} }

#endif //GS2_FORMATION_CONTROL_GETFORMBYUSERIDRESULT_HPP_