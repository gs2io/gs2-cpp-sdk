...
#ifndef GS2_FORMATION_CONTROL_DELETEFORMBYUSERIDRESULT_HPP_
#define GS2_FORMATION_CONTROL_DELETEFORMBYUSERIDRESULT_HPP_
 ...
 */
class DeleteFormByUserIdResult : public Gs2Object
{
private:
...
public:
    DeleteFormByUserIdResult() = default;
    DeleteFormByUserIdResult(const DeleteFormByUserIdResult& deleteFormByUserIdResult) = default;
    DeleteFormByUserIdResult(DeleteFormByUserIdResult&& deleteFormByUserIdResult) = default;
    ~DeleteFormByUserIdResult() = default;

    DeleteFormByUserIdResult& operator=(const DeleteFormByUserIdResult& deleteFormByUserIdResult) = default;
    DeleteFormByUserIdResult& operator=(DeleteFormByUserIdResult&& deleteFormByUserIdResult) = default;

    DeleteFormByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteFormByUserIdResult);
    }

    const DeleteFormByUserIdResult* operator->() const
    {
        return this;
    }

    DeleteFormByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<DeleteFormByUserIdResult> AsyncDeleteFormByUserIdResult;

} }

#endif //GS2_FORMATION_CONTROL_DELETEFORMBYUSERIDRESULT_HPP_