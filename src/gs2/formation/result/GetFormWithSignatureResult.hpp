...
#ifndef GS2_FORMATION_CONTROL_GETFORMWITHSIGNATURERESULT_HPP_
#define GS2_FORMATION_CONTROL_GETFORMWITHSIGNATURERESULT_HPP_
 ...
 */
class GetFormWithSignatureResult : public Gs2Object
{
private:
...
public:
    GetFormWithSignatureResult() = default;
    GetFormWithSignatureResult(const GetFormWithSignatureResult& getFormWithSignatureResult) = default;
    GetFormWithSignatureResult(GetFormWithSignatureResult&& getFormWithSignatureResult) = default;
    ~GetFormWithSignatureResult() = default;

    GetFormWithSignatureResult& operator=(const GetFormWithSignatureResult& getFormWithSignatureResult) = default;
    GetFormWithSignatureResult& operator=(GetFormWithSignatureResult&& getFormWithSignatureResult) = default;

    GetFormWithSignatureResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetFormWithSignatureResult);
    }

    const GetFormWithSignatureResult* operator->() const
    {
        return this;
    }

    GetFormWithSignatureResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<GetFormWithSignatureResult> AsyncGetFormWithSignatureResult;

} }

#endif //GS2_FORMATION_CONTROL_GETFORMWITHSIGNATURERESULT_HPP_