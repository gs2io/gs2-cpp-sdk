...
#ifndef GS2_FORMATION_CONTROL_SETFORMBYUSERIDRESULT_HPP_
#define GS2_FORMATION_CONTROL_SETFORMBYUSERIDRESULT_HPP_
 ...
 */
class SetFormByUserIdResult : public Gs2Object
{
private:
...
public:
    SetFormByUserIdResult() = default;
    SetFormByUserIdResult(const SetFormByUserIdResult& setFormByUserIdResult) = default;
    SetFormByUserIdResult(SetFormByUserIdResult&& setFormByUserIdResult) = default;
    ~SetFormByUserIdResult() = default;

    SetFormByUserIdResult& operator=(const SetFormByUserIdResult& setFormByUserIdResult) = default;
    SetFormByUserIdResult& operator=(SetFormByUserIdResult&& setFormByUserIdResult) = default;

    SetFormByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SetFormByUserIdResult);
    }

    const SetFormByUserIdResult* operator->() const
    {
        return this;
    }

    SetFormByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<SetFormByUserIdResult> AsyncSetFormByUserIdResult;

} }

#endif //GS2_FORMATION_CONTROL_SETFORMBYUSERIDRESULT_HPP_