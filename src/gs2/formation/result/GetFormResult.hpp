...
#ifndef GS2_FORMATION_CONTROL_GETFORMRESULT_HPP_
#define GS2_FORMATION_CONTROL_GETFORMRESULT_HPP_
 ...
 */
class GetFormResult : public Gs2Object
{
private:
...
public:
    GetFormResult() = default;
    GetFormResult(const GetFormResult& getFormResult) = default;
    GetFormResult(GetFormResult&& getFormResult) = default;
    ~GetFormResult() = default;

    GetFormResult& operator=(const GetFormResult& getFormResult) = default;
    GetFormResult& operator=(GetFormResult&& getFormResult) = default;

    GetFormResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetFormResult);
    }

    const GetFormResult* operator->() const
    {
        return this;
    }

    GetFormResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<GetFormResult> AsyncGetFormResult;

} }

#endif //GS2_FORMATION_CONTROL_GETFORMRESULT_HPP_