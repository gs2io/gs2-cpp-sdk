...
#ifndef GS2_FORMATION_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_FORMATION_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Formation
{
public:
...
public:
     ...
     * @param updateMoldScript キャパシティを更新するときに実行するスクリプト
     */
    UpdateNamespaceRequest& withUpdateMoldScript(ScriptSetting updateMoldScript)
    {
        ensureData().updateMoldScript.emplace(std::move(updateMoldScript));
        return *this;
    }
     ...
     * @param updateFormScript フォームを更新するときに実行するスクリプト
     */
    UpdateNamespaceRequest& withUpdateFormScript(ScriptSetting updateFormScript)
    {
        ensureData().updateFormScript.emplace(std::move(updateFormScript));
        return *this;
    }
...
#endif //GS2_FORMATION_CONTROL_UPDATENAMESPACEREQUEST_HPP_