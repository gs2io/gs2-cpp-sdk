...
#ifndef GS2_SCRIPT_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_SCRIPT_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Script
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Script::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Script::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_SCRIPT_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_