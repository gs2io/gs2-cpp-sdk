...
#ifndef GS2_SCRIPT_CONTROL_CREATENAMESPACEREQUEST_HPP_
#define GS2_SCRIPT_CONTROL_CREATENAMESPACEREQUEST_HPP_
 ...
 */
class CreateNamespaceRequest : public Gs2BasicRequest, public Gs2Script
{
public:
...
public:
    ...
    CreateNamespaceRequest& operator=(const CreateNamespaceRequest& createNamespaceRequest)
    {
        ...
        Gs2Script::operator=(createNamespaceRequest);
    ...
    CreateNamespaceRequest& operator=(CreateNamespaceRequest&& createNamespaceRequest)
    {
        ...
        Gs2Script::operator=(std::move(createNamespaceRequest));
...
#endif //GS2_SCRIPT_CONTROL_CREATENAMESPACEREQUEST_HPP_