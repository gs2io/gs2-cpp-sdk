...
#ifndef GS2_SCRIPT_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_SCRIPT_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Script
{
public:
...
public:
    ...
    UpdateNamespaceRequest& operator=(const UpdateNamespaceRequest& updateNamespaceRequest)
    {
        ...
        Gs2Script::operator=(updateNamespaceRequest);
    ...
    UpdateNamespaceRequest& operator=(UpdateNamespaceRequest&& updateNamespaceRequest)
    {
        ...
        Gs2Script::operator=(std::move(updateNamespaceRequest));
...
#endif //GS2_SCRIPT_CONTROL_UPDATENAMESPACEREQUEST_HPP_