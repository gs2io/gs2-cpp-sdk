 ...
 */
void Gs2ScriptWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::describeScripts(DescribeScriptsRequest request, std::function<void(AsyncDescribeScriptsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::createScript(CreateScriptRequest request, std::function<void(AsyncCreateScriptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::createScriptFromGitHub(CreateScriptFromGitHubRequest request, std::function<void(AsyncCreateScriptFromGitHubResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::getScript(GetScriptRequest request, std::function<void(AsyncGetScriptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::updateScript(UpdateScriptRequest request, std::function<void(AsyncUpdateScriptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::updateScriptFromGitHub(UpdateScriptFromGitHubRequest request, std::function<void(AsyncUpdateScriptFromGitHubResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::deleteScript(DeleteScriptRequest request, std::function<void(AsyncDeleteScriptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2ScriptWebSocketClient::debugInvoke(DebugInvokeRequest request, std::function<void(AsyncDebugInvokeResult)> callback)
{
