...
public:
    GetScriptResult() = default;
    GetScriptResult(const GetScriptResult& getScriptResult) = default;
    GetScriptResult(GetScriptResult&& getScriptResult) = default;
    ~GetScriptResult() = default;

    GetScriptResult& operator=(const GetScriptResult& getScriptResult) = default;
    GetScriptResult& operator=(GetScriptResult&& getScriptResult) = default;

    GetScriptResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetScriptResult);
    }
