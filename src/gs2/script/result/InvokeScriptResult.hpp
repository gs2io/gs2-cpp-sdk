...
#ifndef GS2_SCRIPT_CONTROL_INVOKESCRIPTRESULT_HPP_
#define GS2_SCRIPT_CONTROL_INVOKESCRIPTRESULT_HPP_
 ...
 */
class InvokeScriptResult : public Gs2Object
{
private:
...
public:
    InvokeScriptResult() = default;
    InvokeScriptResult(const InvokeScriptResult& invokeScriptResult) = default;
    InvokeScriptResult(InvokeScriptResult&& invokeScriptResult) = default;
    ~InvokeScriptResult() = default;

    InvokeScriptResult& operator=(const InvokeScriptResult& invokeScriptResult) = default;
    InvokeScriptResult& operator=(InvokeScriptResult&& invokeScriptResult) = default;

    InvokeScriptResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(InvokeScriptResult);
    }

    const InvokeScriptResult* operator->() const
    {
        return this;
    }

    InvokeScriptResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<InvokeScriptResult> AsyncInvokeScriptResult;

} }

#endif //GS2_SCRIPT_CONTROL_INVOKESCRIPTRESULT_HPP_