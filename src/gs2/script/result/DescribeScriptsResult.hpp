...
public:
    DescribeScriptsResult() = default;
    DescribeScriptsResult(const DescribeScriptsResult& describeScriptsResult) = default;
    DescribeScriptsResult(DescribeScriptsResult&& describeScriptsResult) = default;
    ~DescribeScriptsResult() = default;

    DescribeScriptsResult& operator=(const DescribeScriptsResult& describeScriptsResult) = default;
    DescribeScriptsResult& operator=(DescribeScriptsResult&& describeScriptsResult) = default;

    DescribeScriptsResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeScriptsResult);
    }
     ...
     */
    void setItems(List<Script> items)
    {
