...
#ifndef GS2_SCRIPT_CONTROL_CREATENAMESPACERESULT_HPP_
#define GS2_SCRIPT_CONTROL_CREATENAMESPACERESULT_HPP_
...
#endif //GS2_SCRIPT_CONTROL_CREATENAMESPACERESULT_HPP_