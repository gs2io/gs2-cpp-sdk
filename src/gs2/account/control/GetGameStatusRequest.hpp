...
#ifndef GS2_ACCOUNT_CONTROL_GETGAMESTATUSREQUEST_HPP_
#define GS2_ACCOUNT_CONTROL_GETGAMESTATUSREQUEST_HPP_
 ...
 */
class GetGameStatusRequest : public Gs2BasicRequest, public Gs2Account
{
public:
...
public:
    ...
    GetGameStatusRequest& operator=(const GetGameStatusRequest& getGameStatusRequest)
    {
        ...
        Gs2Account::operator=(getGameStatusRequest);
    ...
    GetGameStatusRequest& operator=(GetGameStatusRequest&& getGameStatusRequest)
    {
        ...
        Gs2Account::operator=(std::move(getGameStatusRequest));
...
#endif //GS2_ACCOUNT_CONTROL_GETGAMESTATUSREQUEST_HPP_