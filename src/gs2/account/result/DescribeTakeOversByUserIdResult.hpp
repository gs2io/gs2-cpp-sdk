...
public:
    DescribeTakeOversByUserIdResult() = default;
    DescribeTakeOversByUserIdResult(const DescribeTakeOversByUserIdResult& describeTakeOversByUserIdResult) = default;
    DescribeTakeOversByUserIdResult(DescribeTakeOversByUserIdResult&& describeTakeOversByUserIdResult) = default;
    ~DescribeTakeOversByUserIdResult() = default;

    DescribeTakeOversByUserIdResult& operator=(const DescribeTakeOversByUserIdResult& describeTakeOversByUserIdResult) = default;
    DescribeTakeOversByUserIdResult& operator=(DescribeTakeOversByUserIdResult&& describeTakeOversByUserIdResult) = default;

    DescribeTakeOversByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeTakeOversByUserIdResult);
    }
