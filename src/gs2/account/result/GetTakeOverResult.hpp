...
public:
    GetTakeOverResult() = default;
    GetTakeOverResult(const GetTakeOverResult& getTakeOverResult) = default;
    GetTakeOverResult(GetTakeOverResult&& getTakeOverResult) = default;
    ~GetTakeOverResult() = default;

    GetTakeOverResult& operator=(const GetTakeOverResult& getTakeOverResult) = default;
    GetTakeOverResult& operator=(GetTakeOverResult&& getTakeOverResult) = default;

    GetTakeOverResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetTakeOverResult);
    }
