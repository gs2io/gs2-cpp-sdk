...
#ifndef GS2_ACCOUNT_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_ACCOUNT_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Account
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Account::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Account::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_ACCOUNT_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_