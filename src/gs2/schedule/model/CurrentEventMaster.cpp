...
CurrentEventMaster::Data::Data(const Data& data) :
...
void CurrentEventMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentEventMaster CurrentEventMaster::deepCopy() const
{
