...
EventMaster::Data::Data(const Data& data) :
...
void EventMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
EventMaster EventMaster::deepCopy() const
{
