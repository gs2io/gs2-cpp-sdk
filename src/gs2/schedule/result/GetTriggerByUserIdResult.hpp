...
public:
    GetTriggerByUserIdResult() = default;
    GetTriggerByUserIdResult(const GetTriggerByUserIdResult& getTriggerByUserIdResult) = default;
    GetTriggerByUserIdResult(GetTriggerByUserIdResult&& getTriggerByUserIdResult) = default;
    ~GetTriggerByUserIdResult() = default;

    GetTriggerByUserIdResult& operator=(const GetTriggerByUserIdResult& getTriggerByUserIdResult) = default;
    GetTriggerByUserIdResult& operator=(GetTriggerByUserIdResult&& getTriggerByUserIdResult) = default;

    GetTriggerByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetTriggerByUserIdResult);
    }
