...
public:
    DeleteEventMasterResult() = default;
    DeleteEventMasterResult(const DeleteEventMasterResult& deleteEventMasterResult) = default;
    DeleteEventMasterResult(DeleteEventMasterResult&& deleteEventMasterResult) = default;
    ~DeleteEventMasterResult() = default;

    DeleteEventMasterResult& operator=(const DeleteEventMasterResult& deleteEventMasterResult) = default;
    DeleteEventMasterResult& operator=(DeleteEventMasterResult&& deleteEventMasterResult) = default;

    DeleteEventMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteEventMasterResult);
    }
