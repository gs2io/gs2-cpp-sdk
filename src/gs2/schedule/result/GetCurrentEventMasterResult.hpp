...
public:
    GetCurrentEventMasterResult() = default;
    GetCurrentEventMasterResult(const GetCurrentEventMasterResult& getCurrentEventMasterResult) = default;
    GetCurrentEventMasterResult(GetCurrentEventMasterResult&& getCurrentEventMasterResult) = default;
    ~GetCurrentEventMasterResult() = default;

    GetCurrentEventMasterResult& operator=(const GetCurrentEventMasterResult& getCurrentEventMasterResult) = default;
    GetCurrentEventMasterResult& operator=(GetCurrentEventMasterResult&& getCurrentEventMasterResult) = default;

    GetCurrentEventMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetCurrentEventMasterResult);
    }
