...
/**
 * 現在有効なイベントマスターJSONを更新します のレスポンスモデル
 *
...
public:
    ...
    /**
     * 更新した現在有効なイベントマスターJSONを取得
     *
     * @return 更新した現在有効なイベントマスターJSON
     */
    ...
    /**
     * 更新した現在有効なイベントマスターJSONを設定
     *
     * @param item 更新した現在有効なイベントマスターJSON
     */
