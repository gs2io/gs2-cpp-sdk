...
public:
    GetEventByUserIdResult() = default;
    GetEventByUserIdResult(const GetEventByUserIdResult& getEventByUserIdResult) = default;
    GetEventByUserIdResult(GetEventByUserIdResult&& getEventByUserIdResult) = default;
    ~GetEventByUserIdResult() = default;

    GetEventByUserIdResult& operator=(const GetEventByUserIdResult& getEventByUserIdResult) = default;
    GetEventByUserIdResult& operator=(GetEventByUserIdResult&& getEventByUserIdResult) = default;

    GetEventByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetEventByUserIdResult);
    }
