...
public:
    UpdateEventMasterResult() = default;
    UpdateEventMasterResult(const UpdateEventMasterResult& updateEventMasterResult) = default;
    UpdateEventMasterResult(UpdateEventMasterResult&& updateEventMasterResult) = default;
    ~UpdateEventMasterResult() = default;

    UpdateEventMasterResult& operator=(const UpdateEventMasterResult& updateEventMasterResult) = default;
    UpdateEventMasterResult& operator=(UpdateEventMasterResult&& updateEventMasterResult) = default;

    UpdateEventMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateEventMasterResult);
    }
