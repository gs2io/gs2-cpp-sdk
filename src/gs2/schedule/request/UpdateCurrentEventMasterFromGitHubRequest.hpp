...
public:
    UpdateCurrentEventMasterFromGitHubRequest() = default;
    UpdateCurrentEventMasterFromGitHubRequest(const UpdateCurrentEventMasterFromGitHubRequest& updateCurrentEventMasterFromGitHubRequest) = default;
    UpdateCurrentEventMasterFromGitHubRequest(UpdateCurrentEventMasterFromGitHubRequest&& updateCurrentEventMasterFromGitHubRequest) = default;
    ~UpdateCurrentEventMasterFromGitHubRequest() GS2_OVERRIDE = default;

    UpdateCurrentEventMasterFromGitHubRequest& operator=(const UpdateCurrentEventMasterFromGitHubRequest& updateCurrentEventMasterFromGitHubRequest) = default;
    UpdateCurrentEventMasterFromGitHubRequest& operator=(UpdateCurrentEventMasterFromGitHubRequest&& updateCurrentEventMasterFromGitHubRequest) = default;

    UpdateCurrentEventMasterFromGitHubRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateCurrentEventMasterFromGitHubRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    UpdateCurrentEventMasterFromGitHubRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     */
    UpdateCurrentEventMasterFromGitHubRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    UpdateCurrentEventMasterFromGitHubRequest& withRequestId(StringHolder gs2RequestId)
    {
