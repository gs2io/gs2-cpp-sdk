...
#ifndef GS2_SCHEDULE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_SCHEDULE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Schedule
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Schedule::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Schedule::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_SCHEDULE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_