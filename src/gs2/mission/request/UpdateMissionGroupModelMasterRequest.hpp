...
public:
     ...
     * @param resetType リセットタイミング
     */
    UpdateMissionGroupModelMasterRequest& withResetType(StringHolder resetType)
    {
        ensureData().resetType.emplace(std::move(resetType));
        return *this;
    }
     ...
     * @param resetDayOfMonth リセットをする日にち
     */
    UpdateMissionGroupModelMasterRequest& withResetDayOfMonth(Int32 resetDayOfMonth)
    {
        ensureData().resetDayOfMonth.emplace(resetDayOfMonth);
        return *this;
    }
     ...
     * @param resetDayOfWeek リセットする曜日
     */
    UpdateMissionGroupModelMasterRequest& withResetDayOfWeek(StringHolder resetDayOfWeek)
    {
        ensureData().resetDayOfWeek.emplace(std::move(resetDayOfWeek));
        return *this;
    }
     ...
     * @param resetHour リセット時刻
     */
    UpdateMissionGroupModelMasterRequest& withResetHour(Int32 resetHour)
    {
        ensureData().resetHour.emplace(resetHour);
        return *this;
    }
