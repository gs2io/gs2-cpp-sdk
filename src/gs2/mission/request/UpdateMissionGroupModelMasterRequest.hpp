...
public:
    ...
    UpdateMissionGroupModelMasterRequest(const UpdateMissionGroupModelMasterRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Mission(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    UpdateMissionGroupModelMasterRequest(UpdateMissionGroupModelMasterRequest&& obj) :
    ...
    UpdateMissionGroupModelMasterRequest& operator=(const UpdateMissionGroupModelMasterRequest& updateMissionGroupModelMasterRequest)
    {
        Gs2BasicRequest::operator=(updateMissionGroupModelMasterRequest);
        Gs2Mission::operator=(updateMissionGroupModelMasterRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*updateMissionGroupModelMasterRequest.m_pData);

        return *this;
    }

    UpdateMissionGroupModelMasterRequest& operator=(UpdateMissionGroupModelMasterRequest&& updateMissionGroupModelMasterRequest)
    {
        Gs2BasicRequest::operator=(std::move(updateMissionGroupModelMasterRequest));
        Gs2Mission::operator=(std::move(updateMissionGroupModelMasterRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = updateMissionGroupModelMasterRequest.m_pData;
        updateMissionGroupModelMasterRequest.m_pData = nullptr;
     ...
     * @param namespaceName ネームスペース名
     */
    UpdateMissionGroupModelMasterRequest& withNamespaceName(const Char* namespaceName)
    {
        ensureData().namespaceName.emplace(namespaceName);
        return *this;
    }
     ...
     * @param missionGroupName ミッショングループ名
     */
    UpdateMissionGroupModelMasterRequest& withMissionGroupName(const Char* missionGroupName)
    {
        ensureData().missionGroupName.emplace(missionGroupName);
        return *this;
    }
     ...
     * @param metadata メタデータ
     */
    UpdateMissionGroupModelMasterRequest& withMetadata(const Char* metadata)
    {
        ensureData().metadata.emplace(metadata);
        return *this;
    }
     ...
     * @param description ミッショングループの説明
     */
    UpdateMissionGroupModelMasterRequest& withDescription(const Char* description)
    {
        ensureData().description.emplace(description);
        return *this;
    }
     ...
     * @param completeNotificationNamespaceId ミッションを達成したときの通知先ネームスペース のGRN
     */
    UpdateMissionGroupModelMasterRequest& withCompleteNotificationNamespaceId(const Char* completeNotificationNamespaceId)
    {
        ensureData().completeNotificationNamespaceId.emplace(completeNotificationNamespaceId);
        return *this;
    }
     ...
     */
    UpdateMissionGroupModelMasterRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    UpdateMissionGroupModelMasterRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    UpdateMissionGroupModelMasterRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    UpdateMissionGroupModelMasterRequest& withRequestId(const Char* gs2RequestId)
    {
