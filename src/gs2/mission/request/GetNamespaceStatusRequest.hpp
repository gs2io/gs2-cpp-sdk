...
#ifndef GS2_MISSION_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_MISSION_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Mission
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Mission::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Mission::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_MISSION_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_