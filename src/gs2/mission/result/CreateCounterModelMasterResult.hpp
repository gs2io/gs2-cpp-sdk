...
public:
    CreateCounterModelMasterResult() = default;
    CreateCounterModelMasterResult(const CreateCounterModelMasterResult& createCounterModelMasterResult) = default;
    CreateCounterModelMasterResult(CreateCounterModelMasterResult&& createCounterModelMasterResult) = default;
    ~CreateCounterModelMasterResult() = default;

    CreateCounterModelMasterResult& operator=(const CreateCounterModelMasterResult& createCounterModelMasterResult) = default;
    CreateCounterModelMasterResult& operator=(CreateCounterModelMasterResult&& createCounterModelMasterResult) = default;

    CreateCounterModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateCounterModelMasterResult);
    }
