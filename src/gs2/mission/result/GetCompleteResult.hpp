...
public:
    GetCompleteResult() = default;
    GetCompleteResult(const GetCompleteResult& getCompleteResult) = default;
    GetCompleteResult(GetCompleteResult&& getCompleteResult) = default;
    ~GetCompleteResult() = default;

    GetCompleteResult& operator=(const GetCompleteResult& getCompleteResult) = default;
    GetCompleteResult& operator=(GetCompleteResult&& getCompleteResult) = default;

    GetCompleteResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetCompleteResult);
    }
