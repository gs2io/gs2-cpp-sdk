...
public:
    DescribeCounterModelMastersResult() = default;
    DescribeCounterModelMastersResult(const DescribeCounterModelMastersResult& describeCounterModelMastersResult) = default;
    DescribeCounterModelMastersResult(DescribeCounterModelMastersResult&& describeCounterModelMastersResult) = default;
    ~DescribeCounterModelMastersResult() = default;

    DescribeCounterModelMastersResult& operator=(const DescribeCounterModelMastersResult& describeCounterModelMastersResult) = default;
    DescribeCounterModelMastersResult& operator=(DescribeCounterModelMastersResult&& describeCounterModelMastersResult) = default;

    DescribeCounterModelMastersResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeCounterModelMastersResult);
    }
     ...
     */
    void setItems(List<CounterModelMaster> items)
    {
