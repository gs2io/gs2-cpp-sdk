...
public:
    GetCounterModelResult() = default;
    GetCounterModelResult(const GetCounterModelResult& getCounterModelResult) = default;
    GetCounterModelResult(GetCounterModelResult&& getCounterModelResult) = default;
    ~GetCounterModelResult() = default;
     ...
     * @param item カウンターの種類
     */
    void setItem(CounterModel item)
    {
