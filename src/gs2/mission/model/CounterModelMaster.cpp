...
CounterModelMaster::Data::Data(const Data& data) :
...
void CounterModelMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CounterModelMaster CounterModelMaster::deepCopy() const
{
