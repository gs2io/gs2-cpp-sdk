...
CurrentMissionMaster::Data::Data(const Data& data) :
...
void CurrentMissionMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentMissionMaster CurrentMissionMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentMissionMaster);
}
