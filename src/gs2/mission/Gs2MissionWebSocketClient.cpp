...
#include "Gs2MissionWebSocketClient.hpp"
...
void write(detail::json::JsonWriter& jsonWriter, const MissionGroupModelMaster& obj);
...
void write(detail::json::JsonWriter& jsonWriter, const CounterScopeModel& obj);
void write(detail::json::JsonWriter& jsonWriter, const Counter& obj);
void write(detail::json::JsonWriter& jsonWriter, const MissionTaskModelMaster& obj);
void write(detail::json::JsonWriter& jsonWriter, const CurrentMissionMaster& obj);
void write(detail::json::JsonWriter& jsonWriter, const Namespace& obj);
void write(detail::json::JsonWriter& jsonWriter, const Complete& obj);
...
void write(detail::json::JsonWriter& jsonWriter, const CounterModelMaster& obj);
void write(detail::json::JsonWriter& jsonWriter, const CounterModel& obj);
...
void write(detail::json::JsonWriter& jsonWriter, const MissionGroupModel& obj);
void write(detail::json::JsonWriter& jsonWriter, const ScopedValue& obj);
void write(detail::json::JsonWriter& jsonWriter, const MissionTaskModel& obj);
...
void write(detail::json::JsonWriter& jsonWriter, const Namespace& obj)
{
    ...
    if (obj.getMissionCompleteTriggerScriptId())
    {
        ...
        jsonWriter.writeCharArray(*obj.getMissionCompleteTriggerScriptId());
    }
    if (obj.getMissionCompleteDoneTriggerScriptId())
    {
        jsonWriter.writePropertyName("missionCompleteDoneTriggerScriptId");
        jsonWriter.writeCharArray(*obj.getMissionCompleteDoneTriggerScriptId());
    }
    ...
    if (obj.getCounterIncrementDoneTriggerQueueNamespaceId())
    {
        ...
        jsonWriter.writeCharArray(*obj.getCounterIncrementDoneTriggerQueueNamespaceId());
    }
    if (obj.getReceiveRewardsTriggerScriptId())
    {
        jsonWriter.writePropertyName("receiveRewardsTriggerScriptId");
        jsonWriter.writeCharArray(*obj.getReceiveRewardsTriggerScriptId());
    }
    if (obj.getReceiveRewardsDoneTriggerScriptId())
    {
        jsonWriter.writePropertyName("receiveRewardsDoneTriggerScriptId");
        jsonWriter.writeCharArray(*obj.getReceiveRewardsDoneTriggerScriptId());
    }
    if (obj.getReceiveRewardsDoneTriggerQueueNamespaceId())
    {
        ...
        jsonWriter.writeCharArray(*obj.getReceiveRewardsDoneTriggerQueueNamespaceId());
    }
...
private:
    ...
    void constructRequestImpl(detail::json::JsonWriter& jsonWriter) GS2_OVERRIDE
    {
        ...
        {
            jsonWriter.writePropertyName("missionCompleteTriggerScriptId");
            jsonWriter.writeCharArray(*m_Request.getMissionCompleteTriggerScriptId());
        }
        if (m_Request.getMissionCompleteDoneTriggerScriptId())
        {
            jsonWriter.writePropertyName("missionCompleteDoneTriggerScriptId");
            jsonWriter.writeCharArray(*m_Request.getMissionCompleteDoneTriggerScriptId());
        }
        if (m_Request.getMissionCompleteDoneTriggerQueueNamespaceId())
        {
            jsonWriter.writePropertyName("missionCompleteDoneTriggerQueueNamespaceId");
            jsonWriter.writeCharArray(*m_Request.getMissionCompleteDoneTriggerQueueNamespaceId());
        }
        if (m_Request.getCounterIncrementTriggerScriptId())
        {
            jsonWriter.writePropertyName("counterIncrementTriggerScriptId");
            jsonWriter.writeCharArray(*m_Request.getCounterIncrementTriggerScriptId());
        }
        if (m_Request.getCounterIncrementDoneTriggerScriptId())
        {
            jsonWriter.writePropertyName("counterIncrementDoneTriggerScriptId");
            jsonWriter.writeCharArray(*m_Request.getCounterIncrementDoneTriggerScriptId());
        }
        if (m_Request.getCounterIncrementDoneTriggerQueueNamespaceId())
        {
            jsonWriter.writePropertyName("counterIncrementDoneTriggerQueueNamespaceId");
            jsonWriter.writeCharArray(*m_Request.getCounterIncrementDoneTriggerQueueNamespaceId());
        }
        if (m_Request.getReceiveRewardsTriggerScriptId())
        {
            jsonWriter.writePropertyName("receiveRewardsTriggerScriptId");
            jsonWriter.writeCharArray(*m_Request.getReceiveRewardsTriggerScriptId());
        }
        if (m_Request.getReceiveRewardsDoneTriggerScriptId())
        {
            jsonWriter.writePropertyName("receiveRewardsDoneTriggerScriptId");
            jsonWriter.writeCharArray(*m_Request.getReceiveRewardsDoneTriggerScriptId());
        }
        if (m_Request.getReceiveRewardsDoneTriggerQueueNamespaceId())
        {
            jsonWriter.writePropertyName("receiveRewardsDoneTriggerQueueNamespaceId");
            jsonWriter.writeCharArray(*m_Request.getReceiveRewardsDoneTriggerQueueNamespaceId());
        }
 ...
 */
void Gs2MissionWebSocketClient::describeMissionGroupModelMasters(DescribeMissionGroupModelMastersRequest request, std::function<void(AsyncDescribeMissionGroupModelMastersResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::createMissionGroupModelMaster(CreateMissionGroupModelMasterRequest request, std::function<void(AsyncCreateMissionGroupModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getMissionGroupModelMaster(GetMissionGroupModelMasterRequest request, std::function<void(AsyncGetMissionGroupModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::updateMissionGroupModelMaster(UpdateMissionGroupModelMasterRequest request, std::function<void(AsyncUpdateMissionGroupModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::deleteMissionGroupModelMaster(DeleteMissionGroupModelMasterRequest request, std::function<void(AsyncDeleteMissionGroupModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeCounters(DescribeCountersRequest request, std::function<void(AsyncDescribeCountersResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeCountersByUserId(DescribeCountersByUserIdRequest request, std::function<void(AsyncDescribeCountersByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::increaseCounterByUserId(IncreaseCounterByUserIdRequest request, std::function<void(AsyncIncreaseCounterByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getCounter(GetCounterRequest request, std::function<void(AsyncGetCounterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getCounterByUserId(GetCounterByUserIdRequest request, std::function<void(AsyncGetCounterByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::deleteCounterByUserId(DeleteCounterByUserIdRequest request, std::function<void(AsyncDeleteCounterByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::increaseByStampSheet(IncreaseByStampSheetRequest request, std::function<void(AsyncIncreaseByStampSheetResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeMissionTaskModelMasters(DescribeMissionTaskModelMastersRequest request, std::function<void(AsyncDescribeMissionTaskModelMastersResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::createMissionTaskModelMaster(CreateMissionTaskModelMasterRequest request, std::function<void(AsyncCreateMissionTaskModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getMissionTaskModelMaster(GetMissionTaskModelMasterRequest request, std::function<void(AsyncGetMissionTaskModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::updateMissionTaskModelMaster(UpdateMissionTaskModelMasterRequest request, std::function<void(AsyncUpdateMissionTaskModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::deleteMissionTaskModelMaster(DeleteMissionTaskModelMasterRequest request, std::function<void(AsyncDeleteMissionTaskModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::exportMaster(ExportMasterRequest request, std::function<void(AsyncExportMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getCurrentMissionMaster(GetCurrentMissionMasterRequest request, std::function<void(AsyncGetCurrentMissionMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::updateCurrentMissionMaster(UpdateCurrentMissionMasterRequest request, std::function<void(AsyncUpdateCurrentMissionMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::updateCurrentMissionMasterFromGitHub(UpdateCurrentMissionMasterFromGitHubRequest request, std::function<void(AsyncUpdateCurrentMissionMasterFromGitHubResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeCompletes(DescribeCompletesRequest request, std::function<void(AsyncDescribeCompletesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeCompletesByUserId(DescribeCompletesByUserIdRequest request, std::function<void(AsyncDescribeCompletesByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::complete(CompleteRequest request, std::function<void(AsyncCompleteResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::completeByUserId(CompleteByUserIdRequest request, std::function<void(AsyncCompleteByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::receiveByUserId(ReceiveByUserIdRequest request, std::function<void(AsyncReceiveByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getComplete(GetCompleteRequest request, std::function<void(AsyncGetCompleteResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getCompleteByUserId(GetCompleteByUserIdRequest request, std::function<void(AsyncGetCompleteByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::deleteCompleteByUserId(DeleteCompleteByUserIdRequest request, std::function<void(AsyncDeleteCompleteByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::receiveByStampTask(ReceiveByStampTaskRequest request, std::function<void(AsyncReceiveByStampTaskResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeCounterModelMasters(DescribeCounterModelMastersRequest request, std::function<void(AsyncDescribeCounterModelMastersResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::createCounterModelMaster(CreateCounterModelMasterRequest request, std::function<void(AsyncCreateCounterModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getCounterModelMaster(GetCounterModelMasterRequest request, std::function<void(AsyncGetCounterModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::updateCounterModelMaster(UpdateCounterModelMasterRequest request, std::function<void(AsyncUpdateCounterModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::deleteCounterModelMaster(DeleteCounterModelMasterRequest request, std::function<void(AsyncDeleteCounterModelMasterResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeCounterModels(DescribeCounterModelsRequest request, std::function<void(AsyncDescribeCounterModelsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getCounterModel(GetCounterModelRequest request, std::function<void(AsyncGetCounterModelResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeMissionGroupModels(DescribeMissionGroupModelsRequest request, std::function<void(AsyncDescribeMissionGroupModelsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getMissionGroupModel(GetMissionGroupModelRequest request, std::function<void(AsyncGetMissionGroupModelResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::describeMissionTaskModels(DescribeMissionTaskModelsRequest request, std::function<void(AsyncDescribeMissionTaskModelsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MissionWebSocketClient::getMissionTaskModel(GetMissionTaskModelRequest request, std::function<void(AsyncGetMissionTaskModelResult)> callback)
{
