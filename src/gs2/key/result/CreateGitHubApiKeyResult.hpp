...
public:
    CreateGitHubApiKeyResult() = default;
    CreateGitHubApiKeyResult(const CreateGitHubApiKeyResult& createGitHubApiKeyResult) = default;
    CreateGitHubApiKeyResult(CreateGitHubApiKeyResult&& createGitHubApiKeyResult) = default;
    ~CreateGitHubApiKeyResult() = default;

    CreateGitHubApiKeyResult& operator=(const CreateGitHubApiKeyResult& createGitHubApiKeyResult) = default;
    CreateGitHubApiKeyResult& operator=(CreateGitHubApiKeyResult&& createGitHubApiKeyResult) = default;

    CreateGitHubApiKeyResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateGitHubApiKeyResult);
    }
     ...
     */
    void setItem(GitHubApiKey item)
    {
