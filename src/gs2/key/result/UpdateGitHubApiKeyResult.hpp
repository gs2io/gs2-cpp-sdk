...
public:
    UpdateGitHubApiKeyResult() = default;
    UpdateGitHubApiKeyResult(const UpdateGitHubApiKeyResult& updateGitHubApiKeyResult) = default;
    UpdateGitHubApiKeyResult(UpdateGitHubApiKeyResult&& updateGitHubApiKeyResult) = default;
    ~UpdateGitHubApiKeyResult() = default;

    UpdateGitHubApiKeyResult& operator=(const UpdateGitHubApiKeyResult& updateGitHubApiKeyResult) = default;
    UpdateGitHubApiKeyResult& operator=(UpdateGitHubApiKeyResult&& updateGitHubApiKeyResult) = default;

    UpdateGitHubApiKeyResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateGitHubApiKeyResult);
    }
