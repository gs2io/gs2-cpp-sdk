 ...
 */
void Gs2KeyWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::describeKeys(DescribeKeysRequest request, std::function<void(AsyncDescribeKeysResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::createKey(CreateKeyRequest request, std::function<void(AsyncCreateKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::updateKey(UpdateKeyRequest request, std::function<void(AsyncUpdateKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::getKey(GetKeyRequest request, std::function<void(AsyncGetKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::deleteKey(DeleteKeyRequest request, std::function<void(AsyncDeleteKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::encrypt(EncryptRequest request, std::function<void(AsyncEncryptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::decrypt(DecryptRequest request, std::function<void(AsyncDecryptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::describeGitHubApiKeys(DescribeGitHubApiKeysRequest request, std::function<void(AsyncDescribeGitHubApiKeysResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::createGitHubApiKey(CreateGitHubApiKeyRequest request, std::function<void(AsyncCreateGitHubApiKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::updateGitHubApiKey(UpdateGitHubApiKeyRequest request, std::function<void(AsyncUpdateGitHubApiKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::getGitHubApiKey(GetGitHubApiKeyRequest request, std::function<void(AsyncGetGitHubApiKeyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2KeyWebSocketClient::deleteGitHubApiKey(DeleteGitHubApiKeyRequest request, std::function<void(AsyncDeleteGitHubApiKeyResult)> callback)
{
