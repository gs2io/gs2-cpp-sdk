...
#ifndef GS2_KEY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_KEY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Key
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Key::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Key::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_KEY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_