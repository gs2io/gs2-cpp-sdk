...
#ifndef GS2_KEY_CONTROL_CREATENAMESPACEREQUEST_HPP_
#define GS2_KEY_CONTROL_CREATENAMESPACEREQUEST_HPP_
 ...
 */
class CreateNamespaceRequest : public Gs2BasicRequest, public Gs2Key
{
public:
...
public:
    ...
    CreateNamespaceRequest& operator=(const CreateNamespaceRequest& createNamespaceRequest)
    {
        ...
        Gs2Key::operator=(createNamespaceRequest);
    ...
    CreateNamespaceRequest& operator=(CreateNamespaceRequest&& createNamespaceRequest)
    {
        ...
        Gs2Key::operator=(std::move(createNamespaceRequest));
...
#endif //GS2_KEY_CONTROL_CREATENAMESPACEREQUEST_HPP_