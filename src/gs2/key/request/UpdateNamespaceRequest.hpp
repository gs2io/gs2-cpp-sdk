...
#ifndef GS2_KEY_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_KEY_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Key
{
public:
...
public:
    ...
    UpdateNamespaceRequest& operator=(const UpdateNamespaceRequest& updateNamespaceRequest)
    {
        ...
        Gs2Key::operator=(updateNamespaceRequest);
    ...
    UpdateNamespaceRequest& operator=(UpdateNamespaceRequest&& updateNamespaceRequest)
    {
        ...
        Gs2Key::operator=(std::move(updateNamespaceRequest));
...
#endif //GS2_KEY_CONTROL_UPDATENAMESPACEREQUEST_HPP_