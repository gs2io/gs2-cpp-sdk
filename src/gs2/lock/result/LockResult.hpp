...
public:
    LockResult() = default;
    LockResult(const LockResult& lockResult) = default;
    LockResult(LockResult&& lockResult) = default;
    ~LockResult() = default;

    LockResult& operator=(const LockResult& lockResult) = default;
    LockResult& operator=(LockResult&& lockResult) = default;

    LockResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(LockResult);
    }
