...
#ifndef GS2_LOCK_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_LOCK_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Lock
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Lock::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Lock::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_LOCK_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_