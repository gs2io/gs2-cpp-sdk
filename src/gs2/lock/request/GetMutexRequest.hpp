 ...
 */
class GetMutexRequest : public Gs2UserRequest, public Gs2Lock
{
public:
...
public:
    ...
    {
        Gs2UserRequest::operator=(getMutexRequest);
    ...
    {
        Gs2UserRequest::operator=(std::move(getMutexRequest));
     ...
     * @param categoryName カテゴリ名
     */
    GetMutexRequest& withCategoryName(const Char* categoryName)
    {
        ensureData().categoryName.emplace(categoryName);
        return *this;
    }
