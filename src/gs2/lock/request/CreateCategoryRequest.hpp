...
#ifndef GS2_LOCK_CONTROL_CREATECATEGORYREQUEST_HPP_
#define GS2_LOCK_CONTROL_CREATECATEGORYREQUEST_HPP_
 ...
 */
class CreateCategoryRequest : public Gs2BasicRequest, public Gs2Lock
{
public:
...
public:
    ...
    CreateCategoryRequest& operator=(const CreateCategoryRequest& createCategoryRequest)
    {
        ...
        Gs2Lock::operator=(createCategoryRequest);
    ...
    CreateCategoryRequest& operator=(CreateCategoryRequest&& createCategoryRequest)
    {
        ...
        Gs2Lock::operator=(std::move(createCategoryRequest));
...
#endif //GS2_LOCK_CONTROL_CREATECATEGORYREQUEST_HPP_