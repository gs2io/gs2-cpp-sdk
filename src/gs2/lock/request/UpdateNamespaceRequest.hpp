...
#ifndef GS2_LOCK_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_LOCK_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Lock
{
public:
...
public:
    ...
    UpdateNamespaceRequest& operator=(const UpdateNamespaceRequest& updateNamespaceRequest)
    {
        ...
        Gs2Lock::operator=(updateNamespaceRequest);
    ...
    UpdateNamespaceRequest& operator=(UpdateNamespaceRequest&& updateNamespaceRequest)
    {
        ...
        Gs2Lock::operator=(std::move(updateNamespaceRequest));
...
#endif //GS2_LOCK_CONTROL_UPDATENAMESPACEREQUEST_HPP_