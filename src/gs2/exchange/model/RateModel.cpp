...
RateModel::Data::Data(const Data& data) :
...
void RateModel::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RateModel RateModel::deepCopy() const
{
