...
CurrentRateMaster::Data::Data(const Data& data) :
...
void CurrentRateMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentRateMaster CurrentRateMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentRateMaster);
}
