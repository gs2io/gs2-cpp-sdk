...
#include "ExchangeResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace exchange
{

ExchangeResult::Data::Data(const Data& data) :
...
void ExchangeResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ExchangeResult ExchangeResult::deepCopy() const
{
