...
#ifndef GS2_EXCHANGE_CONTROL_ACQUIRERESULT_HPP_
#define GS2_EXCHANGE_CONTROL_ACQUIRERESULT_HPP_
 ...
 */
class AcquireResult : public Gs2Object
{
private:
...
public:
    ...
    AcquireResult(const AcquireResult& acquireResult) = default;
    AcquireResult(AcquireResult&& acquireResult) = default;
    ~AcquireResult() = default;

    AcquireResult& operator=(const AcquireResult& acquireResult) = default;
    AcquireResult& operator=(AcquireResult&& acquireResult) = default;

    AcquireResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(AcquireResult);
    }

    const AcquireResult* operator->() const
    {
        return this;
    }

    AcquireResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<AcquireResult> AsyncAcquireResult;

} }

#endif //GS2_EXCHANGE_CONTROL_ACQUIRERESULT_HPP_