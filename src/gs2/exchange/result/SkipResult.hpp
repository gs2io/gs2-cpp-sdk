...
#ifndef GS2_EXCHANGE_CONTROL_SKIPRESULT_HPP_
#define GS2_EXCHANGE_CONTROL_SKIPRESULT_HPP_
 ...
 */
class SkipResult : public Gs2Object
{
private:
...
public:
    SkipResult() = default;
    SkipResult(const SkipResult& skipResult) = default;
    SkipResult(SkipResult&& skipResult) = default;
    ~SkipResult() = default;

    SkipResult& operator=(const SkipResult& skipResult) = default;
    SkipResult& operator=(SkipResult&& skipResult) = default;

    SkipResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SkipResult);
    }

    const SkipResult* operator->() const
    {
        return this;
    }
...
typedef AsyncResult<SkipResult> AsyncSkipResult;

} }

#endif //GS2_EXCHANGE_CONTROL_SKIPRESULT_HPP_