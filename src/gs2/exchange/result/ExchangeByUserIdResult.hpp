...
#ifndef GS2_EXCHANGE_CONTROL_EXCHANGEBYUSERIDRESULT_HPP_
#define GS2_EXCHANGE_CONTROL_EXCHANGEBYUSERIDRESULT_HPP_
 ...
 */
class ExchangeByUserIdResult : public Gs2Object
{
private:
...
public:
    ExchangeByUserIdResult() = default;
    ExchangeByUserIdResult(const ExchangeByUserIdResult& exchangeByUserIdResult) = default;
    ExchangeByUserIdResult(ExchangeByUserIdResult&& exchangeByUserIdResult) = default;
    ~ExchangeByUserIdResult() = default;

    ExchangeByUserIdResult& operator=(const ExchangeByUserIdResult& exchangeByUserIdResult) = default;
    ExchangeByUserIdResult& operator=(ExchangeByUserIdResult&& exchangeByUserIdResult) = default;

    ExchangeByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(ExchangeByUserIdResult);
    }

    const ExchangeByUserIdResult* operator->() const
    {
        return this;
    }

    ExchangeByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<ExchangeByUserIdResult> AsyncExchangeByUserIdResult;

} }

#endif //GS2_EXCHANGE_CONTROL_EXCHANGEBYUSERIDRESULT_HPP_