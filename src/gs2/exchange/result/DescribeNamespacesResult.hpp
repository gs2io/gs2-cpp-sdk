...
#ifndef GS2_EXCHANGE_CONTROL_DESCRIBENAMESPACESRESULT_HPP_
#define GS2_EXCHANGE_CONTROL_DESCRIBENAMESPACESRESULT_HPP_
...
#endif //GS2_EXCHANGE_CONTROL_DESCRIBENAMESPACESRESULT_HPP_