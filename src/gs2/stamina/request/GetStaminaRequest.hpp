...
public:
    ...
    {
        Gs2BasicRequest::operator=(getStaminaRequest);
    ...
    {
        Gs2BasicRequest::operator=(std::move(getStaminaRequest));
     ...
     * @param namespaceName ネームスペース名
     */
    GetStaminaRequest& withNamespaceName(const Char* namespaceName)
    {
        ensureData().namespaceName.emplace(namespaceName);
        return *this;
    }
     ...
     * @param staminaName スタミナの種類名
     */
    GetStaminaRequest& withStaminaName(const Char* staminaName)
    {
        ensureData().staminaName.emplace(staminaName);
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    GetStaminaRequest& withDuplicationAvoider(const Char* duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(duplicationAvoider);
        return *this;
    }
