...
public:
     ...
     * @param groupName スタミナの種類名
     */
    RaiseMaxValueByUserIdRequest& withGroupName(const Char* groupName)
    {
        ensureData().groupName.emplace(groupName);
        return *this;
    }
     ...
     * @param staminaModelName スタミナの種類名
     */
    RaiseMaxValueByUserIdRequest& withStaminaModelName(const Char* staminaModelName)
    {
        ensureData().staminaModelName.emplace(staminaModelName);
        return *this;
    }
