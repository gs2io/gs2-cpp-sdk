...
#ifndef GS2_STAMINA_CONTROL_DELETEGROUPREQUEST_HPP_
#define GS2_STAMINA_CONTROL_DELETEGROUPREQUEST_HPP_
...
/**
 * スタミナの種類を削除 のリクエストモデル
 *
 * @author Game Server Services, Inc.
 */
class DeleteGroupRequest : public Gs2BasicRequest, public Gs2Stamina
{
public:
...
public:
    ...
    DeleteGroupRequest& operator=(const DeleteGroupRequest& deleteGroupRequest)
    {
        ...
        Gs2Stamina::operator=(deleteGroupRequest);
    ...
    DeleteGroupRequest& operator=(DeleteGroupRequest&& deleteGroupRequest)
    {
        ...
        Gs2Stamina::operator=(std::move(deleteGroupRequest));
...
#endif //GS2_STAMINA_CONTROL_DELETEGROUPREQUEST_HPP_