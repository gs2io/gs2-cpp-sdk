 ...
 */
class SetMaxValueByStatusRequest : public Gs2UserRequest, public Gs2Stamina
{
public:
...
public:
    ...
    {
        Gs2UserRequest::operator=(setMaxValueByStatusRequest);
    ...
    {
        Gs2UserRequest::operator=(std::move(setMaxValueByStatusRequest));
     ...
     * @param groupName スタミナの種類名
     */
    SetMaxValueByStatusRequest& withGroupName(const Char* groupName)
    {
        ensureData().groupName.emplace(groupName);
        return *this;
    }
     ...
     * @param staminaModelName スタミナの種類名
     */
    SetMaxValueByStatusRequest& withStaminaModelName(const Char* staminaModelName)
    {
        ensureData().staminaModelName.emplace(staminaModelName);
        return *this;
    }
