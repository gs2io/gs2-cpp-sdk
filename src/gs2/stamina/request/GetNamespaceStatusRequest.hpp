...
#ifndef GS2_STAMINA_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_STAMINA_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Stamina
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Stamina::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Stamina::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_STAMINA_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_