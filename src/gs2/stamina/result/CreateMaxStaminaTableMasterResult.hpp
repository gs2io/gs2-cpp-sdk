...
public:
    CreateMaxStaminaTableMasterResult() = default;
    CreateMaxStaminaTableMasterResult(const CreateMaxStaminaTableMasterResult& createMaxStaminaTableMasterResult) = default;
    CreateMaxStaminaTableMasterResult(CreateMaxStaminaTableMasterResult&& createMaxStaminaTableMasterResult) = default;
    ~CreateMaxStaminaTableMasterResult() = default;

    CreateMaxStaminaTableMasterResult& operator=(const CreateMaxStaminaTableMasterResult& createMaxStaminaTableMasterResult) = default;
    CreateMaxStaminaTableMasterResult& operator=(CreateMaxStaminaTableMasterResult&& createMaxStaminaTableMasterResult) = default;

    CreateMaxStaminaTableMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateMaxStaminaTableMasterResult);
    }
