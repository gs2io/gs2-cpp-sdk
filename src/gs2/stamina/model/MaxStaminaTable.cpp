...
MaxStaminaTable::Data::Data(const Data& data) :
...
void MaxStaminaTable::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
MaxStaminaTable MaxStaminaTable::deepCopy() const
{
