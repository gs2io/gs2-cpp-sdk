...
CurrentStaminaMaster::Data::Data(const Data& data) :
...
void CurrentStaminaMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentStaminaMaster CurrentStaminaMaster::deepCopy() const
{
