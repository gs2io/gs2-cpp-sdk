...
public:
    CurrentStaminaMaster() = default;
    CurrentStaminaMaster(const CurrentStaminaMaster& currentStaminaMaster) = default;
    CurrentStaminaMaster(CurrentStaminaMaster&& currentStaminaMaster) = default;
    ~CurrentStaminaMaster() = default;

    CurrentStaminaMaster& operator=(const CurrentStaminaMaster& currentStaminaMaster) = default;
    CurrentStaminaMaster& operator=(CurrentStaminaMaster&& currentStaminaMaster) = default;

    CurrentStaminaMaster deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentStaminaMaster);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    CurrentStaminaMaster& withNamespaceName(StringHolder namespaceName)
    {
     ...
     * @param settings マスターデータ
     */
    CurrentStaminaMaster& withSettings(StringHolder settings)
    {
...
inline bool operator!=(const CurrentStaminaMaster& lhs, const CurrentStaminaMaster& lhr)
{
