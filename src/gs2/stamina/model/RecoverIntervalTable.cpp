...
RecoverIntervalTable::Data::Data(const Data& data) :
...
void RecoverIntervalTable::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RecoverIntervalTable RecoverIntervalTable::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(RecoverIntervalTable);
}
