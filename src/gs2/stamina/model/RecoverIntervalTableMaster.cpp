...
RecoverIntervalTableMaster::Data::Data(const Data& data) :
...
void RecoverIntervalTableMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RecoverIntervalTableMaster RecoverIntervalTableMaster::deepCopy() const
{
