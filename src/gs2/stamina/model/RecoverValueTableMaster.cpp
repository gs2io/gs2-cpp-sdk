...
RecoverValueTableMaster::Data::Data(const Data& data) :
...
void RecoverValueTableMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RecoverValueTableMaster RecoverValueTableMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(RecoverValueTableMaster);
}
