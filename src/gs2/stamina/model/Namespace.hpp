...
#ifndef GS2_STAMINA_MODEL_NAMESPACE_HPP_
#define GS2_STAMINA_MODEL_NAMESPACE_HPP_
...
private:
    ...
    public:
        ...
        virtual void set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
        {
            ...
            else if (std::strcmp(name_, "overflowTriggerNamespaceId") == 0)
            {
                if (jsonValue.IsString())
                {
                    this->overflowTriggerNamespaceId.emplace(jsonValue.GetString());
                }
            }
...
public:
     ...
     * @param overflowTriggerScriptId スタミナオーバーフロー上限に当たって回復できなかったスタミナを通知する スクリプト のGRN
     */
    Namespace& withOverflowTriggerScriptId(StringHolder overflowTriggerScriptId)
    {
        setOverflowTriggerScriptId(std::move(overflowTriggerScriptId));
        return *this;
    }
     ...
     * @param overflowTriggerNamespaceId スタミナオーバーフロー上限に当たって回復できなかったスタミナを追加する ネームスペース のGRN
     */
    Namespace& withOverflowTriggerNamespaceId(StringHolder overflowTriggerNamespaceId)
    {
        setOverflowTriggerNamespaceId(std::move(overflowTriggerNamespaceId));
        return *this;
    }
...
inline bool operator!=(const Namespace& lhs, const Namespace& lhr)
{
    if (lhs.m_pData != lhr.m_pData)
    {
        ...
        if (lhs.m_pData->overflowTriggerNamespaceId != lhr.m_pData->overflowTriggerNamespaceId)
        {
            return true;
        }
...
#endif //GS2_STAMINA_MODEL_NAMESPACE_HPP_