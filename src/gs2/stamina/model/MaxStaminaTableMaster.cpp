...
MaxStaminaTableMaster::Data::Data(const Data& data) :
...
void MaxStaminaTableMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
MaxStaminaTableMaster MaxStaminaTableMaster::deepCopy() const
{
