 ...
 */
void Gs2MoneyRestClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::describeWallets(DescribeWalletsRequest request, std::function<void(AsyncDescribeWalletsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::describeWalletsByUserId(DescribeWalletsByUserIdRequest request, std::function<void(AsyncDescribeWalletsByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::queryWallets(QueryWalletsRequest request, std::function<void(AsyncQueryWalletsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::getWallet(GetWalletRequest request, std::function<void(AsyncGetWalletResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::getWalletByUserId(GetWalletByUserIdRequest request, std::function<void(AsyncGetWalletByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::depositByUserId(DepositByUserIdRequest request, std::function<void(AsyncDepositByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::withdraw(WithdrawRequest request, std::function<void(AsyncWithdrawResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::withdrawByUserId(WithdrawByUserIdRequest request, std::function<void(AsyncWithdrawByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::depositByStampSheet(DepositByStampSheetRequest request, std::function<void(AsyncDepositByStampSheetResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::withdrawByStampTask(WithdrawByStampTaskRequest request, std::function<void(AsyncWithdrawByStampTaskResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::describeWalletDetailsByUserId(DescribeWalletDetailsByUserIdRequest request, std::function<void(AsyncDescribeWalletDetailsByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::describeReceipts(DescribeReceiptsRequest request, std::function<void(AsyncDescribeReceiptsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::getByUserIdAndTransactionId(GetByUserIdAndTransactionIdRequest request, std::function<void(AsyncGetByUserIdAndTransactionIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::recordReceipt(RecordReceiptRequest request, std::function<void(AsyncRecordReceiptResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2MoneyRestClient::recordReceiptByStampTask(RecordReceiptByStampTaskRequest request, std::function<void(AsyncRecordReceiptByStampTaskResult)> callback)
{
