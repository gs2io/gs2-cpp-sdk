...
#ifndef GS2_MONEY_CONTROL_DESCRIBEITEMREQUEST_HPP_
#define GS2_MONEY_CONTROL_DESCRIBEITEMREQUEST_HPP_
 ...
 */
class DescribeItemRequest : public Gs2BasicRequest, public Gs2Money
{
public:
...
public:
    ...
    {
        Gs2BasicRequest::operator=(describeItemRequest);
        Gs2Money::operator=(describeItemRequest);
    ...
    {
        Gs2BasicRequest::operator=(std::move(describeItemRequest));
        Gs2Money::operator=(std::move(describeItemRequest));
    ...
    const DescribeItemRequest* operator->() const
    {
        return this;
    }

    DescribeItemRequest* operator->()
    {
        return this;
    }
     ...
     * @param moneyName 課金通貨の名前
     */
    DescribeItemRequest& withMoneyName(const Char* moneyName)
    {
        ensureData().moneyName.emplace(moneyName);
        return *this;
    }
     ...
     * @param pageToken データの取得を開始する位置を指定するトークン
     */
    DescribeItemRequest& withPageToken(const Char* pageToken)
    {
        ensureData().pageToken.emplace(pageToken);
        return *this;
    }
     ...
     * @param limit データの取得件数
     */
    DescribeItemRequest& withLimit(Int32 limit)
    {
        ensureData().limit.emplace(limit);
        return *this;
    }
...
#endif //GS2_MONEY_CONTROL_DESCRIBEITEMREQUEST_HPP_