...
public:
    QueryWalletsResult() = default;
    QueryWalletsResult(const QueryWalletsResult& queryWalletsResult) = default;
    QueryWalletsResult(QueryWalletsResult&& queryWalletsResult) = default;
    ~QueryWalletsResult() = default;

    QueryWalletsResult& operator=(const QueryWalletsResult& queryWalletsResult) = default;
    QueryWalletsResult& operator=(QueryWalletsResult&& queryWalletsResult) = default;

    QueryWalletsResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(QueryWalletsResult);
    }
