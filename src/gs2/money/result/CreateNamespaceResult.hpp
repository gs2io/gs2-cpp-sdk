...
#ifndef GS2_MONEY_CONTROL_CREATENAMESPACERESULT_HPP_
#define GS2_MONEY_CONTROL_CREATENAMESPACERESULT_HPP_
...
#endif //GS2_MONEY_CONTROL_CREATENAMESPACERESULT_HPP_