...
public:
    DescribeWalletsByUserIdResult() = default;
    DescribeWalletsByUserIdResult(const DescribeWalletsByUserIdResult& describeWalletsByUserIdResult) = default;
    DescribeWalletsByUserIdResult(DescribeWalletsByUserIdResult&& describeWalletsByUserIdResult) = default;
    ~DescribeWalletsByUserIdResult() = default;

    DescribeWalletsByUserIdResult& operator=(const DescribeWalletsByUserIdResult& describeWalletsByUserIdResult) = default;
    DescribeWalletsByUserIdResult& operator=(DescribeWalletsByUserIdResult&& describeWalletsByUserIdResult) = default;

    DescribeWalletsByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeWalletsByUserIdResult);
    }
