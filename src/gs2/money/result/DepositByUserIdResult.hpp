...
public:
    DepositByUserIdResult() = default;
    DepositByUserIdResult(const DepositByUserIdResult& depositByUserIdResult) = default;
    DepositByUserIdResult(DepositByUserIdResult&& depositByUserIdResult) = default;
    ~DepositByUserIdResult() = default;

    DepositByUserIdResult& operator=(const DepositByUserIdResult& depositByUserIdResult) = default;
    DepositByUserIdResult& operator=(DepositByUserIdResult&& depositByUserIdResult) = default;

    DepositByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DepositByUserIdResult);
    }
