...
#ifndef GS2_DATASTORE_CONTROL_PREPAREDOWNLOADRESULT_HPP_
#define GS2_DATASTORE_CONTROL_PREPAREDOWNLOADRESULT_HPP_
 ...
 */
class PrepareDownloadResult : public Gs2Object
{
private:
...
public:
    PrepareDownloadResult() = default;
    PrepareDownloadResult(const PrepareDownloadResult& prepareDownloadResult) = default;
    PrepareDownloadResult(PrepareDownloadResult&& prepareDownloadResult) = default;
    ~PrepareDownloadResult() = default;

    PrepareDownloadResult& operator=(const PrepareDownloadResult& prepareDownloadResult) = default;
    PrepareDownloadResult& operator=(PrepareDownloadResult&& prepareDownloadResult) = default;

    PrepareDownloadResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(PrepareDownloadResult);
    }

    const PrepareDownloadResult* operator->() const
    {
        return this;
    }

    PrepareDownloadResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<PrepareDownloadResult> AsyncPrepareDownloadResult;

} }

#endif //GS2_DATASTORE_CONTROL_PREPAREDOWNLOADRESULT_HPP_