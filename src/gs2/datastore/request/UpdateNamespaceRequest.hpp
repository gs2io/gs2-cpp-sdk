...
#ifndef GS2_DATASTORE_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_DATASTORE_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Datastore
{
public:
...
public:
     ...
     * @param doneUploadScript アップロード完了報告時に実行するスクリプト
     */
    UpdateNamespaceRequest& withDoneUploadScript(ScriptSetting doneUploadScript)
    {
        ensureData().doneUploadScript.emplace(std::move(doneUploadScript));
        return *this;
    }
...
#endif //GS2_DATASTORE_CONTROL_UPDATENAMESPACEREQUEST_HPP_