...
public:
    SetRankCapByUserIdRequest() = default;
    SetRankCapByUserIdRequest(const SetRankCapByUserIdRequest& setRankCapByUserIdRequest) = default;
    SetRankCapByUserIdRequest(SetRankCapByUserIdRequest&& setRankCapByUserIdRequest) = default;
    ~SetRankCapByUserIdRequest() GS2_OVERRIDE = default;

    SetRankCapByUserIdRequest& operator=(const SetRankCapByUserIdRequest& setRankCapByUserIdRequest) = default;
    SetRankCapByUserIdRequest& operator=(SetRankCapByUserIdRequest&& setRankCapByUserIdRequest) = default;

    SetRankCapByUserIdRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SetRankCapByUserIdRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    SetRankCapByUserIdRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    SetRankCapByUserIdRequest& withUserId(StringHolder userId)
    {
        ensureData().userId.emplace(std::move(userId));
        return *this;
    }
     ...
     * @param experienceName 経験値の種類の名前
     */
    SetRankCapByUserIdRequest& withExperienceName(StringHolder experienceName)
    {
        ensureData().experienceName.emplace(std::move(experienceName));
        return *this;
    }
     ...
     * @param propertyId プロパティID
     */
    SetRankCapByUserIdRequest& withPropertyId(StringHolder propertyId)
    {
        ensureData().propertyId.emplace(std::move(propertyId));
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    SetRankCapByUserIdRequest& withDuplicationAvoider(StringHolder duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(std::move(duplicationAvoider));
        return *this;
    }
     ...
     */
    SetRankCapByUserIdRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    SetRankCapByUserIdRequest& withRequestId(StringHolder gs2RequestId)
    {
