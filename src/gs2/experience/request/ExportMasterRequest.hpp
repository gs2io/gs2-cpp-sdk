...
/**
 * 経験値マスターJSONのマスターデータをエクスポートします のリクエストモデル
 *
...
public:
    ...
    ExportMasterRequest& operator=(const ExportMasterRequest& exportMasterRequest)
    {
        ...
        Gs2Experience::operator=(exportMasterRequest);
    ...
    ExportMasterRequest& operator=(ExportMasterRequest&& exportMasterRequest)
    {
        ...
        Gs2Experience::operator=(std::move(exportMasterRequest));
     ...
     * @param experienceName 経験値名
     */
    ExportMasterRequest& withExperienceName(const Char* experienceName)
    {
        ensureData().experienceName.emplace(experienceName);
        return *this;
    }
