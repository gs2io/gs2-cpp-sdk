...
public:
    UpdateThresholdMasterRequest() = default;
    UpdateThresholdMasterRequest(const UpdateThresholdMasterRequest& updateThresholdMasterRequest) = default;
    UpdateThresholdMasterRequest(UpdateThresholdMasterRequest&& updateThresholdMasterRequest) = default;
    ~UpdateThresholdMasterRequest() GS2_OVERRIDE = default;

    UpdateThresholdMasterRequest& operator=(const UpdateThresholdMasterRequest& updateThresholdMasterRequest) = default;
    UpdateThresholdMasterRequest& operator=(UpdateThresholdMasterRequest&& updateThresholdMasterRequest) = default;

    UpdateThresholdMasterRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateThresholdMasterRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    UpdateThresholdMasterRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param thresholdName ランクアップ閾値名
     */
    UpdateThresholdMasterRequest& withThresholdName(StringHolder thresholdName)
    {
        ensureData().thresholdName.emplace(std::move(thresholdName));
        return *this;
    }
     ...
     * @param description ランクアップ閾値マスターの説明
     */
    UpdateThresholdMasterRequest& withDescription(StringHolder description)
    {
        ensureData().description.emplace(std::move(description));
        return *this;
    }
     ...
     * @param metadata ランクアップ閾値のメタデータ
     */
    UpdateThresholdMasterRequest& withMetadata(StringHolder metadata)
    {
        ensureData().metadata.emplace(std::move(metadata));
        return *this;
    }
     ...
     * @param values ランクアップ経験値閾値リスト
     */
    UpdateThresholdMasterRequest& withValues(List<Int64> values)
    {
        ensureData().values.emplace(std::move(values));
        return *this;
    }
     ...
     */
    UpdateThresholdMasterRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    UpdateThresholdMasterRequest& withRequestId(StringHolder gs2RequestId)
    {
