...
#ifndef GS2_EXPERIENCE_CONTROL_DESCRIBEEXPERIENCEMODELMASTERSREQUEST_HPP_
#define GS2_EXPERIENCE_CONTROL_DESCRIBEEXPERIENCEMODELMASTERSREQUEST_HPP_
 ...
 */
class DescribeExperienceModelMastersRequest : public Gs2BasicRequest, public Gs2Experience
{
public:
...
public:
    ...
    DescribeExperienceModelMastersRequest* operator->()
    {
        return this;
    }
    /**
     ...
     * @param experienceName 経験値名
     */
    DescribeExperienceModelMastersRequest& withExperienceName(const Char* experienceName)
    {
        ensureData().experienceName.emplace(experienceName);
        return *this;
    }
     ...
     * @param limit データの取得件数
     */
    DescribeExperienceModelMastersRequest& withLimit(Int64 limit)
    {
        ensureData().limit.emplace(limit);
        return *this;
    }
...
#endif //GS2_EXPERIENCE_CONTROL_DESCRIBEEXPERIENCEMODELMASTERSREQUEST_HPP_