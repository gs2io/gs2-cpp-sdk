...
public:
    SetExperienceByUserIdRequest() = default;
    SetExperienceByUserIdRequest(const SetExperienceByUserIdRequest& setExperienceByUserIdRequest) = default;
    SetExperienceByUserIdRequest(SetExperienceByUserIdRequest&& setExperienceByUserIdRequest) = default;
    ~SetExperienceByUserIdRequest() GS2_OVERRIDE = default;

    SetExperienceByUserIdRequest& operator=(const SetExperienceByUserIdRequest& setExperienceByUserIdRequest) = default;
    SetExperienceByUserIdRequest& operator=(SetExperienceByUserIdRequest&& setExperienceByUserIdRequest) = default;

    SetExperienceByUserIdRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SetExperienceByUserIdRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    SetExperienceByUserIdRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    SetExperienceByUserIdRequest& withUserId(StringHolder userId)
    {
        ensureData().userId.emplace(std::move(userId));
        return *this;
    }
     ...
     * @param experienceName 経験値の種類の名前
     */
    SetExperienceByUserIdRequest& withExperienceName(StringHolder experienceName)
    {
        ensureData().experienceName.emplace(std::move(experienceName));
        return *this;
    }
     ...
     * @param propertyId プロパティID
     */
    SetExperienceByUserIdRequest& withPropertyId(StringHolder propertyId)
    {
        ensureData().propertyId.emplace(std::move(propertyId));
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    SetExperienceByUserIdRequest& withDuplicationAvoider(StringHolder duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(std::move(duplicationAvoider));
        return *this;
    }
     ...
     */
    SetExperienceByUserIdRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    SetExperienceByUserIdRequest& withRequestId(StringHolder gs2RequestId)
    {
