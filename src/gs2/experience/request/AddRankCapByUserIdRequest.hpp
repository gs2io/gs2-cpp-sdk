...
public:
    AddRankCapByUserIdRequest() = default;
    AddRankCapByUserIdRequest(const AddRankCapByUserIdRequest& addRankCapByUserIdRequest) = default;
    AddRankCapByUserIdRequest(AddRankCapByUserIdRequest&& addRankCapByUserIdRequest) = default;
    ~AddRankCapByUserIdRequest() GS2_OVERRIDE = default;

    AddRankCapByUserIdRequest& operator=(const AddRankCapByUserIdRequest& addRankCapByUserIdRequest) = default;
    AddRankCapByUserIdRequest& operator=(AddRankCapByUserIdRequest&& addRankCapByUserIdRequest) = default;

    AddRankCapByUserIdRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(AddRankCapByUserIdRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    AddRankCapByUserIdRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    AddRankCapByUserIdRequest& withUserId(StringHolder userId)
    {
        ensureData().userId.emplace(std::move(userId));
        return *this;
    }
     ...
     * @param experienceName 経験値の種類の名前
     */
    AddRankCapByUserIdRequest& withExperienceName(StringHolder experienceName)
    {
        ensureData().experienceName.emplace(std::move(experienceName));
        return *this;
    }
     ...
     * @param propertyId プロパティID
     */
    AddRankCapByUserIdRequest& withPropertyId(StringHolder propertyId)
    {
        ensureData().propertyId.emplace(std::move(propertyId));
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    AddRankCapByUserIdRequest& withDuplicationAvoider(StringHolder duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(std::move(duplicationAvoider));
        return *this;
    }
     ...
     */
    AddRankCapByUserIdRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    AddRankCapByUserIdRequest& withRequestId(StringHolder gs2RequestId)
    {
