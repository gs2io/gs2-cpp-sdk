...
public:
    GetThresholdMasterResult() = default;
    GetThresholdMasterResult(const GetThresholdMasterResult& getThresholdMasterResult) = default;
    GetThresholdMasterResult(GetThresholdMasterResult&& getThresholdMasterResult) = default;
    ~GetThresholdMasterResult() = default;

    GetThresholdMasterResult& operator=(const GetThresholdMasterResult& getThresholdMasterResult) = default;
    GetThresholdMasterResult& operator=(GetThresholdMasterResult&& getThresholdMasterResult) = default;

    GetThresholdMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetThresholdMasterResult);
    }
