...
public:
    UpdateExperienceModelMasterResult() = default;
    UpdateExperienceModelMasterResult(const UpdateExperienceModelMasterResult& updateExperienceModelMasterResult) = default;
    UpdateExperienceModelMasterResult(UpdateExperienceModelMasterResult&& updateExperienceModelMasterResult) = default;
    ~UpdateExperienceModelMasterResult() = default;

    UpdateExperienceModelMasterResult& operator=(const UpdateExperienceModelMasterResult& updateExperienceModelMasterResult) = default;
    UpdateExperienceModelMasterResult& operator=(UpdateExperienceModelMasterResult&& updateExperienceModelMasterResult) = default;

    UpdateExperienceModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateExperienceModelMasterResult);
    }
