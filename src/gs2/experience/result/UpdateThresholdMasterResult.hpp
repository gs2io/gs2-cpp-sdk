...
public:
    UpdateThresholdMasterResult() = default;
    UpdateThresholdMasterResult(const UpdateThresholdMasterResult& updateThresholdMasterResult) = default;
    UpdateThresholdMasterResult(UpdateThresholdMasterResult&& updateThresholdMasterResult) = default;
    ~UpdateThresholdMasterResult() = default;

    UpdateThresholdMasterResult& operator=(const UpdateThresholdMasterResult& updateThresholdMasterResult) = default;
    UpdateThresholdMasterResult& operator=(UpdateThresholdMasterResult&& updateThresholdMasterResult) = default;

    UpdateThresholdMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateThresholdMasterResult);
    }
