...
#ifndef GS2_EXPERIENCE_CONTROL_EXPORTMASTERRESULT_HPP_
#define GS2_EXPERIENCE_CONTROL_EXPORTMASTERRESULT_HPP_
...
/**
 * 経験値マスターJSONのマスターデータをエクスポートします のレスポンスモデル
 *
...
#endif //GS2_EXPERIENCE_CONTROL_EXPORTMASTERRESULT_HPP_