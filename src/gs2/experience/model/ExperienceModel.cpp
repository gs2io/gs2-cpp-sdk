...
ExperienceModel::Data::Data(const Data& data) :
...
void ExperienceModel::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ExperienceModel ExperienceModel::deepCopy() const
{
