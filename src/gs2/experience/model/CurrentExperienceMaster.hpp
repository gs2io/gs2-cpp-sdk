...
public:
    CurrentExperienceMaster() = default;
    CurrentExperienceMaster(const CurrentExperienceMaster& currentExperienceMaster) = default;
    CurrentExperienceMaster(CurrentExperienceMaster&& currentExperienceMaster) = default;
    ~CurrentExperienceMaster() = default;

    CurrentExperienceMaster& operator=(const CurrentExperienceMaster& currentExperienceMaster) = default;
    CurrentExperienceMaster& operator=(CurrentExperienceMaster&& currentExperienceMaster) = default;

    CurrentExperienceMaster deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentExperienceMaster);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    CurrentExperienceMaster& withNamespaceName(StringHolder namespaceName)
    {
     ...
     * @param settings マスターデータ
     */
    CurrentExperienceMaster& withSettings(StringHolder settings)
    {
...
inline bool operator!=(const CurrentExperienceMaster& lhs, const CurrentExperienceMaster& lhr)
{
