...
Threshold::Data::Data(const Data& data) :
...
void Threshold::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
Threshold Threshold::deepCopy() const
{
