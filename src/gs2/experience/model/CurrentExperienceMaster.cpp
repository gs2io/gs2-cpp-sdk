...
CurrentExperienceMaster::Data::Data(const Data& data) :
...
void CurrentExperienceMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentExperienceMaster CurrentExperienceMaster::deepCopy() const
{
