...
ThresholdMaster::Data::Data(const Data& data) :
...
void ThresholdMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ThresholdMaster ThresholdMaster::deepCopy() const
{
