...
#ifndef GS2_GACHA_CONTROL_GETPRIZEMASTERREQUEST_HPP_
#define GS2_GACHA_CONTROL_GETPRIZEMASTERREQUEST_HPP_
 ...
 */
class GetPrizeMasterRequest : public Gs2BasicRequest, public Gs2Gacha
{
public:
    constexpr static const Char* const FUNCTION = "GetPrizeMaster";
...
public:
    ...
    GetPrizeMasterRequest(const GetPrizeMasterRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Gacha(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    GetPrizeMasterRequest(GetPrizeMasterRequest&& obj) :
    ...
    GetPrizeMasterRequest& operator=(const GetPrizeMasterRequest& getPrizeMasterRequest)
    {
        Gs2BasicRequest::operator=(getPrizeMasterRequest);
        Gs2Gacha::operator=(getPrizeMasterRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*getPrizeMasterRequest.m_pData);

        return *this;
    }

    GetPrizeMasterRequest& operator=(GetPrizeMasterRequest&& getPrizeMasterRequest)
    {
        Gs2BasicRequest::operator=(std::move(getPrizeMasterRequest));
        Gs2Gacha::operator=(std::move(getPrizeMasterRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = getPrizeMasterRequest.m_pData;
        getPrizeMasterRequest.m_pData = nullptr;

        return *this;
    }

    const GetPrizeMasterRequest* operator->() const
    {
        return this;
    }

    GetPrizeMasterRequest* operator->()
    {
        return this;
    }
     ...
     * @param gachaPoolName ガチャプールの名前を指定します。
     */
    GetPrizeMasterRequest& withGachaPoolName(const Char* gachaPoolName)
    {
        ensureData().gachaPoolName.emplace(gachaPoolName);
        return *this;
    }
     ...
     * @param prizeTableName 排出確率テーブルの名前を指定します。
     */
    GetPrizeMasterRequest& withPrizeTableName(const Char* prizeTableName)
    {
        ensureData().prizeTableName.emplace(prizeTableName);
        return *this;
    }
     ...
     * @param rarityName 景品レアリティの名前を指定します。
     */
    GetPrizeMasterRequest& withRarityName(const Char* rarityName)
    {
        ensureData().rarityName.emplace(rarityName);
        return *this;
    }
     ...
     * @param resourceId リソースIDを指定します。
     */
    GetPrizeMasterRequest& withResourceId(const Char* resourceId)
    {
        ensureData().resourceId.emplace(resourceId);
        return *this;
    }
     ...
     */
    GetPrizeMasterRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    GetPrizeMasterRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    GetPrizeMasterRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    GetPrizeMasterRequest& withRequestId(const Char* gs2RequestId)
    {
...
#endif //GS2_GACHA_CONTROL_GETPRIZEMASTERREQUEST_HPP_