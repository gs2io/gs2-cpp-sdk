...
#ifndef GS2_GACHA_CONTROL_EXPORTMASTERREQUEST_HPP_
#define GS2_GACHA_CONTROL_EXPORTMASTERREQUEST_HPP_
 ...
 */
class ExportMasterRequest : public Gs2BasicRequest, public Gs2Gacha
{
public:
...
public:
    ...
    ExportMasterRequest& operator=(const ExportMasterRequest& exportMasterRequest)
    {
        ...
        Gs2Gacha::operator=(exportMasterRequest);
    ...
    ExportMasterRequest& operator=(ExportMasterRequest&& exportMasterRequest)
    {
        ...
        Gs2Gacha::operator=(std::move(exportMasterRequest));
     ...
     * @param gachaPoolName ガチャプールの名前を指定します。
     */
    ExportMasterRequest& withGachaPoolName(const Char* gachaPoolName)
    {
        ensureData().gachaPoolName.emplace(gachaPoolName);
        return *this;
    }
...
#endif //GS2_GACHA_CONTROL_EXPORTMASTERREQUEST_HPP_