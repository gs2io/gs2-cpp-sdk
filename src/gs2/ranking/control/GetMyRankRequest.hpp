...
#ifndef GS2_RANKING_CONTROL_GETMYRANKREQUEST_HPP_
#define GS2_RANKING_CONTROL_GETMYRANKREQUEST_HPP_
 ...
 */
class GetMyRankRequest : public Gs2UserRequest, public Gs2Ranking
{
public:
    constexpr static const Char* const FUNCTION = "GetMyRank";
...
public:
    ...
    GetMyRankRequest(const GetMyRankRequest& obj) :
        Gs2UserRequest(obj),
        Gs2Ranking(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    GetMyRankRequest(GetMyRankRequest&& obj) :
    ...
    GetMyRankRequest& operator=(const GetMyRankRequest& getMyRankRequest)
    {
    ...
    GetMyRankRequest& operator=(GetMyRankRequest&& getMyRankRequest)
    {
     ...
     * @param rankingTableName ランキングテーブルの名前を指定します。
     */
    GetMyRankRequest& withRankingTableName(const Char* rankingTableName)
    {
        ensureData().rankingTableName.emplace(rankingTableName);
        return *this;
    }
     ...
     * @param gameMode ゲームモードの名前を指定します。
     */
    GetMyRankRequest& withGameMode(const Char* gameMode)
    {
        ensureData().gameMode.emplace(gameMode);
        return *this;
    }
     ...
     */
    GetMyRankRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    GetMyRankRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    GetMyRankRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    GetMyRankRequest& withRequestId(const Char* gs2RequestId)
    {
     ...
     * @return this
     */
    GetMyRankRequest& withAccessToken(const Char* accessToken) {
...
#endif //GS2_RANKING_CONTROL_GETMYRANKREQUEST_HPP_