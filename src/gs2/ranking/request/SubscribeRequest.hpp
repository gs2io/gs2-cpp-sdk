...
#ifndef GS2_RANKING_CONTROL_SUBSCRIBEREQUEST_HPP_
#define GS2_RANKING_CONTROL_SUBSCRIBEREQUEST_HPP_
 ...
 */
class SubscribeRequest : public Gs2BasicRequest, public Gs2Ranking
{
public:
...
public:
     ...
     * @param categoryName カテゴリ名
     */
    SubscribeRequest& withCategoryName(StringHolder categoryName)
    {
        ensureData().categoryName.emplace(std::move(categoryName));
        return *this;
    }
     ...
     * @param targetUserId 購読されるユーザID
     */
    SubscribeRequest& withTargetUserId(StringHolder targetUserId)
    {
        ensureData().targetUserId.emplace(std::move(targetUserId));
        return *this;
    }
...
#endif //GS2_RANKING_CONTROL_SUBSCRIBEREQUEST_HPP_