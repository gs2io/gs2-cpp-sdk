...
CalculatedAt::Data::Data(const Data& data) :
...
void CalculatedAt::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CalculatedAt CalculatedAt::deepCopy() const
{
