...
#ifndef GS2_RANKING_MODEL_SUBSCRIBE_HPP_
#define GS2_RANKING_MODEL_SUBSCRIBE_HPP_
...
public:
     ...
     * @param categoryName カテゴリ名
     */
    Subscribe& withCategoryName(StringHolder categoryName)
    {
     ...
     * @param targetUserIds 購読されるユーザIDリスト
     */
    Subscribe& withTargetUserIds(List<StringHolder> targetUserIds)
    {
...
#endif //GS2_RANKING_MODEL_SUBSCRIBE_HPP_