...
CurrentRankingMaster::Data::Data(const Data& data) :
...
void CurrentRankingMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentRankingMaster CurrentRankingMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentRankingMaster);
}
