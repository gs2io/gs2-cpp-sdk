...
#ifndef GS2_CONSUMABLEITEM_CONTROL_EXPORTMASTERREQUEST_HPP_
#define GS2_CONSUMABLEITEM_CONTROL_EXPORTMASTERREQUEST_HPP_
 ...
 */
class ExportMasterRequest : public Gs2BasicRequest, public Gs2ConsumableItem
{
public:
...
public:
    ...
    ExportMasterRequest& operator=(const ExportMasterRequest& exportMasterRequest)
    {
        ...
        Gs2ConsumableItem::operator=(exportMasterRequest);
    ...
    ExportMasterRequest& operator=(ExportMasterRequest&& exportMasterRequest)
    {
        ...
        Gs2ConsumableItem::operator=(std::move(exportMasterRequest));
     ...
     * @param itemPoolName アイテムプールの名前を指定します。
     */
    ExportMasterRequest& withItemPoolName(const Char* itemPoolName)
    {
        ensureData().itemPoolName.emplace(itemPoolName);
        return *this;
    }
...
#endif //GS2_CONSUMABLEITEM_CONTROL_EXPORTMASTERREQUEST_HPP_