...
#ifndef GS2_CONSUMABLEITEM_CONTROL_GETINVENTORYREQUEST_HPP_
#define GS2_CONSUMABLEITEM_CONTROL_GETINVENTORYREQUEST_HPP_
 ...
 */
class GetInventoryRequest : public Gs2UserRequest, public Gs2ConsumableItem
{
public:
    constexpr static const Char* const FUNCTION = "GetInventory";
...
public:
    ...
    GetInventoryRequest& operator=(const GetInventoryRequest& getInventoryRequest)
    {
        ...
        Gs2ConsumableItem::operator=(getInventoryRequest);
    ...
    GetInventoryRequest& operator=(GetInventoryRequest&& getInventoryRequest)
    {
        ...
        Gs2ConsumableItem::operator=(std::move(getInventoryRequest));
     ...
     * @param itemPoolName 消費型アイテムプールの名前
     */
    GetInventoryRequest& withItemPoolName(const Char* itemPoolName)
    {
        ensureData().itemPoolName.emplace(itemPoolName);
        return *this;
    }
     ...
     * @param itemName 消費型アイテムの名前
     */
    GetInventoryRequest& withItemName(const Char* itemName)
    {
        ensureData().itemName.emplace(itemName);
        return *this;
    }
     ...
     * @param expireAt 有効期限(エポック秒)
     */
    GetInventoryRequest& withExpireAt(Int32 expireAt)
    {
        ensureData().expireAt.emplace(expireAt);
        return *this;
    }
...
#endif //GS2_CONSUMABLEITEM_CONTROL_GETINVENTORYREQUEST_HPP_