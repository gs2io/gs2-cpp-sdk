...
#ifndef GS2_CONSUMABLEITEM_CONTROL_GETINVENTORYBYUSERIDREQUEST_HPP_
#define GS2_CONSUMABLEITEM_CONTROL_GETINVENTORYBYUSERIDREQUEST_HPP_
 ...
 */
class GetInventoryByUserIdRequest : public Gs2BasicRequest, public Gs2ConsumableItem
{
public:
    constexpr static const Char* const FUNCTION = "GetInventoryByUserId";
...
public:
    ...
    GetInventoryByUserIdRequest& operator=(const GetInventoryByUserIdRequest& getInventoryByUserIdRequest)
    {
        ...
        Gs2ConsumableItem::operator=(getInventoryByUserIdRequest);
    ...
    GetInventoryByUserIdRequest& operator=(GetInventoryByUserIdRequest&& getInventoryByUserIdRequest)
    {
        ...
        Gs2ConsumableItem::operator=(std::move(getInventoryByUserIdRequest));
     ...
     * @param itemPoolName 消費型アイテムプールの名前
     */
    GetInventoryByUserIdRequest& withItemPoolName(const Char* itemPoolName)
    {
        ensureData().itemPoolName.emplace(itemPoolName);
        return *this;
    }
     ...
     * @param itemName 消費型アイテムの名前
     */
    GetInventoryByUserIdRequest& withItemName(const Char* itemName)
    {
        ensureData().itemName.emplace(itemName);
        return *this;
    }
     ...
     * @param expireAt 有効期限(エポック秒)
     */
    GetInventoryByUserIdRequest& withExpireAt(Int32 expireAt)
    {
        ensureData().expireAt.emplace(expireAt);
        return *this;
    }
...
#endif //GS2_CONSUMABLEITEM_CONTROL_GETINVENTORYBYUSERIDREQUEST_HPP_