...
#ifndef GS2_CONSUMABLEITEM_CONTROL_DESCRIBEITEMMASTERREQUEST_HPP_
#define GS2_CONSUMABLEITEM_CONTROL_DESCRIBEITEMMASTERREQUEST_HPP_
 ...
 */
class DescribeItemMasterRequest : public Gs2BasicRequest, public Gs2ConsumableItem
{
public:
...
public:
    ...
    DescribeItemMasterRequest& operator=(const DescribeItemMasterRequest& describeItemMasterRequest)
    {
        ...
        Gs2ConsumableItem::operator=(describeItemMasterRequest);
    ...
    DescribeItemMasterRequest& operator=(DescribeItemMasterRequest&& describeItemMasterRequest)
    {
        ...
        Gs2ConsumableItem::operator=(std::move(describeItemMasterRequest));
     ...
     * @param itemPoolName 消費型アイテムプールの名前
     */
    DescribeItemMasterRequest& withItemPoolName(const Char* itemPoolName)
    {
        ensureData().itemPoolName.emplace(itemPoolName);
        return *this;
    }
...
#endif //GS2_CONSUMABLEITEM_CONTROL_DESCRIBEITEMMASTERREQUEST_HPP_