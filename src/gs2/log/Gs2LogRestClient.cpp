 ...
 */
void Gs2LogRestClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::queryAccessLog(QueryAccessLogRequest request, std::function<void(AsyncQueryAccessLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::countAccessLog(CountAccessLogRequest request, std::function<void(AsyncCountAccessLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::queryIssueStampSheetLog(QueryIssueStampSheetLogRequest request, std::function<void(AsyncQueryIssueStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::countIssueStampSheetLog(CountIssueStampSheetLogRequest request, std::function<void(AsyncCountIssueStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::queryExecuteStampSheetLog(QueryExecuteStampSheetLogRequest request, std::function<void(AsyncQueryExecuteStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::countExecuteStampSheetLog(CountExecuteStampSheetLogRequest request, std::function<void(AsyncCountExecuteStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::queryExecuteStampTaskLog(QueryExecuteStampTaskLogRequest request, std::function<void(AsyncQueryExecuteStampTaskLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogRestClient::countExecuteStampTaskLog(CountExecuteStampTaskLogRequest request, std::function<void(AsyncCountExecuteStampTaskLogResult)> callback)
{
