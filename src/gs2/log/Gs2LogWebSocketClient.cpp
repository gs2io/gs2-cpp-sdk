...
#include "Gs2LogWebSocketClient.hpp"
...
void write(detail::json::JsonWriter& jsonWriter, const AccessLog& obj);
void write(detail::json::JsonWriter& jsonWriter, const AccessLogCount& obj);
void write(detail::json::JsonWriter& jsonWriter, const IssueStampSheetLog& obj);
void write(detail::json::JsonWriter& jsonWriter, const IssueStampSheetLogCount& obj);
void write(detail::json::JsonWriter& jsonWriter, const ExecuteStampSheetLog& obj);
void write(detail::json::JsonWriter& jsonWriter, const ExecuteStampSheetLogCount& obj);
void write(detail::json::JsonWriter& jsonWriter, const ExecuteStampTaskLog& obj);
void write(detail::json::JsonWriter& jsonWriter, const ExecuteStampTaskLogCount& obj);
 ...
 */
void Gs2LogWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::queryAccessLog(QueryAccessLogRequest request, std::function<void(AsyncQueryAccessLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::countAccessLog(CountAccessLogRequest request, std::function<void(AsyncCountAccessLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::queryIssueStampSheetLog(QueryIssueStampSheetLogRequest request, std::function<void(AsyncQueryIssueStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::countIssueStampSheetLog(CountIssueStampSheetLogRequest request, std::function<void(AsyncCountIssueStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::queryExecuteStampSheetLog(QueryExecuteStampSheetLogRequest request, std::function<void(AsyncQueryExecuteStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::countExecuteStampSheetLog(CountExecuteStampSheetLogRequest request, std::function<void(AsyncCountExecuteStampSheetLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::queryExecuteStampTaskLog(QueryExecuteStampTaskLogRequest request, std::function<void(AsyncQueryExecuteStampTaskLogResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2LogWebSocketClient::countExecuteStampTaskLog(CountExecuteStampTaskLogRequest request, std::function<void(AsyncCountExecuteStampTaskLogResult)> callback)
{
