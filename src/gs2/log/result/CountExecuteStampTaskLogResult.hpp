...
#ifndef GS2_LOG_CONTROL_COUNTEXECUTESTAMPTASKLOGRESULT_HPP_
#define GS2_LOG_CONTROL_COUNTEXECUTESTAMPTASKLOGRESULT_HPP_
 ...
 */
class CountExecuteStampTaskLogResult : public Gs2Object
{
private:
    ...
    public:
        /** スタンプタスク実行ログ集計のリスト */
        optional<List<ExecuteStampTaskLogCount>> items;
            ...
            if (std::strcmp(name_, "items") == 0)
            {
                if (jsonValue.IsArray())
                {
                    ...
                    for (const detail::json::JsonConstValue* json = array.Begin(); json != array.End(); ++json) {
                        ExecuteStampTaskLogCount item_;
...
public:
    CountExecuteStampTaskLogResult() = default;
    CountExecuteStampTaskLogResult(const CountExecuteStampTaskLogResult& countExecuteStampTaskLogResult) = default;
    CountExecuteStampTaskLogResult(CountExecuteStampTaskLogResult&& countExecuteStampTaskLogResult) = default;
    ~CountExecuteStampTaskLogResult() = default;
    ...
    CountExecuteStampTaskLogResult* operator->()
    {
        return this;
    }
    /**
     ...
     *
     * @return スタンプタスク実行ログ集計のリスト
     */
    const optional<List<ExecuteStampTaskLogCount>>& getItems() const
    {
     ...
     *
     * @param items スタンプタスク実行ログ集計のリスト
     */
    void setItems(List<ExecuteStampTaskLogCount> items)
    {
...
typedef AsyncResult<CountExecuteStampTaskLogResult> AsyncCountExecuteStampTaskLogResult;

} }

#endif //GS2_LOG_CONTROL_COUNTEXECUTESTAMPTASKLOGRESULT_HPP_