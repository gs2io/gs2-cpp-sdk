...
#include "QueryExecuteStampSheetLogResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace log
{

QueryExecuteStampSheetLogResult::Data::Data(const Data& data) :
...
void QueryExecuteStampSheetLogResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
QueryExecuteStampSheetLogResult QueryExecuteStampSheetLogResult::deepCopy() const
{
