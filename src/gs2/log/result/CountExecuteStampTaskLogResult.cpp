...
#include "CountExecuteStampTaskLogResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace log
{

CountExecuteStampTaskLogResult::Data::Data(const Data& data) :
...
void CountExecuteStampTaskLogResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CountExecuteStampTaskLogResult CountExecuteStampTaskLogResult::deepCopy() const
{
