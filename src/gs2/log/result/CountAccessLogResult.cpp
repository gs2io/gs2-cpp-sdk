...
#include "CountAccessLogResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace log
{

CountAccessLogResult::Data::Data(const Data& data) :
...
void CountAccessLogResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CountAccessLogResult CountAccessLogResult::deepCopy() const
{
