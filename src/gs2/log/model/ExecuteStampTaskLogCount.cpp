...
ExecuteStampTaskLogCount::Data::Data(const Data& data) :
...
void ExecuteStampTaskLogCount::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ExecuteStampTaskLogCount ExecuteStampTaskLogCount::deepCopy() const
{
