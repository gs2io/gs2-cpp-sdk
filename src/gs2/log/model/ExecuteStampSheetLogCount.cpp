...
#include "ExecuteStampSheetLogCount.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace log {

ExecuteStampSheetLogCount::Data::Data(const Data& data) :
...
void ExecuteStampSheetLogCount::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ExecuteStampSheetLogCount ExecuteStampSheetLogCount::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(ExecuteStampSheetLogCount);
}

bool operator!=(const ExecuteStampSheetLogCount& lhs, const ExecuteStampSheetLogCount& lhr)
{
