...
AccessLogCount::Data::Data(const Data& data) :
...
void AccessLogCount::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
AccessLogCount AccessLogCount::deepCopy() const
{
