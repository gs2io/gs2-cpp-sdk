...
#include "ExecuteStampTaskLog.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace log {

ExecuteStampTaskLog::Data::Data(const Data& data) :
...
void ExecuteStampTaskLog::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ExecuteStampTaskLog ExecuteStampTaskLog::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(ExecuteStampTaskLog);
}

bool operator!=(const ExecuteStampTaskLog& lhs, const ExecuteStampTaskLog& lhr)
{
