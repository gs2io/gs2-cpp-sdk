...
#ifndef GS2_LOG_MODEL_ISSUESTAMPSHEETLOGCOUNT_HPP_
#define GS2_LOG_MODEL_ISSUESTAMPSHEETLOGCOUNT_HPP_
 ...
 *
 */
class IssueStampSheetLogCount : public Gs2Object
{
    friend bool operator!=(const IssueStampSheetLogCount& lhs, const IssueStampSheetLogCount& lhr);
...
public:
    IssueStampSheetLogCount() = default;
    IssueStampSheetLogCount(const IssueStampSheetLogCount& issueStampSheetLogCount) = default;
    IssueStampSheetLogCount(IssueStampSheetLogCount&& issueStampSheetLogCount) = default;
    ~IssueStampSheetLogCount() = default;

    IssueStampSheetLogCount& operator=(const IssueStampSheetLogCount& issueStampSheetLogCount) = default;
    IssueStampSheetLogCount& operator=(IssueStampSheetLogCount&& issueStampSheetLogCount) = default;

    IssueStampSheetLogCount deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(IssueStampSheetLogCount);
    }

    const IssueStampSheetLogCount* operator->() const
    {
        return this;
    }

    IssueStampSheetLogCount* operator->()
    {
        return this;
    }
    /**
     ...
     * @param service マイクロサービスの種類
     */
    IssueStampSheetLogCount& withService(StringHolder service)
    {
     ...
     * @param method マイクロサービスのメソッド
     */
    IssueStampSheetLogCount& withMethod(StringHolder method)
    {
     ...
     * @param userId ユーザーID
     */
    IssueStampSheetLogCount& withUserId(StringHolder userId)
    {
     ...
     * @param action 報酬アクション
     */
    IssueStampSheetLogCount& withAction(StringHolder action)
    {
     ...
     * @param count 回数
     */
    IssueStampSheetLogCount& withCount(Int64 count)
    {
        setCount(count);
        return *this;
    }
...
inline bool operator!=(const IssueStampSheetLogCount& lhs, const IssueStampSheetLogCount& lhr)
{
...
#endif //GS2_LOG_MODEL_ISSUESTAMPSHEETLOGCOUNT_HPP_