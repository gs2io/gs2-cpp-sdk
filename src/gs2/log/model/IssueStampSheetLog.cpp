...
#include "IssueStampSheetLog.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace log {

IssueStampSheetLog::Data::Data(const Data& data) :
...
void IssueStampSheetLog::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
    ...
    else if (std::strcmp(name_, "tasks") == 0)
    {
        if (jsonValue.IsString())
        {
            this->tasks.emplace(jsonValue.GetString());
        }
    }
}

IssueStampSheetLog IssueStampSheetLog::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(IssueStampSheetLog);
}
