...
FriendUser::Data::Data(const Data& data) :
...
void FriendUser::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
FriendUser FriendUser::deepCopy() const
{
