...
void write(detail::json::JsonWriter& jsonWriter, const User& obj);
void write(detail::json::JsonWriter& jsonWriter, const SecurityPolicy& obj);
void write(detail::json::JsonWriter& jsonWriter, const Identifier& obj);
void write(detail::json::JsonWriter& jsonWriter, const AttachSecurityPolicy& obj);
void write(detail::json::JsonWriter& jsonWriter, const ProjectToken& obj);
 ...
 */
void Gs2IdentifierWebSocketClient::describeUsers(DescribeUsersRequest request, std::function<void(AsyncDescribeUsersResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::createUser(CreateUserRequest request, std::function<void(AsyncCreateUserResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::updateUser(UpdateUserRequest request, std::function<void(AsyncUpdateUserResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::getUser(GetUserRequest request, std::function<void(AsyncGetUserResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::deleteUser(DeleteUserRequest request, std::function<void(AsyncDeleteUserResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::describeSecurityPolicies(DescribeSecurityPoliciesRequest request, std::function<void(AsyncDescribeSecurityPoliciesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::describeCommonSecurityPolicies(DescribeCommonSecurityPoliciesRequest request, std::function<void(AsyncDescribeCommonSecurityPoliciesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::createSecurityPolicy(CreateSecurityPolicyRequest request, std::function<void(AsyncCreateSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::updateSecurityPolicy(UpdateSecurityPolicyRequest request, std::function<void(AsyncUpdateSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::getSecurityPolicy(GetSecurityPolicyRequest request, std::function<void(AsyncGetSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::deleteSecurityPolicy(DeleteSecurityPolicyRequest request, std::function<void(AsyncDeleteSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::describeIdentifiers(DescribeIdentifiersRequest request, std::function<void(AsyncDescribeIdentifiersResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::createIdentifier(CreateIdentifierRequest request, std::function<void(AsyncCreateIdentifierResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::getIdentifier(GetIdentifierRequest request, std::function<void(AsyncGetIdentifierResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::deleteIdentifier(DeleteIdentifierRequest request, std::function<void(AsyncDeleteIdentifierResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::getHasSecurityPolicy(GetHasSecurityPolicyRequest request, std::function<void(AsyncGetHasSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::attachSecurityPolicy(AttachSecurityPolicyRequest request, std::function<void(AsyncAttachSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::detachSecurityPolicy(DetachSecurityPolicyRequest request, std::function<void(AsyncDetachSecurityPolicyResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2IdentifierWebSocketClient::login(LoginRequest request, std::function<void(AsyncLoginResult)> callback)
{
