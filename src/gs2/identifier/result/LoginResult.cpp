...
LoginResult::Data::Data(const Data& data) :
...
void LoginResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
LoginResult LoginResult::deepCopy() const
{
