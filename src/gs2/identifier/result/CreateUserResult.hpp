...
public:
    ...
    CreateUserResult(const CreateUserResult& createUserResult) = default;
    CreateUserResult(CreateUserResult&& createUserResult) = default;
    ~CreateUserResult() = default;

    CreateUserResult& operator=(const CreateUserResult& createUserResult) = default;
    CreateUserResult& operator=(CreateUserResult&& createUserResult) = default;

    CreateUserResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateUserResult);
    }
