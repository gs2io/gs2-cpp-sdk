...
SecurityPolicy::Data::Data(const Data& data) :
...
void SecurityPolicy::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
SecurityPolicy SecurityPolicy::deepCopy() const
{
