...
ProjectToken::Data::Data(const Data& data) :
    detail::json::IModel(data),
    token(data.token)
{
}

void ProjectToken::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ProjectToken ProjectToken::deepCopy() const
{
