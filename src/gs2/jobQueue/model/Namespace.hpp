...
#ifndef GS2_JOBQUEUE_MODEL_NAMESPACE_HPP_
#define GS2_JOBQUEUE_MODEL_NAMESPACE_HPP_
...
private:
    ...
    public:
        ...
        virtual void set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
        {
            ...
            else if (std::strcmp(name_, "pushNotification") == 0)
            {
...
public:
    ...
    {
        setPushNotification(std::move(pushNotification));
        return *this;
    }
...
#endif //GS2_JOBQUEUE_MODEL_NAMESPACE_HPP_