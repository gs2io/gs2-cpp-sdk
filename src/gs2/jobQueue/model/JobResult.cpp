...
JobResult::Data::Data(const Data& data) :
...
void JobResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
JobResult JobResult::deepCopy() const
{
