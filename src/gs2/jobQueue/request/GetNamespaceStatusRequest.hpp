...
#ifndef GS2_JOBQUEUE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_JOBQUEUE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2JobQueue
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2JobQueue::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2JobQueue::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_JOBQUEUE_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_