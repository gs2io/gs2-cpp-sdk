...
public:
    RunByUserIdResult() = default;
    RunByUserIdResult(const RunByUserIdResult& runByUserIdResult) = default;
    RunByUserIdResult(RunByUserIdResult&& runByUserIdResult) = default;
    ~RunByUserIdResult() = default;
