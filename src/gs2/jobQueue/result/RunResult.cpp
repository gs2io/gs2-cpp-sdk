...
RunResult::Data::Data(const Data& data) :
...
void RunResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RunResult RunResult::deepCopy() const
{
