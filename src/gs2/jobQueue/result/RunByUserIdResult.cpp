...
#include "RunByUserIdResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace jobQueue
{

RunByUserIdResult::Data::Data(const Data& data) :
...
void RunByUserIdResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RunByUserIdResult RunByUserIdResult::deepCopy() const
{
