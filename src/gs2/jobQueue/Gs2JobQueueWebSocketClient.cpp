 ...
 */
void Gs2JobQueueWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::describeJobsByUserId(DescribeJobsByUserIdRequest request, std::function<void(AsyncDescribeJobsByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::getJobByUserId(GetJobByUserIdRequest request, std::function<void(AsyncGetJobByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::pushByUserId(PushByUserIdRequest request, std::function<void(AsyncPushByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::run(RunRequest request, std::function<void(AsyncRunResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::runByUserId(RunByUserIdRequest request, std::function<void(AsyncRunByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::deleteJobByUserId(DeleteJobByUserIdRequest request, std::function<void(AsyncDeleteJobByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::pushByStampSheet(PushByStampSheetRequest request, std::function<void(AsyncPushByStampSheetResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::describeDeadLetterJobsByUserId(DescribeDeadLetterJobsByUserIdRequest request, std::function<void(AsyncDescribeDeadLetterJobsByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::getDeadLetterJobByUserId(GetDeadLetterJobByUserIdRequest request, std::function<void(AsyncGetDeadLetterJobByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2JobQueueWebSocketClient::deleteDeadLetterJobByUserId(DeleteDeadLetterJobByUserIdRequest request, std::function<void(AsyncDeleteDeadLetterJobByUserIdResult)> callback)
{
