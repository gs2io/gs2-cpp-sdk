...
public:
    UpdateCurrentDistributorMasterFromGitHubRequest() = default;
    UpdateCurrentDistributorMasterFromGitHubRequest(const UpdateCurrentDistributorMasterFromGitHubRequest& updateCurrentDistributorMasterFromGitHubRequest) = default;
    UpdateCurrentDistributorMasterFromGitHubRequest(UpdateCurrentDistributorMasterFromGitHubRequest&& updateCurrentDistributorMasterFromGitHubRequest) = default;
    ~UpdateCurrentDistributorMasterFromGitHubRequest() GS2_OVERRIDE = default;

    UpdateCurrentDistributorMasterFromGitHubRequest& operator=(const UpdateCurrentDistributorMasterFromGitHubRequest& updateCurrentDistributorMasterFromGitHubRequest) = default;
    UpdateCurrentDistributorMasterFromGitHubRequest& operator=(UpdateCurrentDistributorMasterFromGitHubRequest&& updateCurrentDistributorMasterFromGitHubRequest) = default;

    UpdateCurrentDistributorMasterFromGitHubRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateCurrentDistributorMasterFromGitHubRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    UpdateCurrentDistributorMasterFromGitHubRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     */
    UpdateCurrentDistributorMasterFromGitHubRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    UpdateCurrentDistributorMasterFromGitHubRequest& withRequestId(StringHolder gs2RequestId)
    {
