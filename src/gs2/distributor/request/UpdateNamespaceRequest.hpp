...
#ifndef GS2_DISTRIBUTOR_CONTROL_UPDATENAMESPACEREQUEST_HPP_
#define GS2_DISTRIBUTOR_CONTROL_UPDATENAMESPACEREQUEST_HPP_
 ...
 */
class UpdateNamespaceRequest : public Gs2BasicRequest, public Gs2Distributor
{
public:
...
public:
    ...
    UpdateNamespaceRequest& operator=(const UpdateNamespaceRequest& updateNamespaceRequest)
    {
        ...
        Gs2Distributor::operator=(updateNamespaceRequest);
    ...
    UpdateNamespaceRequest& operator=(UpdateNamespaceRequest&& updateNamespaceRequest)
    {
        ...
        Gs2Distributor::operator=(std::move(updateNamespaceRequest));
...
#endif //GS2_DISTRIBUTOR_CONTROL_UPDATENAMESPACEREQUEST_HPP_