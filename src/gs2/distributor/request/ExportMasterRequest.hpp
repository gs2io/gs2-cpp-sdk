...
/**
 * ディストリビューターマスターJSONのマスターデータをエクスポートします のリクエストモデル
 *
...
public:
    ...
    ExportMasterRequest& operator=(const ExportMasterRequest& exportMasterRequest)
    {
        ...
        Gs2Distributor::operator=(exportMasterRequest);
    ...
    ExportMasterRequest& operator=(ExportMasterRequest&& exportMasterRequest)
    {
        ...
        Gs2Distributor::operator=(std::move(exportMasterRequest));
     ...
     * @param distributorName ディストリビュータ名
     */
    ExportMasterRequest& withDistributorName(const Char* distributorName)
    {
        ensureData().distributorName.emplace(distributorName);
        return *this;
    }
