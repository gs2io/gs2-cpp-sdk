...
private:
    ...
    class DistributeWithoutOverflowProcessTask : public detail::Gs2WebSocketSessionTask<DistributeWithoutOverflowProcessResult>
    {
    private:
        ...
        const char* getFunctionName() const GS2_OVERRIDE
        {
            return "distributeWithoutOverflowProcess";
        }
    ...
    public:
        DistributeWithoutOverflowProcessTask(
            ...
            Gs2WebSocketSessionTask<DistributeWithoutOverflowProcessResult>::CallbackType callback
        ) :
            Gs2WebSocketSessionTask<DistributeWithoutOverflowProcessResult>(callback),
            m_Request(std::move(request))
        {}
    ...
    class RunStampSheetExpressTask : public detail::Gs2WebSocketSessionTask<RunStampSheetExpressResult>
    {
    private:
    ...
    public:
        RunStampSheetExpressTask(
            ...
            Gs2WebSocketSessionTask<RunStampSheetExpressResult>::CallbackType callback
        ) :
            Gs2WebSocketSessionTask<RunStampSheetExpressResult>(callback),
            m_Request(std::move(request))
        {}
    ...
    class RunStampTaskWithoutNamespaceTask : public detail::Gs2WebSocketSessionTask<RunStampTaskWithoutNamespaceResult>
    {
    private:
        ...
        const char* getFunctionName() const GS2_OVERRIDE
        {
            return "runStampTaskWithoutNamespace";
        }
    ...
    public:
        RunStampTaskWithoutNamespaceTask(
            ...
            Gs2WebSocketSessionTask<RunStampTaskWithoutNamespaceResult>::CallbackType callback
        ) :
            Gs2WebSocketSessionTask<RunStampTaskWithoutNamespaceResult>(callback),
            m_Request(std::move(request))
        {}
    ...
    class RunStampSheetWithoutNamespaceTask : public detail::Gs2WebSocketSessionTask<RunStampSheetWithoutNamespaceResult>
    {
    private:
        ...
        const char* getFunctionName() const GS2_OVERRIDE
        {
            return "runStampSheetWithoutNamespace";
        }
    ...
    public:
        RunStampSheetWithoutNamespaceTask(
            ...
            Gs2WebSocketSessionTask<RunStampSheetWithoutNamespaceResult>::CallbackType callback
        ) :
            Gs2WebSocketSessionTask<RunStampSheetWithoutNamespaceResult>(callback),
            m_Request(std::move(request))
        {}
    ...
    class RunStampSheetExpressWithoutNamespaceTask : public detail::Gs2WebSocketSessionTask<RunStampSheetExpressWithoutNamespaceResult>
    {
    private:
        ...
        const char* getFunctionName() const GS2_OVERRIDE
        {
            return "runStampSheetExpressWithoutNamespace";
        }
    ...
    public:
        RunStampSheetExpressWithoutNamespaceTask(
            ...
            Gs2WebSocketSessionTask<RunStampSheetExpressWithoutNamespaceResult>::CallbackType callback
        ) :
            Gs2WebSocketSessionTask<RunStampSheetExpressWithoutNamespaceResult>(callback),
            m_Request(std::move(request))
        {}
...
protected:
    ...
    static void write(detail::json::JsonWriter& jsonWriter, const DistributorModelMaster& obj)
    {
        jsonWriter.writeObjectStart();
    ...
    static void write(detail::json::JsonWriter& jsonWriter, const DistributorModel& obj)
    {
        jsonWriter.writeObjectStart();
        if (obj.getDistributorModelId())
        {
    ...
    static void write(detail::json::JsonWriter& jsonWriter, const CurrentDistributorMaster& obj)
    {
        jsonWriter.writeObjectStart();
    ...
    static void write(detail::json::JsonWriter& jsonWriter, const DistributeResource& obj)
    {
        jsonWriter.writeObjectStart();
        if (obj.getAction())
        {
