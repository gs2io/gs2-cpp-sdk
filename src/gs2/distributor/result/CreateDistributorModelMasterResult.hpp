...
public:
    CreateDistributorModelMasterResult() = default;
    CreateDistributorModelMasterResult(const CreateDistributorModelMasterResult& createDistributorModelMasterResult) = default;
    CreateDistributorModelMasterResult(CreateDistributorModelMasterResult&& createDistributorModelMasterResult) = default;
    ~CreateDistributorModelMasterResult() = default;

    CreateDistributorModelMasterResult& operator=(const CreateDistributorModelMasterResult& createDistributorModelMasterResult) = default;
    CreateDistributorModelMasterResult& operator=(CreateDistributorModelMasterResult&& createDistributorModelMasterResult) = default;

    CreateDistributorModelMasterResult deepCopy() const
    {
