...
#include "DistributeResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace distributor
{

DistributeResult::Data::Data(const Data& data) :
...
void DistributeResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
DistributeResult DistributeResult::deepCopy() const
{
