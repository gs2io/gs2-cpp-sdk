...
/**
 * 現在有効なディストリビューターマスターJSONを更新します のレスポンスモデル
 *
...
public:
    ...
    /**
     * 更新した現在有効なディストリビューターマスターJSONを取得
     *
     * @return 更新した現在有効なディストリビューターマスターJSON
     */
    ...
    /**
     * 更新した現在有効なディストリビューターマスターJSONを設定
     *
     * @param item 更新した現在有効なディストリビューターマスターJSON
     */
