...
public:
    UpdateCurrentDistributorMasterResult() = default;
    UpdateCurrentDistributorMasterResult(const UpdateCurrentDistributorMasterResult& updateCurrentDistributorMasterResult) = default;
    UpdateCurrentDistributorMasterResult(UpdateCurrentDistributorMasterResult&& updateCurrentDistributorMasterResult) = default;
    ~UpdateCurrentDistributorMasterResult() = default;

    UpdateCurrentDistributorMasterResult& operator=(const UpdateCurrentDistributorMasterResult& updateCurrentDistributorMasterResult) = default;
    UpdateCurrentDistributorMasterResult& operator=(UpdateCurrentDistributorMasterResult&& updateCurrentDistributorMasterResult) = default;

    UpdateCurrentDistributorMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateCurrentDistributorMasterResult);
    }
