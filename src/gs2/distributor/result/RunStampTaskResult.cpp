...
#include "RunStampTaskResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace distributor
{

RunStampTaskResult::Data::Data(const Data& data) :
...
void RunStampTaskResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
RunStampTaskResult RunStampTaskResult::deepCopy() const
{
