...
DistributeResource::Data::Data(const Data& data) :
...
void DistributeResource::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
DistributeResource DistributeResource::deepCopy() const
{
