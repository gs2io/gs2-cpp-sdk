...
CurrentDistributorMaster::Data::Data(const Data& data) :
...
void CurrentDistributorMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentDistributorMaster CurrentDistributorMaster::deepCopy() const
{
