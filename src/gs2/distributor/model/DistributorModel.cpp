...
DistributorModel::Data::Data(const Data& data) :
...
void DistributorModel::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
DistributorModel DistributorModel::deepCopy() const
{
