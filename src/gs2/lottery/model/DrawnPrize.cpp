...
DrawnPrize::Data::Data(const Data& data) :
...
void DrawnPrize::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
DrawnPrize DrawnPrize::deepCopy() const
{
