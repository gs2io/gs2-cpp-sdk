...
PrizeTableMaster::Data::Data(const Data& data) :
...
void PrizeTableMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
PrizeTableMaster PrizeTableMaster::deepCopy() const
{
