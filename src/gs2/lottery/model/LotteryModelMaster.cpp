...
LotteryModelMaster::Data::Data(const Data& data) :
...
void LotteryModelMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
LotteryModelMaster LotteryModelMaster::deepCopy() const
{
