...
public:
    CurrentLotteryMaster() = default;
    CurrentLotteryMaster(const CurrentLotteryMaster& currentLotteryMaster) = default;
    CurrentLotteryMaster(CurrentLotteryMaster&& currentLotteryMaster) = default;
    ~CurrentLotteryMaster() = default;

    CurrentLotteryMaster& operator=(const CurrentLotteryMaster& currentLotteryMaster) = default;
    CurrentLotteryMaster& operator=(CurrentLotteryMaster&& currentLotteryMaster) = default;

    CurrentLotteryMaster deepCopy() const
    {
     ...
     * @param namespaceName ネームスペース名
     */
    CurrentLotteryMaster& withNamespaceName(StringHolder namespaceName)
    {
     ...
     * @param settings マスターデータ
     */
    CurrentLotteryMaster& withSettings(StringHolder settings)
    {
