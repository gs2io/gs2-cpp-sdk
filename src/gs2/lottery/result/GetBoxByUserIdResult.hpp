...
public:
    GetBoxByUserIdResult() = default;
    GetBoxByUserIdResult(const GetBoxByUserIdResult& getBoxByUserIdResult) = default;
    GetBoxByUserIdResult(GetBoxByUserIdResult&& getBoxByUserIdResult) = default;
    ~GetBoxByUserIdResult() = default;

    GetBoxByUserIdResult& operator=(const GetBoxByUserIdResult& getBoxByUserIdResult) = default;
    GetBoxByUserIdResult& operator=(GetBoxByUserIdResult&& getBoxByUserIdResult) = default;

    GetBoxByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetBoxByUserIdResult);
    }
