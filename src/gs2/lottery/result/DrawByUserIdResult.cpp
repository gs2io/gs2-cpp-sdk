...
#include "DrawByUserIdResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace lottery
{

DrawByUserIdResult::Data::Data(const Data& data) :
...
void DrawByUserIdResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
DrawByUserIdResult DrawByUserIdResult::deepCopy() const
{
