...
#include "DrawByStampSheetResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace lottery
{

DrawByStampSheetResult::Data::Data(const Data& data) :
...
void DrawByStampSheetResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
DrawByStampSheetResult DrawByStampSheetResult::deepCopy() const
{
