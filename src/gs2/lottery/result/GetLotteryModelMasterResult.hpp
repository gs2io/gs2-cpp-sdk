...
public:
    GetLotteryModelMasterResult() = default;
    GetLotteryModelMasterResult(const GetLotteryModelMasterResult& getLotteryModelMasterResult) = default;
    GetLotteryModelMasterResult(GetLotteryModelMasterResult&& getLotteryModelMasterResult) = default;
    ~GetLotteryModelMasterResult() = default;

    GetLotteryModelMasterResult& operator=(const GetLotteryModelMasterResult& getLotteryModelMasterResult) = default;
    GetLotteryModelMasterResult& operator=(GetLotteryModelMasterResult&& getLotteryModelMasterResult) = default;

    GetLotteryModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetLotteryModelMasterResult);
    }
