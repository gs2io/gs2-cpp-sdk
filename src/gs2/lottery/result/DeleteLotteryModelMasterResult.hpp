...
public:
    DeleteLotteryModelMasterResult() = default;
    DeleteLotteryModelMasterResult(const DeleteLotteryModelMasterResult& deleteLotteryModelMasterResult) = default;
    DeleteLotteryModelMasterResult(DeleteLotteryModelMasterResult&& deleteLotteryModelMasterResult) = default;
    ~DeleteLotteryModelMasterResult() = default;

    DeleteLotteryModelMasterResult& operator=(const DeleteLotteryModelMasterResult& deleteLotteryModelMasterResult) = default;
    DeleteLotteryModelMasterResult& operator=(DeleteLotteryModelMasterResult&& deleteLotteryModelMasterResult) = default;

    DeleteLotteryModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteLotteryModelMasterResult);
    }
