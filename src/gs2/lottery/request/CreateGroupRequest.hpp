...
#ifndef GS2_LOTTERY_CONTROL_CREATEGROUPREQUEST_HPP_
#define GS2_LOTTERY_CONTROL_CREATEGROUPREQUEST_HPP_
...
/**
 * グループの種類を新規作成 のリクエストモデル
 *
 * @author Game Server Services, Inc.
 */
class CreateGroupRequest : public Gs2BasicRequest, public Gs2Lottery
{
public:
...
public:
    ...
    CreateGroupRequest& operator=(const CreateGroupRequest& createGroupRequest)
    {
        ...
        Gs2Lottery::operator=(createGroupRequest);
    ...
    CreateGroupRequest& operator=(CreateGroupRequest&& createGroupRequest)
    {
        ...
        Gs2Lottery::operator=(std::move(createGroupRequest));
...
#endif //GS2_LOTTERY_CONTROL_CREATEGROUPREQUEST_HPP_