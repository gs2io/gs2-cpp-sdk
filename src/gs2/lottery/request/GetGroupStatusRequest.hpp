...
#ifndef GS2_LOTTERY_CONTROL_GETGROUPSTATUSREQUEST_HPP_
#define GS2_LOTTERY_CONTROL_GETGROUPSTATUSREQUEST_HPP_
 ...
 */
class GetGroupStatusRequest : public Gs2BasicRequest, public Gs2Lottery
{
public:
...
public:
    ...
    GetGroupStatusRequest& operator=(const GetGroupStatusRequest& getGroupStatusRequest)
    {
        ...
        Gs2Lottery::operator=(getGroupStatusRequest);
    ...
    GetGroupStatusRequest& operator=(GetGroupStatusRequest&& getGroupStatusRequest)
    {
        ...
        Gs2Lottery::operator=(std::move(getGroupStatusRequest));
...
#endif //GS2_LOTTERY_CONTROL_GETGROUPSTATUSREQUEST_HPP_