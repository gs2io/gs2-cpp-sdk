...
#ifndef GS2_LOTTERY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_LOTTERY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Lottery
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Lottery::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Lottery::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_LOTTERY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_