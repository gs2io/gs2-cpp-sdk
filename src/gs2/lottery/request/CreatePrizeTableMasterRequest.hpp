...
public:
     ...
     * @param groupName グループ名
     */
    CreatePrizeTableMasterRequest& withGroupName(const Char* groupName)
    {
        ensureData().groupName.emplace(groupName);
        return *this;
    }
     ...
     * @param prizes 景品リスト
     */
    CreatePrizeTableMasterRequest& withPrizes(const List<PrizeMaster>& prizes)
    {
        ensureData().prizes.emplace(prizes);
        return *this;
    }
