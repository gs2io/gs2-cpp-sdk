...
#include "QuestModelMaster.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace quest {

QuestModelMaster::Data::Data(const Data& data) :
...
void QuestModelMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
QuestModelMaster QuestModelMaster::deepCopy() const
{
