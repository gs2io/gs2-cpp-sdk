...
#include "CurrentQuestMaster.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace quest {

CurrentQuestMaster::Data::Data(const Data& data) :
...
void CurrentQuestMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentQuestMaster CurrentQuestMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentQuestMaster);
}
