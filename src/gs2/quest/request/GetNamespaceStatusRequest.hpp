...
#ifndef GS2_QUEST_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_QUEST_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Quest
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Quest::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Quest::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_QUEST_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_