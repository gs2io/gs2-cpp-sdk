...
public:
    CreateQuestModelMasterRequest() = default;
    CreateQuestModelMasterRequest(const CreateQuestModelMasterRequest& createQuestModelMasterRequest) = default;
    CreateQuestModelMasterRequest(CreateQuestModelMasterRequest&& createQuestModelMasterRequest) = default;
    ~CreateQuestModelMasterRequest() GS2_OVERRIDE = default;

    CreateQuestModelMasterRequest& operator=(const CreateQuestModelMasterRequest& createQuestModelMasterRequest) = default;
    CreateQuestModelMasterRequest& operator=(CreateQuestModelMasterRequest&& createQuestModelMasterRequest) = default;

    CreateQuestModelMasterRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateQuestModelMasterRequest);
    }
     ...
     * @param namespaceName カテゴリ名
     */
    CreateQuestModelMasterRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param questGroupName クエストグループモデル名
     */
    CreateQuestModelMasterRequest& withQuestGroupName(StringHolder questGroupName)
    {
        ensureData().questGroupName.emplace(std::move(questGroupName));
        return *this;
    }
     ...
     * @param name クエスト名
     */
    CreateQuestModelMasterRequest& withName(StringHolder name)
    {
        ensureData().name.emplace(std::move(name));
        return *this;
    }
     ...
     * @param description クエストモデルの説明
     */
    CreateQuestModelMasterRequest& withDescription(StringHolder description)
    {
        ensureData().description.emplace(std::move(description));
        return *this;
    }
     ...
     * @param metadata クエストのメタデータ
     */
    CreateQuestModelMasterRequest& withMetadata(StringHolder metadata)
    {
        ensureData().metadata.emplace(std::move(metadata));
        return *this;
    }
     ...
     * @param challengePeriodEventId 挑戦可能な期間を指定するイベントマスター のGRN
     */
    CreateQuestModelMasterRequest& withChallengePeriodEventId(StringHolder challengePeriodEventId)
    {
        ensureData().challengePeriodEventId.emplace(std::move(challengePeriodEventId));
        return *this;
    }
     ...
     * @param consumeActions クエストの参加料
     */
    CreateQuestModelMasterRequest& withConsumeActions(List<ConsumeAction> consumeActions)
    {
        ensureData().consumeActions.emplace(std::move(consumeActions));
        return *this;
    }
     ...
     * @param failedAcquireActions クエスト失敗時の報酬
     */
    CreateQuestModelMasterRequest& withFailedAcquireActions(List<AcquireAction> failedAcquireActions)
    {
        ensureData().failedAcquireActions.emplace(std::move(failedAcquireActions));
        return *this;
    }
     ...
     * @param premiseQuestNames クエストに挑戦するためにクリアしておく必要のあるクエスト名
     */
    CreateQuestModelMasterRequest& withPremiseQuestNames(List<StringHolder> premiseQuestNames)
    {
        ensureData().premiseQuestNames.emplace(std::move(premiseQuestNames));
        return *this;
    }
     ...
     */
    CreateQuestModelMasterRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    CreateQuestModelMasterRequest& withRequestId(StringHolder gs2RequestId)
    {
