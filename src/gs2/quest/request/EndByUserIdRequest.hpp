...
public:
    ...
    EndByUserIdRequest(const EndByUserIdRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Quest(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    EndByUserIdRequest(EndByUserIdRequest&& obj) :
    ...
    EndByUserIdRequest& operator=(const EndByUserIdRequest& endByUserIdRequest)
    {
        Gs2BasicRequest::operator=(endByUserIdRequest);
        Gs2Quest::operator=(endByUserIdRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*endByUserIdRequest.m_pData);

        return *this;
    }

    EndByUserIdRequest& operator=(EndByUserIdRequest&& endByUserIdRequest)
    {
        Gs2BasicRequest::operator=(std::move(endByUserIdRequest));
        Gs2Quest::operator=(std::move(endByUserIdRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = endByUserIdRequest.m_pData;
        endByUserIdRequest.m_pData = nullptr;
     ...
     * @param namespaceName カテゴリ名
     */
    EndByUserIdRequest& withNamespaceName(const Char* namespaceName)
    {
        ensureData().namespaceName.emplace(namespaceName);
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    EndByUserIdRequest& withUserId(const Char* userId)
    {
        ensureData().userId.emplace(userId);
        return *this;
    }
     ...
     * @param transactionId トランザクションID
     */
    EndByUserIdRequest& withTransactionId(const Char* transactionId)
    {
        ensureData().transactionId.emplace(transactionId);
        return *this;
    }
     ...
     * @param rewards 実際にクエストで得た報酬
     */
    EndByUserIdRequest& withRewards(const List<Reward>& rewards)
    {
        ensureData().rewards.emplace(rewards);
        return *this;
    }
     ...
     * @param config スタンプシートの変数に適用する設定値
     */
    EndByUserIdRequest& withConfig(const List<Config>& config)
    {
        ensureData().config.emplace(config);
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    EndByUserIdRequest& withDuplicationAvoider(const Char* duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(duplicationAvoider);
        return *this;
    }
     ...
     */
    EndByUserIdRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    EndByUserIdRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    EndByUserIdRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    EndByUserIdRequest& withRequestId(const Char* gs2RequestId)
    {
