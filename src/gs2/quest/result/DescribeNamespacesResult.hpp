...
#ifndef GS2_QUEST_CONTROL_DESCRIBENAMESPACESRESULT_HPP_
#define GS2_QUEST_CONTROL_DESCRIBENAMESPACESRESULT_HPP_
...
public:
     ...
     *
     * @param items クエストを分類するカテゴリーのリスト
     */
...
#endif //GS2_QUEST_CONTROL_DESCRIBENAMESPACESRESULT_HPP_