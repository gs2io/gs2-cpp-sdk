...
public:
    UpdateQuestModelMasterResult() = default;
    UpdateQuestModelMasterResult(const UpdateQuestModelMasterResult& updateQuestModelMasterResult) = default;
    UpdateQuestModelMasterResult(UpdateQuestModelMasterResult&& updateQuestModelMasterResult) = default;
    ~UpdateQuestModelMasterResult() = default;

    UpdateQuestModelMasterResult& operator=(const UpdateQuestModelMasterResult& updateQuestModelMasterResult) = default;
    UpdateQuestModelMasterResult& operator=(UpdateQuestModelMasterResult&& updateQuestModelMasterResult) = default;

    UpdateQuestModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateQuestModelMasterResult);
    }
