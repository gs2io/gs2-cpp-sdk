...
public:
    ...
    StartByUserIdResult(const StartByUserIdResult& startByUserIdResult) :
        Gs2Object(startByUserIdResult),
        m_pData(startByUserIdResult.m_pData != nullptr ? new Data(*startByUserIdResult.m_pData) : nullptr)
    {}

    StartByUserIdResult(StartByUserIdResult&& startByUserIdResult) :
        Gs2Object(std::move(startByUserIdResult)),
        m_pData(startByUserIdResult.m_pData)
    {
        startByUserIdResult.m_pData = nullptr;
    }
    ...
    StartByUserIdResult& operator=(const StartByUserIdResult& startByUserIdResult)
    {
        Gs2Object::operator=(startByUserIdResult);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*startByUserIdResult.m_pData);

        return *this;
    }

    StartByUserIdResult& operator=(StartByUserIdResult&& startByUserIdResult)
    {
        Gs2Object::operator=(std::move(startByUserIdResult));
