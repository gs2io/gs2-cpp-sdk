...
#include "GetProgressByUserIdResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace quest
{

GetProgressByUserIdResult::Data::Data(const Data& data) :
...
void GetProgressByUserIdResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
GetProgressByUserIdResult GetProgressByUserIdResult::deepCopy() const
{
