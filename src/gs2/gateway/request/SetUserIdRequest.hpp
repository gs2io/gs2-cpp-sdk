 ...
 */
class SetUserIdRequest : public Gs2UserRequest, public Gs2Gateway
{
public:
...
public:
    ...
    {
        Gs2UserRequest::operator=(setUserIdRequest);
    ...
    {
        Gs2UserRequest::operator=(std::move(setUserIdRequest));
