...
#ifndef GS2_GATEWAY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_GATEWAY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Gateway
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Gateway::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Gateway::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_GATEWAY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_