...
public:
    SetUserIdByUserIdRequest() = default;
    SetUserIdByUserIdRequest(const SetUserIdByUserIdRequest& setUserIdByUserIdRequest) = default;
    SetUserIdByUserIdRequest(SetUserIdByUserIdRequest&& setUserIdByUserIdRequest) = default;
    ~SetUserIdByUserIdRequest() GS2_OVERRIDE = default;

    SetUserIdByUserIdRequest& operator=(const SetUserIdByUserIdRequest& setUserIdByUserIdRequest) = default;
    SetUserIdByUserIdRequest& operator=(SetUserIdByUserIdRequest&& setUserIdByUserIdRequest) = default;

    SetUserIdByUserIdRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SetUserIdByUserIdRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    SetUserIdByUserIdRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param connectionId コネクションID
     */
    SetUserIdByUserIdRequest& withConnectionId(StringHolder connectionId)
    {
        ensureData().connectionId.emplace(std::move(connectionId));
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    SetUserIdByUserIdRequest& withUserId(StringHolder userId)
    {
        ensureData().userId.emplace(std::move(userId));
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    SetUserIdByUserIdRequest& withDuplicationAvoider(StringHolder duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(std::move(duplicationAvoider));
        return *this;
    }
     ...
     */
    SetUserIdByUserIdRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    SetUserIdByUserIdRequest& withRequestId(StringHolder gs2RequestId)
    {
