 ...
 */
class DeleteFirebaseTokenRequest : public Gs2UserRequest, public Gs2Gateway
{
public:
...
public:
    ...
    {
        Gs2UserRequest::operator=(deleteFirebaseTokenRequest);
    ...
    {
        Gs2UserRequest::operator=(std::move(deleteFirebaseTokenRequest));
