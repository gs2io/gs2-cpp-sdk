...
#include "Gs2GatewayWebSocketClient.hpp"
...
void write(detail::json::JsonWriter& jsonWriter, const WebSocketSession& obj);
void write(detail::json::JsonWriter& jsonWriter, const FirebaseToken& obj);
 ...
 */
void Gs2GatewayWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::describeWebSocketSessions(DescribeWebSocketSessionsRequest request, std::function<void(AsyncDescribeWebSocketSessionsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::describeWebSocketSessionsByUserId(DescribeWebSocketSessionsByUserIdRequest request, std::function<void(AsyncDescribeWebSocketSessionsByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::setUserId(SetUserIdRequest request, std::function<void(AsyncSetUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::setUserIdByUserId(SetUserIdByUserIdRequest request, std::function<void(AsyncSetUserIdByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::getWebSocketSession(GetWebSocketSessionRequest request, std::function<void(AsyncGetWebSocketSessionResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::getWebSocketSessionByConnectionId(GetWebSocketSessionByConnectionIdRequest request, std::function<void(AsyncGetWebSocketSessionByConnectionIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::sendNotification(SendNotificationRequest request, std::function<void(AsyncSendNotificationResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::setFirebaseToken(SetFirebaseTokenRequest request, std::function<void(AsyncSetFirebaseTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::setFirebaseTokenByUserId(SetFirebaseTokenByUserIdRequest request, std::function<void(AsyncSetFirebaseTokenByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::getFirebaseToken(GetFirebaseTokenRequest request, std::function<void(AsyncGetFirebaseTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::getFirebaseTokenByUserId(GetFirebaseTokenByUserIdRequest request, std::function<void(AsyncGetFirebaseTokenByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::deleteFirebaseToken(DeleteFirebaseTokenRequest request, std::function<void(AsyncDeleteFirebaseTokenResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::deleteFirebaseTokenByUserId(DeleteFirebaseTokenByUserIdRequest request, std::function<void(AsyncDeleteFirebaseTokenByUserIdResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2GatewayWebSocketClient::sendMobileNotificationByUserId(SendMobileNotificationByUserIdRequest request, std::function<void(AsyncSendMobileNotificationByUserIdResult)> callback)
{
