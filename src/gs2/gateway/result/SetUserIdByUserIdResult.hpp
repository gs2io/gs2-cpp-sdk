...
public:
    SetUserIdByUserIdResult() = default;
    SetUserIdByUserIdResult(const SetUserIdByUserIdResult& setUserIdByUserIdResult) = default;
    SetUserIdByUserIdResult(SetUserIdByUserIdResult&& setUserIdByUserIdResult) = default;
    ~SetUserIdByUserIdResult() = default;

    SetUserIdByUserIdResult& operator=(const SetUserIdByUserIdResult& setUserIdByUserIdResult) = default;
    SetUserIdByUserIdResult& operator=(SetUserIdByUserIdResult&& setUserIdByUserIdResult) = default;

    SetUserIdByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SetUserIdByUserIdResult);
    }
