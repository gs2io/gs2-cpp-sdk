...
public:
    SetUserIdResult() = default;
    SetUserIdResult(const SetUserIdResult& setUserIdResult) = default;
    SetUserIdResult(SetUserIdResult&& setUserIdResult) = default;
    ~SetUserIdResult() = default;

    SetUserIdResult& operator=(const SetUserIdResult& setUserIdResult) = default;
    SetUserIdResult& operator=(SetUserIdResult&& setUserIdResult) = default;

    SetUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(SetUserIdResult);
    }
