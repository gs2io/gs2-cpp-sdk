...
public:
    DescribeWebSocketSessionsByUserIdResult() = default;
    DescribeWebSocketSessionsByUserIdResult(const DescribeWebSocketSessionsByUserIdResult& describeWebSocketSessionsByUserIdResult) = default;
    DescribeWebSocketSessionsByUserIdResult(DescribeWebSocketSessionsByUserIdResult&& describeWebSocketSessionsByUserIdResult) = default;
    ~DescribeWebSocketSessionsByUserIdResult() = default;

    DescribeWebSocketSessionsByUserIdResult& operator=(const DescribeWebSocketSessionsByUserIdResult& describeWebSocketSessionsByUserIdResult) = default;
    DescribeWebSocketSessionsByUserIdResult& operator=(DescribeWebSocketSessionsByUserIdResult&& describeWebSocketSessionsByUserIdResult) = default;

    DescribeWebSocketSessionsByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeWebSocketSessionsByUserIdResult);
    }
