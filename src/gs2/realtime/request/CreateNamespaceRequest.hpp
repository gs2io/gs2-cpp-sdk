...
#ifndef GS2_REALTIME_CONTROL_CREATENAMESPACEREQUEST_HPP_
#define GS2_REALTIME_CONTROL_CREATENAMESPACEREQUEST_HPP_
 ...
 */
class CreateNamespaceRequest : public Gs2BasicRequest, public Gs2Realtime
{
public:
...
public:
     ...
     * @param serverType サーバの種類
     */
    CreateNamespaceRequest& withServerType(StringHolder serverType)
    {
        ensureData().serverType.emplace(std::move(serverType));
        return *this;
    }
     ...
     * @param serverSpec サーバのスペック
     */
    CreateNamespaceRequest& withServerSpec(StringHolder serverSpec)
    {
        ensureData().serverSpec.emplace(std::move(serverSpec));
        return *this;
    }
...
#endif //GS2_REALTIME_CONTROL_CREATENAMESPACEREQUEST_HPP_