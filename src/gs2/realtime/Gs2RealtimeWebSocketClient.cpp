 ...
 */
void Gs2RealtimeWebSocketClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::describeRooms(DescribeRoomsRequest request, std::function<void(AsyncDescribeRoomsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::wantRoom(WantRoomRequest request, std::function<void(AsyncWantRoomResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::getRoom(GetRoomRequest request, std::function<void(AsyncGetRoomResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeWebSocketClient::deleteRoom(DeleteRoomRequest request, std::function<void(AsyncDeleteRoomResult)> callback)
{
