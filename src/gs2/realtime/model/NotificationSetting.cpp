...
NotificationSetting::Data::Data(const Data& data) :
...
void NotificationSetting::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
NotificationSetting NotificationSetting::deepCopy() const
{
