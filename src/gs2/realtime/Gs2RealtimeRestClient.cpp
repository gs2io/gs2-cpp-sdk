...
class WantRoomTask : public detail::Gs2RestSessionTask<WantRoomResult>
{
private:
...
public:
    WantRoomTask(
        ...
        Gs2RestSessionTask<WantRoomResult>::CallbackType callback
    ) :
        Gs2RestSessionTask<WantRoomResult>(callback),
        m_Request(std::move(request))
    {}
 ...
 */
void Gs2RealtimeRestClient::describeNamespaces(DescribeNamespacesRequest request, std::function<void(AsyncDescribeNamespacesResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::createNamespace(CreateNamespaceRequest request, std::function<void(AsyncCreateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::getNamespaceStatus(GetNamespaceStatusRequest request, std::function<void(AsyncGetNamespaceStatusResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::getNamespace(GetNamespaceRequest request, std::function<void(AsyncGetNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::updateNamespace(UpdateNamespaceRequest request, std::function<void(AsyncUpdateNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::deleteNamespace(DeleteNamespaceRequest request, std::function<void(AsyncDeleteNamespaceResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::describeRooms(DescribeRoomsRequest request, std::function<void(AsyncDescribeRoomsResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::wantRoom(WantRoomRequest request, std::function<void(AsyncWantRoomResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::getRoom(GetRoomRequest request, std::function<void(AsyncGetRoomResult)> callback)
{
 ...
 * @param request リクエストパラメータ
 */
void Gs2RealtimeRestClient::deleteRoom(DeleteRoomRequest request, std::function<void(AsyncDeleteRoomResult)> callback)
{
