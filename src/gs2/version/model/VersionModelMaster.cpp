...
#include "VersionModelMaster.hpp"
#include <gs2/core/json/JsonParser.hpp>
#include <cstring>

namespace gs2 { namespace version {

VersionModelMaster::Data::Data(const Data& data) :
...
void VersionModelMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
VersionModelMaster VersionModelMaster::deepCopy() const
{
