...
#ifndef GS2_VERSION_CONTROL_CREATEVERSIONMODELMASTERREQUEST_HPP_
#define GS2_VERSION_CONTROL_CREATEVERSIONMODELMASTERREQUEST_HPP_
 ...
 */
class CreateVersionModelMasterRequest : public Gs2BasicRequest, public Gs2Version
{
public:
...
public:
    CreateVersionModelMasterRequest() = default;
    CreateVersionModelMasterRequest(const CreateVersionModelMasterRequest& createVersionModelMasterRequest) = default;
    CreateVersionModelMasterRequest(CreateVersionModelMasterRequest&& createVersionModelMasterRequest) = default;
    ~CreateVersionModelMasterRequest() GS2_OVERRIDE = default;

    CreateVersionModelMasterRequest& operator=(const CreateVersionModelMasterRequest& createVersionModelMasterRequest) = default;
    CreateVersionModelMasterRequest& operator=(CreateVersionModelMasterRequest&& createVersionModelMasterRequest) = default;

    CreateVersionModelMasterRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CreateVersionModelMasterRequest);
    }

    const CreateVersionModelMasterRequest* operator->() const
    {
        return this;
    }

    CreateVersionModelMasterRequest* operator->()
    {
        return this;
    }
     ...
     * @param namespaceName ネームスペース名
     */
    CreateVersionModelMasterRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param name バージョン名
     */
    CreateVersionModelMasterRequest& withName(StringHolder name)
    {
        ensureData().name.emplace(std::move(name));
        return *this;
    }
     ...
     * @param description バージョンマスターの説明
     */
    CreateVersionModelMasterRequest& withDescription(StringHolder description)
    {
        ensureData().description.emplace(std::move(description));
        return *this;
    }
     ...
     * @param metadata バージョンのメタデータ
     */
    CreateVersionModelMasterRequest& withMetadata(StringHolder metadata)
    {
        ensureData().metadata.emplace(std::move(metadata));
        return *this;
    }
     ...
     * @param warningVersion バージョンアップを促すバージョン
     */
    CreateVersionModelMasterRequest& withWarningVersion(Version warningVersion)
    {
        ensureData().warningVersion.emplace(std::move(warningVersion));
        return *this;
    }
     ...
     * @param scope 判定に使用するバージョン値の種類
     */
    CreateVersionModelMasterRequest& withScope(StringHolder scope)
    {
        ensureData().scope.emplace(std::move(scope));
        return *this;
    }
     ...
     * @param currentVersion 現在のバージョン
     */
    CreateVersionModelMasterRequest& withCurrentVersion(Version currentVersion)
    {
        ensureData().currentVersion.emplace(std::move(currentVersion));
        return *this;
    }
     ...
     * @param needSignature 判定するバージョン値に署名検証を必要とするか
     */
    CreateVersionModelMasterRequest& withNeedSignature(Bool needSignature)
    {
        ensureData().needSignature.emplace(needSignature);
        return *this;
    }
     ...
     * @param signatureKeyId 署名検証に使用する暗号鍵 のGRN
     */
    CreateVersionModelMasterRequest& withSignatureKeyId(StringHolder signatureKeyId)
    {
        ensureData().signatureKeyId.emplace(std::move(signatureKeyId));
        return *this;
    }
     ...
     */
    CreateVersionModelMasterRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    CreateVersionModelMasterRequest& withRequestId(StringHolder gs2RequestId)
    {
...
#endif //GS2_VERSION_CONTROL_CREATEVERSIONMODELMASTERREQUEST_HPP_