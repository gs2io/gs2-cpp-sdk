...
#ifndef GS2_VERSION_CONTROL_CHECKVERSIONRESULT_HPP_
#define GS2_VERSION_CONTROL_CHECKVERSIONRESULT_HPP_
 ...
 */
class CheckVersionResult : public Gs2Object
{
private:
...
public:
    CheckVersionResult() = default;
    CheckVersionResult(const CheckVersionResult& checkVersionResult) = default;
    CheckVersionResult(CheckVersionResult&& checkVersionResult) = default;
    ~CheckVersionResult() = default;

    CheckVersionResult& operator=(const CheckVersionResult& checkVersionResult) = default;
    CheckVersionResult& operator=(CheckVersionResult&& checkVersionResult) = default;

    CheckVersionResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CheckVersionResult);
    }

    const CheckVersionResult* operator->() const
    {
        return this;
    }

    CheckVersionResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<CheckVersionResult> AsyncCheckVersionResult;

} }

#endif //GS2_VERSION_CONTROL_CHECKVERSIONRESULT_HPP_