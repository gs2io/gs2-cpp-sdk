...
#include "CheckVersionResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace version
{

CheckVersionResult::Data::Data(const Data& data) :
...
void CheckVersionResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CheckVersionResult CheckVersionResult::deepCopy() const
{
