...
InventoryModel::Data::Data(const Data& data) :
...
void InventoryModel::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
InventoryModel InventoryModel::deepCopy() const
{
