...
ItemModel::Data::Data(const Data& data) :
...
void ItemModel::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ItemModel ItemModel::deepCopy() const
{
