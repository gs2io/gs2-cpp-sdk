...
CurrentItemModelMaster::Data::Data(const Data& data) :
...
void CurrentItemModelMaster::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
CurrentItemModelMaster CurrentItemModelMaster::deepCopy() const
{
    GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(CurrentItemModelMaster);
}
