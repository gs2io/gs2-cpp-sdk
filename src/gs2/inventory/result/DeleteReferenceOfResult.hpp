...
#ifndef GS2_INVENTORY_CONTROL_DELETEREFERENCEOFRESULT_HPP_
#define GS2_INVENTORY_CONTROL_DELETEREFERENCEOFRESULT_HPP_
 ...
 */
class DeleteReferenceOfResult : public Gs2Object
{
private:
...
public:
    DeleteReferenceOfResult() = default;
    DeleteReferenceOfResult(const DeleteReferenceOfResult& deleteReferenceOfResult) = default;
    DeleteReferenceOfResult(DeleteReferenceOfResult&& deleteReferenceOfResult) = default;
    ~DeleteReferenceOfResult() = default;

    DeleteReferenceOfResult& operator=(const DeleteReferenceOfResult& deleteReferenceOfResult) = default;
    DeleteReferenceOfResult& operator=(DeleteReferenceOfResult&& deleteReferenceOfResult) = default;

    DeleteReferenceOfResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteReferenceOfResult);
    }

    const DeleteReferenceOfResult* operator->() const
    {
        return this;
    }

    DeleteReferenceOfResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<DeleteReferenceOfResult> AsyncDeleteReferenceOfResult;

} }

#endif //GS2_INVENTORY_CONTROL_DELETEREFERENCEOFRESULT_HPP_