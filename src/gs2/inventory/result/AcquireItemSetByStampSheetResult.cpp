...
#include "AcquireItemSetByStampSheetResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

AcquireItemSetByStampSheetResult::Data::Data(const Data& data) :
...
void AcquireItemSetByStampSheetResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
AcquireItemSetByStampSheetResult AcquireItemSetByStampSheetResult::deepCopy() const
{
