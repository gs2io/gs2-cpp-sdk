...
#include "GetItemSetByUserIdResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

GetItemSetByUserIdResult::Data::Data(const Data& data) :
...
void GetItemSetByUserIdResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
GetItemSetByUserIdResult GetItemSetByUserIdResult::deepCopy() const
{
