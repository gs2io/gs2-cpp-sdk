...
public:
    GetInventoryModelMasterResult() = default;
    GetInventoryModelMasterResult(const GetInventoryModelMasterResult& getInventoryModelMasterResult) = default;
    GetInventoryModelMasterResult(GetInventoryModelMasterResult&& getInventoryModelMasterResult) = default;
    ~GetInventoryModelMasterResult() = default;

    GetInventoryModelMasterResult& operator=(const GetInventoryModelMasterResult& getInventoryModelMasterResult) = default;
    GetInventoryModelMasterResult& operator=(GetInventoryModelMasterResult&& getInventoryModelMasterResult) = default;

    GetInventoryModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetInventoryModelMasterResult);
    }
