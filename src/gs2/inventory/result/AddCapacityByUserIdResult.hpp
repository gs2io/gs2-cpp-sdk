...
public:
    AddCapacityByUserIdResult() = default;
    AddCapacityByUserIdResult(const AddCapacityByUserIdResult& addCapacityByUserIdResult) = default;
    AddCapacityByUserIdResult(AddCapacityByUserIdResult&& addCapacityByUserIdResult) = default;
    ~AddCapacityByUserIdResult() = default;

    AddCapacityByUserIdResult& operator=(const AddCapacityByUserIdResult& addCapacityByUserIdResult) = default;
    AddCapacityByUserIdResult& operator=(AddCapacityByUserIdResult&& addCapacityByUserIdResult) = default;

    AddCapacityByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(AddCapacityByUserIdResult);
    }
