...
#include "AcquireItemSetByUserIdResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

AcquireItemSetByUserIdResult::Data::Data(const Data& data) :
...
void AcquireItemSetByUserIdResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
AcquireItemSetByUserIdResult AcquireItemSetByUserIdResult::deepCopy() const
{
