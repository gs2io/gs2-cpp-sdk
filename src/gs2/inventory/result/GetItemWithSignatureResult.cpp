...
#include "GetItemWithSignatureResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

GetItemWithSignatureResult::Data::Data(const Data& data) :
...
void GetItemWithSignatureResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
GetItemWithSignatureResult GetItemWithSignatureResult::deepCopy() const
{
