...
#include "GetItemSetResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

GetItemSetResult::Data::Data(const Data& data) :
...
void GetItemSetResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
GetItemSetResult GetItemSetResult::deepCopy() const
{
