...
#ifndef GS2_INVENTORY_CONTROL_VERIFYREFERENCEOFBYUSERIDRESULT_HPP_
#define GS2_INVENTORY_CONTROL_VERIFYREFERENCEOFBYUSERIDRESULT_HPP_
 ...
 */
class VerifyReferenceOfByUserIdResult : public Gs2Object
{
private:
...
public:
    VerifyReferenceOfByUserIdResult() = default;
    VerifyReferenceOfByUserIdResult(const VerifyReferenceOfByUserIdResult& verifyReferenceOfByUserIdResult) = default;
    VerifyReferenceOfByUserIdResult(VerifyReferenceOfByUserIdResult&& verifyReferenceOfByUserIdResult) = default;
    ~VerifyReferenceOfByUserIdResult() = default;

    VerifyReferenceOfByUserIdResult& operator=(const VerifyReferenceOfByUserIdResult& verifyReferenceOfByUserIdResult) = default;
    VerifyReferenceOfByUserIdResult& operator=(VerifyReferenceOfByUserIdResult&& verifyReferenceOfByUserIdResult) = default;

    VerifyReferenceOfByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(VerifyReferenceOfByUserIdResult);
    }

    const VerifyReferenceOfByUserIdResult* operator->() const
    {
        return this;
    }

    VerifyReferenceOfByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<VerifyReferenceOfByUserIdResult> AsyncVerifyReferenceOfByUserIdResult;

} }

#endif //GS2_INVENTORY_CONTROL_VERIFYREFERENCEOFBYUSERIDRESULT_HPP_