...
#include "ConsumeItemSetResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

ConsumeItemSetResult::Data::Data(const Data& data) :
...
void ConsumeItemSetResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ConsumeItemSetResult ConsumeItemSetResult::deepCopy() const
{
