...
#ifndef GS2_INVENTORY_CONTROL_GETITEMWITHSIGNATURERESULT_HPP_
#define GS2_INVENTORY_CONTROL_GETITEMWITHSIGNATURERESULT_HPP_
 ...
 */
class GetItemWithSignatureResult : public Gs2Object
{
private:
...
public:
    GetItemWithSignatureResult() = default;
    GetItemWithSignatureResult(const GetItemWithSignatureResult& getItemWithSignatureResult) = default;
    GetItemWithSignatureResult(GetItemWithSignatureResult&& getItemWithSignatureResult) = default;
    ~GetItemWithSignatureResult() = default;

    GetItemWithSignatureResult& operator=(const GetItemWithSignatureResult& getItemWithSignatureResult) = default;
    GetItemWithSignatureResult& operator=(GetItemWithSignatureResult&& getItemWithSignatureResult) = default;

    GetItemWithSignatureResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetItemWithSignatureResult);
    }

    const GetItemWithSignatureResult* operator->() const
    {
        return this;
    }

    GetItemWithSignatureResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<GetItemWithSignatureResult> AsyncGetItemWithSignatureResult;

} }

#endif //GS2_INVENTORY_CONTROL_GETITEMWITHSIGNATURERESULT_HPP_