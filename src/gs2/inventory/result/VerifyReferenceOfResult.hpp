...
#ifndef GS2_INVENTORY_CONTROL_VERIFYREFERENCEOFRESULT_HPP_
#define GS2_INVENTORY_CONTROL_VERIFYREFERENCEOFRESULT_HPP_
 ...
 */
class VerifyReferenceOfResult : public Gs2Object
{
private:
...
public:
    VerifyReferenceOfResult() = default;
    VerifyReferenceOfResult(const VerifyReferenceOfResult& verifyReferenceOfResult) = default;
    VerifyReferenceOfResult(VerifyReferenceOfResult&& verifyReferenceOfResult) = default;
    ~VerifyReferenceOfResult() = default;

    VerifyReferenceOfResult& operator=(const VerifyReferenceOfResult& verifyReferenceOfResult) = default;
    VerifyReferenceOfResult& operator=(VerifyReferenceOfResult&& verifyReferenceOfResult) = default;

    VerifyReferenceOfResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(VerifyReferenceOfResult);
    }

    const VerifyReferenceOfResult* operator->() const
    {
        return this;
    }

    VerifyReferenceOfResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<VerifyReferenceOfResult> AsyncVerifyReferenceOfResult;

} }

#endif //GS2_INVENTORY_CONTROL_VERIFYREFERENCEOFRESULT_HPP_