...
public:
    DeleteInventoryModelMasterResult() = default;
    DeleteInventoryModelMasterResult(const DeleteInventoryModelMasterResult& deleteInventoryModelMasterResult) = default;
    DeleteInventoryModelMasterResult(DeleteInventoryModelMasterResult&& deleteInventoryModelMasterResult) = default;
    ~DeleteInventoryModelMasterResult() = default;

    DeleteInventoryModelMasterResult& operator=(const DeleteInventoryModelMasterResult& deleteInventoryModelMasterResult) = default;
    DeleteInventoryModelMasterResult& operator=(DeleteInventoryModelMasterResult&& deleteInventoryModelMasterResult) = default;

    DeleteInventoryModelMasterResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DeleteInventoryModelMasterResult);
    }
