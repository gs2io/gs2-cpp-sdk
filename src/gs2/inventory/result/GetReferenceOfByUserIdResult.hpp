...
#ifndef GS2_INVENTORY_CONTROL_GETREFERENCEOFBYUSERIDRESULT_HPP_
#define GS2_INVENTORY_CONTROL_GETREFERENCEOFBYUSERIDRESULT_HPP_
 ...
 */
class GetReferenceOfByUserIdResult : public Gs2Object
{
private:
...
public:
    GetReferenceOfByUserIdResult() = default;
    GetReferenceOfByUserIdResult(const GetReferenceOfByUserIdResult& getReferenceOfByUserIdResult) = default;
    GetReferenceOfByUserIdResult(GetReferenceOfByUserIdResult&& getReferenceOfByUserIdResult) = default;
    ~GetReferenceOfByUserIdResult() = default;

    GetReferenceOfByUserIdResult& operator=(const GetReferenceOfByUserIdResult& getReferenceOfByUserIdResult) = default;
    GetReferenceOfByUserIdResult& operator=(GetReferenceOfByUserIdResult&& getReferenceOfByUserIdResult) = default;

    GetReferenceOfByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetReferenceOfByUserIdResult);
    }

    const GetReferenceOfByUserIdResult* operator->() const
    {
        return this;
    }

    GetReferenceOfByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<GetReferenceOfByUserIdResult> AsyncGetReferenceOfByUserIdResult;

} }

#endif //GS2_INVENTORY_CONTROL_GETREFERENCEOFBYUSERIDRESULT_HPP_