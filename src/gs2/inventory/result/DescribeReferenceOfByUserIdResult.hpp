...
#ifndef GS2_INVENTORY_CONTROL_DESCRIBEREFERENCEOFBYUSERIDRESULT_HPP_
#define GS2_INVENTORY_CONTROL_DESCRIBEREFERENCEOFBYUSERIDRESULT_HPP_
 ...
 */
class DescribeReferenceOfByUserIdResult : public Gs2Object
{
private:
...
public:
    DescribeReferenceOfByUserIdResult() = default;
    DescribeReferenceOfByUserIdResult(const DescribeReferenceOfByUserIdResult& describeReferenceOfByUserIdResult) = default;
    DescribeReferenceOfByUserIdResult(DescribeReferenceOfByUserIdResult&& describeReferenceOfByUserIdResult) = default;
    ~DescribeReferenceOfByUserIdResult() = default;

    DescribeReferenceOfByUserIdResult& operator=(const DescribeReferenceOfByUserIdResult& describeReferenceOfByUserIdResult) = default;
    DescribeReferenceOfByUserIdResult& operator=(DescribeReferenceOfByUserIdResult&& describeReferenceOfByUserIdResult) = default;

    DescribeReferenceOfByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeReferenceOfByUserIdResult);
    }

    const DescribeReferenceOfByUserIdResult* operator->() const
    {
        return this;
    }

    DescribeReferenceOfByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<DescribeReferenceOfByUserIdResult> AsyncDescribeReferenceOfByUserIdResult;

} }

#endif //GS2_INVENTORY_CONTROL_DESCRIBEREFERENCEOFBYUSERIDRESULT_HPP_