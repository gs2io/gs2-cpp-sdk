...
#ifndef GS2_INVENTORY_CONTROL_ADDREFERENCEOFRESULT_HPP_
#define GS2_INVENTORY_CONTROL_ADDREFERENCEOFRESULT_HPP_
 ...
 */
class AddReferenceOfResult : public Gs2Object
{
private:
...
public:
    AddReferenceOfResult() = default;
    AddReferenceOfResult(const AddReferenceOfResult& addReferenceOfResult) = default;
    AddReferenceOfResult(AddReferenceOfResult&& addReferenceOfResult) = default;
    ~AddReferenceOfResult() = default;

    AddReferenceOfResult& operator=(const AddReferenceOfResult& addReferenceOfResult) = default;
    AddReferenceOfResult& operator=(AddReferenceOfResult&& addReferenceOfResult) = default;

    AddReferenceOfResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(AddReferenceOfResult);
    }

    const AddReferenceOfResult* operator->() const
    {
        return this;
    }

    AddReferenceOfResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<AddReferenceOfResult> AsyncAddReferenceOfResult;

} }

#endif //GS2_INVENTORY_CONTROL_ADDREFERENCEOFRESULT_HPP_