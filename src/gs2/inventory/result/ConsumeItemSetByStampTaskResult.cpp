...
#include "ConsumeItemSetByStampTaskResult.hpp"
#include <gs2/core/json/JsonParser.hpp>

namespace gs2 { namespace inventory
{

ConsumeItemSetByStampTaskResult::Data::Data(const Data& data) :
...
void ConsumeItemSetByStampTaskResult::Data::set(const Char name_[], const detail::json::JsonConstValue& jsonValue)
{
...
ConsumeItemSetByStampTaskResult ConsumeItemSetByStampTaskResult::deepCopy() const
{
