...
#ifndef GS2_INVENTORY_CONTROL_ADDREFERENCEOFBYUSERIDRESULT_HPP_
#define GS2_INVENTORY_CONTROL_ADDREFERENCEOFBYUSERIDRESULT_HPP_
 ...
 */
class AddReferenceOfByUserIdResult : public Gs2Object
{
private:
...
public:
    AddReferenceOfByUserIdResult() = default;
    AddReferenceOfByUserIdResult(const AddReferenceOfByUserIdResult& addReferenceOfByUserIdResult) = default;
    AddReferenceOfByUserIdResult(AddReferenceOfByUserIdResult&& addReferenceOfByUserIdResult) = default;
    ~AddReferenceOfByUserIdResult() = default;

    AddReferenceOfByUserIdResult& operator=(const AddReferenceOfByUserIdResult& addReferenceOfByUserIdResult) = default;
    AddReferenceOfByUserIdResult& operator=(AddReferenceOfByUserIdResult&& addReferenceOfByUserIdResult) = default;

    AddReferenceOfByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(AddReferenceOfByUserIdResult);
    }

    const AddReferenceOfByUserIdResult* operator->() const
    {
        return this;
    }

    AddReferenceOfByUserIdResult* operator->()
    {
        return this;
    }
    /**
...
typedef AsyncResult<AddReferenceOfByUserIdResult> AsyncAddReferenceOfByUserIdResult;

} }

#endif //GS2_INVENTORY_CONTROL_ADDREFERENCEOFBYUSERIDRESULT_HPP_