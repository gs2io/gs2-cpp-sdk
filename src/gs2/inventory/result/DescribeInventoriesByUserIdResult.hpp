...
public:
    DescribeInventoriesByUserIdResult() = default;
    DescribeInventoriesByUserIdResult(const DescribeInventoriesByUserIdResult& describeInventoriesByUserIdResult) = default;
    DescribeInventoriesByUserIdResult(DescribeInventoriesByUserIdResult&& describeInventoriesByUserIdResult) = default;
    ~DescribeInventoriesByUserIdResult() = default;

    DescribeInventoriesByUserIdResult& operator=(const DescribeInventoriesByUserIdResult& describeInventoriesByUserIdResult) = default;
    DescribeInventoriesByUserIdResult& operator=(DescribeInventoriesByUserIdResult&& describeInventoriesByUserIdResult) = default;

    DescribeInventoriesByUserIdResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(DescribeInventoriesByUserIdResult);
    }
