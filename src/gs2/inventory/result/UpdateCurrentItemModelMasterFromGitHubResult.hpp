...
public:
    UpdateCurrentItemModelMasterFromGitHubResult() = default;
    UpdateCurrentItemModelMasterFromGitHubResult(const UpdateCurrentItemModelMasterFromGitHubResult& updateCurrentItemModelMasterFromGitHubResult) = default;
    UpdateCurrentItemModelMasterFromGitHubResult(UpdateCurrentItemModelMasterFromGitHubResult&& updateCurrentItemModelMasterFromGitHubResult) = default;
    ~UpdateCurrentItemModelMasterFromGitHubResult() = default;

    UpdateCurrentItemModelMasterFromGitHubResult& operator=(const UpdateCurrentItemModelMasterFromGitHubResult& updateCurrentItemModelMasterFromGitHubResult) = default;
    UpdateCurrentItemModelMasterFromGitHubResult& operator=(UpdateCurrentItemModelMasterFromGitHubResult&& updateCurrentItemModelMasterFromGitHubResult) = default;

    UpdateCurrentItemModelMasterFromGitHubResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(UpdateCurrentItemModelMasterFromGitHubResult);
    }
