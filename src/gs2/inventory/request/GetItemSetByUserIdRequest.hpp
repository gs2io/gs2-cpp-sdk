...
public:
    GetItemSetByUserIdRequest() = default;
    GetItemSetByUserIdRequest(const GetItemSetByUserIdRequest& getItemSetByUserIdRequest) = default;
    GetItemSetByUserIdRequest(GetItemSetByUserIdRequest&& getItemSetByUserIdRequest) = default;
    ~GetItemSetByUserIdRequest() GS2_OVERRIDE = default;

    GetItemSetByUserIdRequest& operator=(const GetItemSetByUserIdRequest& getItemSetByUserIdRequest) = default;
    GetItemSetByUserIdRequest& operator=(GetItemSetByUserIdRequest&& getItemSetByUserIdRequest) = default;

    GetItemSetByUserIdRequest deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetItemSetByUserIdRequest);
    }
     ...
     * @param namespaceName ネームスペース名
     */
    GetItemSetByUserIdRequest& withNamespaceName(StringHolder namespaceName)
    {
        ensureData().namespaceName.emplace(std::move(namespaceName));
        return *this;
    }
     ...
     * @param inventoryName インベントリの名前
     */
    GetItemSetByUserIdRequest& withInventoryName(StringHolder inventoryName)
    {
        ensureData().inventoryName.emplace(std::move(inventoryName));
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    GetItemSetByUserIdRequest& withUserId(StringHolder userId)
    {
        ensureData().userId.emplace(std::move(userId));
        return *this;
    }
     ...
     * @param itemName アイテムマスターの名前
     */
    GetItemSetByUserIdRequest& withItemName(StringHolder itemName)
    {
        ensureData().itemName.emplace(std::move(itemName));
        return *this;
    }
     ...
     * @param itemSetName アイテムセットを識別する名前
     */
    GetItemSetByUserIdRequest& withItemSetName(StringHolder itemSetName)
    {
        ensureData().itemSetName.emplace(std::move(itemSetName));
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    GetItemSetByUserIdRequest& withDuplicationAvoider(StringHolder duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(std::move(duplicationAvoider));
        return *this;
    }
     ...
     */
    GetItemSetByUserIdRequest& withGs2ClientId(StringHolder gs2ClientId)
    {
     ...
     */
    GetItemSetByUserIdRequest& withRequestId(StringHolder gs2RequestId)
    {
