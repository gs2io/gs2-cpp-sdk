...
public:
     ...
     * @param categoryName カテゴリ名
     */
    GetItemModelRequest& withCategoryName(const Char* categoryName)
    {
        ensureData().categoryName.emplace(categoryName);
        return *this;
    }
     ...
     * @param inventoryModelName インベントリの種類名
     */
    GetItemModelRequest& withInventoryModelName(const Char* inventoryModelName)
    {
        ensureData().inventoryModelName.emplace(inventoryModelName);
        return *this;
    }
     ...
     * @param itemModelName アイテムモデルの種類名
     */
    GetItemModelRequest& withItemModelName(const Char* itemModelName)
    {
        ensureData().itemModelName.emplace(itemModelName);
        return *this;
    }
