...
#ifndef GS2_INVENTORY_CONTROL_UPDATECATEGORYREQUEST_HPP_
#define GS2_INVENTORY_CONTROL_UPDATECATEGORYREQUEST_HPP_
 ...
 */
class UpdateCategoryRequest : public Gs2BasicRequest, public Gs2Inventory
{
public:
...
public:
    ...
    UpdateCategoryRequest& operator=(const UpdateCategoryRequest& updateCategoryRequest)
    {
        ...
        Gs2Inventory::operator=(updateCategoryRequest);
    ...
    UpdateCategoryRequest& operator=(UpdateCategoryRequest&& updateCategoryRequest)
    {
        ...
        Gs2Inventory::operator=(std::move(updateCategoryRequest));
     ...
     * @param overflowTriggerScriptId 入手上限に当たって入手できなかった数量を通知する スクリプト のGRN
     */
    UpdateCategoryRequest& withOverflowTriggerScriptId(const Char* overflowTriggerScriptId)
    {
        ensureData().overflowTriggerScriptId.emplace(overflowTriggerScriptId);
        return *this;
    }
     ...
     * @param overflowTriggerQueueId 入手上限に当たって入手できなかった数量を通知するジョブを追加する キュー のGRN
     */
    UpdateCategoryRequest& withOverflowTriggerQueueId(const Char* overflowTriggerQueueId)
    {
        ensureData().overflowTriggerQueueId.emplace(overflowTriggerQueueId);
        return *this;
    }
...
#endif //GS2_INVENTORY_CONTROL_UPDATECATEGORYREQUEST_HPP_