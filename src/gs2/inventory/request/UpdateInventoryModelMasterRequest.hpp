...
public:
     ...
     * @param categoryName カテゴリ名
     */
    UpdateInventoryModelMasterRequest& withCategoryName(const Char* categoryName)
    {
        ensureData().categoryName.emplace(categoryName);
        return *this;
    }
     ...
     * @param inventoryModelName インベントリの種類名
     */
    UpdateInventoryModelMasterRequest& withInventoryModelName(const Char* inventoryModelName)
    {
        ensureData().inventoryModelName.emplace(inventoryModelName);
        return *this;
    }
