...
#ifndef GS2_INVENTORY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
#define GS2_INVENTORY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_
 ...
 */
class GetNamespaceStatusRequest : public Gs2BasicRequest, public Gs2Inventory
{
public:
...
public:
    ...
    GetNamespaceStatusRequest& operator=(const GetNamespaceStatusRequest& getNamespaceStatusRequest)
    {
        ...
        Gs2Inventory::operator=(getNamespaceStatusRequest);
    ...
    GetNamespaceStatusRequest& operator=(GetNamespaceStatusRequest&& getNamespaceStatusRequest)
    {
        ...
        Gs2Inventory::operator=(std::move(getNamespaceStatusRequest));
...
#endif //GS2_INVENTORY_CONTROL_GETNAMESPACESTATUSREQUEST_HPP_