...
public:
     ...
     * @param categoryName カテゴリ名
     */
    DeleteItemModelMasterRequest& withCategoryName(const Char* categoryName)
    {
        ensureData().categoryName.emplace(categoryName);
        return *this;
    }
     ...
     * @param inventoryModelName インベントリの種類名
     */
    DeleteItemModelMasterRequest& withInventoryModelName(const Char* inventoryModelName)
    {
        ensureData().inventoryModelName.emplace(inventoryModelName);
        return *this;
    }
     ...
     * @param itemModelName アイテムモデルの種類名
     */
    DeleteItemModelMasterRequest& withItemModelName(const Char* itemModelName)
    {
        ensureData().itemModelName.emplace(itemModelName);
        return *this;
    }
