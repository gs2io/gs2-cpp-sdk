...
public:
    ...
    DeleteItemSetByUserIdRequest(const DeleteItemSetByUserIdRequest& obj) :
        Gs2BasicRequest(obj),
        Gs2Inventory(obj),
        m_pData(obj.m_pData != nullptr ? new Data(*obj.m_pData) : nullptr)
    {}

    DeleteItemSetByUserIdRequest(DeleteItemSetByUserIdRequest&& obj) :
    ...
    DeleteItemSetByUserIdRequest& operator=(const DeleteItemSetByUserIdRequest& deleteItemSetByUserIdRequest)
    {
        Gs2BasicRequest::operator=(deleteItemSetByUserIdRequest);
        Gs2Inventory::operator=(deleteItemSetByUserIdRequest);

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = new Data(*deleteItemSetByUserIdRequest.m_pData);

        return *this;
    }

    DeleteItemSetByUserIdRequest& operator=(DeleteItemSetByUserIdRequest&& deleteItemSetByUserIdRequest)
    {
        Gs2BasicRequest::operator=(std::move(deleteItemSetByUserIdRequest));
        Gs2Inventory::operator=(std::move(deleteItemSetByUserIdRequest));

        if (m_pData != nullptr)
        {
            delete m_pData;
        }
        m_pData = deleteItemSetByUserIdRequest.m_pData;
        deleteItemSetByUserIdRequest.m_pData = nullptr;
     ...
     * @param categoryName カテゴリ名
     */
    DeleteItemSetByUserIdRequest& withCategoryName(const Char* categoryName)
    {
        ensureData().categoryName.emplace(categoryName);
        return *this;
    }
     ...
     * @param userId ユーザーID
     */
    DeleteItemSetByUserIdRequest& withUserId(const Char* userId)
    {
        ensureData().userId.emplace(userId);
        return *this;
    }
     ...
     * @param inventoryModelName インベントリモデル名
     */
    DeleteItemSetByUserIdRequest& withInventoryModelName(const Char* inventoryModelName)
    {
        ensureData().inventoryModelName.emplace(inventoryModelName);
        return *this;
    }
     ...
     * @param itemModelName アイテムモデルの種類名
     */
    DeleteItemSetByUserIdRequest& withItemModelName(const Char* itemModelName)
    {
        ensureData().itemModelName.emplace(itemModelName);
        return *this;
    }
     ...
     * @param duplicationAvoider 重複実行回避機能に使用するID
     */
    DeleteItemSetByUserIdRequest& withDuplicationAvoider(const Char* duplicationAvoider)
    {
        ensureData().duplicationAvoider.emplace(duplicationAvoider);
        return *this;
    }
     ...
     */
    DeleteItemSetByUserIdRequest& withGs2ClientId(const Char* gs2ClientId)
    {
     ...
     */
    DeleteItemSetByUserIdRequest& withGs2Timestamp(Int64 gs2Timestamp)
    {
     ...
     */
    DeleteItemSetByUserIdRequest& withGs2RequestSign(const Char* gs2RequestSign)
    {
     ...
     */
    DeleteItemSetByUserIdRequest& withRequestId(const Char* gs2RequestId)
    {
