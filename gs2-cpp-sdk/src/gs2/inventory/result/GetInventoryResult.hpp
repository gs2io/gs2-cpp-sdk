...
public:
    GetInventoryResult() = default;
    GetInventoryResult(const GetInventoryResult& getInventoryResult) = default;
    GetInventoryResult(GetInventoryResult&& getInventoryResult) = default;
    ~GetInventoryResult() = default;

    GetInventoryResult& operator=(const GetInventoryResult& getInventoryResult) = default;
    GetInventoryResult& operator=(GetInventoryResult&& getInventoryResult) = default;

    GetInventoryResult deepCopy() const
    {
        GS2_CORE_SHARED_DATA_DEEP_COPY_IMPLEMENTATION(GetInventoryResult);
    }
